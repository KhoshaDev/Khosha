var Ni=Object.defineProperty;var Bn=e=>{throw TypeError(e)};var Bi=(e,t,s)=>t in e?Ni(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var D=(e,t,s)=>Bi(e,typeof t!="symbol"?t+"":t,s),ja=(e,t,s)=>t.has(e)||Bn("Cannot "+s);var i=(e,t,s)=>(ja(e,t,"read from private field"),s?s.call(e):t.get(e)),b=(e,t,s)=>t.has(e)?Bn("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),x=(e,t,s,a)=>(ja(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),g=(e,t,s)=>(ja(e,t,"access private method"),s);var Ht=(e,t,s,a)=>({set _(n){x(e,t,n,s)},get _(){return i(e,t,a)}});(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const l of n)if(l.type==="childList")for(const d of l.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function s(n){const l={};return n.integrity&&(l.integrity=n.integrity),n.referrerPolicy&&(l.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?l.credentials="include":n.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(n){if(n.ep)return;n.ep=!0;const l=s(n);fetch(n.href,l)}})();const c={currentApp:window.innerWidth<768?"launcher":"sales",currentTab:"new-sale",salesMode:"default",salesHistoryId:"ORD-99281",historyViewMode:"completed",historyDateFilter:"today",historyFromDate:"",historyToDate:"",showMobileReceipt:!1,reportsTab:"sales",repairTab:"active",repairViewMode:"search",selectedRepairDevice:null,selectedClient:null,selectedClientId:null,clientViewMode:"directory",clientSearchQuery:"",clientInvoiceId:null,selectedGroupId:null,groupViewMode:"list",groupSearchQuery:"",promoterViewMode:"performance",inventoryTab:"brands",inventoryMode:"details",settingsView:"roles",viewportWidth:window.innerWidth,gridCols:window.innerWidth<768?4:3,schemesTab:"list",activeSchemeBrand:"Apple",activeScheme:"June Activation Bonus",showSchemeDetails:!1,marketplaceTab:"browse",marketplaceViewMode:"list",isLoggedIn:!1,authMode:"login",registrationStep:1,inquiryViewMode:"list",activeInquiry:null,preBookingViewMode:"dashboard",activeCampaign:null,automationViewMode:"dashboard",activeAutomationId:null},hl=[],ml=e=>{hl.push(e)},C=(e=!0)=>{hl.forEach(t=>t(e))};function Fi(e){c.currentApp=e,e==="clients"&&(c.clientViewMode="directory"),C()}function Ui(e){c.currentTab=e,C()}function Vi(e){c.salesHistoryId=e,e&&window.innerWidth<768&&(c.showMobileReceipt=!0),C()}function Gi(e){c.showMobileReceipt=e,C()}function Hi(e){c.reportsTab=e,C()}function Wi(e){c.repairTab=e,C()}function zi(e,t=null){c.repairViewMode=e,t&&(c.selectedRepairDevice=t),C()}function Ji(e){c.gridCols=e,C()}function gl(e,t=null,s=null){c.clientViewMode=e,t&&(c.selectedClient=t),s&&(c.selectedClientId=s),e!=="invoice"&&(c.clientInvoiceId=null),C()}function Yi(e){c.clientInvoiceId=e,c.clientViewMode="invoice",C()}function Ki(e){c.schemesTab=e,C()}function Qi(e){c.activeSchemeBrand=e,C()}function Xi(e){c.activeScheme=e,C()}function Zi(e){c.showSchemeDetails=e,C()}function er(e){c.marketplaceTab=e,C()}function tr(e){c.marketplaceViewMode=e,C()}function sr(e){c.isLoggedIn=e;const t=window.innerWidth<768;c.currentApp=e?t?"launcher":"sales":"launcher",C()}function ar(e){c.authMode=e,c.registrationStep=1,C()}function nr(e){c.registrationStep=e,C()}function lr(e){c.inquiryViewMode=e,C()}function ir(e){c.activeInquiry=e,C()}function rr(e){c.preBookingViewMode=e,C()}function or(e){c.activeCampaign=e,C()}function cr(e){c.automationViewMode=e,C()}function dr(e){c.activeAutomationId=e,C()}window.triggerRender=C;window.setApp=Fi;window.setTab=Ui;window.setSalesHistoryId=Vi;window.toggleMobileReceipt=Gi;window.setReportsTab=Hi;window.setRepairTab=Wi;function wl(e){c.salesMode=e,C()}window.setSalesMode=wl;function pr(e){c.historyViewMode=e,C()}function ur(e){c.historyDateFilter=e,e!=="custom"&&(c.historyFromDate="",c.historyToDate=""),C()}function xr(e,t){c.historyFromDate=e,c.historyToDate=t,c.historyDateFilter="custom",C()}window.setHistoryViewMode=pr;window.setHistoryDateFilter=ur;window.setHistoryCustomDates=xr;window.setRepairMode=zi;window.setGridCols=Ji;window.setClientMode=gl;window.viewClientInvoice=Yi;window.setSchemesTab=Ki;window.setSchemeBrand=Qi;window.setScheme=Xi;window.toggleSchemeDetails=Zi;window.setMarketplaceTab=er;window.setMarketplaceViewMode=tr;window.setLoginStatus=sr;window.setAuthMode=ar;window.setRegistrationStep=nr;window.setInquiryViewMode=lr;window.setActiveInquiry=ir;window.setPreBookingViewMode=rr;window.setActiveCampaign=or;window.setAutomationViewMode=cr;window.setActiveAutomation=dr;function fr(e){c.groupViewMode=e,C()}function br(e){c.selectedGroupId=e,C()}window.setGroupViewMode=fr;window.setSelectedGroup=br;function hr(){return`
    ...
    `}function mr(){const e=c.registrationStep;let t="";return e===1?t=`
    ...
    `}function vl(){return c.authMode==="register"?mr():hr()}const gr=[{n:"SALES DESK",i:"account_balance_wallet",k:"sales"},{n:"CLIENTS",i:"group",k:"clients"},{n:"INQUIRIES",i:"help_outline",k:"inquiries"},{n:"PROMOTERS",i:"business_center",k:"promoters"},{n:"INTERNAL STORE",i:"storefront"},{n:"INVENTORY",i:"inventory_2",k:"inventory"},{n:"REPAIRS",i:"build",k:"repairs"},{n:"MARKETPLACE",i:"swap_horizontal_circle",k:"marketplace"},{n:"CLAIMS",i:"verified_user"},{n:"SCHEMES",i:"percent",k:"schemes"},{n:"MARKETING",i:"campaign",k:"marketing"},{n:"AUTOMATION",i:"smart_toy",s:!0,k:"automation"},{n:"PRE-BOOKING",i:"rocket_launch",k:"prebooking"},{n:"REPORTS",i:"bar_chart",k:"reports"},{n:"SETTINGS",i:"settings",k:"settings"}];function wr(e){const t=e?c.gridCols:4;return`
    ...
    `}function Ba(e){const t=e==="mobile";return`
    ...
    `}class q extends Error{constructor(s,a,n,l,d){a!==void 0&&(s=`${a}: ${s}`);super(s,{cause:d});D(this,"code");D(this,"extendedCode");D(this,"rawCode");this.code=a,this.extendedCode=n,this.rawCode=l,this.name="LibsqlError"}}class Kt extends q{constructor(s,a,n,l,d,r){super(s,n,l,d,r);D(this,"statementIndex");this.statementIndex=a,this.name="LibsqlBatchError"}}function yr(e){const t=kr.exec(e);if(t===null)throw new q(`The URL '${e}' is not in a valid format`,"URL_INVALID");const s=t.groups,a=s.scheme,n=s.authority!==void 0?_r(s.authority):void 0,l=Ft(s.path),d=s.query!==void 0?Ir(s.query):void 0,r=s.fragment!==void 0?Ft(s.fragment):void 0;return{scheme:a,authority:n,path:l,query:d,fragment:r}}const kr=(()=>{const e="(?<scheme>[A-Za-z][A-Za-z.+-]*)",t="(?<authority>[^/?#]*)",s="(?<path>[^?#]*)",a="(?<query>[^#]*)",n="(?<fragment>.*)";return new RegExp(`^${e}:(//${t})?${s}(\\?${a})?(#${n})?$`,"su")})();function _r(e){const t=Sr.exec(e);if(t===null)throw new q("The authority part of the URL is not in a valid format","URL_INVALID");const s=t.groups,a=Ft(s.host_br??s.host),n=s.port?parseInt(s.port,10):void 0,l=s.username!==void 0?{username:Ft(s.username),password:s.password!==void 0?Ft(s.password):void 0}:void 0;return{host:a,port:n,userinfo:l}}const Sr=new RegExp("^((?<username>[^:]*)(:(?<password>.*))?@)?((?<host>[^:\\[\\]]*)|(\\[(?<host_br>[^\\[\\]]*)\\]))(:(?<port>[0-9]*))?$","su");function Ir(e){const t=e.split("&"),s=[];for(const a of t){if(a==="")continue;let n,l;const d=a.indexOf("=");d<0?(n=a,l=""):(n=a.substring(0,d),l=a.substring(d+1)),s.push({key:Ft(n.replaceAll("+"," ")),value:Ft(l.replaceAll("+"," "))})}return{pairs:s}}function Ft(e){try{return decodeURIComponent(e)}catch(t){throw t instanceof URIError?new q(`URL component has invalid percent encoding: ${t}`,"URL_INVALID",void 0,void 0,t):t}}function Fa(e,t,s){if(t===void 0)throw new q(`URL with scheme ${JSON.stringify(e+":")} requires authority (the "//" part)`,"URL_INVALID");const a=`${e}:`,n=$r(t.host),l=Cr(t.port),r=`//${Ar(t.userinfo)}${n}${l}`;let p=s.split("/").map(encodeURIComponent).join("/");return p!==""&&!p.startsWith("/")&&(p="/"+p),new URL(`${a}${r}${p}`)}function $r(e){return e.includes(":")?`[${encodeURI(e)}]`:encodeURI(e)}function Cr(e){return e!==void 0?`:${e}`:""}function Ar(e){if(e===void 0)return"";const t=encodeURIComponent(e.username),s=e.password!==void 0?`:${encodeURIComponent(e.password)}`:"";return`${t}${s}@`}const yl="3.7.8",Rr=yl,Ss=typeof Buffer=="function",Fn=typeof TextDecoder=="function"?new TextDecoder:void 0,Un=typeof TextEncoder=="function"?new TextEncoder:void 0,Er="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",As=Array.prototype.slice.call(Er),ra=(e=>{let t={};return e.forEach((s,a)=>t[s]=a),t})(As),Tr=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,Z=String.fromCharCode.bind(String),Vn=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):e=>new Uint8Array(Array.prototype.slice.call(e,0)),kl=e=>e.replace(/=/g,"").replace(/[+\/]/g,t=>t=="+"?"-":"_"),_l=e=>e.replace(/[^A-Za-z0-9\+\/]/g,""),Sl=e=>{let t,s,a,n,l="";const d=e.length%3;for(let r=0;r<e.length;){if((s=e.charCodeAt(r++))>255||(a=e.charCodeAt(r++))>255||(n=e.charCodeAt(r++))>255)throw new TypeError("invalid character found");t=s<<16|a<<8|n,l+=As[t>>18&63]+As[t>>12&63]+As[t>>6&63]+As[t&63]}return d?l.slice(0,d-3)+"===".substring(d):l},pn=typeof btoa=="function"?e=>btoa(e):Ss?e=>Buffer.from(e,"binary").toString("base64"):Sl,Ua=Ss?e=>Buffer.from(e).toString("base64"):e=>{let s=[];for(let a=0,n=e.length;a<n;a+=4096)s.push(Z.apply(null,e.subarray(a,a+4096)));return pn(s.join(""))},da=(e,t=!1)=>t?kl(Ua(e)):Ua(e),Mr=e=>{if(e.length<2){var t=e.charCodeAt(0);return t<128?e:t<2048?Z(192|t>>>6)+Z(128|t&63):Z(224|t>>>12&15)+Z(128|t>>>6&63)+Z(128|t&63)}else{var t=65536+(e.charCodeAt(0)-55296)*1024+(e.charCodeAt(1)-56320);return Z(240|t>>>18&7)+Z(128|t>>>12&63)+Z(128|t>>>6&63)+Z(128|t&63)}},Dr=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,Il=e=>e.replace(Dr,Mr),Gn=Ss?e=>Buffer.from(e,"utf8").toString("base64"):Un?e=>Ua(Un.encode(e)):e=>pn(Il(e)),Qt=(e,t=!1)=>t?kl(Gn(e)):Gn(e),Hn=e=>Qt(e,!0),Lr=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,qr=e=>{switch(e.length){case 4:var t=(7&e.charCodeAt(0))<<18|(63&e.charCodeAt(1))<<12|(63&e.charCodeAt(2))<<6|63&e.charCodeAt(3),s=t-65536;return Z((s>>>10)+55296)+Z((s&1023)+56320);case 3:return Z((15&e.charCodeAt(0))<<12|(63&e.charCodeAt(1))<<6|63&e.charCodeAt(2));default:return Z((31&e.charCodeAt(0))<<6|63&e.charCodeAt(1))}},$l=e=>e.replace(Lr,qr),Cl=e=>{if(e=e.replace(/\s+/g,""),!Tr.test(e))throw new TypeError("malformed base64.");e+="==".slice(2-(e.length&3));let t,s,a,n=[];for(let l=0;l<e.length;)t=ra[e.charAt(l++)]<<18|ra[e.charAt(l++)]<<12|(s=ra[e.charAt(l++)])<<6|(a=ra[e.charAt(l++)]),s===64?n.push(Z(t>>16&255)):a===64?n.push(Z(t>>16&255,t>>8&255)):n.push(Z(t>>16&255,t>>8&255,t&255));return n.join("")},un=typeof atob=="function"?e=>atob(_l(e)):Ss?e=>Buffer.from(e,"base64").toString("binary"):Cl,Al=Ss?e=>Vn(Buffer.from(e,"base64")):e=>Vn(un(e).split("").map(t=>t.charCodeAt(0))),Rl=e=>Al(El(e)),jr=Ss?e=>Buffer.from(e,"base64").toString("utf8"):Fn?e=>Fn.decode(Al(e)):e=>$l(un(e)),El=e=>_l(e.replace(/[-_]/g,t=>t=="-"?"+":"/")),Va=e=>jr(El(e)),Or=e=>{if(typeof e!="string")return!1;const t=e.replace(/\s+/g,"").replace(/={0,2}$/,"");return!/[^\s0-9a-zA-Z\+/]/.test(t)||!/[^\s0-9a-zA-Z\-_]/.test(t)},Tl=e=>({value:e,enumerable:!1,writable:!0,configurable:!0}),Ml=function(){const e=(t,s)=>Object.defineProperty(String.prototype,t,Tl(s));e("fromBase64",function(){return Va(this)}),e("toBase64",function(t){return Qt(this,t)}),e("toBase64URI",function(){return Qt(this,!0)}),e("toBase64URL",function(){return Qt(this,!0)}),e("toUint8Array",function(){return Rl(this)})},Dl=function(){const e=(t,s)=>Object.defineProperty(Uint8Array.prototype,t,Tl(s));e("toBase64",function(t){return da(this,t)}),e("toBase64URI",function(){return da(this,!0)}),e("toBase64URL",function(){return da(this,!0)})},Pr=()=>{Ml(),Dl()},xn={version:yl,VERSION:Rr,atob:un,atobPolyfill:Cl,btoa:pn,btoaPolyfill:Sl,fromBase64:Va,toBase64:Qt,encode:Qt,encodeURI:Hn,encodeURL:Hn,utob:Il,btou:$l,decode:Va,isValid:Or,fromUint8Array:da,toUint8Array:Rl,extendString:Ml,extendUint8Array:Dl,extendBuiltins:Pr},Bs="https://github.com/libsql/libsql-client-ts#supported-urls";function Ga(e){if(e==="write")return"BEGIN IMMEDIATE";if(e==="read")return"BEGIN TRANSACTION READONLY";if(e==="deferred")return"BEGIN DEFERRED";throw RangeError('Unknown transaction mode, supported values are "write", "read" and "deferred"')}class Nr{constructor(t,s,a,n,l){D(this,"columns");D(this,"columnTypes");D(this,"rows");D(this,"rowsAffected");D(this,"lastInsertRowid");this.columns=t,this.columnTypes=s,this.rows=a,this.rowsAffected=n,this.lastInsertRowid=l}toJSON(){return{columns:this.columns,columnTypes:this.columnTypes,rows:this.rows.map(Br),rowsAffected:this.rowsAffected,lastInsertRowid:this.lastInsertRowid!==void 0?""+this.lastInsertRowid:null}}}function Br(e){return Array.prototype.map.call(e,Fr)}function Fr(e){return typeof e=="bigint"?""+e:e instanceof ArrayBuffer?xn.fromUint8Array(new Uint8Array(e)):e}const Wn=":memory:";function Ur(e,t){var S,_;if(typeof e!="object")throw new TypeError(`Expected client configuration as object, got ${typeof e}`);let{url:s,authToken:a,tls:n,intMode:l,concurrency:d}=e;d=Math.max(0,d||20),l??(l="number");let r=[];s===Wn&&(s="file::memory:");const p=yr(s),o=p.scheme.toLowerCase(),u=o==="file"&&p.path===Wn&&p.authority===void 0;let h;u?h={cache:{values:["shared","private"],update:(k,P)=>r.push(`${k}=${P}`)}}:h={tls:{values:["0","1"],update:(k,P)=>n=P==="1"},authToken:{update:(k,P)=>a=P}};for(const{key:k,value:P}of((S=p.query)==null?void 0:S.pairs)??[]){if(!Object.hasOwn(h,k))throw new q(`Unsupported URL query parameter ${JSON.stringify(k)}`,"URL_PARAM_NOT_SUPPORTED");const G=h[k];if(G.values!==void 0&&!G.values.includes(P))throw new q(`Unknown value for the "${k}" query argument: ${JSON.stringify(P)}. Supported values are: [${G.values.map(Cs=>'"'+Cs+'"').join(", ")}]`,"URL_INVALID");G.update!==void 0&&(G==null||G.update(k,P))}const w=r.length===0?"":`?${r.join("&")}`,v=p.path+w;let m;if(o==="libsql")if(n===!1){if(((_=p.authority)==null?void 0:_.port)===void 0)throw new q('A "libsql:" URL with ?tls=0 must specify an explicit port',"URL_INVALID");m="http"}else m="https";else m=o;if(m==="http"||m==="ws"?n??(n=!1):n??(n=!0),m!=="http"&&m!=="ws"&&m!=="https"&&m!=="wss"&&m!=="file")throw new q(`The client supports only "libsql:", "wss:", "ws:", "https:", "http:" and "file:" URLs, got ${JSON.stringify(p.scheme+":")}. For more information, please read ${Bs}`,"URL_SCHEME_NOT_SUPPORTED");if(l!=="number"&&l!=="bigint"&&l!=="string")throw new TypeError(`Invalid value for intMode, expected "number", "bigint" or "string", got ${JSON.stringify(l)}`);if(p.fragment!==void 0)throw new q(`URL fragments are not supported: ${JSON.stringify("#"+p.fragment)}`,"URL_INVALID");return u?{scheme:"file",tls:!1,path:v,intMode:l,concurrency:d,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch,authToken:void 0,encryptionKey:void 0,remoteEncryptionKey:void 0,authority:void 0}:{scheme:m,tls:n,authority:p.authority,path:v,authToken:a,intMode:l,concurrency:d,encryptionKey:e.encryptionKey,remoteEncryptionKey:e.remoteEncryptionKey,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch}}let Jt;typeof WebSocket<"u"?Jt=WebSocket:typeof global<"u"?Jt=global.WebSocket:typeof window<"u"?Jt=window.WebSocket:typeof self<"u"&&(Jt=self.WebSocket);class Ll{constructor(){D(this,"intMode");this.intMode="number"}}class U extends Error{constructor(t){super(t),this.name="ClientError"}}class R extends U{constructor(t){super(t),this.name="ProtoError"}}class ql extends U{constructor(s,a){super(s);D(this,"code");D(this,"proto");this.name="ResponseError",this.code=a.code,this.proto=a,this.stack=void 0}}class ke extends U{constructor(t,s){s!==void 0?(super(`${t}: ${s}`),this.cause=s):super(t),this.name="ClosedError"}}class jl extends U{constructor(t){super(t),this.name="WebSocketUnsupportedError"}}class Ha extends U{constructor(t){super(t),this.name="WebSocketError"}}class pa extends U{constructor(s,a){super(s);D(this,"status");this.status=a,this.name="HttpServerError"}}class vs extends U{constructor(t){super(t),this.name="ProtocolVersionError"}}class kt extends U{constructor(t){super(t),this.name="InternalError"}}class Is extends U{constructor(t){super(t),this.name="MisuseError"}}function Me(e){if(typeof e=="string")return e;throw $s(e,"string")}function Le(e){if(e!=null){if(typeof e=="string")return e;throw $s(e,"string or null")}}function Ut(e){if(typeof e=="number")return e;throw $s(e,"number")}function Fs(e){if(typeof e=="boolean")return e;throw $s(e,"boolean")}function ma(e){if(Array.isArray(e))return e;throw $s(e,"array")}function ee(e){if(e!==null&&typeof e=="object"&&!Array.isArray(e))return e;throw $s(e,"object")}function _t(e,t){return ma(e).map(s=>t(ee(s)))}function $s(e,t){if(e===void 0)return new R(`Expected ${t}, but the property was missing`);let s=typeof e;return e===null?s="null":Array.isArray(e)&&(s="array"),new R(`Expected ${t}, received ${s}`)}function fn(e,t){return t(ee(e))}var H,dt,He,$t;class Vr{constructor(t){b(this,He);b(this,H);b(this,dt);x(this,H,t),x(this,dt,!1)}begin(){i(this,H).push("{"),x(this,dt,!0)}end(){i(this,H).push("}"),x(this,dt,!1)}string(t,s){g(this,He,$t).call(this,t),i(this,H).push(JSON.stringify(s))}stringRaw(t,s){g(this,He,$t).call(this,t),i(this,H).push('"'),i(this,H).push(s),i(this,H).push('"')}number(t,s){g(this,He,$t).call(this,t),i(this,H).push(""+s)}boolean(t,s){g(this,He,$t).call(this,t),i(this,H).push(s?"true":"false")}object(t,s,a){g(this,He,$t).call(this,t),this.begin(),a(this,s),this.end()}arrayObjects(t,s,a){g(this,He,$t).call(this,t),i(this,H).push("[");for(let n=0;n<s.length;++n)n!==0&&i(this,H).push(","),this.begin(),a(this,s[n]),this.end();i(this,H).push("]")}}H=new WeakMap,dt=new WeakMap,He=new WeakSet,$t=function(t){i(this,dt)?(i(this,H).push('"'),x(this,dt,!1)):i(this,H).push(',"'),i(this,H).push(t),i(this,H).push('":')};function Ol(e,t){const s=[],a=new Vr(s);return a.begin(),t(a,e),a.end(),s.join("")}const Ps=0,Wa=1,za=2,Gr=5;var je,Us,be;class Hr{constructor(t){b(this,je);b(this,Us);b(this,be);x(this,je,t),x(this,Us,new DataView(t.buffer,t.byteOffset,t.byteLength)),x(this,be,0)}varint(){let t=0;for(let s=0;;s+=7){const a=i(this,je)[Ht(this,be)._++];if(t|=(a&127)<<s,!(a&128))break}return t}varintBig(){let t=0n;for(let s=0n;;s+=7n){const a=i(this,je)[Ht(this,be)._++];if(t|=BigInt(a&127)<<s,!(a&128))break}return t}bytes(t){const s=new Uint8Array(i(this,je).buffer,i(this,je).byteOffset+i(this,be),t);return x(this,be,i(this,be)+t),s}double(){const t=i(this,Us).getFloat64(i(this,be),!0);return x(this,be,i(this,be)+8),t}skipVarint(){for(;i(this,je)[Ht(this,be)._++]&128;);}skip(t){x(this,be,i(this,be)+t)}eof(){return i(this,be)>=i(this,je).byteLength}}je=new WeakMap,Us=new WeakMap,be=new WeakMap;var re,ae,Et,Rs;class Wr{constructor(t){b(this,Et);b(this,re);b(this,ae);x(this,re,t),x(this,ae,-1)}setup(t){x(this,ae,t)}bytes(){g(this,Et,Rs).call(this,za);const t=i(this,re).varint();return i(this,re).bytes(t)}string(){return new TextDecoder().decode(this.bytes())}message(t){return Ra(this.bytes(),t)}int32(){return g(this,Et,Rs).call(this,Ps),i(this,re).varint()}uint32(){return this.int32()}bool(){return this.int32()!==0}uint64(){return g(this,Et,Rs).call(this,Ps),i(this,re).varintBig()}sint64(){const t=this.uint64();return t>>1n^-(t&1n)}double(){return g(this,Et,Rs).call(this,Wa),i(this,re).double()}maybeSkip(){if(!(i(this,ae)<0)){if(i(this,ae)===Ps)i(this,re).skipVarint();else if(i(this,ae)===Wa)i(this,re).skip(8);else if(i(this,ae)===za){const t=i(this,re).varint();i(this,re).skip(t)}else if(i(this,ae)===Gr)i(this,re).skip(4);else throw new R(`Unexpected wire type ${i(this,ae)}`);x(this,ae,-1)}}}re=new WeakMap,ae=new WeakMap,Et=new WeakSet,Rs=function(t){if(i(this,ae)!==t)throw new R(`Expected wire type ${t}, got ${i(this,ae)}`);x(this,ae,-1)};function Ra(e,t){const s=new Hr(e),a=new Wr(s);let n=t.default();for(;!s.eof();){const l=s.varint(),d=l>>3,r=l&7;a.setup(r);const p=t[d];if(p!==void 0){const o=p(a,n);o!==void 0&&(n=o)}a.maybeSkip()}return n}var Se,pt,es,oe,Y,Es,ua,Pl,Ts;const jn=class jn{constructor(){b(this,Y);b(this,Se);b(this,pt);b(this,es);b(this,oe);x(this,Se,new ArrayBuffer(256)),x(this,pt,new Uint8Array(i(this,Se))),x(this,es,new DataView(i(this,Se))),x(this,oe,0)}bytes(t,s){g(this,Y,Ts).call(this,t,za),g(this,Y,ua).call(this,s.byteLength),g(this,Y,Es).call(this,s.byteLength),i(this,pt).set(s,i(this,oe)),x(this,oe,i(this,oe)+s.byteLength)}string(t,s){this.bytes(t,new TextEncoder().encode(s))}message(t,s,a){const n=new jn;a(n,s),this.bytes(t,n.data())}int32(t,s){g(this,Y,Ts).call(this,t,Ps),g(this,Y,ua).call(this,s)}uint32(t,s){this.int32(t,s)}bool(t,s){this.int32(t,s?1:0)}sint64(t,s){g(this,Y,Ts).call(this,t,Ps),g(this,Y,Pl).call(this,s<<1n^s>>63n)}double(t,s){g(this,Y,Ts).call(this,t,Wa),g(this,Y,Es).call(this,8),i(this,es).setFloat64(i(this,oe),s,!0),x(this,oe,i(this,oe)+8)}data(){return new Uint8Array(i(this,Se),0,i(this,oe))}};Se=new WeakMap,pt=new WeakMap,es=new WeakMap,oe=new WeakMap,Y=new WeakSet,Es=function(t){if(i(this,oe)+t<=i(this,Se).byteLength)return;let s=i(this,Se).byteLength;for(;s<i(this,oe)+t;)s*=2;const a=new ArrayBuffer(s),n=new Uint8Array(a),l=new DataView(a);n.set(new Uint8Array(i(this,Se),0,i(this,oe))),x(this,Se,a),x(this,pt,n),x(this,es,l)},ua=function(t){g(this,Y,Es).call(this,5),t=0|t;do{let s=t&127;t>>>=7,s|=t?128:0,i(this,pt)[Ht(this,oe)._++]=s}while(t)},Pl=function(t){g(this,Y,Es).call(this,10),t=t&0xffffffffffffffffn;do{let s=Number(t&0x7fn);t>>=7n,s|=t?128:0,i(this,pt)[Ht(this,oe)._++]=s}while(t)},Ts=function(t,s){g(this,Y,ua).call(this,t<<3|s)};let Ja=jn;function Nl(e,t){const s=new Ja;return t(s,e),s.data()}var he,We;class Ms{constructor(){b(this,he);b(this,We);x(this,he,new Set),x(this,We,new Set)}alloc(){for(const s of i(this,We))return i(this,We).delete(s),i(this,he).add(s),i(this,he).has(i(this,he).size-1)||i(this,We).add(i(this,he).size-1),s;const t=i(this,he).size;return i(this,he).add(t),t}free(t){if(!i(this,he).delete(t))throw new kt("Freeing an id that is not allocated");i(this,We).delete(i(this,he).size),t<i(this,he).size&&i(this,We).add(t)}}he=new WeakMap,We=new WeakMap;function V(e,t){throw new kt(t)}function Ns(e){if(e===null)return null;if(typeof e=="string")return e;if(typeof e=="number"){if(!Number.isFinite(e))throw new RangeError("Only finite numbers (not Infinity or NaN) can be passed as arguments");return e}else if(typeof e=="bigint"){if(e<zr||e>Jr)throw new RangeError("This bigint value is too large to be represented as a 64-bit integer and passed as argument");return e}else{if(typeof e=="boolean")return e?1n:0n;if(e instanceof ArrayBuffer)return new Uint8Array(e);if(e instanceof Uint8Array)return e;if(e instanceof Date)return+e.valueOf();if(typeof e=="object")return""+e.toString();throw new TypeError("Unsupported type of value")}}const zr=-9223372036854775808n,Jr=9223372036854775807n;function Bl(e,t){if(e===null)return null;if(typeof e=="number")return e;if(typeof e=="string")return e;if(typeof e=="bigint")if(t==="number"){const s=Number(e);if(!Number.isSafeInteger(s))throw new RangeError("Received integer which is too large to be safely represented as a JavaScript number");return s}else{if(t==="bigint")return e;if(t==="string")return""+e;throw new Is("Invalid value for IntMode")}else{if(e instanceof Uint8Array)return e.slice().buffer;throw e===void 0?new R("Received unrecognized type of Value"):V(e,"Impossible type of Value")}}function na(e){return{affectedRowCount:e.affectedRowCount,lastInsertRowid:e.lastInsertRowid,columnNames:e.cols.map(t=>t.name),columnDecltypes:e.cols.map(t=>t.decltype)}}function Fl(e,t){const s=na(e),a=e.rows.map(n=>Gl(s.columnNames,n,t));return{...s,rows:a}}function Ul(e,t){const s=na(e);let a;return e.rows.length>0&&(a=Gl(s.columnNames,e.rows[0],t)),{...s,row:a}}function Vl(e,t){const s=na(e);let a;return e.rows.length>0&&s.columnNames.length>0&&(a=Bl(e.rows[0][0],t)),{...s,value:a}}function Gl(e,t,s){const a={};Object.defineProperty(a,"length",{value:t.length});for(let n=0;n<t.length;++n){const l=Bl(t[n],s);Object.defineProperty(a,n,{value:l});const d=e[n];d!==void 0&&!Object.hasOwn(a,d)&&Object.defineProperty(a,d,{value:l,enumerable:!0,configurable:!0,writable:!0})}return a}function ys(e){return new ql(e.message,e)}var ts,ss,ze;class bn{constructor(t,s){b(this,ts);b(this,ss);b(this,ze);x(this,ts,t),x(this,ss,s),x(this,ze,void 0)}_getSqlId(t){if(i(this,ts)!==t)throw new Is("Attempted to use SQL text opened with other object");if(i(this,ze)!==void 0)throw new ke("SQL text is closed",i(this,ze));return i(this,ss)}close(){this._setClosed(new U("SQL text was manually closed"))}_setClosed(t){i(this,ze)===void 0&&(x(this,ze,t),i(this,ts)._closeSql(i(this,ss)))}get closed(){return i(this,ze)!==void 0}}ts=new WeakMap,ss=new WeakMap,ze=new WeakMap;function Ya(e,t){return t instanceof bn?{sqlId:t._getSqlId(e)}:{sql:""+t}}var Oe,Ie;class ga{constructor(){b(this,Oe);b(this,Ie);x(this,Oe,[]),x(this,Ie,[])}get length(){return i(this,Oe).length+i(this,Ie).length}push(t){i(this,Oe).push(t)}shift(){return i(this,Ie).length===0&&i(this,Oe).length>0&&(x(this,Ie,i(this,Oe).reverse()),x(this,Oe,[])),i(this,Ie).pop()}first(){return i(this,Ie).length!==0?i(this,Ie)[i(this,Ie).length-1]:i(this,Oe)[0]}}Oe=new WeakMap,Ie=new WeakMap;let Hl=class{constructor(t){D(this,"sql");D(this,"_args");D(this,"_namedArgs");this.sql=t,this._args=[],this._namedArgs=new Map}bindIndexes(t){this._args.length=0;for(const s of t)this._args.push(Ns(s));return this}bindIndex(t,s){if(t!==(t|0)||t<=0)throw new RangeError("Index of a positional argument must be positive integer");for(;this._args.length<t;)this._args.push(null);return this._args[t-1]=Ns(s),this}bindName(t,s){return this._namedArgs.set(t,Ns(s)),this}unbindAll(){return this._args.length=0,this._namedArgs.clear(),this}};function Wl(e,t,s){let a,n=[],l=[];if(t instanceof Hl){a=t.sql,n=t._args;for(const[p,o]of t._namedArgs.entries())l.push({name:p,value:o})}else Array.isArray(t)?(a=t[0],Array.isArray(t[1])?n=t[1].map(p=>Ns(p)):l=Object.entries(t[1]).map(([p,o])=>({name:p,value:Ns(o)}))):a=t;const{sql:d,sqlId:r}=Ya(e,a);return{sql:d,sqlId:r,args:n,namedArgs:l,wantRows:s}}var Vs,as,ul;let Yr=(ul=class{constructor(t,s){D(this,"_stream");b(this,Vs);D(this,"_steps");b(this,as);this._stream=t,x(this,Vs,s),this._steps=[],x(this,as,!1)}step(){return new Xr(this)}execute(){if(i(this,as))throw new Is("This batch has already been executed");x(this,as,!0);const t={steps:this._steps.map(s=>s.proto)};return i(this,Vs)?Qr(this._stream,this._steps,t):Kr(this._stream,this._steps,t)}},Vs=new WeakMap,as=new WeakMap,ul);function Kr(e,t,s){return e._batch(s).then(a=>{for(let n=0;n<t.length;++n){const l=a.stepResults.get(n),d=a.stepErrors.get(n);t[n].callback(l,d)}})}async function Qr(e,t,s){const a=await e._openCursor(s);try{let n=0,l,d=[];for(;;){const r=await a.next();if(r===void 0)break;if(r.type==="step_begin"){if(r.step<n||r.step>=t.length)throw new R("Server produced StepBeginEntry for unexpected step");if(l!==void 0)throw new R("Server produced StepBeginEntry before terminating previous step");for(let p=n;p<r.step;++p)t[p].callback(void 0,void 0);n=r.step+1,l=r,d=[]}else if(r.type==="step_end"){if(l===void 0)throw new R("Server produced StepEndEntry but no step is active");const p={cols:l.cols,rows:d,affectedRowCount:r.affectedRowCount,lastInsertRowid:r.lastInsertRowid};t[l.step].callback(p,void 0),l=void 0,d=[]}else if(r.type==="step_error"){if(l===void 0){if(r.step>=t.length)throw new R("Server produced StepErrorEntry for unexpected step");for(let p=n;p<r.step;++p)t[p].callback(void 0,void 0)}else{if(r.step!==l.step)throw new R("Server produced StepErrorEntry for unexpected step");l=void 0,d=[]}t[r.step].callback(void 0,r.error),n=r.step+1}else if(r.type==="row"){if(l===void 0)throw new R("Server produced RowEntry but no step is active");d.push(r.row)}else throw r.type==="error"?ys(r.error):r.type==="none"?new R("Server produced unrecognized CursorEntry"):V(r,"Impossible CursorEntry")}if(l!==void 0)throw new R("Server closed Cursor before terminating active step");for(let r=n;r<t.length;++r)t[r].callback(void 0,void 0)}finally{a.close()}}var Je,Tt,Ds,xl;let Xr=(xl=class{constructor(t){b(this,Tt);D(this,"_batch");b(this,Je);D(this,"_index");this._batch=t,x(this,Je,[]),this._index=void 0}condition(t){return i(this,Je).push(t._proto),this}query(t){return g(this,Tt,Ds).call(this,t,!0,Fl)}queryRow(t){return g(this,Tt,Ds).call(this,t,!0,Ul)}queryValue(t){return g(this,Tt,Ds).call(this,t,!0,Vl)}run(t){return g(this,Tt,Ds).call(this,t,!1,na)}},Je=new WeakMap,Tt=new WeakSet,Ds=function(t,s,a){if(this._index!==void 0)throw new Is("This BatchStep has already been added to the batch");const n=Wl(this._batch._stream._sqlOwner(),t,s);let l;i(this,Je).length===0?l=void 0:i(this,Je).length===1?l=i(this,Je)[0]:l={type:"and",conds:i(this,Je).slice()};const d={stmt:n,condition:l};return new Promise((r,p)=>{const o=(u,h)=>{u!==void 0&&h!==void 0?p(new R("Server returned both result and error")):h!==void 0?p(ys(h)):r(u!==void 0?a(u,this._batch._stream.intMode):void 0)};this._index=this._batch._steps.length,this._batch._steps.push({proto:d,callback:o})})},xl),ue=class Ct{constructor(t,s){D(this,"_batch");D(this,"_proto");this._batch=t,this._proto=s}static ok(t){return new Ct(t._batch,{type:"ok",step:zn(t)})}static error(t){return new Ct(t._batch,{type:"error",step:zn(t)})}static not(t){return new Ct(t._batch,{type:"not",cond:t._proto})}static and(t,s){for(const a of s)Jn(t,a);return new Ct(t,{type:"and",conds:s.map(a=>a._proto)})}static or(t,s){for(const a of s)Jn(t,a);return new Ct(t,{type:"or",conds:s.map(a=>a._proto)})}static isAutocommit(t){return t._stream.client()._ensureVersion(3,"BatchCond.isAutocommit()"),new Ct(t,{type:"is_autocommit"})}};function zn(e){if(e._index===void 0)throw new Is("Cannot add a condition referencing a step that has not been added to the batch");return e._index}function Jn(e,t){if(t._batch!==e)throw new Is("Cannot mix BatchCond objects for different Batch objects")}function Zr(e){return{paramNames:e.params.map(t=>t.name),columns:e.cols,isExplain:e.isExplain,isReadonly:e.isReadonly}}var Mt,Ls;class zl{constructor(t){b(this,Mt);D(this,"intMode");this.intMode=t}query(t){return g(this,Mt,Ls).call(this,t,!0,Fl)}queryRow(t){return g(this,Mt,Ls).call(this,t,!0,Ul)}queryValue(t){return g(this,Mt,Ls).call(this,t,!0,Vl)}run(t){return g(this,Mt,Ls).call(this,t,!1,na)}batch(t=!1){return new Yr(this,t)}describe(t){const s=Ya(this._sqlOwner(),t);return this._describe(s).then(Zr)}sequence(t){const s=Ya(this._sqlOwner(),t);return this._sequence(s)}}Mt=new WeakSet,Ls=function(t,s,a){const n=Wl(this._sqlOwner(),t,s);return this._execute(n).then(l=>a(l,this.intMode))};class Jl{}const eo=1e3,to=10;var $a,Dt,ns,ls,Lt,Ye,qt,Ca,Yl;class so extends Jl{constructor(s,a,n){super();b(this,Ca);b(this,$a);b(this,Dt);b(this,ns);b(this,ls);b(this,Lt);b(this,Ye);b(this,qt);x(this,$a,s),x(this,Dt,a),x(this,ns,n),x(this,ls,new ga),x(this,Lt,new ga),x(this,Ye,void 0),x(this,qt,!1)}async next(){for(;;){if(i(this,Ye)!==void 0)throw new ke("Cursor is closed",i(this,Ye));for(;!i(this,qt)&&i(this,Lt).length<to;)i(this,Lt).push(g(this,Ca,Yl).call(this));const s=i(this,ls).shift();if(i(this,qt)||s!==void 0)return s;await i(this,Lt).shift().then(a=>{if(a!==void 0){for(const n of a.entries)i(this,ls).push(n);i(this,qt)||x(this,qt,a.done)}})}}_setClosed(s){i(this,Ye)===void 0&&(x(this,Ye,s),i(this,Dt)._sendCursorRequest(this,{type:"close_cursor",cursorId:i(this,ns)}).catch(()=>{}),i(this,Dt)._cursorClosed(this))}close(){this._setClosed(new U("Cursor was manually closed"))}get closed(){return i(this,Ye)!==void 0}}$a=new WeakMap,Dt=new WeakMap,ns=new WeakMap,ls=new WeakMap,Lt=new WeakMap,Ye=new WeakMap,qt=new WeakMap,Ca=new WeakSet,Yl=function(){return i(this,Dt)._sendCursorRequest(this,{type:"fetch_cursor",cursorId:i(this,ns),maxCount:eo}).then(s=>s,s=>{this._setClosed(s)})};var X,ve,Ke,me,ut,$e,W,Wt,Qa,xa,fa;const On=class On extends zl{constructor(s,a){super(s.intMode);b(this,W);b(this,X);b(this,ve);b(this,Ke);b(this,me);b(this,ut);b(this,$e);x(this,X,s),x(this,ve,a),x(this,Ke,new ga),x(this,me,void 0),x(this,ut,!1),x(this,$e,void 0)}static open(s){const a=s._streamIdAlloc.alloc(),n=new On(s,a),l=()=>{},d=p=>{var o;return g(o=n,W,fa).call(o,p)},r={type:"open_stream",streamId:a};return s._sendRequest(r,{responseCallback:l,errorCallback:d}),n}client(){return i(this,X)}_sqlOwner(){return i(this,X)}_execute(s){return g(this,W,Wt).call(this,{type:"execute",streamId:i(this,ve),stmt:s}).then(a=>a.result)}_batch(s){return g(this,W,Wt).call(this,{type:"batch",streamId:i(this,ve),batch:s}).then(a=>a.result)}_describe(s){return i(this,X)._ensureVersion(2,"describe()"),g(this,W,Wt).call(this,{type:"describe",streamId:i(this,ve),sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return i(this,X)._ensureVersion(2,"sequence()"),g(this,W,Wt).call(this,{type:"sequence",streamId:i(this,ve),sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return i(this,X)._ensureVersion(3,"getAutocommit()"),g(this,W,Wt).call(this,{type:"get_autocommit",streamId:i(this,ve)}).then(s=>s.isAutocommit)}_openCursor(s){return i(this,X)._ensureVersion(3,"cursor"),new Promise((a,n)=>{g(this,W,Qa).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_sendCursorRequest(s,a){if(s!==i(this,me))throw new kt("Cursor not associated with the stream attempted to execute a request");return new Promise((n,l)=>{i(this,$e)!==void 0?l(new ke("Stream is closed",i(this,$e))):i(this,X)._sendRequest(a,{responseCallback:n,errorCallback:l})})}_cursorClosed(s){if(s!==i(this,me))throw new kt("Cursor was closed, but it was not associated with the stream");x(this,me,void 0),g(this,W,xa).call(this)}close(){g(this,W,fa).call(this,new U("Stream was manually closed"))}closeGracefully(){x(this,ut,!0),g(this,W,xa).call(this)}get closed(){return i(this,$e)!==void 0||i(this,ut)}};X=new WeakMap,ve=new WeakMap,Ke=new WeakMap,me=new WeakMap,ut=new WeakMap,$e=new WeakMap,W=new WeakSet,Wt=function(s){return new Promise((a,n)=>{g(this,W,Qa).call(this,{type:"request",request:s,responseCallback:a,errorCallback:n})})},Qa=function(s){i(this,$e)!==void 0?s.errorCallback(new ke("Stream is closed",i(this,$e))):i(this,ut)?s.errorCallback(new ke("Stream is closing",void 0)):(i(this,Ke).push(s),g(this,W,xa).call(this))},xa=function(){for(;;){const s=i(this,Ke).first();if(s===void 0&&i(this,me)===void 0&&i(this,ut)){g(this,W,fa).call(this,new U("Stream was gracefully closed"));break}else if((s==null?void 0:s.type)==="request"&&i(this,me)===void 0){const{request:a,responseCallback:n,errorCallback:l}=s;i(this,Ke).shift(),i(this,X)._sendRequest(a,{responseCallback:n,errorCallback:l})}else if((s==null?void 0:s.type)==="cursor"&&i(this,me)===void 0){const{batch:a,cursorCallback:n}=s;i(this,Ke).shift();const l=i(this,X)._cursorIdAlloc.alloc(),d=new so(i(this,X),this,l),r={type:"open_cursor",streamId:i(this,ve),cursorId:l,batch:a},p=()=>{},o=u=>d._setClosed(u);i(this,X)._sendRequest(r,{responseCallback:p,errorCallback:o}),x(this,me,d),n(d)}else break}},fa=function(s){if(i(this,$e)!==void 0)return;for(x(this,$e,s),i(this,me)!==void 0&&i(this,me)._setClosed(s);;){const d=i(this,Ke).shift();if(d!==void 0)d.errorCallback(s);else break}const a={type:"close_stream",streamId:i(this,ve)},n=()=>i(this,X)._streamIdAlloc.free(i(this,ve)),l=()=>{};i(this,X)._sendRequest(a,{responseCallback:n,errorCallback:l})};let Ka=On;function hn(e,t){t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId),e.arrayObjects("args",t.args,Kl),e.arrayObjects("named_args",t.namedArgs,ao),e.boolean("want_rows",t.wantRows)}function ao(e,t){e.string("name",t.name),e.object("value",t.value,Kl)}function wa(e,t){e.arrayObjects("steps",t.steps,no)}function no(e,t){t.condition!==void 0&&e.object("condition",t.condition,Xa),e.object("stmt",t.stmt,hn)}function Xa(e,t){if(e.stringRaw("type",t.type),t.type==="ok"||t.type==="error")e.number("step",t.step);else if(t.type==="not")e.object("cond",t.cond,Xa);else if(t.type==="and"||t.type==="or")e.arrayObjects("conds",t.conds,Xa);else if(t.type!=="is_autocommit")throw V(t,"Impossible type of BatchCond")}function Kl(e,t){if(t===null)e.stringRaw("type","null");else if(typeof t=="bigint")e.stringRaw("type","integer"),e.stringRaw("value",""+t);else if(typeof t=="number")e.stringRaw("type","float"),e.number("value",t);else if(typeof t=="string")e.stringRaw("type","text"),e.string("value",t);else if(t instanceof Uint8Array)e.stringRaw("type","blob"),e.stringRaw("base64",xn.fromUint8Array(t));else if(t!==void 0)throw V(t,"Impossible type of Value")}function lo(e,t){if(e.stringRaw("type",t.type),t.type==="hello")t.jwt!==void 0&&e.string("jwt",t.jwt);else if(t.type==="request")e.number("request_id",t.requestId),e.object("request",t.request,io);else throw V(t,"Impossible type of ClientMsg")}function io(e,t){if(e.stringRaw("type",t.type),t.type==="open_stream")e.number("stream_id",t.streamId);else if(t.type==="close_stream")e.number("stream_id",t.streamId);else if(t.type==="execute")e.number("stream_id",t.streamId),e.object("stmt",t.stmt,hn);else if(t.type==="batch")e.number("stream_id",t.streamId),e.object("batch",t.batch,wa);else if(t.type==="open_cursor")e.number("stream_id",t.streamId),e.number("cursor_id",t.cursorId),e.object("batch",t.batch,wa);else if(t.type==="close_cursor")e.number("cursor_id",t.cursorId);else if(t.type==="fetch_cursor")e.number("cursor_id",t.cursorId),e.number("max_count",t.maxCount);else if(t.type==="sequence")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type==="get_autocommit")e.number("stream_id",t.streamId);else throw V(t,"Impossible type of Request")}function mn(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId);for(const s of t.args)e.message(3,s,Ql);for(const s of t.namedArgs)e.message(4,s,ro);e.bool(5,t.wantRows)}function ro(e,t){e.string(1,t.name),e.message(2,t.value,Ql)}function Ea(e,t){for(const s of t.steps)e.message(1,s,oo)}function oo(e,t){t.condition!==void 0&&e.message(1,t.condition,gn),e.message(2,t.stmt,mn)}function gn(e,t){if(t.type==="ok")e.uint32(1,t.step);else if(t.type==="error")e.uint32(2,t.step);else if(t.type==="not")e.message(3,t.cond,gn);else if(t.type==="and")e.message(4,t.conds,Yn);else if(t.type==="or")e.message(5,t.conds,Yn);else if(t.type==="is_autocommit")e.message(6,void 0,Xl);else throw V(t,"Impossible type of BatchCond")}function Yn(e,t){for(const s of t)e.message(1,s,gn)}function Ql(e,t){if(t===null)e.message(1,void 0,Xl);else if(typeof t=="bigint")e.sint64(2,t);else if(typeof t=="number")e.double(3,t);else if(typeof t=="string")e.string(4,t);else if(t instanceof Uint8Array)e.bytes(5,t);else if(t!==void 0)throw V(t,"Impossible type of Value")}function Xl(e,t){}function co(e,t){if(t.type==="hello")e.message(1,t,po);else if(t.type==="request")e.message(2,t,uo);else throw V(t,"Impossible type of ClientMsg")}function po(e,t){t.jwt!==void 0&&e.string(1,t.jwt)}function uo(e,t){e.int32(1,t.requestId);const s=t.request;if(s.type==="open_stream")e.message(2,s,xo);else if(s.type==="close_stream")e.message(3,s,fo);else if(s.type==="execute")e.message(4,s,bo);else if(s.type==="batch")e.message(5,s,ho);else if(s.type==="open_cursor")e.message(6,s,mo);else if(s.type==="close_cursor")e.message(7,s,go);else if(s.type==="fetch_cursor")e.message(8,s,wo);else if(s.type==="sequence")e.message(9,s,vo);else if(s.type==="describe")e.message(10,s,yo);else if(s.type==="store_sql")e.message(11,s,ko);else if(s.type==="close_sql")e.message(12,s,_o);else if(s.type==="get_autocommit")e.message(13,s,So);else throw V(s,"Impossible type of Request")}function xo(e,t){e.int32(1,t.streamId)}function fo(e,t){e.int32(1,t.streamId)}function bo(e,t){e.int32(1,t.streamId),e.message(2,t.stmt,mn)}function ho(e,t){e.int32(1,t.streamId),e.message(2,t.batch,Ea)}function mo(e,t){e.int32(1,t.streamId),e.int32(2,t.cursorId),e.message(3,t.batch,Ea)}function go(e,t){e.int32(1,t.cursorId)}function wo(e,t){e.int32(1,t.cursorId),e.uint32(2,t.maxCount)}function vo(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function yo(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function ko(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function _o(e,t){e.int32(1,t.sqlId)}function So(e,t){e.int32(1,t.streamId)}function ks(e){const t=Me(e.message),s=Le(e.code);return{message:t,code:s}}function wn(e){const t=_t(e.cols,Zl),s=ma(e.rows).map(d=>_t(d,ai)),a=Ut(e.affected_row_count),n=Le(e.last_insert_rowid),l=n!==void 0?BigInt(n):void 0;return{cols:t,rows:s,affectedRowCount:a,lastInsertRowid:l}}function Zl(e){const t=Le(e.name),s=Le(e.decltype);return{name:t,decltype:s}}function ei(e){const t=new Map;ma(e.step_results).forEach((a,n)=>{a!==null&&t.set(n,wn(ee(a)))});const s=new Map;return ma(e.step_errors).forEach((a,n)=>{a!==null&&s.set(n,ks(ee(a)))}),{stepResults:t,stepErrors:s}}function ti(e){const t=Me(e.type);if(t==="step_begin"){const s=Ut(e.step),a=_t(e.cols,Zl);return{type:"step_begin",step:s,cols:a}}else if(t==="step_end"){const s=Ut(e.affected_row_count),a=Le(e.last_insert_rowid),n=a!==void 0?BigInt(a):void 0;return{type:"step_end",affectedRowCount:s,lastInsertRowid:n}}else if(t==="step_error"){const s=Ut(e.step),a=ks(ee(e.error));return{type:"step_error",step:s,error:a}}else{if(t==="row")return{type:"row",row:_t(e.row,ai)};if(t==="error")return{type:"error",error:ks(ee(e.error))};throw new R("Unexpected type of CursorEntry")}}function si(e){const t=_t(e.params,Io),s=_t(e.cols,$o),a=Fs(e.is_explain),n=Fs(e.is_readonly);return{params:t,cols:s,isExplain:a,isReadonly:n}}function Io(e){return{name:Le(e.name)}}function $o(e){const t=Me(e.name),s=Le(e.decltype);return{name:t,decltype:s}}function ai(e){const t=Me(e.type);if(t==="null")return null;if(t==="integer"){const s=Me(e.value);return BigInt(s)}else{if(t==="float")return Ut(e.value);if(t==="text")return Me(e.value);if(t==="blob")return xn.toUint8Array(Me(e.base64));throw new R("Unexpected type of Value")}}function Co(e){const t=Me(e.type);if(t==="hello_ok")return{type:"hello_ok"};if(t==="hello_error")return{type:"hello_error",error:ks(ee(e.error))};if(t==="response_ok"){const s=Ut(e.request_id),a=Ao(ee(e.response));return{type:"response_ok",requestId:s,response:a}}else if(t==="response_error"){const s=Ut(e.request_id),a=ks(ee(e.error));return{type:"response_error",requestId:s,error:a}}else throw new R("Unexpected type of ServerMsg")}function Ao(e){const t=Me(e.type);if(t==="open_stream")return{type:"open_stream"};if(t==="close_stream")return{type:"close_stream"};if(t==="execute")return{type:"execute",result:wn(ee(e.result))};if(t==="batch")return{type:"batch",result:ei(ee(e.result))};if(t==="open_cursor")return{type:"open_cursor"};if(t==="close_cursor")return{type:"close_cursor"};if(t==="fetch_cursor"){const s=_t(e.entries,ti),a=Fs(e.done);return{type:"fetch_cursor",entries:s,done:a}}else{if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:si(ee(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Fs(e.is_autocommit)};throw new R("Unexpected type of Response")}}const Ue={default(){return{message:"",code:void 0}},1(e,t){t.message=e.string()},2(e,t){t.code=e.string()}},_s={default(){return{cols:[],rows:[],affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.cols.push(e.message(ni))},2(e,t){t.rows.push(e.message(li))},3(e,t){t.affectedRowCount=Number(e.uint64())},4(e,t){t.lastInsertRowid=e.sint64()}},ni={default(){return{name:void 0,decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},li={default(){return[]},1(e,t){t.push(e.message(jo))}},va={default(){return{stepResults:new Map,stepErrors:new Map}},1(e,t){const[s,a]=e.message(Ro);t.stepResults.set(s,a)},2(e,t){const[s,a]=e.message(Eo);t.stepErrors.set(s,a)}},Ro={default(){return[0,_s.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(_s)}},Eo={default(){return[0,Ue.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(Ue)}},ii={default(){return{type:"none"}},1(e){return e.message(To)},2(e){return e.message(Mo)},3(e){return e.message(Do)},4(e){return{type:"row",row:e.message(li)}},5(e){return{type:"error",error:e.message(Ue)}}},To={default(){return{type:"step_begin",step:0,cols:[]}},1(e,t){t.step=e.uint32()},2(e,t){t.cols.push(e.message(ni))}},Mo={default(){return{type:"step_end",affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.affectedRowCount=e.uint32()},2(e,t){t.lastInsertRowid=e.uint64()}},Do={default(){return{type:"step_error",step:0,error:Ue.default()}},1(e,t){t.step=e.uint32()},2(e,t){t.error=e.message(Ue)}},ya={default(){return{params:[],cols:[],isExplain:!1,isReadonly:!1}},1(e,t){t.params.push(e.message(Lo))},2(e,t){t.cols.push(e.message(qo))},3(e,t){t.isExplain=e.bool()},4(e,t){t.isReadonly=e.bool()}},Lo={default(){return{name:void 0}},1(e,t){t.name=e.string()}},qo={default(){return{name:"",decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},jo={default(){},1(e){return null},2(e){return e.sint64()},3(e){return e.double()},4(e){return e.string()},5(e){return e.bytes()}},Oo={default(){return{type:"none"}},1(e){return{type:"hello_ok"}},2(e){return e.message(Po)},3(e){return e.message(Bo)},4(e){return e.message(No)}},Po={default(){return{type:"hello_error",error:Ue.default()}},1(e,t){t.error=e.message(Ue)}},No={default(){return{type:"response_error",requestId:0,error:Ue.default()}},1(e,t){t.requestId=e.int32()},2(e,t){t.error=e.message(Ue)}},Bo={default(){return{type:"response_ok",requestId:0,response:{type:"none"}}},1(e,t){t.requestId=e.int32()},2(e,t){t.response={type:"open_stream"}},3(e,t){t.response={type:"close_stream"}},4(e,t){t.response=e.message(Fo)},5(e,t){t.response=e.message(Uo)},6(e,t){t.response={type:"open_cursor"}},7(e,t){t.response={type:"close_cursor"}},8(e,t){t.response=e.message(Vo)},9(e,t){t.response={type:"sequence"}},10(e,t){t.response=e.message(Go)},11(e,t){t.response={type:"store_sql"}},12(e,t){t.response={type:"close_sql"}},13(e,t){t.response=e.message(Ho)}},Fo={default(){return{type:"execute",result:_s.default()}},1(e,t){t.result=e.message(_s)}},Uo={default(){return{type:"batch",result:va.default()}},1(e,t){t.result=e.message(va)}},Vo={default(){return{type:"fetch_cursor",entries:[],done:!1}},1(e,t){t.entries.push(e.message(ii))},2(e,t){t.done=e.bool()}},Go={default(){return{type:"describe",result:ya.default()}},1(e,t){t.result=e.message(ya)}},Ho={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},Wo=new Map([["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]),ri=new Map([["hrana3-protobuf",{version:3,encoding:"protobuf"}],["hrana3",{version:3,encoding:"json"}],["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]);var te,Pe,jt,ce,Ot,de,is,Ce,xt,rs,j,Za,oi,en,ci,di,qe,pi,ui,fl;let zo=(fl=class extends Ll{constructor(s,a){super();b(this,j);b(this,te);b(this,Pe);b(this,jt);b(this,ce);b(this,Ot);b(this,de);b(this,is);b(this,Ce);b(this,xt);D(this,"_streamIdAlloc");D(this,"_cursorIdAlloc");b(this,rs);x(this,te,s),x(this,Pe,[]),x(this,jt,!1),x(this,ce,void 0),x(this,Ot,!1),x(this,de,void 0),x(this,is,!1),x(this,Ce,new Map),x(this,xt,new Ms),this._streamIdAlloc=new Ms,this._cursorIdAlloc=new Ms,x(this,rs,new Ms),i(this,te).binaryType="arraybuffer",i(this,te).addEventListener("open",()=>g(this,j,oi).call(this)),i(this,te).addEventListener("close",n=>g(this,j,di).call(this,n)),i(this,te).addEventListener("error",n=>g(this,j,ci).call(this,n)),i(this,te).addEventListener("message",n=>g(this,j,pi).call(this,n)),g(this,j,Za).call(this,{type:"hello",jwt:a})}getVersion(){return new Promise((s,a)=>{if(x(this,is,!0),i(this,ce)!==void 0)a(i(this,ce));else if(i(this,jt))s(i(this,de).version);else{const n=()=>s(i(this,de).version);i(this,Pe).push({openCallback:n,errorCallback:a})}})}_ensureVersion(s,a){if(i(this,de)===void 0||!i(this,is))throw new vs(`${a} is supported only on protocol version ${s} and higher, but the version supported by the WebSocket server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(i(this,de).version<s)throw new vs(`${a} is supported on protocol version ${s} and higher, but the WebSocket server only supports version ${i(this,de).version}`)}_sendRequest(s,a){if(i(this,ce)!==void 0){a.errorCallback(new ke("Client is closed",i(this,ce)));return}const n=i(this,xt).alloc();i(this,Ce).set(n,{...a,type:s.type}),g(this,j,Za).call(this,{type:"request",requestId:n,request:s})}openStream(){return Ka.open(this)}storeSql(s){this._ensureVersion(2,"storeSql()");const a=i(this,rs).alloc(),n=new bn(this,a),l=()=>{},d=p=>n._setClosed(p),r={type:"store_sql",sqlId:a,sql:s};return this._sendRequest(r,{responseCallback:l,errorCallback:d}),n}_closeSql(s){if(i(this,ce)!==void 0)return;const a=()=>i(this,rs).free(s),n=d=>g(this,j,qe).call(this,d),l={type:"close_sql",sqlId:s};this._sendRequest(l,{responseCallback:a,errorCallback:n})}close(){g(this,j,qe).call(this,new U("Client was manually closed"))}get closed(){return i(this,ce)!==void 0}},te=new WeakMap,Pe=new WeakMap,jt=new WeakMap,ce=new WeakMap,Ot=new WeakMap,de=new WeakMap,is=new WeakMap,Ce=new WeakMap,xt=new WeakMap,rs=new WeakMap,j=new WeakSet,Za=function(s){if(i(this,ce)!==void 0)throw new kt("Trying to send a message on a closed client");if(i(this,jt))g(this,j,en).call(this,s);else{const a=()=>g(this,j,en).call(this,s),n=()=>{};i(this,Pe).push({openCallback:a,errorCallback:n})}},oi=function(){const s=i(this,te).protocol;if(s===void 0){g(this,j,qe).call(this,new U("The `WebSocket.protocol` property is undefined. This most likely means that the WebSocket implementation provided by the environment is broken. If you are using Miniflare 2, please update to Miniflare 3, which fixes this problem."));return}else if(s==="")x(this,de,{version:1,encoding:"json"});else if(x(this,de,ri.get(s)),i(this,de)===void 0){g(this,j,qe).call(this,new R(`Unrecognized WebSocket subprotocol: ${JSON.stringify(s)}`));return}for(const a of i(this,Pe))a.openCallback();i(this,Pe).length=0,x(this,jt,!0)},en=function(s){const a=i(this,de).encoding;if(a==="json"){const n=Ol(s,lo);i(this,te).send(n)}else if(a==="protobuf"){const n=Nl(s,co);i(this,te).send(n)}else throw V(a,"Impossible encoding")},ci=function(s){const n=s.message??"WebSocket was closed due to an error";g(this,j,qe).call(this,new Ha(n))},di=function(s){let a=`WebSocket was closed with code ${s.code}`;s.reason&&(a+=`: ${s.reason}`),g(this,j,qe).call(this,new Ha(a))},qe=function(s){if(i(this,ce)===void 0){x(this,ce,s);for(const a of i(this,Pe))a.errorCallback(s);i(this,Pe).length=0;for(const[a,n]of i(this,Ce).entries())n.errorCallback(s),i(this,xt).free(a);i(this,Ce).clear(),i(this,te).close()}},pi=function(s){if(i(this,ce)===void 0)try{let a;const n=i(this,de).encoding;if(n==="json"){if(typeof s.data!="string"){i(this,te).close(3003,"Only text messages are accepted with JSON encoding"),g(this,j,qe).call(this,new R("Received non-text message from server with JSON encoding"));return}a=fn(JSON.parse(s.data),Co)}else if(n==="protobuf"){if(!(s.data instanceof ArrayBuffer)){i(this,te).close(3003,"Only binary messages are accepted with Protobuf encoding"),g(this,j,qe).call(this,new R("Received non-binary message from server with Protobuf encoding"));return}a=Ra(new Uint8Array(s.data),Oo)}else throw V(n,"Impossible encoding");g(this,j,ui).call(this,a)}catch(a){i(this,te).close(3007,"Could not handle message"),g(this,j,qe).call(this,a)}},ui=function(s){if(s.type==="none")throw new R("Received an unrecognized ServerMsg");if(s.type==="hello_ok"||s.type==="hello_error"){if(i(this,Ot))throw new R("Received a duplicated hello response");if(x(this,Ot,!0),s.type==="hello_error")throw ys(s.error);return}else if(!i(this,Ot))throw new R("Received a non-hello message before a hello response");if(s.type==="response_ok"){const a=s.requestId,n=i(this,Ce).get(a);if(i(this,Ce).delete(a),n===void 0)throw new R("Received unexpected OK response");i(this,xt).free(a);try{if(n.type!==s.response.type)throw console.dir({responseState:n,msg:s}),new R("Received unexpected type of response");n.responseCallback(s.response)}catch(l){throw n.errorCallback(l),l}}else if(s.type==="response_error"){const a=s.requestId,n=i(this,Ce).get(a);if(i(this,Ce).delete(a),n===void 0)throw new R("Received unexpected error response");i(this,xt).free(a),n.errorCallback(ys(s.error))}else throw V(s,"Impossible ServerMsg type")},fl);var oa=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Jo(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var tn={exports:{}};(function(e,t){var s=typeof globalThis<"u"&&globalThis||typeof self<"u"&&self||typeof oa<"u"&&oa,a=function(){function l(){this.fetch=!1,this.DOMException=s.DOMException}return l.prototype=s,new l}();(function(l){(function(d){var r=typeof l<"u"&&l||typeof self<"u"&&self||typeof oa<"u"&&oa||{},p={searchParams:"URLSearchParams"in r,iterable:"Symbol"in r&&"iterator"in Symbol,blob:"FileReader"in r&&"Blob"in r&&function(){try{return new Blob,!0}catch{return!1}}(),formData:"FormData"in r,arrayBuffer:"ArrayBuffer"in r};function o(f){return f&&DataView.prototype.isPrototypeOf(f)}if(p.arrayBuffer)var u=["[object Int8Array]","[object Uint8Array]","[object Uint8ClampedArray]","[object Int16Array]","[object Uint16Array]","[object Int32Array]","[object Uint32Array]","[object Float32Array]","[object Float64Array]"],h=ArrayBuffer.isView||function(f){return f&&u.indexOf(Object.prototype.toString.call(f))>-1};function w(f){if(typeof f!="string"&&(f=String(f)),/[^a-z0-9\-#$%&'*+.^_`|~!]/i.test(f)||f==="")throw new TypeError('Invalid character in header field name: "'+f+'"');return f.toLowerCase()}function v(f){return typeof f!="string"&&(f=String(f)),f}function m(f){var y={next:function(){var A=f.shift();return{done:A===void 0,value:A}}};return p.iterable&&(y[Symbol.iterator]=function(){return y}),y}function S(f){this.map={},f instanceof S?f.forEach(function(y,A){this.append(A,y)},this):Array.isArray(f)?f.forEach(function(y){if(y.length!=2)throw new TypeError("Headers constructor: expected name/value pair to be length 2, found"+y.length);this.append(y[0],y[1])},this):f&&Object.getOwnPropertyNames(f).forEach(function(y){this.append(y,f[y])},this)}S.prototype.append=function(f,y){f=w(f),y=v(y);var A=this.map[f];this.map[f]=A?A+", "+y:y},S.prototype.delete=function(f){delete this.map[w(f)]},S.prototype.get=function(f){return f=w(f),this.has(f)?this.map[f]:null},S.prototype.has=function(f){return this.map.hasOwnProperty(w(f))},S.prototype.set=function(f,y){this.map[w(f)]=v(y)},S.prototype.forEach=function(f,y){for(var A in this.map)this.map.hasOwnProperty(A)&&f.call(y,this.map[A],A,this)},S.prototype.keys=function(){var f=[];return this.forEach(function(y,A){f.push(A)}),m(f)},S.prototype.values=function(){var f=[];return this.forEach(function(y){f.push(y)}),m(f)},S.prototype.entries=function(){var f=[];return this.forEach(function(y,A){f.push([A,y])}),m(f)},p.iterable&&(S.prototype[Symbol.iterator]=S.prototype.entries);function _(f){if(!f._noBody){if(f.bodyUsed)return Promise.reject(new TypeError("Already read"));f.bodyUsed=!0}}function k(f){return new Promise(function(y,A){f.onload=function(){y(f.result)},f.onerror=function(){A(f.error)}})}function P(f){var y=new FileReader,A=k(y);return y.readAsArrayBuffer(f),A}function G(f){var y=new FileReader,A=k(y),O=/charset=([A-Za-z0-9_-]+)/.exec(f.type),N=O?O[1]:"utf-8";return y.readAsText(f,N),A}function Cs(f){for(var y=new Uint8Array(f),A=new Array(y.length),O=0;O<y.length;O++)A[O]=String.fromCharCode(y[O]);return A.join("")}function Gt(f){if(f.slice)return f.slice(0);var y=new Uint8Array(f.byteLength);return y.set(new Uint8Array(f)),y.buffer}function Pn(){return this.bodyUsed=!1,this._initBody=function(f){this.bodyUsed=this.bodyUsed,this._bodyInit=f,f?typeof f=="string"?this._bodyText=f:p.blob&&Blob.prototype.isPrototypeOf(f)?this._bodyBlob=f:p.formData&&FormData.prototype.isPrototypeOf(f)?this._bodyFormData=f:p.searchParams&&URLSearchParams.prototype.isPrototypeOf(f)?this._bodyText=f.toString():p.arrayBuffer&&p.blob&&o(f)?(this._bodyArrayBuffer=Gt(f.buffer),this._bodyInit=new Blob([this._bodyArrayBuffer])):p.arrayBuffer&&(ArrayBuffer.prototype.isPrototypeOf(f)||h(f))?this._bodyArrayBuffer=Gt(f):this._bodyText=f=Object.prototype.toString.call(f):(this._noBody=!0,this._bodyText=""),this.headers.get("content-type")||(typeof f=="string"?this.headers.set("content-type","text/plain;charset=UTF-8"):this._bodyBlob&&this._bodyBlob.type?this.headers.set("content-type",this._bodyBlob.type):p.searchParams&&URLSearchParams.prototype.isPrototypeOf(f)&&this.headers.set("content-type","application/x-www-form-urlencoded;charset=UTF-8"))},p.blob&&(this.blob=function(){var f=_(this);if(f)return f;if(this._bodyBlob)return Promise.resolve(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve(new Blob([this._bodyArrayBuffer]));if(this._bodyFormData)throw new Error("could not read FormData body as blob");return Promise.resolve(new Blob([this._bodyText]))}),this.arrayBuffer=function(){if(this._bodyArrayBuffer){var f=_(this);return f||(ArrayBuffer.isView(this._bodyArrayBuffer)?Promise.resolve(this._bodyArrayBuffer.buffer.slice(this._bodyArrayBuffer.byteOffset,this._bodyArrayBuffer.byteOffset+this._bodyArrayBuffer.byteLength)):Promise.resolve(this._bodyArrayBuffer))}else{if(p.blob)return this.blob().then(P);throw new Error("could not read as ArrayBuffer")}},this.text=function(){var f=_(this);if(f)return f;if(this._bodyBlob)return G(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve(Cs(this._bodyArrayBuffer));if(this._bodyFormData)throw new Error("could not read FormData body as text");return Promise.resolve(this._bodyText)},p.formData&&(this.formData=function(){return this.text().then(ji)}),this.json=function(){return this.text().then(JSON.parse)},this}var Li=["CONNECT","DELETE","GET","HEAD","OPTIONS","PATCH","POST","PUT","TRACE"];function qi(f){var y=f.toUpperCase();return Li.indexOf(y)>-1?y:f}function rt(f,y){if(!(this instanceof rt))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');y=y||{};var A=y.body;if(f instanceof rt){if(f.bodyUsed)throw new TypeError("Already read");this.url=f.url,this.credentials=f.credentials,y.headers||(this.headers=new S(f.headers)),this.method=f.method,this.mode=f.mode,this.signal=f.signal,!A&&f._bodyInit!=null&&(A=f._bodyInit,f.bodyUsed=!0)}else this.url=String(f);if(this.credentials=y.credentials||this.credentials||"same-origin",(y.headers||!this.headers)&&(this.headers=new S(y.headers)),this.method=qi(y.method||this.method||"GET"),this.mode=y.mode||this.mode||null,this.signal=y.signal||this.signal||function(){if("AbortController"in r){var E=new AbortController;return E.signal}}(),this.referrer=null,(this.method==="GET"||this.method==="HEAD")&&A)throw new TypeError("Body not allowed for GET or HEAD requests");if(this._initBody(A),(this.method==="GET"||this.method==="HEAD")&&(y.cache==="no-store"||y.cache==="no-cache")){var O=/([?&])_=[^&]*/;if(O.test(this.url))this.url=this.url.replace(O,"$1_="+new Date().getTime());else{var N=/\?/;this.url+=(N.test(this.url)?"&":"?")+"_="+new Date().getTime()}}}rt.prototype.clone=function(){return new rt(this,{body:this._bodyInit})};function ji(f){var y=new FormData;return f.trim().split("&").forEach(function(A){if(A){var O=A.split("="),N=O.shift().replace(/\+/g," "),E=O.join("=").replace(/\+/g," ");y.append(decodeURIComponent(N),decodeURIComponent(E))}}),y}function Oi(f){var y=new S,A=f.replace(/\r?\n[\t ]+/g," ");return A.split("\r").map(function(O){return O.indexOf(`
`)===0?O.substr(1,O.length):O}).forEach(function(O){var N=O.split(":"),E=N.shift().trim();if(E){var ia=N.join(":").trim();try{y.append(E,ia)}catch(qa){console.warn("Response "+qa.message)}}}),y}Pn.call(rt.prototype);function _e(f,y){if(!(this instanceof _e))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');if(y||(y={}),this.type="default",this.status=y.status===void 0?200:y.status,this.status<200||this.status>599)throw new RangeError("Failed to construct 'Response': The status provided (0) is outside the range [200, 599].");this.ok=this.status>=200&&this.status<300,this.statusText=y.statusText===void 0?"":""+y.statusText,this.headers=new S(y.headers),this.url=y.url||"",this._initBody(f)}Pn.call(_e.prototype),_e.prototype.clone=function(){return new _e(this._bodyInit,{status:this.status,statusText:this.statusText,headers:new S(this.headers),url:this.url})},_e.error=function(){var f=new _e(null,{status:200,statusText:""});return f.ok=!1,f.status=0,f.type="error",f};var Pi=[301,302,303,307,308];_e.redirect=function(f,y){if(Pi.indexOf(y)===-1)throw new RangeError("Invalid status code");return new _e(null,{status:y,headers:{location:f}})},d.DOMException=r.DOMException;try{new d.DOMException}catch{d.DOMException=function(y,A){this.message=y,this.name=A;var O=Error(y);this.stack=O.stack},d.DOMException.prototype=Object.create(Error.prototype),d.DOMException.prototype.constructor=d.DOMException}function La(f,y){return new Promise(function(A,O){var N=new rt(f,y);if(N.signal&&N.signal.aborted)return O(new d.DOMException("Aborted","AbortError"));var E=new XMLHttpRequest;function ia(){E.abort()}E.onload=function(){var Q={statusText:E.statusText,headers:Oi(E.getAllResponseHeaders()||"")};N.url.indexOf("file://")===0&&(E.status<200||E.status>599)?Q.status=200:Q.status=E.status,Q.url="responseURL"in E?E.responseURL:Q.headers.get("X-Request-URL");var It="response"in E?E.response:E.responseText;setTimeout(function(){A(new _e(It,Q))},0)},E.onerror=function(){setTimeout(function(){O(new TypeError("Network request failed"))},0)},E.ontimeout=function(){setTimeout(function(){O(new TypeError("Network request timed out"))},0)},E.onabort=function(){setTimeout(function(){O(new d.DOMException("Aborted","AbortError"))},0)};function qa(Q){try{return Q===""&&r.location.href?r.location.href:Q}catch{return Q}}if(E.open(N.method,qa(N.url),!0),N.credentials==="include"?E.withCredentials=!0:N.credentials==="omit"&&(E.withCredentials=!1),"responseType"in E&&(p.blob?E.responseType="blob":p.arrayBuffer&&(E.responseType="arraybuffer")),y&&typeof y.headers=="object"&&!(y.headers instanceof S||r.Headers&&y.headers instanceof r.Headers)){var Nn=[];Object.getOwnPropertyNames(y.headers).forEach(function(Q){Nn.push(w(Q)),E.setRequestHeader(Q,v(y.headers[Q]))}),N.headers.forEach(function(Q,It){Nn.indexOf(It)===-1&&E.setRequestHeader(It,Q)})}else N.headers.forEach(function(Q,It){E.setRequestHeader(It,Q)});N.signal&&(N.signal.addEventListener("abort",ia),E.onreadystatechange=function(){E.readyState===4&&N.signal.removeEventListener("abort",ia)}),E.send(typeof N._bodyInit>"u"?null:N._bodyInit)})}return La.polyfill=!0,r.fetch||(r.fetch=La,r.Headers=S,r.Request=rt,r.Response=_e),d.Headers=S,d.Request=rt,d.Response=_e,d.fetch=La,d})({})})(a),a.fetch.ponyfill=!0,delete a.fetch.polyfill;var n=s.fetch?s:a;t=n.fetch,t.default=n.fetch,t.fetch=n.fetch,t.Headers=n.Headers,t.Request=n.Request,t.Response=n.Response,e.exports=t})(tn,tn.exports);var ka=tn.exports;let Yt;if(typeof queueMicrotask<"u")Yt=queueMicrotask;else{const e=Promise.resolve();Yt=t=>{e.then(t)}}var ge,Ae,pe,Aa,xi;class Yo{constructor(t){b(this,Aa);b(this,ge);b(this,Ae);b(this,pe);x(this,ge,new Uint8Array(new ArrayBuffer(t))),x(this,Ae,0),x(this,pe,0)}get length(){return i(this,pe)-i(this,Ae)}data(){return i(this,ge).slice(i(this,Ae),i(this,pe))}push(t){g(this,Aa,xi).call(this,t.byteLength),i(this,ge).set(t,i(this,pe)),x(this,pe,i(this,pe)+t.byteLength)}shift(t){x(this,Ae,i(this,Ae)+t)}}ge=new WeakMap,Ae=new WeakMap,pe=new WeakMap,Aa=new WeakSet,xi=function(t){if(i(this,pe)+t<=i(this,ge).byteLength)return;const s=i(this,pe)-i(this,Ae);if(s+t<=i(this,ge).byteLength&&2*i(this,pe)>=i(this,ge).byteLength)i(this,ge).copyWithin(0,i(this,Ae),i(this,pe));else{let a=i(this,ge).byteLength;do a*=2;while(s+t>a);const n=new Uint8Array(new ArrayBuffer(a));n.set(i(this,ge).slice(i(this,Ae),i(this,pe)),0),x(this,ge,n)}x(this,pe,s),x(this,Ae,0)};function Ko(e){const t=Le(e.baton),s=Le(e.base_url),a=_t(e.results,Qo);return{baton:t,baseUrl:s,results:a}}function Qo(e){const t=Me(e.type);if(t==="ok")return{type:"ok",response:Xo(ee(e.response))};if(t==="error")return{type:"error",error:ks(ee(e.error))};throw new R("Unexpected type of StreamResult")}function Xo(e){const t=Me(e.type);if(t==="close")return{type:"close"};if(t==="execute")return{type:"execute",result:wn(ee(e.result))};if(t==="batch")return{type:"batch",result:ei(ee(e.result))};if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:si(ee(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Fs(e.is_autocommit)};throw new R("Unexpected type of StreamResponse")}function Zo(e){const t=Le(e.baton),s=Le(e.base_url);return{baton:t,baseUrl:s}}const ec={default(){return{baton:void 0,baseUrl:void 0,results:[]}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()},3(e,t){t.results.push(e.message(tc))}},tc={default(){return{type:"none"}},1(e){return{type:"ok",response:e.message(sc)}},2(e){return{type:"error",error:e.message(Ue)}}},sc={default(){return{type:"none"}},1(e){return{type:"close"}},2(e){return e.message(ac)},3(e){return e.message(nc)},4(e){return{type:"sequence"}},5(e){return e.message(lc)},6(e){return{type:"store_sql"}},7(e){return{type:"close_sql"}},8(e){return e.message(ic)}},ac={default(){return{type:"execute",result:_s.default()}},1(e,t){t.result=e.message(_s)}},nc={default(){return{type:"batch",result:va.default()}},1(e,t){t.result=e.message(va)}},lc={default(){return{type:"describe",result:ya.default()}},1(e,t){t.result=e.message(ya)}},ic={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},rc={default(){return{baton:void 0,baseUrl:void 0}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()}};var Gs,Pt,Qe,Ne,Xe,os,it,sn,fi,bi;class oc extends Jl{constructor(s,a){super();b(this,it);b(this,Gs);b(this,Pt);b(this,Qe);b(this,Ne);b(this,Xe);b(this,os);x(this,Gs,s),x(this,Pt,a),x(this,Qe,void 0),x(this,Ne,new Yo(16*1024)),x(this,Xe,void 0),x(this,os,!1)}async open(s){if(s.body===null)throw new R("No response body for cursor request");x(this,Qe,s.body[Symbol.asyncIterator]());const a=await g(this,it,sn).call(this,Zo,rc);if(a===void 0)throw new R("Empty response to cursor request");return a}next(){return g(this,it,sn).call(this,ti,ii)}close(){this._setClosed(new U("Cursor was manually closed"))}_setClosed(s){i(this,Xe)===void 0&&(x(this,Xe,s),i(this,Gs)._cursorClosed(this),i(this,Qe)!==void 0&&i(this,Qe).return())}get closed(){return i(this,Xe)!==void 0}}Gs=new WeakMap,Pt=new WeakMap,Qe=new WeakMap,Ne=new WeakMap,Xe=new WeakMap,os=new WeakMap,it=new WeakSet,sn=async function(s,a){for(;;){if(i(this,os))return;if(i(this,Xe)!==void 0)throw new ke("Cursor is closed",i(this,Xe));if(i(this,Pt)==="json"){const d=g(this,it,fi).call(this);if(d!==void 0){const r=new TextDecoder().decode(d),p=JSON.parse(r);return fn(p,s)}}else if(i(this,Pt)==="protobuf"){const d=g(this,it,bi).call(this);if(d!==void 0)return Ra(d,a)}else throw V(i(this,Pt),"Impossible encoding");if(i(this,Qe)===void 0)throw new kt("Attempted to read from HTTP cursor before it was opened");const{value:n,done:l}=await i(this,Qe).next();if(l&&i(this,Ne).length===0)x(this,os,!0);else{if(l)throw new R("Unexpected end of cursor stream");i(this,Ne).push(n)}}},fi=function(){const s=i(this,Ne).data(),n=s.indexOf(10);if(n<0)return;const l=s.slice(0,n);return i(this,Ne).shift(n+1),l},bi=function(){const s=i(this,Ne).data();let a=0,n=0;for(;;){if(n>=s.byteLength)return;const d=s[n];if(a|=(d&127)<<7*n,n+=1,!(d&128))break}if(s.byteLength<n+a)return;const l=s.slice(n,n+a);return i(this,Ne).shift(n+a),l};function cc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.arrayObjects("requests",t.requests,dc)}function dc(e,t){if(e.stringRaw("type",t.type),t.type!=="close"){if(t.type==="execute")e.object("stmt",t.stmt,hn);else if(t.type==="batch")e.object("batch",t.batch,wa);else if(t.type==="sequence")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type!=="get_autocommit")throw V(t,"Impossible type of StreamRequest")}}function pc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.object("batch",t.batch,wa)}function uc(e,t){t.baton!==void 0&&e.string(1,t.baton);for(const s of t.requests)e.message(2,s,xc)}function xc(e,t){if(t.type==="close")e.message(1,t,fc);else if(t.type==="execute")e.message(2,t,bc);else if(t.type==="batch")e.message(3,t,hc);else if(t.type==="sequence")e.message(4,t,mc);else if(t.type==="describe")e.message(5,t,gc);else if(t.type==="store_sql")e.message(6,t,wc);else if(t.type==="close_sql")e.message(7,t,vc);else if(t.type==="get_autocommit")e.message(8,t,yc);else throw V(t,"Impossible type of StreamRequest")}function fc(e,t){}function bc(e,t){e.message(1,t.stmt,mn)}function hc(e,t){e.message(1,t.batch,Ea)}function mc(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function gc(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function wc(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function vc(e,t){e.int32(1,t.sqlId)}function yc(e,t){}function kc(e,t){t.baton!==void 0&&e.string(1,t.baton),e.message(2,t.batch,Ea)}var Ze,ft,cs,Hs,ds,bt,Re,ht,et,tt,mt,Be,ps,T,ot,an,At,hi,mi,nn,gi,wi,ln;class _c extends zl{constructor(s,a,n,l,d){super(s.intMode);b(this,T);b(this,Ze);b(this,ft);b(this,cs);b(this,Hs);b(this,ds);b(this,bt);b(this,Re);b(this,ht);b(this,et);b(this,tt);b(this,mt);b(this,Be);b(this,ps);x(this,Ze,s),x(this,ft,a.toString()),x(this,cs,n),x(this,Hs,l),x(this,ds,d),x(this,bt,void 0),x(this,Re,new ga),x(this,ht,!1),x(this,tt,!1),x(this,mt,!1),x(this,Be,void 0),x(this,ps,new Ms)}client(){return i(this,Ze)}_sqlOwner(){return this}storeSql(s){const a=i(this,ps).alloc();return g(this,T,ot).call(this,{type:"store_sql",sqlId:a,sql:s}).then(()=>{},n=>this._setClosed(n)),new bn(this,a)}_closeSql(s){i(this,Be)===void 0&&g(this,T,ot).call(this,{type:"close_sql",sqlId:s}).then(()=>i(this,ps).free(s),a=>this._setClosed(a))}_execute(s){return g(this,T,ot).call(this,{type:"execute",stmt:s}).then(a=>a.result)}_batch(s){return g(this,T,ot).call(this,{type:"batch",batch:s}).then(a=>a.result)}_describe(s){return g(this,T,ot).call(this,{type:"describe",sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return g(this,T,ot).call(this,{type:"sequence",sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return i(this,Ze)._ensureVersion(3,"getAutocommit()"),g(this,T,ot).call(this,{type:"get_autocommit"}).then(s=>s.isAutocommit)}_openCursor(s){return new Promise((a,n)=>{g(this,T,an).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_cursorClosed(s){if(s!==i(this,et))throw new kt("Cursor was closed, but it was not associated with the stream");x(this,et,void 0),Yt(()=>g(this,T,At).call(this))}close(){this._setClosed(new U("Stream was manually closed"))}closeGracefully(){x(this,tt,!0),Yt(()=>g(this,T,At).call(this))}get closed(){return i(this,Be)!==void 0||i(this,tt)}_setClosed(s){if(i(this,Be)===void 0){for(x(this,Be,s),i(this,et)!==void 0&&i(this,et)._setClosed(s),i(this,Ze)._streamClosed(this);;){const a=i(this,Re).shift();if(a!==void 0)a.errorCallback(s);else break}(i(this,bt)!==void 0||i(this,ht))&&!i(this,mt)&&(i(this,Re).push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),x(this,mt,!0),Yt(()=>g(this,T,At).call(this)))}}}Ze=new WeakMap,ft=new WeakMap,cs=new WeakMap,Hs=new WeakMap,ds=new WeakMap,bt=new WeakMap,Re=new WeakMap,ht=new WeakMap,et=new WeakMap,tt=new WeakMap,mt=new WeakMap,Be=new WeakMap,ps=new WeakMap,T=new WeakSet,ot=function(s){return new Promise((a,n)=>{g(this,T,an).call(this,{type:"pipeline",request:s,responseCallback:a,errorCallback:n})})},an=function(s){if(i(this,Be)!==void 0)throw new ke("Stream is closed",i(this,Be));if(i(this,tt))throw new ke("Stream is closing",void 0);i(this,Re).push(s),Yt(()=>g(this,T,At).call(this))},At=function(){if(i(this,ht)||i(this,et)!==void 0)return;if(i(this,tt)&&i(this,Re).length===0){this._setClosed(new U("Stream was gracefully closed"));return}const s=i(this,Ze)._endpoint;if(s===void 0){i(this,Ze)._endpointPromise.then(()=>g(this,T,At).call(this),n=>this._setClosed(n));return}const a=i(this,Re).shift();if(a!==void 0)if(a.type==="pipeline"){const n=[a];for(;;){const l=i(this,Re).first();if(l!==void 0&&l.type==="pipeline")n.push(l),i(this,Re).shift();else if(l===void 0&&i(this,tt)&&!i(this,mt)){n.push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),x(this,mt,!0);break}else break}g(this,T,hi).call(this,s,n)}else if(a.type==="cursor")g(this,T,mi).call(this,s,a);else throw V(a,"Impossible type of QueueEntry")},hi=function(s,a){g(this,T,nn).call(this,()=>g(this,T,gi).call(this,a,s),n=>Ic(n,s.encoding),n=>n.baton,n=>n.baseUrl,n=>Sc(a,n),n=>a.forEach(l=>l.errorCallback(n)))},mi=function(s,a){const n=new oc(this,s.encoding);x(this,et,n),g(this,T,nn).call(this,()=>g(this,T,wi).call(this,a,s),l=>n.open(l),l=>l.baton,l=>l.baseUrl,l=>a.cursorCallback(n),l=>a.errorCallback(l))},nn=function(s,a,n,l,d,r){let p;try{const o=s();p=i(this,Hs)(o)}catch(o){p=Promise.reject(o)}x(this,ht,!0),p.then(o=>o.ok?a(o):$c(o).then(u=>{throw u})).then(o=>{x(this,bt,n(o)),x(this,ft,l(o)??i(this,ft)),d(o)}).catch(o=>{this._setClosed(o),r(o)}).finally(()=>{x(this,ht,!1),g(this,T,At).call(this)})},gi=function(s,a){return g(this,T,ln).call(this,new URL(a.pipelinePath,i(this,ft)),{baton:i(this,bt),requests:s.map(n=>n.request)},a.encoding,cc,uc)},wi=function(s,a){if(a.cursorPath===void 0)throw new vs(`Cursors are supported only on protocol version 3 and higher, but the HTTP server only supports version ${a.version}.`);return g(this,T,ln).call(this,new URL(a.cursorPath,i(this,ft)),{baton:i(this,bt),batch:s.batch},a.encoding,pc,kc)},ln=function(s,a,n,l,d){let r,p;if(n==="json")r=Ol(a,l),p="application/json";else if(n==="protobuf")r=Nl(a,d),p="application/x-protobuf";else throw V(n,"Impossible encoding");const o=new ka.Headers;return o.set("content-type",p),i(this,cs)!==void 0&&o.set("authorization",`Bearer ${i(this,cs)}`),i(this,ds)!==void 0&&o.set("x-turso-encryption-key",i(this,ds)),new ka.Request(s.toString(),{method:"POST",headers:o,body:r})};function Sc(e,t){if(t.results.length!==e.length)throw new R("Server returned unexpected number of pipeline results");for(let s=0;s<e.length;++s){const a=t.results[s],n=e[s];if(a.type==="ok"){if(a.response.type!==n.request.type)throw new R("Received unexpected type of response");n.responseCallback(a.response)}else if(a.type==="error")n.errorCallback(ys(a.error));else throw a.type==="none"?new R("Received unrecognized type of StreamResult"):V(a,"Received impossible type of StreamResult")}}async function Ic(e,t){var s;if(t==="json"){const a=await e.json();return fn(a,Ko)}if(t==="protobuf"){const a=await e.arrayBuffer();return Ra(new Uint8Array(a),ec)}throw await((s=e.body)==null?void 0:s.cancel()),V(t,"Impossible encoding")}async function $c(e){var a;const t=e.headers.get("content-type")??"text/plain";let s=`Server returned HTTP status ${e.status}`;if(t==="application/json"){const n=await e.json();return"message"in n?ys(n):new pa(s,e.status)}if(t==="text/plain"){const n=(await e.text()).trim();return n!==""&&(s+=`: ${n}`),new pa(s,e.status)}return await((a=e.body)==null?void 0:a.cancel()),new pa(s,e.status)}const Cc=[{versionPath:"v3-protobuf",pipelinePath:"v3-protobuf/pipeline",cursorPath:"v3-protobuf/cursor",version:3,encoding:"protobuf"}],rn={versionPath:"v2",pipelinePath:"v2/pipeline",cursorPath:void 0,version:2,encoding:"json"};var us,Ws,xs,zs,st,Nt,fs,ba,bl;let Ac=(bl=class extends Ll{constructor(s,a,n,l,d=2){super();b(this,fs);b(this,us);b(this,Ws);b(this,xs);b(this,zs);b(this,st);b(this,Nt);D(this,"_endpointPromise");D(this,"_endpoint");x(this,us,s),x(this,Ws,a),x(this,xs,n??ka.fetch),x(this,zs,l),x(this,st,void 0),x(this,Nt,new Set),d==3?(this._endpointPromise=Rc(i(this,xs),i(this,us)),this._endpointPromise.then(r=>this._endpoint=r,r=>g(this,fs,ba).call(this,r))):(this._endpointPromise=Promise.resolve(rn),this._endpointPromise.then(r=>this._endpoint=r,r=>g(this,fs,ba).call(this,r)))}async getVersion(){return this._endpoint!==void 0?this._endpoint.version:(await this._endpointPromise).version}_ensureVersion(s,a){if(!(s<=rn.version)){if(this._endpoint===void 0)throw new vs(`${a} is supported only on protocol version ${s} and higher, but the version supported by the HTTP server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(this._endpoint.version<s)throw new vs(`${a} is supported only on protocol version ${s} and higher, but the HTTP server only supports version ${this._endpoint.version}.`)}}openStream(){if(i(this,st)!==void 0)throw new ke("Client is closed",i(this,st));const s=new _c(this,i(this,us),i(this,Ws),i(this,xs),i(this,zs));return i(this,Nt).add(s),s}_streamClosed(s){i(this,Nt).delete(s)}close(){g(this,fs,ba).call(this,new U("Client was manually closed"))}get closed(){return i(this,st)!==void 0}},us=new WeakMap,Ws=new WeakMap,xs=new WeakMap,zs=new WeakMap,st=new WeakMap,Nt=new WeakMap,fs=new WeakSet,ba=function(s){if(i(this,st)===void 0){x(this,st,s);for(const a of Array.from(i(this,Nt)))a._setClosed(new ke("Client was closed",s))}},bl);async function Rc(e,t){const s=e;for(const a of Cc){const n=new URL(a.versionPath,t),l=new ka.Request(n.toString(),{method:"GET"}),d=await s(l);if(await d.arrayBuffer(),d.ok)return a}return rn}function vi(e,t,s=2){if(typeof Jt>"u")throw new jl("WebSockets are not supported in this environment");var a=void 0;s==3?a=Array.from(ri.keys()):a=Array.from(Wo.keys());const n=new Jt(e,a);return new zo(n,t)}function Kn(e,t,s,a,n=2){return new Ac(e instanceof URL?e:new URL(e),t,s,a,n)}var bs,at,ne;class yi{constructor(t,s){b(this,bs);b(this,at);b(this,ne);x(this,bs,t),x(this,at,s),x(this,ne,void 0)}execute(t){return this.batch([t]).then(s=>s[0])}async batch(t){const s=this._getStream();if(s.closed)throw new q("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{const a=t.map(Vt);let n;if(i(this,ne)===void 0){this._getSqlCache().apply(a);const d=s.batch(i(this,at)>=3),r=d.step(),p=r.run(Ga(i(this,bs)));let o=r;n=a.map(u=>{const h=d.step().condition(ue.ok(o));i(this,at)>=3&&h.condition(ue.not(ue.isAutocommit(d)));const w=h.query(u);return w.catch(()=>{}),o=h,w}),x(this,ne,d.execute().then(()=>p).then(()=>{}));try{await i(this,ne)}catch(u){throw this.close(),u}}else{i(this,at)<3&&await i(this,ne),this._getSqlCache().apply(a);const d=s.batch(i(this,at)>=3);let r;n=a.map(p=>{const o=d.step();r!==void 0&&o.condition(ue.ok(r)),i(this,at)>=3&&o.condition(ue.not(ue.isAutocommit(d)));const u=o.query(p);return u.catch(()=>{}),r=o,u}),await d.execute()}const l=[];for(let d=0;d<n.length;d++)try{const r=await n[d];if(r===void 0)throw new Kt("Statement in a transaction was not executed, probably because the transaction has been rolled back",d,"TRANSACTION_CLOSED");l.push(Ta(r))}catch(r){if(r instanceof Kt)throw r;const p=F(r);throw p instanceof q?new Kt(p.message,d,p.code,p.extendedCode,p.rawCode,p.cause instanceof Error?p.cause:void 0):p}return l}catch(a){throw F(a)}}async executeMultiple(t){const s=this._getStream();if(s.closed)throw new q("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{if(i(this,ne)===void 0){x(this,ne,s.run(Ga(i(this,bs))).then(()=>{}));try{await i(this,ne)}catch(a){throw this.close(),a}}else await i(this,ne);await s.sequence(t)}catch(a){throw F(a)}}async rollback(){try{const t=this._getStream();if(t.closed||i(this,ne)===void 0)return;const s=t.run("ROLLBACK").catch(a=>{throw F(a)});t.closeGracefully(),await s}catch(t){throw F(t)}finally{this.close()}}async commit(){try{const t=this._getStream();if(t.closed)throw new q("Cannot commit the transaction because it is already closed","TRANSACTION_CLOSED");if(i(this,ne)!==void 0)await i(this,ne);else return;const s=t.run("COMMIT").catch(a=>{throw F(a)});t.closeGracefully(),await s}catch(t){throw F(t)}finally{this.close()}}}bs=new WeakMap,at=new WeakMap,ne=new WeakMap;async function _a(e,t,s,a,n=!1){n&&s.step().run("PRAGMA foreign_keys=off");const l=s.step(),d=l.run(Ga(e));let r=l;const p=a.map(v=>{const m=s.step().condition(ue.ok(r));t>=3&&m.condition(ue.not(ue.isAutocommit(s)));const S=m.query(v);return r=m,S}),o=s.step().condition(ue.ok(r));t>=3&&o.condition(ue.not(ue.isAutocommit(s)));const u=o.run("COMMIT");s.step().condition(ue.not(ue.ok(o))).run("ROLLBACK").catch(v=>{}),n&&s.step().run("PRAGMA foreign_keys=on"),await s.execute();const w=[];await d;for(let v=0;v<p.length;v++)try{const m=await p[v];if(m===void 0)throw new Kt("Statement in a batch was not executed, probably because the transaction has been rolled back",v,"TRANSACTION_CLOSED");w.push(Ta(m))}catch(m){if(m instanceof Kt)throw m;const S=F(m);throw S instanceof q?new Kt(S.message,v,S.code,S.extendedCode,S.rawCode,S.cause instanceof Error?S.cause:void 0):S}return await u,w}function Vt(e){let t,s;Array.isArray(e)?[t,s]=e:typeof e=="string"?t=e:(t=e.sql,s=e.args);const a=new Hl(t);if(s)if(Array.isArray(s))a.bindIndexes(s);else for(const[n,l]of Object.entries(s))a.bindName(n,l);return a}function Ta(e){const t=e.columnNames.map(d=>d??""),s=e.columnDecltypes.map(d=>d??""),a=e.rows,n=e.affectedRowCount,l=e.lastInsertRowid!==void 0?e.lastInsertRowid:void 0;return new Nr(t,s,a,n,l)}function F(e){if(e instanceof U){const t=ki(e);return new q(e.message,t,void 0,void 0,e)}return e}function ki(e){return e instanceof ql&&e.code!==void 0?e.code:e instanceof R?"HRANA_PROTO_ERROR":e instanceof ke?e.cause instanceof U?ki(e.cause):"HRANA_CLOSED_ERROR":e instanceof Ha?"HRANA_WEBSOCKET_ERROR":e instanceof pa?"SERVER_ERROR":e instanceof vs?"PROTOCOL_VERSION_ERROR":e instanceof kt?"INTERNAL_ERROR":"UNKNOWN"}var Js,Fe;class vn{constructor(t,s){b(this,Js);b(this,Fe);D(this,"capacity");x(this,Js,t),x(this,Fe,new Ec),this.capacity=s}apply(t){if(this.capacity<=0)return;const s=new Set;for(const a of t){if(typeof a.sql!="string")continue;const n=a.sql;if(n.length>=5e3)continue;let l=i(this,Fe).get(n);if(l===void 0){for(;i(this,Fe).size+1>this.capacity;){const[d,r]=i(this,Fe).peekLru();if(s.has(r))break;r.close(),i(this,Fe).delete(d)}i(this,Fe).size+1<=this.capacity&&(l=i(this,Js).storeSql(n),i(this,Fe).set(n,l))}l!==void 0&&(a.sql=l,s.add(l))}}}Js=new WeakMap,Fe=new WeakMap;var Ee;class Ec{constructor(){b(this,Ee);x(this,Ee,new Map)}get(t){const s=i(this,Ee).get(t);return s!==void 0&&(i(this,Ee).delete(t),i(this,Ee).set(t,s)),s}set(t,s){i(this,Ee).set(t,s)}peekLru(){for(const t of i(this,Ee).entries())return t}delete(t){i(this,Ee).delete(t)}get size(){return i(this,Ee).size}}Ee=new WeakMap;function Tc(e){var t=0,s=[];function a(){t--,t<e&&n()}function n(){var p=s.shift();r.queue=s.length,p&&d(p.fn).then(p.resolve).catch(p.reject)}function l(p){return new Promise(function(o,u){s.push({fn:p,resolve:o,reject:u}),r.queue=s.length})}function d(p){t++;try{return Promise.resolve(p()).then(function(o){return a(),o},function(o){throw a(),o})}catch(o){return a(),Promise.reject(o)}}var r=function(p){return t>=e?l(p):d(p)};return r}function Mc(e,t){var s=!1,a=this;return Promise.all(e.map(function(){var n=arguments;return a(function(){if(!s)return t.apply(void 0,n).catch(function(l){throw s=!0,l})})}))}function Qn(e){return e.queue=0,e.map=Mc,e}var Dc=function(e){return Qn(e?Tc(e):function(t){return t()})};const _i=Jo(Dc);function Lc(e){if(e.scheme!=="wss"&&e.scheme!=="ws")throw new q(`The WebSocket client supports only "libsql:", "wss:" and "ws:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Bs}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new q("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="ws"&&e.tls)throw new q('A "ws:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="wss"&&!e.tls)throw new q('A "wss:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Fa(e.scheme,e.authority,e.path);let s;try{s=vi(t,e.authToken)}catch(a){if(a instanceof jl){const n=e.scheme==="wss"?"https":"http",l=Fa(n,e.authority,e.path);throw new q(`This environment does not support WebSockets, please switch to the HTTP client by using a "${n}:" URL (${JSON.stringify(l)}). For more information, please read ${Bs}`,"WEBSOCKETS_NOT_SUPPORTED")}throw F(a)}return new jc(s,t,e.authToken,e.intMode,e.concurrency)}const qc=60*1e3,Xn=100;var Ys,Ks,Qs,z,se,dn,Xs,we,zt,qs;class jc{constructor(t,s,a,n,l){b(this,we);b(this,Ys);b(this,Ks);b(this,Qs);b(this,z);b(this,se);D(this,"closed");D(this,"protocol");b(this,dn);b(this,Xs);x(this,Ys,s),x(this,Ks,a),x(this,Qs,n),x(this,z,g(this,we,qs).call(this,t)),x(this,se,void 0),this.closed=!1,this.protocol="ws",x(this,Xs,_i(l))}async limit(t){return i(this,Xs).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{const n=await g(this,we,zt).call(this);try{const l=Vt(a);n.conn.sqlCache.apply([l]);const d=n.stream.query(l);n.stream.closeGracefully();const r=await d;return Ta(r)}catch(l){throw F(l)}finally{this._closeStream(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{const a=await g(this,we,zt).call(this);try{const l=t.map(u=>Array.isArray(u)?{sql:u[0],args:u[1]||[]}:u).map(Vt),d=await a.conn.client.getVersion();a.conn.sqlCache.apply(l);const r=a.stream.batch(d>=3);return await _a(s,d,r,l)}catch(n){throw F(n)}finally{this._closeStream(a)}})}async migrate(t){return this.limit(async()=>{const s=await g(this,we,zt).call(this);try{const a=t.map(Vt),n=await s.conn.client.getVersion(),l=s.stream.batch(n>=3);return await _a("deferred",n,l,a,!0)}catch(a){throw F(a)}finally{this._closeStream(s)}})}async transaction(t="write"){return this.limit(async()=>{const s=await g(this,we,zt).call(this);try{const a=await s.conn.client.getVersion();return new Oc(this,s,t,a)}catch(a){throw this._closeStream(s),F(a)}})}async executeMultiple(t){return this.limit(async()=>{const s=await g(this,we,zt).call(this);try{const a=s.stream.sequence(t);s.stream.closeGracefully(),await a}catch(a){throw F(a)}finally{this._closeStream(s)}})}sync(){throw new q("sync not supported in ws mode","SYNC_NOT_SUPPORTED")}async reconnect(){try{for(const a of Array.from(i(this,z).streamStates))try{a.stream.close()}catch{}i(this,z).client.close()}catch{}if(i(this,se)){try{i(this,se).client.close()}catch{}x(this,se,void 0)}const t=g(this,we,qs).call(this),s=await t.client.getVersion();t.useSqlCache=s>=2,t.useSqlCache&&(t.sqlCache.capacity=Xn),x(this,z,t),this.closed=!1}_closeStream(t){t.stream.close();const s=t.conn;s.streamStates.delete(t),s.streamStates.size===0&&s!==i(this,z)&&s.client.close()}close(){if(i(this,z).client.close(),this.closed=!0,i(this,se)){try{i(this,se).client.close()}catch{}x(this,se,void 0)}this.closed=!0}}Ys=new WeakMap,Ks=new WeakMap,Qs=new WeakMap,z=new WeakMap,se=new WeakMap,dn=new WeakMap,Xs=new WeakMap,we=new WeakSet,zt=async function(){if(this.closed)throw new q("The client is closed","CLIENT_CLOSED");if(new Date().valueOf()-i(this,z).openTime.valueOf()>qc&&i(this,se)===void 0){const n=g(this,we,qs).call(this);x(this,se,n),n.client.getVersion().then(l=>{i(this,z)!==n&&i(this,z).streamStates.size===0&&i(this,z).client.close(),x(this,z,n),x(this,se,void 0)},l=>{x(this,se,void 0)})}if(i(this,z).client.closed)try{i(this,se)!==void 0?x(this,z,i(this,se)):x(this,z,g(this,we,qs).call(this))}catch(n){throw F(n)}const a=i(this,z);try{a.useSqlCache===void 0&&(a.useSqlCache=await a.client.getVersion()>=2,a.useSqlCache&&(a.sqlCache.capacity=Xn));const n=a.client.openStream();n.intMode=i(this,Qs);const l={conn:a,stream:n};return a.streamStates.add(l),l}catch(n){throw F(n)}},qs=function(t){try{return t??(t=vi(i(this,Ys),i(this,Ks))),{client:t,useSqlCache:void 0,sqlCache:new vn(t,0),openTime:new Date,streamStates:new Set}}catch(s){throw F(s)}};var Zs,gt;class Oc extends yi{constructor(s,a,n,l){super(n,l);b(this,Zs);b(this,gt);x(this,Zs,s),x(this,gt,a)}_getStream(){return i(this,gt).stream}_getSqlCache(){return i(this,gt).conn.sqlCache}close(){i(this,Zs)._closeStream(i(this,gt))}get closed(){return i(this,gt).stream.closed}}Zs=new WeakMap,gt=new WeakMap;function Pc(e){if(e.scheme!=="https"&&e.scheme!=="http")throw new q(`The HTTP client supports only "libsql:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Bs}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new q("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="http"&&e.tls)throw new q('A "http:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="https"&&!e.tls)throw new q('A "https:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Fa(e.scheme,e.authority,e.path);return new Nc(t,e.authToken,e.intMode,e.fetch,e.concurrency,e.remoteEncryptionKey)}const Si=30;var J,hs,ms,gs,ea,ws,ta,sa;class Nc{constructor(t,s,a,n,l,d){b(this,J);D(this,"protocol");b(this,hs);b(this,ms);b(this,gs);b(this,ea);b(this,ws);b(this,ta);b(this,sa);x(this,hs,t),x(this,ws,s),x(this,ms,a),x(this,gs,n),x(this,ea,l),x(this,ta,d),x(this,J,Kn(i(this,hs),i(this,ws),i(this,gs),d)),i(this,J).intMode=i(this,ms),this.protocol="http",x(this,sa,_i(i(this,ea)))}async limit(t){return i(this,sa).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{try{const n=Vt(a);let l;const d=i(this,J).openStream();try{l=d.query(n)}finally{d.closeGracefully()}const r=await l;return Ta(r)}catch(n){throw F(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{try{const n=t.map(o=>Array.isArray(o)?{sql:o[0],args:o[1]||[]}:o).map(Vt),l=await i(this,J).getVersion();let d;const r=i(this,J).openStream();try{new vn(r,Si).apply(n);const u=r.batch(!1);d=_a(s,l,u,n)}finally{r.closeGracefully()}return await d}catch(a){throw F(a)}})}async migrate(t){return this.limit(async()=>{try{const s=t.map(Vt),a=await i(this,J).getVersion();let n;const l=i(this,J).openStream();try{const r=l.batch(!1);n=_a("deferred",a,r,s,!0)}finally{l.closeGracefully()}return await n}catch(s){throw F(s)}})}async transaction(t="write"){return this.limit(async()=>{try{const s=await i(this,J).getVersion();return new Bc(i(this,J).openStream(),t,s)}catch(s){throw F(s)}})}async executeMultiple(t){return this.limit(async()=>{try{let s;const a=i(this,J).openStream();try{s=a.sequence(t)}finally{a.closeGracefully()}await s}catch(s){throw F(s)}})}sync(){throw new q("sync not supported in http mode","SYNC_NOT_SUPPORTED")}close(){i(this,J).close()}async reconnect(){try{this.closed||i(this,J).close()}finally{x(this,J,Kn(i(this,hs),i(this,ws),i(this,gs),i(this,ta))),i(this,J).intMode=i(this,ms)}}get closed(){return i(this,J).closed}}J=new WeakMap,hs=new WeakMap,ms=new WeakMap,gs=new WeakMap,ea=new WeakMap,ws=new WeakMap,ta=new WeakMap,sa=new WeakMap;var Bt,aa;class Bc extends yi{constructor(s,a,n){super(a,n);b(this,Bt);b(this,aa);x(this,Bt,s),x(this,aa,new vn(s,Si))}_getStream(){return i(this,Bt)}_getSqlCache(){return i(this,aa)}close(){i(this,Bt).close()}get closed(){return i(this,Bt).closed}}Bt=new WeakMap,aa=new WeakMap;function Fc(e){return Uc(Ur(e))}function Uc(e){if(e.scheme==="ws"||e.scheme==="wss")return Lc(e);if(e.scheme==="http"||e.scheme==="https")return Pc(e);throw new q(`The client that uses Web standard APIs supports only "libsql:", "wss:", "ws:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Bs}`,"URL_SCHEME_NOT_SUPPORTED")}const Vc={url:"libsql://retailer-os-digitalhues.aws-ap-south-1.turso.io",authToken:"eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzAxODY2NzMsImlkIjoiNDcwMDliODAtYmJlYS00YzQ3LTk1MzQtY2NlYjg4OWUzYjFjIiwicmlkIjoiNTk1ODMwNWEtMjlkNy00OGU5LWJkNTctN2FiZWVjNzVjMWYwIn0.381aJkYkBtcCsSDyQkFNLZud9lOPi9TuT3uRZgLYS9BqrjLFb0Zc7P1qRWN0k16XkHQ7raDwhCUE9H1G8Q80BA"},Gc=Fc(Vc);async function $(e,t=[]){try{return(await Gc.execute({sql:e,args:t})).rows}catch(s){throw console.error("DB Query Error:",s.message,"SQL:",e,"Params:",t),s}}const M={clients:{getAll:()=>$("SELECT * FROM customers"),add:e=>$("INSERT INTO customers (id, name, phone, email, joined_at, dob, location) VALUES (?, ?, ?, ?, ?, ?, ?)",[e.id,e.name,e.phone||"",e.email||"",new Date().toISOString(),e.dob||null,e.location||""]),getById:e=>$("SELECT * FROM customers WHERE id = ?",[e])},companies:{getAll:()=>$("SELECT * FROM companies"),add:e=>$("INSERT INTO companies (id, name, gst_number, customer_id, created_at) VALUES (?, ?, ?, ?, ?)",[e.id,e.name,e.gst_number,e.customer_id,new Date().toISOString()]),getByCustomerId:e=>$("SELECT * FROM companies WHERE customer_id = ?",[e]),getById:e=>$("SELECT * FROM companies WHERE id = ?",[e])},sales:{getAll:()=>$("SELECT * FROM sales ORDER BY date DESC"),getById:e=>$("SELECT * FROM sales WHERE id = ?",[e]),getDrafts:()=>$("SELECT * FROM sales WHERE status = 'draft' ORDER BY date DESC"),add:e=>$(`INSERT INTO sales (id, customer_id, customer_name, date, total_amount, status, payment_mode, payment_reference, gst_required, company_id, installation_required, installation_date) 
    ...
    `}let Xt=!1,ha="",I=[],De=null,nt="Select Customer",ie=!1,Ve="",Ge="",la=!1,B="",lt="",vt=null;const Zt=e=>`${e}-${Math.random().toString(36).substr(2,8).toUpperCase()}`,Hc=["appliances","air conditioners","ac","washing machines","refrigerators","tvs","television","home theater","dishwasher","microwave","geyser","water heater"];function yn(e){if(e.installation_required===1)return!0;const t=(e.category||"").toLowerCase();return Hc.some(s=>t.includes(s))}async function Wc(e){const t=window.getCache().products,s=window.getCache().schemes||[],a=t.find(n=>n.id===e);if(a){const n=yn(a),l=s.filter(r=>{const p=!r.brand||r.brand===a.brand,o=!r.category||r.category===a.category,u=(!r.min_price||a.mop>=r.min_price)&&(!r.max_price||a.mop<=r.max_price),h=new Date(r.start_date)<=new Date&&new Date(r.end_date)>=new Date;return p&&o&&u&&h&&r.status==="active"});I.push({...a,qty:1,imei:"",serial_number:"",mac_id:"",manufacturing_date:"",showDetails:!1,installation_required:n,installation_date:"",discount_type:null,discount_value:0,discount_amount:0,scheme_id:null,scheme_name:null,final_price:a.mop,applicableSchemes:l,showDiscount:!1,extraFields:[]});const d=document.getElementById("sales-item-search");d&&(d.value=""),window.triggerRender()}}window.toggleCartItemDiscount=e=>{I[e]&&(I[e].showDiscount=!I[e].showDiscount,window.triggerRender())};window.applyStoreDiscount=(e,t)=>{if(I[e]){const s=I[e],a=parseFloat(t)||0;a>0&&a<=100?(s.discount_type="store",s.discount_value=a,s.discount_amount=Math.round(s.mop*a/100),s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop-s.discount_amount):(s.discount_type=null,s.discount_value=0,s.discount_amount=0,s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop),window.triggerRender()}};window.applySchemeDiscount=(e,t)=>{if(I[e]){const s=I[e],n=(window.getCache().schemes||[]).find(l=>l.id===t);n?(s.discount_type="scheme",s.scheme_id=n.id,s.scheme_name=n.name,n.discount_type==="percentage"?(s.discount_value=n.discount_value,s.discount_amount=Math.round(s.mop*n.discount_value/100)):(s.discount_value=n.discount_value,s.discount_amount=n.discount_value),s.final_price=s.mop-s.discount_amount):(s.discount_type=null,s.discount_value=0,s.discount_amount=0,s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop),window.triggerRender()}};window.clearItemDiscount=e=>{if(I[e]){const t=I[e];t.discount_type=null,t.discount_value=0,t.discount_amount=0,t.scheme_id=null,t.scheme_name=null,t.final_price=t.mop,window.triggerRender()}};function $i(e,t){De=e,nt=t;const s=document.getElementById("customer-dropdown-menu");s&&s.classList.add("hidden");const n=(window.getCache().companies||[]).find(l=>l.customer_id===e);n&&(Ve=n.name,Ge=n.gst_number),window.triggerRender()}window.updateCartItemDetail=(e,t,s)=>{I[e]&&(I[e][t]=s)};window.toggleCartItemDetails=e=>{I[e]&&(I[e].showDetails=!I[e].showDetails,window.triggerRender())};window.toggleItemInstallation=e=>{I[e]&&(I[e].installation_required=!I[e].installation_required,I[e].installation_required||(I[e].installation_date=""),window.triggerRender())};window.updateItemInstallationDate=(e,t)=>{I[e]&&(I[e].installation_date=t)};const zc="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";function Jc(){return localStorage.getItem("openai_api_key")||zc}window.captureDeviceImage=async e=>{const t=Jc(),s=document.createElement("input");s.type="file",s.accept="image/*",s.capture="environment",s.onchange=async a=>{const n=a.target.files[0];if(n){Xt=!0,ha="Reading image...",window.triggerRender(!1);try{const l=await Yc(n);ha="AI analyzing...",Kc(e,ha);const d=I[e],r={name:d.name,brand:d.brand,category:d.category},p=await Qc(l,r,t);I[e]&&p&&(p.imei&&(I[e].imei=p.imei),p.serial_number&&(I[e].serial_number=p.serial_number),p.mac_id&&(I[e].mac_id=p.mac_id),p.manufacturing_date&&(I[e].manufacturing_date=p.manufacturing_date),p.extraFields&&p.extraFields.length>0&&(I[e].extraFields=[...I[e].extraFields||[],...p.extraFields])),Xt=!1,window.triggerRender(!1);const o=[];p.imei&&o.push("IMEI"),p.serial_number&&o.push("Serial"),p.mac_id&&o.push("MAC ID"),p.manufacturing_date&&o.push("Mfg Date"),p.extraFields&&p.extraFields.forEach(u=>o.push(u.label)),o.length>0?window.toast.success(`Found: ${o.join(", ")}`):window.toast.warning("No device details found. Try a clearer image.")}catch(l){console.error("AI Vision Error:",l),Xt=!1,window.triggerRender(!1),window.toast.error(l.message||"Error analyzing image")}}},s.click()};function Yc(e){return new Promise((t,s)=>{const a=new FileReader;a.onload=()=>{const n=a.result.split(",")[1];t(n)},a.onerror=s,a.readAsDataURL(e)})}function Kc(e,t){const s=document.getElementById(`ocr-progress-${e}`);s&&(s.textContent=t)}async function Qc(e,t,s){var p,o,u,h;const a=`You are analyzing a product label/box image to extract device information.
...
Example response:
{
  ...
  "extraFields": [{"key": "model", "label": "Model", "value": "SM-A546E"}]
                ...
                <div class="relative text-left">
                    ...
                    ${l?`
                        <div class="absolute top-full left-0 right-0 z-50 bg-white border border-slate-100 rounded-2xl shadow-2xl mt-2 overflow-hidden text-left max-h-60 overflow-y-auto">
                            ${d.length>0?d.map(o=>{var h;const u=yn(o);return`
        ...
        `:""}
    `}function el(e){const t=new Date(e);return t.setHours(0,0,0,0),t}function ca(e){const t=new Date(e);return t.setHours(23,59,59,999),t}function tl(e,t,s,a){if(t==="all")return e;const n=new Date,l=el(n);return e.filter(d=>{const r=new Date(d.date);switch(t){case"today":return r>=l&&r<=ca(n);case"week":{const p=new Date(l);return p.setDate(p.getDate()-p.getDay()),r>=p&&r<=ca(n)}case"month":{const p=new Date(l.getFullYear(),l.getMonth(),1);return r>=p&&r<=ca(n)}case"custom":{if(!s&&!a)return!0;const p=s?el(new Date(s)):new Date(0),o=a?ca(new Date(a)):new Date;return r>=p&&r<=o}default:return!0}})}window.toggleDateFilterDropdown=e=>{e&&e.stopPropagation();const t=document.getElementById("date-filter-dropdown");t&&t.classList.toggle("hidden")};window.updateHistoryFromDate=e=>{c.historyFromDate=e,c.historyToDate&&(c.historyDateFilter="custom",window.triggerRender())};window.updateHistoryToDate=e=>{c.historyToDate=e,c.historyFromDate&&(c.historyDateFilter="custom",window.triggerRender())};function Ri(){const e=window.getCache(),t=e.sales||[],s=e.saleItems||[],a=t.filter(v=>v.status==="draft"),n=t.filter(v=>v.status!=="draft"),l=c.historyViewMode||"completed",d=c.historyDateFilter||"all",r=tl(a,d,c.historyFromDate,c.historyToDate),p=tl(n,d,c.historyFromDate,c.historyToDate),o=l==="drafts"?r:p,u=()=>{switch(d){case"today":return"Today";case"week":return"This Week";case"month":return"This Month";case"custom":return c.historyFromDate||c.historyToDate?"Custom Range":"All Time";default:return"All Time"}},h=v=>{switch(v){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}},w=v=>{switch(v){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Paid"}};return`
        ${Ii("history")}
        <div class="scrolling-content px-4 sm:px-8 space-y-6 pb-12 text-left">
...
`,t+="Powered by RetailerOS",t}function td(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function sd(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function _n(){const e=c.currentTab==="history",t=Ma();if(!t)return`<div class="p-10 text-center opacity-40 flex flex-col items-center justify-center h-full">
                ...
                <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center text-left">
                    <div class="flex items-center gap-3 text-left">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                            <span class="material-icons-outlined text-sm">${td(t.paymentMode)}</span>
                        </div>
                        <div class="text-left">
                            <p class="text-[9px] font-black uppercase tracking-widest text-left">Paid via ${sd(t.paymentMode)}</p>
    ...
    `}function sl(){const e=window.getCache(),t=e.customers||[],s=c.clientSearchQuery||"",n=[...s?t.filter(l=>l.name.toLowerCase().includes(s.toLowerCase())||l.phone&&l.phone.includes(s)||l.email&&l.email.toLowerCase().includes(s.toLowerCase())):t].sort((l,d)=>new Date(d.joined_at||0)-new Date(l.joined_at||0));return`
    ...
    `}function rd(){const e=window.getCache(),t=e.groups||[],s=e.groupMembers||[],a=e.customers||[],n=e.sales||[],l=t.find(u=>u.id===c.selectedGroupId);if(!l)return`
    ...
    `}function od(){const e=window.getCache(),t=e.groups||[],s=e.groupMembers||[],a=e.customers||[],n=t.find(r=>r.id===c.selectedGroupId);if(!n)return c.groupViewMode="list","";const l=s.filter(r=>r.group_id===n.id).map(r=>r.customer_id),d=a.filter(r=>!l.includes(r.id));return`
        <div class="h-full flex flex-col overflow-hidden">
            <!-- Header -->
            <div class="p-6 border-b border-slate-100 flex items-center justify-between shrink-0">
                <div class="flex items-center gap-4">
    ...
    `}function nl(){return ld()}function ll(){switch(c.groupViewMode){case"create":return id();case"detail":return rd();case"add-members":return od();default:return`
                <div class="h-full flex items-center justify-center text-slate-300 text-center p-8">
                    <div class="text-center">
            ...
            `}}function cd(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function dd(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function il(e="desktop"){var u,h;const t=window.getCache(),s=c.clientInvoiceId,a=(t.sales||[]).find(w=>w.id===s);if(!a)return`
                ...
                <div class="card p-6 sm:p-8 bg-white text-slate-900 leading-relaxed shadow-sm border border-slate-100">
                    ...
                    ${o.paymentMode?`
                        <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                                    <span class="material-icons-outlined text-sm">${cd(o.paymentMode)}</span>
                                </div>
                                <div>
...
`,l+="Powered by RetailerOS";const d=`https://wa.me/${((p=a==null?void 0:a.phone)==null?void 0:p.replace(/\D/g,""))||""}?text=${encodeURIComponent(l)}`;window.open(d,"_blank")};function Sn(e){const t=e==="desktop-secondary",s=e==="desktop-primary";return t?c.clientViewMode==="add"?on("desktop"):c.clientViewMode==="invoice"?il("desktop"):c.clientViewMode==="profile"?al("desktop"):c.clientViewMode==="groups"?ll():`
            <div class="h-full flex items-center justify-center text-slate-300 text-center">
                <div class="text-center">
        ...
        `:s?c.clientViewMode==="groups"?nl():sl():c.clientViewMode==="add"?on("mobile"):c.clientViewMode==="invoice"?il("mobile"):c.clientViewMode==="profile"?al("mobile"):c.clientViewMode==="groups"?c.groupViewMode==="detail"||c.groupViewMode==="create"||c.groupViewMode==="add-members"?ll():nl():sl()}const Oa=(e,t,s=[])=>`
...
`;function bd(){return`
    ...
    `}async function gd(e){if(c.activeRepairId)try{await M.query("UPDATE repairs SET status = ? WHERE id = ?",[e,c.activeRepairId]),await K()}catch(t){alert("Update failed: "+t.message)}}window.updateRepairStatus=gd;function wd(){const e=window.getCache(),t=e.repairs.find(n=>n.id===c.activeRepairId)||e.repairs[0];if(!t)return'<div class="p-20 text-center opacity-30 text-[10px] font-black uppercase">No active job selected</div>';const s=[{l:"Collected",s:"COLLECTED",i:"done"},{l:"Sent to Brand",s:"SENT_TO_BRAND",i:"shipping"},{l:"At Service Center",s:"IN_REPAIR",i:"build"},{l:"Ready for Pickup",s:"READY",i:"check_circle"},{l:"Handed Over",s:"COMPLETED",i:"person"}],a=s.findIndex(n=>n.s===t.status);return`
    ...
    `}function rl(){const t=window.getCache().repairs||[];return`
    ...
    `}function $n(e){const t={search:{t:"RetailerOS",s:"Repairs Management",txn:null},intake:{t:"Device Intake",s:"Repair Management",txn:"TXN-4920"},status:{t:"Job ID: #REP-2024",s:"Repair Assignment",badge:"ACTIVE"},history:{t:"Job History",s:"Service Records",badge:null}},s={search:bd(),intake:md(),status:wd()};if(e==="desktop-primary")return`
            ...
            <div class="scrolling-content px-8 space-y-8 pb-12">
                ${c.repairTab==="active"?s.search:rl()}
            </div>
        ...
        ${Pa(n.t,n.s,l,!0)}
        <div class="scrolling-content px-8 space-y-8 pb-12">
            ${c.repairTab==="history"?rl():s[c.repairViewMode]}
        </div>
    `}function vd(){return`
        <header class="p-4 sm:p-8 pb-4 shrink-0">
             <div class="flex items-center justify-between mb-6">
    ...
    `}function Cn(e){return e==="desktop-secondary"?kd():yd()}function _d(){return`
        <header class="p-4 sm:p-8 pb-4 shrink-0">
             <div class="flex items-center justify-between mb-6">
                <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors">
                    <span class="material-icons-outlined">chevron_left</span>
    ...
    `}function An(e){const t=e==="desktop-secondary";return window.setPromoterViewMode=s=>{c.promoterViewMode=s,C()},t?c.promoterViewMode==="onboarding"?Id():$d():Sd()}function Cd(){return`
    ...
    `}async function Ed(){const e=document.getElementById("inward-model").value,t=document.getElementById("inward-imei").value;if(document.getElementById("inward-sn").value,!e||!t){alert("Model name and IMEI are required.");return}const s=document.getElementById("confirm-inward-btn");s.disabled=!0,s.innerText="Syncing...";try{const a=await M.query("SELECT * FROM products WHERE name = ?",[e]);let n=1;if(a.length>0)n=parseInt(a[0].stock)+1,await M.query("UPDATE products SET stock = ? WHERE id = ?",[n,a[0].id]);else{const l="PRD-"+Math.random().toString(36).substr(2,6).toUpperCase();await M.query(`
            ...
            VALUES (?, ?, ?, ?, ?, ?)
        `,["LOG-"+Math.random().toString(36).substr(2,6).toUpperCase(),e,"INWARD",1,"New Shipment Arrival",new Date().toISOString()]),await K(),window.setInventoryMode("details")}catch(a){alert("Inward failed: "+a.message),s.disabled=!1,s.innerText="Confirm Inward"}}window.confirmInward=Ed;function Td(){return`
        <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            <!-- Header -->
            <div class="p-6 border-b border-slate-100 flex items-center justify-between shrink-0 text-left">
                 <div class="flex items-center gap-3 text-left">
    ...
    `}function Md(){return`
         <div class="h-full flex flex-col relative bg-white text-left">
            ...
            <div class="flex-1 overflow-y-auto p-6 space-y-4 custom-scrollbar bg-slate-50/50 text-left">
                ...
                `:cache.products.map(e=>{const t=parseInt(e.stock)||0,s=parseInt(e.price)||0,a=s*1.1,n=s*.9,l=t*n,d=(s-n)*t;return`
                    <div class="card p-5 bg-white border border-slate-200 hover:border-slate-300 transition-all shadow-sm group text-left">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4 text-left">
                            <div class="text-left">
                                <p class="text-[7px] font-black text-slate-400 uppercase tracking-widest mb-0.5 text-left">BLOCKED CAPITAL</p>
                                <h4 class="text-sm font-black text-slate-900 tracking-tight text-left">₹${l.toLocaleString()}</h4>
                            </div>
                             <div class="text-right">
                                <p class="text-[7px] font-black text-slate-400 uppercase tracking-widest mb-0.5 text-right">EXPECTED MARGIN</p>
                                <h4 class="text-sm font-black text-green-500 tracking-tight text-right">₹${d.toLocaleString()}</h4>
                            </div>
                        </div>
    ...
    `}function Rn(e){const t=e==="desktop-secondary";return window.setInventoryTab=s=>{c.inventoryTab=s,C()},window.setInventoryMode=s=>{c.inventoryMode=s,C()},t?c.inventoryMode==="inward"?Td():Md():`
        <div class="h-full flex flex-col relative bg-white">
            ${Cd()}
            ${c.inventoryTab==="brands"?Ad():Rd()}
        </div>
    ...
    `}function Ld(){const e=c.settingsSubView==="add",t=c.settingsActiveRole||"Store Manager";return`
         <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            <!-- Header -->
            <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
                <div class="flex items-center justify-between mb-6 text-left">
    ...
    `}function En(e){const t=e==="desktop-secondary";return window.setSettingsView=s=>{c.settingsView=s,c.settingsSubView=null,C()},window.setSettingsSubView=s=>{c.settingsSubView=s,C()},window.setSettingsRole=s=>{c.settingsActiveRole=s,c.settingsSubView="detail",C()},window.saveNewRole=()=>{const s=document.querySelector('input[placeholder="e.g. Floor Supervisor"]');s&&s.value?(c.settingsActiveRole=s.value,c.settingsSubView="detail",window.toast.success(`Role "${s.value}" created successfully!`),C()):window.toast.warning("Please enter a role name")},window.updateRole=()=>{window.toast.success("Role profile updated successfully!"),window.setSettingsSubView("detail")},t?c.settingsView==="roles"?Ld():c.settingsView==="accounting"?qd():c.settingsView==="ledger"?jd():c.settingsView==="ai"?Pd():"":Dd(e)}function Nd(){return`
        <div class="space-y-4 text-left">
            ${[{id:"apple",n:"Apple",s:"PREMIUM PARTNER",amt:"₹4,82,500",live:12,comp:48,set:142,nSet:24,i:"apple"},{id:"nothing",n:"Nothing",s:"EMERGAGING BRAND",amt:"₹1,12,000",live:4,comp:15,set:56,nSet:8,i:"nothing"},{id:"oneplus",n:"OnePlus",s:"GLOBAL TECH",amt:"₹2,45,900",live:8,comp:32,set:98,nSet:12,i:"oneplus"}].map(t=>`
                <div onclick="selectSchemeBrand('${t.n}')" class="card p-5 border-2 transition-all group cursor-pointer relative overflow-hidden text-left ${c.activeBrand===t.n?"border-slate-900 shadow-lg":"border-transparent hover:border-slate-200"}">
                    <div class="flex items-center justify-between mb-6 text-left">
                        <div class="flex items-center gap-4 text-left">
    ...
    `}function Bd(){const t=window.getCache().schemes||[];return`
    ...
    `}function Fd(e){const t=e==="mobile",s=c.activeScheme;if(!s)return'<div class="p-10 text-center">Select a scheme to view details</div>';const n=(window.getCache().sales||[]).filter(d=>d.product_name.includes(s.brand)||d.items&&d.items.some(r=>r.name.includes(s.brand))),l={count:n.length,growth:"+0%",color:s.brand==="Apple"?"bg-indigo-950":s.brand==="Nothing"?"bg-slate-950":"bg-emerald-950"};return`
        <div class="h-full flex flex-col bg-white animate-slide-up relative text-left">
            ...
            <div class="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar pb-32 text-left">
                ...
                <!-- Metrics -->
                <div class="${l.color} rounded-[32px] p-6 text-white relative overflow-hidden text-left">
                    ...
                    <div class="flex items-end gap-3 text-left">
                        <h2 class="text-5xl font-black tracking-tighter text-left">${l.count}</h2>
                        <p class="text-[10px] font-bold text-green-400 mb-2 text-left">${l.growth} this week</p>
                    </div>
                            ...
                            <div class="card p-4 border-slate-100 hover:border-slate-300 transition-all cursor-pointer text-left">
                                <div class="flex justify-between items-start mb-2 text-left">
                                    <div class="text-left">
                                        ...
                                        <p class="text-xs font-black text-slate-900 text-left">${d.id}</p>
                                    </div>
                                     <div class="text-right">
                                        <p class="text-[7px] font-bold text-slate-300 uppercase tracking-widest mb-1 text-right">DATE</p>
                                        <p class="text-[10px] font-black text-slate-900 text-right">${new Date(d.date).toLocaleDateString()}</p>
                                    </div>
                                </div>
                                <div class="flex justify-between items-end pt-3 border-t border-slate-50 text-left">
                                    <div class="text-left">
                                        ...
                                        <p class="text-[10px] font-bold text-slate-500 text-left">${d.product_name}</p>
                                    </div>
                                     <div class="text-right">
                                        <p class="text-[7px] font-bold text-slate-300 uppercase tracking-widest mb-1 text-right">IMEI</p>
                                        <p class="text-[9px] font-bold text-slate-400 tracking-wider text-right">${d.imei||"N/A"}</p>
                                    </div>
                                </div>
                            </div>
                        `).join("")}
    ...
    `}function Tn(e){const t=e==="desktop-secondary",s=e==="mobile";if(window.selectSchemeBrand=n=>{c.activeBrand=n,c.schemesTab="list",C()},window.selectScheme=n=>{c.activeScheme=n,s&&(c.showSchemeDetails=!0),C()},window.setSchemesTab=n=>{c.schemesTab=n,C()},window.toggleSchemeDetails=n=>{c.showSchemeDetails=n,C()},t||s&&c.showSchemeDetails)return Fd(e);const a=c.schemesTab==="brands";return`
    ...
    `}function Ud(){const e=c.marketplaceTab==="browse";return`
        <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
            <div class="flex items-center justify-between mb-6 text-left">
                <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors text-left">
                    <span class="material-icons-outlined text-left">chevron_left</span>
    ...
    `}function Vd(){const t=window.getCache().marketplace||[];return`
    ...
    `}function Mn(e){if(e==="desktop-secondary"||e==="mobile"&&c.marketplaceViewMode==="add")return Hd(e);const a=c.marketplaceTab==="browse";return`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            ${Ud()}
    ...
    `}function Jd(){const t=window.getCache().inquiries||[],s=a=>{switch(a){case"PENDING":return"bg-orange-50 text-orange-400";case"FULFILLED":return"bg-green-50 text-green-500";case"CONTACTED":return"bg-blue-50 text-blue-500";case"LOST SALE":return"bg-red-50 text-red-400";default:return"bg-slate-50 text-slate-400"}};return`
        <div class="space-y-3 text-left">
    ...
    `}async function Qd(e){var t;if((t=c.activeInquiry)!=null&&t.id)try{await M.query("UPDATE inquiries SET status = ? WHERE id = ?",[e,c.activeInquiry.id]),await K(),window.setInquiryViewMode("list")}catch(s){alert("Update failed: "+s.message)}}window.updateInquiryStatus=Qd;function Xd(){const e=c.activeInquiry;return e?`
    ...
    `:'<div class="p-20 text-center uppercase text-[10px] font-black opacity-30">No inquiry selected</div>'}function Dn(e){return e==="desktop-secondary"||e==="mobile"&&c.inquiryViewMode==="add"?Kd():c.inquiryViewMode==="resolve"&&c.activeInquiry?Xd():`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            ${Wd()}
    ...
    `}function Zd(){const t=window.getCache().campaigns||[];return`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
                <div class="flex items-center justify-between mb-6 text-left">
                    <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors text-left">
    ...
    `}function tp(e){const t=c.activeCampaign;return t?`
    ...
    `}function Ln(e){return e==="desktop-secondary"||e==="mobile"&&c.preBookingViewMode==="create"?ep():c.preBookingViewMode==="details"&&c.activeCampaign?tp():c.preBookingViewMode==="public"?sp():Zd()}function ap(){const e=window.getCache(),t=e.automations||[],s=e.automationMessages||[],a=t.filter(o=>o.status==="active").length;t.filter(o=>o.status==="completed").length,s.length;const n=s.filter(o=>o.status==="sent").length,l=s.filter(o=>o.status==="pending").length,d=new Date,r=new Date(Date.now()+7*864e5),p=s.filter(o=>o.status==="pending"&&new Date(o.scheduled_date)<=r).sort((o,u)=>new Date(o.scheduled_date)-new Date(u.scheduled_date)).slice(0,5);return`
        <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
             <div class="flex items-center justify-between mb-6 text-left">
                <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors text-left">
                    <span class="material-icons-outlined text-left">chevron_left</span>
    ...
    `}function qn(e){const t=e==="mobile",s=e==="desktop-secondary";return window.setAutomationMode=(a,n=null)=>{c.automationViewMode=a,n!==null&&(c.activeAutomationId=n),C()},s?c.automationViewMode==="create"?ol():c.automationViewMode==="details"&&c.activeAutomationId?cl(c.activeAutomationId):`
            <div class="h-full flex items-center justify-center text-slate-300 text-center">
                <div class="text-center">
        ...
        `:t&&c.automationViewMode==="create"?ol(!0):t&&c.automationViewMode==="details"?cl(c.activeAutomationId,!0):ap()}function np(e=!0){if(!e)return;const t=[c.currentApp];c.currentApp==="sales"?t.push(c.currentTab):c.currentApp==="clients"?(t.push(c.clientViewMode),c.selectedClient&&c.clientViewMode==="profile"&&t.push(encodeURIComponent(c.selectedClient))):c.currentApp==="reports"?t.push(c.reportsTab):c.currentApp==="repairs"?(t.push(c.repairTab),t.push(c.repairViewMode)):c.currentApp==="inventory"?(t.push(c.inventoryTab),t.push(c.inventoryMode)):c.currentApp==="marketplace"?(t.push(c.marketplaceTab),t.push(c.marketplaceViewMode)):c.currentApp==="inquiries"?t.push(c.inquiryViewMode):c.currentApp==="prebooking"?t.push(c.preBookingViewMode):c.currentApp==="automation"?t.push(c.automationViewMode):c.currentApp==="schemes"?t.push(c.schemesTab):c.currentApp==="settings"&&t.push(c.settingsView);const s="#/"+t.filter(Boolean).join("/");window.location.hash!==s&&window.history.pushState(null,"",s)}function dl(){const e=window.location.hash.replace("#/","");if(!e)return;const t=e.split("/"),s=t[0];s&&(c.currentApp=s),s==="sales"?t[1]&&(c.currentTab=t[1]):s==="clients"?(t[1]&&(c.clientViewMode=t[1]),t[2]&&(c.selectedClient=decodeURIComponent(t[2]))):s==="reports"?t[1]&&(c.reportsTab=t[1]):s==="repairs"?(t[1]&&(c.repairTab=t[1]),t[2]&&(c.repairViewMode=t[2])):s==="inventory"?(t[1]&&(c.inventoryTab=t[1]),t[2]&&(c.inventoryMode=t[2])):s==="marketplace"?(t[1]&&(c.marketplaceTab=t[1]),t[2]&&(c.marketplaceViewMode=t[2])):s==="inquiries"?t[1]&&(c.inquiryViewMode=t[1]):s==="prebooking"?t[1]&&(c.preBookingViewMode=t[1]):s==="automation"?t[1]&&(c.automationViewMode=t[1]):s==="schemes"?t[1]&&(c.schemesTab=t[1]):s==="settings"&&t[1]&&(c.settingsView=t[1]),C(!1)}function lp(){window.addEventListener("hashchange",dl),dl()}const St={endpoint:"https://live-mt-server.wati.io/319917",token:"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..V1k2oIW0iDKep9_zG9WpS62LVcgXxj7vAndigvmZS2I"};function ip(e){if(!e)return null;let t=e.replace(/\D/g,"");return t.length===10&&(t="91"+t),t}async function rp(e,t){var a;const s=ip(e);if(!s)throw new Error("Invalid phone number");try{const n=await fetch(`${St.endpoint}/api/v1/sendSessionMessage/${s}`,{method:"POST",headers:{Authorization:St.token,"Content-Type":"application/json"},body:JSON.stringify({messageText:t})}),l=await n.json();if(!n.ok){if(console.error("WATI API Error:",l),(a=l.message)!=null&&a.includes("session")||l.result===!1)return console.log("Session expired, trying template message..."),await op(s,t);throw new Error(l.message||"Failed to send message")}return{success:!0,data:l}}catch(n){throw console.error("WATI Send Error:",n),n}}async function op(e,t){try{const s=await fetch(`${St.endpoint}/api/v1/sendTemplateMessage`,{method:"POST",headers:{Authorization:St.token,"Content-Type":"application/json"},body:JSON.stringify({whatsappNumber:e,templateName:"retaileros_notification",parameters:[{name:"message",value:t}],broadcast_name:"RetailerOS"})}),a=await s.json();return!s.ok&&a.result===!1?(console.log("Template not found, trying interactive message..."),await cp(e,t)):{success:!0,data:a,method:"template"}}catch(s){throw console.error("Template message error:",s),s}}async function cp(e,t){try{const s=await fetch(`${St.endpoint}/api/v1/sendInteractiveButtonsMessage`,{method:"POST",headers:{Authorization:St.token,"Content-Type":"application/json"},body:JSON.stringify({whatsappNumber:e,header:{type:"Text",text:"RetailerOS"},body:t,footer:"Powered by RetailerOS",buttons:[{type:"reply",reply:{id:"reply_ok",title:"OK"}}]})}),a=await s.json();return{success:s.ok,data:a,method:"interactive"}}catch(s){throw console.error("Interactive message error:",s),s}}async function dp(){try{return(await fetch(`${St.endpoint}/api/v1/getContacts?pageSize=1`,{method:"GET",headers:{Authorization:St.token}})).ok}catch(e){return console.error("WATI connection test failed:",e),!1}}window.sendWhatsAppMessage=rp;window.testWatiConnection=dp;let Rt=null,Na=null;const pl={success:{icon:"check_circle",bg:"bg-slate-900",text:"text-white"},error:{icon:"error",bg:"bg-red-600",text:"text-white"},warning:{icon:"warning",bg:"bg-amber-500",text:"text-white"},info:{icon:"info",bg:"bg-slate-700",text:"text-white"}};function pp(){Rt||(Rt=document.createElement("div"),Rt.id="toast-container",Rt.className="fixed top-4 left-1/2 -translate-x-1/2 z-[9999] flex flex-col items-center gap-2 pointer-events-none",document.body.appendChild(Rt))}function Os(e,t="info",s=3e3){pp(),Na&&clearTimeout(Na);const a=pl[t]||pl.info,n=document.createElement("div");return n.className=`
        ${a.bg} ${a.text} 
    ...
    `,(t==="error"||e.length>50)&&(n.innerHTML+=`
        ...
        `),Rt.innerHTML="",Rt.appendChild(n),requestAnimationFrame(()=>{n.classList.remove("opacity-0","translate-y-[-20px]","scale-95"),n.classList.add("opacity-100","translate-y-0","scale-100")}),Na=setTimeout(()=>{up(n)},s),n}function up(e){!e||!e.parentElement||(e.classList.remove("opacity-100","translate-y-0","scale-100"),e.classList.add("opacity-0","translate-y-[-20px]","scale-95"),setTimeout(()=>{e.remove()},300))}function Sa(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}const xp={success:(e,t)=>Os(e,"success",t),error:(e,t)=>Os(e,"error",t||5e3),warning:(e,t)=>Os(e,"warning",t||4e3),info:(e,t)=>Os(e,"info",t)};function fp(e,t,s){const a=document.createElement("div");a.className="fixed inset-0 z-[9998] bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4",a.innerHTML=`
    ...
    `,document.body.appendChild(n);const l=n.querySelector("div > div"),d=n.querySelector("#prompt-input");requestAnimationFrame(()=>{l.classList.remove("scale-95","opacity-0"),l.classList.add("scale-100","opacity-100"),d.focus(),d.select()}),d.onkeydown=r=>{if(r.key==="Enter"){const p=d.value.trim();ct(n),p&&s&&s(p)}else r.key==="Escape"&&(ct(n),a&&a())},n.querySelector("#prompt-cancel").onclick=()=>{ct(n),a&&a()},n.querySelector("#prompt-ok").onclick=()=>{const r=d.value.trim();ct(n),r&&s&&s(r)},n.onclick=r=>{r.target===n&&(ct(n),a&&a())}}window.toast=xp;window.showToast=Os;window.showConfirm=fp;window.showPrompt=bp;function Mi(){return c.currentApp==="sales"?c.currentTab==="new-sale"?Ai():Ri():c.currentApp==="clients"?Sn("desktop-primary"):c.currentApp==="reports"?In("desktop-primary"):c.currentApp==="repairs"?$n("desktop-primary"):c.currentApp==="marketing"?Cn("desktop-primary"):c.currentApp==="promoters"?An("desktop-primary"):c.currentApp==="inventory"?Rn("desktop-primary"):c.currentApp==="settings"?En("desktop-primary"):c.currentApp==="schemes"?Tn("desktop-primary"):c.currentApp==="marketplace"?Mn("desktop-primary"):c.currentApp==="inquiries"?Dn("desktop-primary"):c.currentApp==="prebooking"?Ln("desktop-primary"):c.currentApp==="automation"?qn("desktop-primary"):'<div class="p-10 flex items-center justify-center h-full text-slate-300 font-bold uppercase tracking-widest">App Module Not Found</div>'}function hp(){return c.currentApp==="sales"?c.salesMode==="add-customer"?on("desktop"):_n():c.currentApp==="clients"?Sn("desktop-secondary"):c.currentApp==="reports"?In("desktop-secondary"):c.currentApp==="repairs"?$n("desktop-secondary"):c.currentApp==="marketing"?Cn("desktop-secondary"):c.currentApp==="promoters"?An("desktop-secondary"):c.currentApp==="inventory"?Rn("desktop-secondary"):c.currentApp==="settings"?En("desktop-secondary"):c.currentApp==="schemes"?Tn("desktop-secondary"):c.currentApp==="marketplace"?Mn("desktop-secondary"):c.currentApp==="inquiries"?Dn("desktop-secondary"):c.currentApp==="prebooking"?Ln("desktop-secondary"):c.currentApp==="automation"?qn("desktop-secondary"):'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-2 opacity-50">grid_view</span><p class="text-[10px] font-black uppercase tracking-widest">Select an app to view details</p></div></div>'}function Di(){return Ba("desktop")}function mp(){return`
        <div class="h-full flex flex-row divide-x divide-slate-200 bg-white w-full">
            ...
            <div class="flex-1 bg-white h-full overflow-hidden flex flex-col relative z-10">
               ${c.isLoggedIn?c.currentApp==="launcher"?'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-4 opacity-20">arrow_back</span><p class="text-[10px] font-black uppercase tracking-widest opacity-40">Select an App from the Menu</p></div></div>':Mi():'<div class="h-full w-full bg-slate-950 flex flex-col items-center justify-center text-white/5 font-black text-[20vw] leading-none overflow-hidden select-none pointer-events-none"><div>OS</div></div>'}
            </div>
            ...
            <div class="w-[30%] shrink-0 bg-slate-50/50 h-full overflow-hidden flex flex-col relative dot-grid border-l border-slate-200">
                ${c.isLoggedIn?c.currentApp==="launcher"?'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-6xl mb-4 opacity-20">dashboard</span><p class="text-[10px] font-black uppercase tracking-widest opacity-40">Retailer OS Environment</p></div></div>':hp():'<div class="h-full w-full bg-slate-950/95 flex flex-col items-center justify-center text-white/5 font-black text-[15vw] leading-none overflow-hidden select-none pointer-events-none"><div>RETAILER</div></div>'}
            </div>
        </div>
    `}function gp(){return`
        <div class="h-full grid grid-cols-2 divide-x divide-slate-200 bg-white">
            ...
            <div class="col-span-1 bg-white h-full overflow-hidden flex flex-col relative z-10">
               ${c.currentApp==="launcher"?'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-4 opacity-20">arrow_back</span><p class="text-[10px] font-black uppercase tracking-widest opacity-40">Select an App from the Menu</p></div></div>':Mi()}
    ...
    `}function wp(){if(!c.isLoggedIn)return vl();if(c.currentApp==="launcher")return Ba("mobile");if(c.currentApp==="sales"){const t=window.getActiveCart&&window.getActiveCart().length>0,s=c.currentTab==="new-sale"&&t||c.currentTab==="history"&&c.salesHistoryId;return c.showMobileReceipt&&s?`
        ...
        `:""}
        `}let e="";if(c.currentApp==="clients")e=Sn("mobile");else if(c.currentApp==="reports")e=In("mobile");else if(c.currentApp==="repairs")e=$n("mobile");else if(c.currentApp==="marketing")e=Cn("mobile");else if(c.currentApp==="promoters")e=An("mobile");else if(c.currentApp==="inventory")e=Rn("mobile");else if(c.currentApp==="settings")e=En("mobile");else if(c.currentApp==="schemes")e=Tn("mobile");else if(c.currentApp==="marketplace")e=Mn("mobile");else if(c.currentApp==="inquiries")e=Dn("mobile");else if(c.currentApp==="prebooking")e=Ln("mobile");else if(c.currentApp==="automation")e=qn("mobile");else return Ba("mobile");return`
        <div class="flex flex-col w-full h-full overflow-hidden bg-slate-50 relative">
            ${e}
        </div>
    `}function Ia(){const e=document.getElementById("app");if(e)try{const t=window.innerWidth;t<768?e.innerHTML=wp():t>=768&&t<1024?e.innerHTML=gp():e.innerHTML=mp()}catch(t){console.error(t),e.innerHTML=`< div class="p-4 text-red-500 font-bold" > Error: ${t.message} <br><small>${t.stack}</small></div>`}}ml(Ia);ml(np);lp();window.addEventListener("resize",()=>{window.innerWidth!==c.viewportWidth&&(c.viewportWidth=window.innerWidth,c.gridCols=window.innerWidth<768?4:3,Ia())});K().then(()=>{console.log("Initial data sync complete"),Ia()}).catch(e=>{console.error("Initial sync failed:",e),Ia()});
