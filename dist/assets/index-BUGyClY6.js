var or=Object.defineProperty;var Zn=e=>{throw TypeError(e)};var cr=(e,t,s)=>t in e?or(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var q=(e,t,s)=>cr(e,typeof t!="symbol"?t+"":t,s),Wa=(e,t,s)=>t.has(e)||Zn("Cannot "+s);var d=(e,t,s)=>(Wa(e,t,"read from private field"),s?s.call(e):t.get(e)),_=(e,t,s)=>t.has(e)?Zn("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),h=(e,t,s,a)=>(Wa(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),S=(e,t,s)=>(Wa(e,t,"access private method"),s);var es=(e,t,s,a)=>({set _(n){h(e,t,n,s)},get _(){return d(e,t,a)}});(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const l of n)if(l.type==="childList")for(const i of l.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function s(n){const l={};return n.integrity&&(l.integrity=n.integrity),n.referrerPolicy&&(l.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?l.credentials="include":n.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(n){if(n.ep)return;n.ep=!0;const l=s(n);fetch(n.href,l)}})();const dr=localStorage.getItem("retaileros_logged_in")==="true",pr=localStorage.getItem("retaileros_retailer_id")||null,ur=localStorage.getItem("retaileros_retailer_code")||null,xr=localStorage.getItem("retaileros_retailer_name")||null,fr=localStorage.getItem("retaileros_push_notifications")!=="false";window._pushNotificationsEnabled=fr;const p={retailerId:pr,retailerCode:ur,retailerName:xr,currentApp:window.innerWidth<768?"launcher":"sales",currentTab:"new-sale",salesMode:"default",salesHistoryId:"ORD-99281",historyViewMode:"completed",historyDateFilter:"today",historyFromDate:"",historyToDate:"",showMobileReceipt:!1,reportsTab:"sales",repairTab:"active",repairViewMode:"search",selectedRepairDevice:null,activeRepairId:null,repairContext:null,selectedClient:null,selectedClientId:null,clientViewMode:"directory",clientSearchQuery:"",clientInvoiceId:null,selectedGroupId:null,groupViewMode:"list",groupSearchQuery:"",promoterViewMode:"performance",inventoryTab:"brands",inventoryMode:"details",activeCategory:null,settingsView:null,viewportWidth:window.innerWidth,gridCols:window.innerWidth<768?4:3,schemesTab:"list",activeSchemeBrand:"Apple",activeScheme:"June Activation Bonus",showSchemeDetails:!1,marketplaceTab:"browse",marketplaceViewMode:"list",myStoreTab:"dashboard",myStoreViewMode:"list",activeStoreOrderId:null,activeListingId:null,isLoggedIn:dr,authMode:"login",registrationStep:1,inquiryViewMode:"list",activeInquiry:null,preBookingViewMode:"dashboard",activeCampaign:null,automationViewMode:"dashboard",activeAutomationId:null},Ll=[],Ol=e=>{Ll.push(e)},D=(e=!0)=>{Ll.forEach(t=>t(e))};function br(e){p.currentApp=e,e==="clients"&&(p.clientViewMode="directory"),D()}function mr(e){p.currentTab=e,D()}function hr(e){p.salesHistoryId=e,e&&window.innerWidth<768&&(p.showMobileReceipt=!0),D()}function gr(e){p.showMobileReceipt=e,D()}function wr(e){p.reportsTab=e,D()}function vr(e){p.repairTab=e,D()}function yr(e,t=null){p.repairViewMode=e,t&&(p.selectedRepairDevice=t),D()}function kr(e){p.gridCols=e,D()}function jl(e,t=null,s=null){p.clientViewMode=e,t&&(p.selectedClient=t),s&&(p.selectedClientId=s),e!=="invoice"&&(p.clientInvoiceId=null),D()}function _r(e){p.clientInvoiceId=e,p.clientViewMode="invoice",D()}function Sr(e){p.schemesTab=e,D()}function $r(e){p.activeSchemeBrand=e,D()}function Er(e){p.activeScheme=e,D()}function Ir(e){p.showSchemeDetails=e,D()}function Cr(e){p.marketplaceTab=e,D()}function Rr(e){p.marketplaceViewMode=e,D()}function Ar(e,t,s){p.retailerId=e,p.retailerCode=t,p.retailerName=s,localStorage.setItem("retaileros_retailer_id",e),localStorage.setItem("retaileros_retailer_code",t),localStorage.setItem("retaileros_retailer_name",s)}function Pl(){p.retailerId=null,p.retailerCode=null,p.retailerName=null,localStorage.removeItem("retaileros_retailer_id"),localStorage.removeItem("retaileros_retailer_code"),localStorage.removeItem("retaileros_retailer_name")}function Tr(){return p.retailerId}function Mr(e){p.isLoggedIn=e,e?localStorage.setItem("retaileros_logged_in","true"):(localStorage.removeItem("retaileros_logged_in"),Pl());const t=window.innerWidth<768;p.currentApp=e?t?"launcher":"sales":"launcher",D()}function Dr(e){p.authMode=e,p.registrationStep=1,D()}function Lr(e){p.registrationStep=e,window.updateAuthContent?window.updateAuthContent():D()}function Or(e){p.inquiryViewMode=e,D()}function jr(e){p.activeInquiry=e,D()}function Pr(e){p.preBookingViewMode=e,D()}function Nr(e){p.activeCampaign=e,D()}function qr(e){p.automationViewMode=e,D()}function Br(e){p.activeAutomationId=e,D()}window.triggerRender=D;window.setApp=br;window.setTab=mr;window.setSalesHistoryId=hr;window.toggleMobileReceipt=gr;window.setReportsTab=wr;window.setRepairTab=vr;function Nl(e){p.salesMode=e,D()}window.setSalesMode=Nl;function Fr(e){p.historyViewMode=e,D()}function Vr(e){p.historyDateFilter=e,e!=="custom"&&(p.historyFromDate="",p.historyToDate=""),D()}function Ur(e,t){p.historyFromDate=e,p.historyToDate=t,p.historyDateFilter="custom",D()}window.setHistoryViewMode=Fr;window.setHistoryDateFilter=Vr;window.setHistoryCustomDates=Ur;window.setRepairMode=yr;window.setGridCols=kr;window.setClientMode=jl;window.viewClientInvoice=_r;window.setSchemesTab=Sr;window.setSchemeBrand=$r;window.setScheme=Er;window.toggleSchemeDetails=Ir;window.setMarketplaceTab=Cr;window.setMarketplaceViewMode=Rr;function Hr(e){p.myStoreTab=e,p.myStoreViewMode="list",D()}function Gr(e){p.myStoreViewMode=e,D()}function Wr(e){p.activeStoreOrderId=e,p.myStoreViewMode="order-detail",D()}function zr(e){p.activeListingId=e,D()}window.setMyStoreTab=Hr;window.setMyStoreViewMode=Gr;window.setActiveStoreOrder=Wr;window.setActiveListing=zr;window.setRetailer=Ar;window.clearRetailer=Pl;window.getRetailerId=Tr;window.setLoginStatus=Mr;window.setAuthMode=Dr;window.setRegistrationStep=Lr;window.setInquiryViewMode=Or;window.setActiveInquiry=jr;window.setPreBookingViewMode=Pr;window.setActiveCampaign=Nr;window.setAutomationViewMode=qr;window.setActiveAutomation=Br;function Yr(e){p.groupViewMode=e,D()}function Jr(e){p.selectedGroupId=e,D()}window.setGroupViewMode=Yr;window.setSelectedGroup=Jr;function Kr(){const e=window._pushNotificationsEnabled!==!1;window._pushNotificationsEnabled=!e,localStorage.setItem("retaileros_push_notifications",e?"false":"true"),D()}window.togglePushNotifications=Kr;const Qr="modulepreload",Xr=function(e){return"/"+e},el={},Ys=function(t,s,a){let n=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),r=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));n=Promise.allSettled(s.map(c=>{if(c=Xr(c),c in el)return;el[c]=!0;const o=c.endsWith(".css"),u=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const b=document.createElement("link");if(b.rel=o?"stylesheet":Qr,o||(b.as="script"),b.crossOrigin="",b.href=c,r&&b.setAttribute("nonce",r),document.head.appendChild(b),o)return new Promise((m,y)=>{b.addEventListener("load",m),b.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${c}`)))})}))}function l(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return n.then(i=>{for(const r of i||[])r.status==="rejected"&&l(r.reason);return t().catch(l)})};function ql(e){const t=e==="mobile";return`
    ...
    `}function eo(){return p.registrationStep<3?`
    ...
    `}function to(){const e=p.registrationStep;return`
...
Error: `+s.message)}};window.verifyOtp=function(){const e=[];for(let a=0;a<6;a++){const n=document.getElementById(`otp-${a}`);n&&e.push(n.value)}const t=e.join("");if(t.length!==6){alert("Please enter all 6 digits");return}const s="444619";console.log("Verifying OTP:",t),t===s?console.log("✅ Default OTP accepted:",s):console.log("ℹ️  Development mode: Any OTP accepted"),window.setRegistrationStep(3)};window.resendOtp=function(){for(let t=0;t<6;t++){const s=document.getElementById(`otp-${t}`);s&&(s.value="")}const e=document.getElementById("otp-0");e&&e.focus(),console.log("Resending OTP..."),alert("OTP has been resent successfully!")};window.finalizeRegistration=async function(){try{const e=window._approvedRetailerData;if(!e){alert("Session expired. Please start registration again."),window.setRegistrationStep(1);return}const{db:t}=await Ys(async()=>{const{db:n}=await Promise.resolve().then(()=>Mn);return{db:n}},void 0),s=await t.retailers.add(e);window.setRetailer(s.id,s.retailerCode,e.RetailerName),localStorage.setItem("retaileros_logged_in","true"),delete window._approvedRetailerData;const{syncData:a}=await Ys(async()=>{const{syncData:n}=await Promise.resolve().then(()=>zi);return{syncData:n}},void 0);await a(),window.setLoginStatus(!0),console.log("Registration completed successfully:",s)}catch(e){console.error("Registration failed:",e),alert("Registration failed. Please try again.")}};function Bl(){return p.authMode==="register"?Js("mobile"):ql("mobile")}const so=[{n:"ALERTS",i:"notifications",k:"notifications"},{n:"SALES DESK",i:"account_balance_wallet",k:"sales"},{n:"CLIENTS",i:"group",k:"clients"},{n:"INQUIRIES",i:"help_outline",k:"inquiries"},{n:"PROMOTERS",i:"business_center",k:"promoters"},{n:"MY STORE",i:"storefront",k:"mystore"},{n:"INVENTORY",i:"inventory_2",k:"inventory"},{n:"REPAIRS",i:"build",k:"repairs"},{n:"MARKETPLACE",i:"swap_horizontal_circle",k:"marketplace"},{n:"CLAIMS",i:"verified_user"},{n:"SCHEMES",i:"percent",k:"schemes"},{n:"MARKETING",i:"campaign",k:"marketing"},{n:"AUTOMATION",i:"smart_toy",s:!0,k:"automation"},{n:"PRE-BOOKING",i:"rocket_launch",k:"prebooking"},{n:"REPORTS",i:"bar_chart",k:"reports"},{n:"SETTINGS",i:"settings",k:"settings"}];function ao(e){const t=e?p.gridCols:4,s=e&&{2:"grid-cols-2",3:"grid-cols-3",4:"grid-cols-4"}[t]||"grid-cols-4",a=window.getNotificationCount?window.getNotificationCount():0;return`
    ...
    `}class F extends Error{constructor(s,a,n,l,i){a!==void 0&&(s=`${a}: ${s}`);super(s,{cause:i});q(this,"code");q(this,"extendedCode");q(this,"rawCode");this.code=a,this.extendedCode=n,this.rawCode=l,this.name="LibsqlError"}}class ls extends F{constructor(s,a,n,l,i,r){super(s,n,l,i,r);q(this,"statementIndex");this.statementIndex=a,this.name="LibsqlBatchError"}}function lo(e){const t=io.exec(e);if(t===null)throw new F(`The URL '${e}' is not in a valid format`,"URL_INVALID");const s=t.groups,a=s.scheme,n=s.authority!==void 0?ro(s.authority):void 0,l=Qt(s.path),i=s.query!==void 0?co(s.query):void 0,r=s.fragment!==void 0?Qt(s.fragment):void 0;return{scheme:a,authority:n,path:l,query:i,fragment:r}}const io=(()=>{const e="(?<scheme>[A-Za-z][A-Za-z.+-]*)",t="(?<authority>[^/?#]*)",s="(?<path>[^?#]*)",a="(?<query>[^#]*)",n="(?<fragment>.*)";return new RegExp(`^${e}:(//${t})?${s}(\\?${a})?(#${n})?$`,"su")})();function ro(e){const t=oo.exec(e);if(t===null)throw new F("The authority part of the URL is not in a valid format","URL_INVALID");const s=t.groups,a=Qt(s.host_br??s.host),n=s.port?parseInt(s.port,10):void 0,l=s.username!==void 0?{username:Qt(s.username),password:s.password!==void 0?Qt(s.password):void 0}:void 0;return{host:a,port:n,userinfo:l}}const oo=new RegExp("^((?<username>[^:]*)(:(?<password>.*))?@)?((?<host>[^:\\[\\]]*)|(\\[(?<host_br>[^\\[\\]]*)\\]))(:(?<port>[0-9]*))?$","su");function co(e){const t=e.split("&"),s=[];for(const a of t){if(a==="")continue;let n,l;const i=a.indexOf("=");i<0?(n=a,l=""):(n=a.substring(0,i),l=a.substring(i+1)),s.push({key:Qt(n.replaceAll("+"," ")),value:Qt(l.replaceAll("+"," "))})}return{pairs:s}}function Qt(e){try{return decodeURIComponent(e)}catch(t){throw t instanceof URIError?new F(`URL component has invalid percent encoding: ${t}`,"URL_INVALID",void 0,void 0,t):t}}function Qa(e,t,s){if(t===void 0)throw new F(`URL with scheme ${JSON.stringify(e+":")} requires authority (the "//" part)`,"URL_INVALID");const a=`${e}:`,n=po(t.host),l=uo(t.port),r=`//${xo(t.userinfo)}${n}${l}`;let c=s.split("/").map(encodeURIComponent).join("/");return c!==""&&!c.startsWith("/")&&(c="/"+c),new URL(`${a}${r}${c}`)}function po(e){return e.includes(":")?`[${encodeURI(e)}]`:encodeURI(e)}function uo(e){return e!==void 0?`:${e}`:""}function xo(e){if(e===void 0)return"";const t=encodeURIComponent(e.username),s=e.password!==void 0?`:${encodeURIComponent(e.password)}`:"";return`${t}${s}@`}const Vl="3.7.8",fo=Vl,Ds=typeof Buffer=="function",tl=typeof TextDecoder=="function"?new TextDecoder:void 0,sl=typeof TextEncoder=="function"?new TextEncoder:void 0,bo="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",js=Array.prototype.slice.call(bo),ha=(e=>{let t={};return e.forEach((s,a)=>t[s]=a),t})(js),mo=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,le=String.fromCharCode.bind(String),al=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):e=>new Uint8Array(Array.prototype.slice.call(e,0)),Ul=e=>e.replace(/=/g,"").replace(/[+\/]/g,t=>t=="+"?"-":"_"),Hl=e=>e.replace(/[^A-Za-z0-9\+\/]/g,""),Gl=e=>{let t,s,a,n,l="";const i=e.length%3;for(let r=0;r<e.length;){if((s=e.charCodeAt(r++))>255||(a=e.charCodeAt(r++))>255||(n=e.charCodeAt(r++))>255)throw new TypeError("invalid character found");t=s<<16|a<<8|n,l+=js[t>>18&63]+js[t>>12&63]+js[t>>6&63]+js[t&63]}return i?l.slice(0,i-3)+"===".substring(i):l},kn=typeof btoa=="function"?e=>btoa(e):Ds?e=>Buffer.from(e,"binary").toString("base64"):Gl,Xa=Ds?e=>Buffer.from(e).toString("base64"):e=>{let s=[];for(let a=0,n=e.length;a<n;a+=4096)s.push(le.apply(null,e.subarray(a,a+4096)));return kn(s.join(""))},va=(e,t=!1)=>t?Ul(Xa(e)):Xa(e),ho=e=>{if(e.length<2){var t=e.charCodeAt(0);return t<128?e:t<2048?le(192|t>>>6)+le(128|t&63):le(224|t>>>12&15)+le(128|t>>>6&63)+le(128|t&63)}else{var t=65536+(e.charCodeAt(0)-55296)*1024+(e.charCodeAt(1)-56320);return le(240|t>>>18&7)+le(128|t>>>12&63)+le(128|t>>>6&63)+le(128|t&63)}},go=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,Wl=e=>e.replace(go,ho),nl=Ds?e=>Buffer.from(e,"utf8").toString("base64"):sl?e=>Xa(sl.encode(e)):e=>kn(Wl(e)),is=(e,t=!1)=>t?Ul(nl(e)):nl(e),ll=e=>is(e,!0),wo=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,vo=e=>{switch(e.length){case 4:var t=(7&e.charCodeAt(0))<<18|(63&e.charCodeAt(1))<<12|(63&e.charCodeAt(2))<<6|63&e.charCodeAt(3),s=t-65536;return le((s>>>10)+55296)+le((s&1023)+56320);case 3:return le((15&e.charCodeAt(0))<<12|(63&e.charCodeAt(1))<<6|63&e.charCodeAt(2));default:return le((31&e.charCodeAt(0))<<6|63&e.charCodeAt(1))}},zl=e=>e.replace(wo,vo),Yl=e=>{if(e=e.replace(/\s+/g,""),!mo.test(e))throw new TypeError("malformed base64.");e+="==".slice(2-(e.length&3));let t,s,a,n=[];for(let l=0;l<e.length;)t=ha[e.charAt(l++)]<<18|ha[e.charAt(l++)]<<12|(s=ha[e.charAt(l++)])<<6|(a=ha[e.charAt(l++)]),s===64?n.push(le(t>>16&255)):a===64?n.push(le(t>>16&255,t>>8&255)):n.push(le(t>>16&255,t>>8&255,t&255));return n.join("")},_n=typeof atob=="function"?e=>atob(Hl(e)):Ds?e=>Buffer.from(e,"base64").toString("binary"):Yl,Jl=Ds?e=>al(Buffer.from(e,"base64")):e=>al(_n(e).split("").map(t=>t.charCodeAt(0))),Kl=e=>Jl(Ql(e)),yo=Ds?e=>Buffer.from(e,"base64").toString("utf8"):tl?e=>tl.decode(Jl(e)):e=>zl(_n(e)),Ql=e=>Hl(e.replace(/[-_]/g,t=>t=="-"?"+":"/")),Za=e=>yo(Ql(e)),ko=e=>{if(typeof e!="string")return!1;const t=e.replace(/\s+/g,"").replace(/={0,2}$/,"");return!/[^\s0-9a-zA-Z\+/]/.test(t)||!/[^\s0-9a-zA-Z\-_]/.test(t)},Xl=e=>({value:e,enumerable:!1,writable:!0,configurable:!0}),Zl=function(){const e=(t,s)=>Object.defineProperty(String.prototype,t,Xl(s));e("fromBase64",function(){return Za(this)}),e("toBase64",function(t){return is(this,t)}),e("toBase64URI",function(){return is(this,!0)}),e("toBase64URL",function(){return is(this,!0)}),e("toUint8Array",function(){return Kl(this)})},ei=function(){const e=(t,s)=>Object.defineProperty(Uint8Array.prototype,t,Xl(s));e("toBase64",function(t){return va(this,t)}),e("toBase64URI",function(){return va(this,!0)}),e("toBase64URL",function(){return va(this,!0)})},_o=()=>{Zl(),ei()},Sn={version:Vl,VERSION:fo,atob:_n,atobPolyfill:Yl,btoa:kn,btoaPolyfill:Gl,fromBase64:Za,toBase64:is,encode:is,encodeURI:ll,encodeURL:ll,utob:Wl,btou:zl,decode:Za,isValid:ko,fromUint8Array:va,toUint8Array:Kl,extendString:Zl,extendUint8Array:ei,extendBuiltins:_o},Ks="https://github.com/libsql/libsql-client-ts#supported-urls";function en(e){if(e==="write")return"BEGIN IMMEDIATE";if(e==="read")return"BEGIN TRANSACTION READONLY";if(e==="deferred")return"BEGIN DEFERRED";throw RangeError('Unknown transaction mode, supported values are "write", "read" and "deferred"')}class So{constructor(t,s,a,n,l){q(this,"columns");q(this,"columnTypes");q(this,"rows");q(this,"rowsAffected");q(this,"lastInsertRowid");this.columns=t,this.columnTypes=s,this.rows=a,this.rowsAffected=n,this.lastInsertRowid=l}toJSON(){return{columns:this.columns,columnTypes:this.columnTypes,rows:this.rows.map($o),rowsAffected:this.rowsAffected,lastInsertRowid:this.lastInsertRowid!==void 0?""+this.lastInsertRowid:null}}}function $o(e){return Array.prototype.map.call(e,Eo)}function Eo(e){return typeof e=="bigint"?""+e:e instanceof ArrayBuffer?Sn.fromUint8Array(new Uint8Array(e)):e}const il=":memory:";function Io(e,t){var f,x;if(typeof e!="object")throw new TypeError(`Expected client configuration as object, got ${typeof e}`);let{url:s,authToken:a,tls:n,intMode:l,concurrency:i}=e;i=Math.max(0,i||20),l??(l="number");let r=[];s===il&&(s="file::memory:");const c=lo(s),o=c.scheme.toLowerCase(),u=o==="file"&&c.path===il&&c.authority===void 0;let b;u?b={cache:{values:["shared","private"],update:(g,E)=>r.push(`${g}=${E}`)}}:b={tls:{values:["0","1"],update:(g,E)=>n=E==="1"},authToken:{update:(g,E)=>a=E}};for(const{key:g,value:E}of((f=c.query)==null?void 0:f.pairs)??[]){if(!Object.hasOwn(b,g))throw new F(`Unsupported URL query parameter ${JSON.stringify(g)}`,"URL_PARAM_NOT_SUPPORTED");const C=b[g];if(C.values!==void 0&&!C.values.includes(E))throw new F(`Unknown value for the "${g}" query argument: ${JSON.stringify(E)}. Supported values are: [${C.values.map($=>'"'+$+'"').join(", ")}]`,"URL_INVALID");C.update!==void 0&&(C==null||C.update(g,E))}const m=r.length===0?"":`?${r.join("&")}`,y=c.path+m;let w;if(o==="libsql")if(n===!1){if(((x=c.authority)==null?void 0:x.port)===void 0)throw new F('A "libsql:" URL with ?tls=0 must specify an explicit port',"URL_INVALID");w="http"}else w="https";else w=o;if(w==="http"||w==="ws"?n??(n=!1):n??(n=!0),w!=="http"&&w!=="ws"&&w!=="https"&&w!=="wss"&&w!=="file")throw new F(`The client supports only "libsql:", "wss:", "ws:", "https:", "http:" and "file:" URLs, got ${JSON.stringify(c.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(l!=="number"&&l!=="bigint"&&l!=="string")throw new TypeError(`Invalid value for intMode, expected "number", "bigint" or "string", got ${JSON.stringify(l)}`);if(c.fragment!==void 0)throw new F(`URL fragments are not supported: ${JSON.stringify("#"+c.fragment)}`,"URL_INVALID");return u?{scheme:"file",tls:!1,path:y,intMode:l,concurrency:i,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch,authToken:void 0,encryptionKey:void 0,remoteEncryptionKey:void 0,authority:void 0}:{scheme:w,tls:n,authority:c.authority,path:y,authToken:a,intMode:l,concurrency:i,encryptionKey:e.encryptionKey,remoteEncryptionKey:e.remoteEncryptionKey,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch}}let as;typeof WebSocket<"u"?as=WebSocket:typeof global<"u"?as=global.WebSocket:typeof window<"u"?as=window.WebSocket:typeof self<"u"&&(as=self.WebSocket);class ti{constructor(){q(this,"intMode");this.intMode="number"}}class K extends Error{constructor(t){super(t),this.name="ClientError"}}class j extends K{constructor(t){super(t),this.name="ProtoError"}}class si extends K{constructor(s,a){super(s);q(this,"code");q(this,"proto");this.name="ResponseError",this.code=a.code,this.proto=a,this.stack=void 0}}class Ae extends K{constructor(t,s){s!==void 0?(super(`${t}: ${s}`),this.cause=s):super(t),this.name="ClosedError"}}class ai extends K{constructor(t){super(t),this.name="WebSocketUnsupportedError"}}class tn extends K{constructor(t){super(t),this.name="WebSocketError"}}class ya extends K{constructor(s,a){super(s);q(this,"status");this.status=a,this.name="HttpServerError"}}class Rs extends K{constructor(t){super(t),this.name="ProtocolVersionError"}}class At extends K{constructor(t){super(t),this.name="InternalError"}}class Ls extends K{constructor(t){super(t),this.name="MisuseError"}}function qe(e){if(typeof e=="string")return e;throw Os(e,"string")}function Fe(e){if(e!=null){if(typeof e=="string")return e;throw Os(e,"string or null")}}function Xt(e){if(typeof e=="number")return e;throw Os(e,"number")}function Qs(e){if(typeof e=="boolean")return e;throw Os(e,"boolean")}function Ia(e){if(Array.isArray(e))return e;throw Os(e,"array")}function ie(e){if(e!==null&&typeof e=="object"&&!Array.isArray(e))return e;throw Os(e,"object")}function Tt(e,t){return Ia(e).map(s=>t(ie(s)))}function Os(e,t){if(e===void 0)return new j(`Expected ${t}, but the property was missing`);let s=typeof e;return e===null?s="null":Array.isArray(e)&&(s="array"),new j(`Expected ${t}, received ${s}`)}function $n(e,t){return t(ie(e))}var X,gt,Ze,Ot;class Co{constructor(t){_(this,Ze);_(this,X);_(this,gt);h(this,X,t),h(this,gt,!1)}begin(){d(this,X).push("{"),h(this,gt,!0)}end(){d(this,X).push("}"),h(this,gt,!1)}string(t,s){S(this,Ze,Ot).call(this,t),d(this,X).push(JSON.stringify(s))}stringRaw(t,s){S(this,Ze,Ot).call(this,t),d(this,X).push('"'),d(this,X).push(s),d(this,X).push('"')}number(t,s){S(this,Ze,Ot).call(this,t),d(this,X).push(""+s)}boolean(t,s){S(this,Ze,Ot).call(this,t),d(this,X).push(s?"true":"false")}object(t,s,a){S(this,Ze,Ot).call(this,t),this.begin(),a(this,s),this.end()}arrayObjects(t,s,a){S(this,Ze,Ot).call(this,t),d(this,X).push("[");for(let n=0;n<s.length;++n)n!==0&&d(this,X).push(","),this.begin(),a(this,s[n]),this.end();d(this,X).push("]")}}X=new WeakMap,gt=new WeakMap,Ze=new WeakSet,Ot=function(t){d(this,gt)?(d(this,X).push('"'),h(this,gt,!1)):d(this,X).push(',"'),d(this,X).push(t),d(this,X).push('":')};function ni(e,t){const s=[],a=new Co(s);return a.begin(),t(a,e),a.end(),s.join("")}const Ws=0,sn=1,an=2,Ro=5;var Ue,Xs,_e;class Ao{constructor(t){_(this,Ue);_(this,Xs);_(this,_e);h(this,Ue,t),h(this,Xs,new DataView(t.buffer,t.byteOffset,t.byteLength)),h(this,_e,0)}varint(){let t=0;for(let s=0;;s+=7){const a=d(this,Ue)[es(this,_e)._++];if(t|=(a&127)<<s,!(a&128))break}return t}varintBig(){let t=0n;for(let s=0n;;s+=7n){const a=d(this,Ue)[es(this,_e)._++];if(t|=BigInt(a&127)<<s,!(a&128))break}return t}bytes(t){const s=new Uint8Array(d(this,Ue).buffer,d(this,Ue).byteOffset+d(this,_e),t);return h(this,_e,d(this,_e)+t),s}double(){const t=d(this,Xs).getFloat64(d(this,_e),!0);return h(this,_e,d(this,_e)+8),t}skipVarint(){for(;d(this,Ue)[es(this,_e)._++]&128;);}skip(t){h(this,_e,d(this,_e)+t)}eof(){return d(this,_e)>=d(this,Ue).byteLength}}Ue=new WeakMap,Xs=new WeakMap,_e=new WeakMap;var be,ce,Bt,Ps;class To{constructor(t){_(this,Bt);_(this,be);_(this,ce);h(this,be,t),h(this,ce,-1)}setup(t){h(this,ce,t)}bytes(){S(this,Bt,Ps).call(this,an);const t=d(this,be).varint();return d(this,be).bytes(t)}string(){return new TextDecoder().decode(this.bytes())}message(t){return qa(this.bytes(),t)}int32(){return S(this,Bt,Ps).call(this,Ws),d(this,be).varint()}uint32(){return this.int32()}bool(){return this.int32()!==0}uint64(){return S(this,Bt,Ps).call(this,Ws),d(this,be).varintBig()}sint64(){const t=this.uint64();return t>>1n^-(t&1n)}double(){return S(this,Bt,Ps).call(this,sn),d(this,be).double()}maybeSkip(){if(!(d(this,ce)<0)){if(d(this,ce)===Ws)d(this,be).skipVarint();else if(d(this,ce)===sn)d(this,be).skip(8);else if(d(this,ce)===an){const t=d(this,be).varint();d(this,be).skip(t)}else if(d(this,ce)===Ro)d(this,be).skip(4);else throw new j(`Unexpected wire type ${d(this,ce)}`);h(this,ce,-1)}}}be=new WeakMap,ce=new WeakMap,Bt=new WeakSet,Ps=function(t){if(d(this,ce)!==t)throw new j(`Expected wire type ${t}, got ${d(this,ce)}`);h(this,ce,-1)};function qa(e,t){const s=new Ao(e),a=new To(s);let n=t.default();for(;!s.eof();){const l=s.varint(),i=l>>3,r=l&7;a.setup(r);const c=t[i];if(c!==void 0){const o=c(a,n);o!==void 0&&(n=o)}a.maybeSkip()}return n}var Te,wt,cs,me,se,Ns,ka,li,qs;const Kn=class Kn{constructor(){_(this,se);_(this,Te);_(this,wt);_(this,cs);_(this,me);h(this,Te,new ArrayBuffer(256)),h(this,wt,new Uint8Array(d(this,Te))),h(this,cs,new DataView(d(this,Te))),h(this,me,0)}bytes(t,s){S(this,se,qs).call(this,t,an),S(this,se,ka).call(this,s.byteLength),S(this,se,Ns).call(this,s.byteLength),d(this,wt).set(s,d(this,me)),h(this,me,d(this,me)+s.byteLength)}string(t,s){this.bytes(t,new TextEncoder().encode(s))}message(t,s,a){const n=new Kn;a(n,s),this.bytes(t,n.data())}int32(t,s){S(this,se,qs).call(this,t,Ws),S(this,se,ka).call(this,s)}uint32(t,s){this.int32(t,s)}bool(t,s){this.int32(t,s?1:0)}sint64(t,s){S(this,se,qs).call(this,t,Ws),S(this,se,li).call(this,s<<1n^s>>63n)}double(t,s){S(this,se,qs).call(this,t,sn),S(this,se,Ns).call(this,8),d(this,cs).setFloat64(d(this,me),s,!0),h(this,me,d(this,me)+8)}data(){return new Uint8Array(d(this,Te),0,d(this,me))}};Te=new WeakMap,wt=new WeakMap,cs=new WeakMap,me=new WeakMap,se=new WeakSet,Ns=function(t){if(d(this,me)+t<=d(this,Te).byteLength)return;let s=d(this,Te).byteLength;for(;s<d(this,me)+t;)s*=2;const a=new ArrayBuffer(s),n=new Uint8Array(a),l=new DataView(a);n.set(new Uint8Array(d(this,Te),0,d(this,me))),h(this,Te,a),h(this,wt,n),h(this,cs,l)},ka=function(t){S(this,se,Ns).call(this,5),t=0|t;do{let s=t&127;t>>>=7,s|=t?128:0,d(this,wt)[es(this,me)._++]=s}while(t)},li=function(t){S(this,se,Ns).call(this,10),t=t&0xffffffffffffffffn;do{let s=Number(t&0x7fn);t>>=7n,s|=t?128:0,d(this,wt)[es(this,me)._++]=s}while(t)},qs=function(t,s){S(this,se,ka).call(this,t<<3|s)};let nn=Kn;function ii(e,t){const s=new nn;return t(s,e),s.data()}var Se,et;class Bs{constructor(){_(this,Se);_(this,et);h(this,Se,new Set),h(this,et,new Set)}alloc(){for(const s of d(this,et))return d(this,et).delete(s),d(this,Se).add(s),d(this,Se).has(d(this,Se).size-1)||d(this,et).add(d(this,Se).size-1),s;const t=d(this,Se).size;return d(this,Se).add(t),t}free(t){if(!d(this,Se).delete(t))throw new At("Freeing an id that is not allocated");d(this,et).delete(d(this,Se).size),t<d(this,Se).size&&d(this,et).add(t)}}Se=new WeakMap,et=new WeakMap;function Q(e,t){throw new At(t)}function zs(e){if(e===null)return null;if(typeof e=="string")return e;if(typeof e=="number"){if(!Number.isFinite(e))throw new RangeError("Only finite numbers (not Infinity or NaN) can be passed as arguments");return e}else if(typeof e=="bigint"){if(e<Mo||e>Do)throw new RangeError("This bigint value is too large to be represented as a 64-bit integer and passed as argument");return e}else{if(typeof e=="boolean")return e?1n:0n;if(e instanceof ArrayBuffer)return new Uint8Array(e);if(e instanceof Uint8Array)return e;if(e instanceof Date)return+e.valueOf();if(typeof e=="object")return""+e.toString();throw new TypeError("Unsupported type of value")}}const Mo=-9223372036854775808n,Do=9223372036854775807n;function ri(e,t){if(e===null)return null;if(typeof e=="number")return e;if(typeof e=="string")return e;if(typeof e=="bigint")if(t==="number"){const s=Number(e);if(!Number.isSafeInteger(s))throw new RangeError("Received integer which is too large to be safely represented as a JavaScript number");return s}else{if(t==="bigint")return e;if(t==="string")return""+e;throw new Ls("Invalid value for IntMode")}else{if(e instanceof Uint8Array)return e.slice().buffer;throw e===void 0?new j("Received unrecognized type of Value"):Q(e,"Impossible type of Value")}}function fa(e){return{affectedRowCount:e.affectedRowCount,lastInsertRowid:e.lastInsertRowid,columnNames:e.cols.map(t=>t.name),columnDecltypes:e.cols.map(t=>t.decltype)}}function oi(e,t){const s=fa(e),a=e.rows.map(n=>pi(s.columnNames,n,t));return{...s,rows:a}}function ci(e,t){const s=fa(e);let a;return e.rows.length>0&&(a=pi(s.columnNames,e.rows[0],t)),{...s,row:a}}function di(e,t){const s=fa(e);let a;return e.rows.length>0&&s.columnNames.length>0&&(a=ri(e.rows[0][0],t)),{...s,value:a}}function pi(e,t,s){const a={};Object.defineProperty(a,"length",{value:t.length});for(let n=0;n<t.length;++n){const l=ri(t[n],s);Object.defineProperty(a,n,{value:l});const i=e[n];i!==void 0&&!Object.hasOwn(a,i)&&Object.defineProperty(a,i,{value:l,enumerable:!0,configurable:!0,writable:!0})}return a}function As(e){return new si(e.message,e)}var ds,ps,tt;class En{constructor(t,s){_(this,ds);_(this,ps);_(this,tt);h(this,ds,t),h(this,ps,s),h(this,tt,void 0)}_getSqlId(t){if(d(this,ds)!==t)throw new Ls("Attempted to use SQL text opened with other object");if(d(this,tt)!==void 0)throw new Ae("SQL text is closed",d(this,tt));return d(this,ps)}close(){this._setClosed(new K("SQL text was manually closed"))}_setClosed(t){d(this,tt)===void 0&&(h(this,tt,t),d(this,ds)._closeSql(d(this,ps)))}get closed(){return d(this,tt)!==void 0}}ds=new WeakMap,ps=new WeakMap,tt=new WeakMap;function ln(e,t){return t instanceof En?{sqlId:t._getSqlId(e)}:{sql:""+t}}var He,Me;class Ca{constructor(){_(this,He);_(this,Me);h(this,He,[]),h(this,Me,[])}get length(){return d(this,He).length+d(this,Me).length}push(t){d(this,He).push(t)}shift(){return d(this,Me).length===0&&d(this,He).length>0&&(h(this,Me,d(this,He).reverse()),h(this,He,[])),d(this,Me).pop()}first(){return d(this,Me).length!==0?d(this,Me)[d(this,Me).length-1]:d(this,He)[0]}}He=new WeakMap,Me=new WeakMap;let ui=class{constructor(t){q(this,"sql");q(this,"_args");q(this,"_namedArgs");this.sql=t,this._args=[],this._namedArgs=new Map}bindIndexes(t){this._args.length=0;for(const s of t)this._args.push(zs(s));return this}bindIndex(t,s){if(t!==(t|0)||t<=0)throw new RangeError("Index of a positional argument must be positive integer");for(;this._args.length<t;)this._args.push(null);return this._args[t-1]=zs(s),this}bindName(t,s){return this._namedArgs.set(t,zs(s)),this}unbindAll(){return this._args.length=0,this._namedArgs.clear(),this}};function xi(e,t,s){let a,n=[],l=[];if(t instanceof ui){a=t.sql,n=t._args;for(const[c,o]of t._namedArgs.entries())l.push({name:c,value:o})}else Array.isArray(t)?(a=t[0],Array.isArray(t[1])?n=t[1].map(c=>zs(c)):l=Object.entries(t[1]).map(([c,o])=>({name:c,value:zs(o)}))):a=t;const{sql:i,sqlId:r}=ln(e,a);return{sql:i,sqlId:r,args:n,namedArgs:l,wantRows:s}}var Zs,us,Al;let Lo=(Al=class{constructor(t,s){q(this,"_stream");_(this,Zs);q(this,"_steps");_(this,us);this._stream=t,h(this,Zs,s),this._steps=[],h(this,us,!1)}step(){return new Po(this)}execute(){if(d(this,us))throw new Ls("This batch has already been executed");h(this,us,!0);const t={steps:this._steps.map(s=>s.proto)};return d(this,Zs)?jo(this._stream,this._steps,t):Oo(this._stream,this._steps,t)}},Zs=new WeakMap,us=new WeakMap,Al);function Oo(e,t,s){return e._batch(s).then(a=>{for(let n=0;n<t.length;++n){const l=a.stepResults.get(n),i=a.stepErrors.get(n);t[n].callback(l,i)}})}async function jo(e,t,s){const a=await e._openCursor(s);try{let n=0,l,i=[];for(;;){const r=await a.next();if(r===void 0)break;if(r.type==="step_begin"){if(r.step<n||r.step>=t.length)throw new j("Server produced StepBeginEntry for unexpected step");if(l!==void 0)throw new j("Server produced StepBeginEntry before terminating previous step");for(let c=n;c<r.step;++c)t[c].callback(void 0,void 0);n=r.step+1,l=r,i=[]}else if(r.type==="step_end"){if(l===void 0)throw new j("Server produced StepEndEntry but no step is active");const c={cols:l.cols,rows:i,affectedRowCount:r.affectedRowCount,lastInsertRowid:r.lastInsertRowid};t[l.step].callback(c,void 0),l=void 0,i=[]}else if(r.type==="step_error"){if(l===void 0){if(r.step>=t.length)throw new j("Server produced StepErrorEntry for unexpected step");for(let c=n;c<r.step;++c)t[c].callback(void 0,void 0)}else{if(r.step!==l.step)throw new j("Server produced StepErrorEntry for unexpected step");l=void 0,i=[]}t[r.step].callback(void 0,r.error),n=r.step+1}else if(r.type==="row"){if(l===void 0)throw new j("Server produced RowEntry but no step is active");i.push(r.row)}else throw r.type==="error"?As(r.error):r.type==="none"?new j("Server produced unrecognized CursorEntry"):Q(r,"Impossible CursorEntry")}if(l!==void 0)throw new j("Server closed Cursor before terminating active step");for(let r=n;r<t.length;++r)t[r].callback(void 0,void 0)}finally{a.close()}}var st,Ft,Fs,Tl;let Po=(Tl=class{constructor(t){_(this,Ft);q(this,"_batch");_(this,st);q(this,"_index");this._batch=t,h(this,st,[]),this._index=void 0}condition(t){return d(this,st).push(t._proto),this}query(t){return S(this,Ft,Fs).call(this,t,!0,oi)}queryRow(t){return S(this,Ft,Fs).call(this,t,!0,ci)}queryValue(t){return S(this,Ft,Fs).call(this,t,!0,di)}run(t){return S(this,Ft,Fs).call(this,t,!1,fa)}},st=new WeakMap,Ft=new WeakSet,Fs=function(t,s,a){if(this._index!==void 0)throw new Ls("This BatchStep has already been added to the batch");const n=xi(this._batch._stream._sqlOwner(),t,s);let l;d(this,st).length===0?l=void 0:d(this,st).length===1?l=d(this,st)[0]:l={type:"and",conds:d(this,st).slice()};const i={stmt:n,condition:l};return new Promise((r,c)=>{const o=(u,b)=>{u!==void 0&&b!==void 0?c(new j("Server returned both result and error")):b!==void 0?c(As(b)):r(u!==void 0?a(u,this._batch._stream.intMode):void 0)};this._index=this._batch._steps.length,this._batch._steps.push({proto:i,callback:o})})},Tl),ve=class jt{constructor(t,s){q(this,"_batch");q(this,"_proto");this._batch=t,this._proto=s}static ok(t){return new jt(t._batch,{type:"ok",step:rl(t)})}static error(t){return new jt(t._batch,{type:"error",step:rl(t)})}static not(t){return new jt(t._batch,{type:"not",cond:t._proto})}static and(t,s){for(const a of s)ol(t,a);return new jt(t,{type:"and",conds:s.map(a=>a._proto)})}static or(t,s){for(const a of s)ol(t,a);return new jt(t,{type:"or",conds:s.map(a=>a._proto)})}static isAutocommit(t){return t._stream.client()._ensureVersion(3,"BatchCond.isAutocommit()"),new jt(t,{type:"is_autocommit"})}};function rl(e){if(e._index===void 0)throw new Ls("Cannot add a condition referencing a step that has not been added to the batch");return e._index}function ol(e,t){if(t._batch!==e)throw new Ls("Cannot mix BatchCond objects for different Batch objects")}function No(e){return{paramNames:e.params.map(t=>t.name),columns:e.cols,isExplain:e.isExplain,isReadonly:e.isReadonly}}var Vt,Vs;class fi{constructor(t){_(this,Vt);q(this,"intMode");this.intMode=t}query(t){return S(this,Vt,Vs).call(this,t,!0,oi)}queryRow(t){return S(this,Vt,Vs).call(this,t,!0,ci)}queryValue(t){return S(this,Vt,Vs).call(this,t,!0,di)}run(t){return S(this,Vt,Vs).call(this,t,!1,fa)}batch(t=!1){return new Lo(this,t)}describe(t){const s=ln(this._sqlOwner(),t);return this._describe(s).then(No)}sequence(t){const s=ln(this._sqlOwner(),t);return this._sequence(s)}}Vt=new WeakSet,Vs=function(t,s,a){const n=xi(this._sqlOwner(),t,s);return this._execute(n).then(l=>a(l,this.intMode))};class bi{}const qo=1e3,Bo=10;var ja,Ut,xs,fs,Ht,at,Gt,Pa,mi;class Fo extends bi{constructor(s,a,n){super();_(this,Pa);_(this,ja);_(this,Ut);_(this,xs);_(this,fs);_(this,Ht);_(this,at);_(this,Gt);h(this,ja,s),h(this,Ut,a),h(this,xs,n),h(this,fs,new Ca),h(this,Ht,new Ca),h(this,at,void 0),h(this,Gt,!1)}async next(){for(;;){if(d(this,at)!==void 0)throw new Ae("Cursor is closed",d(this,at));for(;!d(this,Gt)&&d(this,Ht).length<Bo;)d(this,Ht).push(S(this,Pa,mi).call(this));const s=d(this,fs).shift();if(d(this,Gt)||s!==void 0)return s;await d(this,Ht).shift().then(a=>{if(a!==void 0){for(const n of a.entries)d(this,fs).push(n);d(this,Gt)||h(this,Gt,a.done)}})}}_setClosed(s){d(this,at)===void 0&&(h(this,at,s),d(this,Ut)._sendCursorRequest(this,{type:"close_cursor",cursorId:d(this,xs)}).catch(()=>{}),d(this,Ut)._cursorClosed(this))}close(){this._setClosed(new K("Cursor was manually closed"))}get closed(){return d(this,at)!==void 0}}ja=new WeakMap,Ut=new WeakMap,xs=new WeakMap,fs=new WeakMap,Ht=new WeakMap,at=new WeakMap,Gt=new WeakMap,Pa=new WeakSet,mi=function(){return d(this,Ut)._sendCursorRequest(this,{type:"fetch_cursor",cursorId:d(this,xs),maxCount:qo}).then(s=>s,s=>{this._setClosed(s)})};var ne,Ce,nt,$e,vt,De,Z,ts,on,_a,Sa;const Qn=class Qn extends fi{constructor(s,a){super(s.intMode);_(this,Z);_(this,ne);_(this,Ce);_(this,nt);_(this,$e);_(this,vt);_(this,De);h(this,ne,s),h(this,Ce,a),h(this,nt,new Ca),h(this,$e,void 0),h(this,vt,!1),h(this,De,void 0)}static open(s){const a=s._streamIdAlloc.alloc(),n=new Qn(s,a),l=()=>{},i=c=>{var o;return S(o=n,Z,Sa).call(o,c)},r={type:"open_stream",streamId:a};return s._sendRequest(r,{responseCallback:l,errorCallback:i}),n}client(){return d(this,ne)}_sqlOwner(){return d(this,ne)}_execute(s){return S(this,Z,ts).call(this,{type:"execute",streamId:d(this,Ce),stmt:s}).then(a=>a.result)}_batch(s){return S(this,Z,ts).call(this,{type:"batch",streamId:d(this,Ce),batch:s}).then(a=>a.result)}_describe(s){return d(this,ne)._ensureVersion(2,"describe()"),S(this,Z,ts).call(this,{type:"describe",streamId:d(this,Ce),sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return d(this,ne)._ensureVersion(2,"sequence()"),S(this,Z,ts).call(this,{type:"sequence",streamId:d(this,Ce),sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return d(this,ne)._ensureVersion(3,"getAutocommit()"),S(this,Z,ts).call(this,{type:"get_autocommit",streamId:d(this,Ce)}).then(s=>s.isAutocommit)}_openCursor(s){return d(this,ne)._ensureVersion(3,"cursor"),new Promise((a,n)=>{S(this,Z,on).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_sendCursorRequest(s,a){if(s!==d(this,$e))throw new At("Cursor not associated with the stream attempted to execute a request");return new Promise((n,l)=>{d(this,De)!==void 0?l(new Ae("Stream is closed",d(this,De))):d(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})})}_cursorClosed(s){if(s!==d(this,$e))throw new At("Cursor was closed, but it was not associated with the stream");h(this,$e,void 0),S(this,Z,_a).call(this)}close(){S(this,Z,Sa).call(this,new K("Stream was manually closed"))}closeGracefully(){h(this,vt,!0),S(this,Z,_a).call(this)}get closed(){return d(this,De)!==void 0||d(this,vt)}};ne=new WeakMap,Ce=new WeakMap,nt=new WeakMap,$e=new WeakMap,vt=new WeakMap,De=new WeakMap,Z=new WeakSet,ts=function(s){return new Promise((a,n)=>{S(this,Z,on).call(this,{type:"request",request:s,responseCallback:a,errorCallback:n})})},on=function(s){d(this,De)!==void 0?s.errorCallback(new Ae("Stream is closed",d(this,De))):d(this,vt)?s.errorCallback(new Ae("Stream is closing",void 0)):(d(this,nt).push(s),S(this,Z,_a).call(this))},_a=function(){for(;;){const s=d(this,nt).first();if(s===void 0&&d(this,$e)===void 0&&d(this,vt)){S(this,Z,Sa).call(this,new K("Stream was gracefully closed"));break}else if((s==null?void 0:s.type)==="request"&&d(this,$e)===void 0){const{request:a,responseCallback:n,errorCallback:l}=s;d(this,nt).shift(),d(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})}else if((s==null?void 0:s.type)==="cursor"&&d(this,$e)===void 0){const{batch:a,cursorCallback:n}=s;d(this,nt).shift();const l=d(this,ne)._cursorIdAlloc.alloc(),i=new Fo(d(this,ne),this,l),r={type:"open_cursor",streamId:d(this,Ce),cursorId:l,batch:a},c=()=>{},o=u=>i._setClosed(u);d(this,ne)._sendRequest(r,{responseCallback:c,errorCallback:o}),h(this,$e,i),n(i)}else break}},Sa=function(s){if(d(this,De)!==void 0)return;for(h(this,De,s),d(this,$e)!==void 0&&d(this,$e)._setClosed(s);;){const i=d(this,nt).shift();if(i!==void 0)i.errorCallback(s);else break}const a={type:"close_stream",streamId:d(this,Ce)},n=()=>d(this,ne)._streamIdAlloc.free(d(this,Ce)),l=()=>{};d(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})};let rn=Qn;function In(e,t){t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId),e.arrayObjects("args",t.args,hi),e.arrayObjects("named_args",t.namedArgs,Vo),e.boolean("want_rows",t.wantRows)}function Vo(e,t){e.string("name",t.name),e.object("value",t.value,hi)}function Ra(e,t){e.arrayObjects("steps",t.steps,Uo)}function Uo(e,t){t.condition!==void 0&&e.object("condition",t.condition,cn),e.object("stmt",t.stmt,In)}function cn(e,t){if(e.stringRaw("type",t.type),t.type==="ok"||t.type==="error")e.number("step",t.step);else if(t.type==="not")e.object("cond",t.cond,cn);else if(t.type==="and"||t.type==="or")e.arrayObjects("conds",t.conds,cn);else if(t.type!=="is_autocommit")throw Q(t,"Impossible type of BatchCond")}function hi(e,t){if(t===null)e.stringRaw("type","null");else if(typeof t=="bigint")e.stringRaw("type","integer"),e.stringRaw("value",""+t);else if(typeof t=="number")e.stringRaw("type","float"),e.number("value",t);else if(typeof t=="string")e.stringRaw("type","text"),e.string("value",t);else if(t instanceof Uint8Array)e.stringRaw("type","blob"),e.stringRaw("base64",Sn.fromUint8Array(t));else if(t!==void 0)throw Q(t,"Impossible type of Value")}function Ho(e,t){if(e.stringRaw("type",t.type),t.type==="hello")t.jwt!==void 0&&e.string("jwt",t.jwt);else if(t.type==="request")e.number("request_id",t.requestId),e.object("request",t.request,Go);else throw Q(t,"Impossible type of ClientMsg")}function Go(e,t){if(e.stringRaw("type",t.type),t.type==="open_stream")e.number("stream_id",t.streamId);else if(t.type==="close_stream")e.number("stream_id",t.streamId);else if(t.type==="execute")e.number("stream_id",t.streamId),e.object("stmt",t.stmt,In);else if(t.type==="batch")e.number("stream_id",t.streamId),e.object("batch",t.batch,Ra);else if(t.type==="open_cursor")e.number("stream_id",t.streamId),e.number("cursor_id",t.cursorId),e.object("batch",t.batch,Ra);else if(t.type==="close_cursor")e.number("cursor_id",t.cursorId);else if(t.type==="fetch_cursor")e.number("cursor_id",t.cursorId),e.number("max_count",t.maxCount);else if(t.type==="sequence")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type==="get_autocommit")e.number("stream_id",t.streamId);else throw Q(t,"Impossible type of Request")}function Cn(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId);for(const s of t.args)e.message(3,s,gi);for(const s of t.namedArgs)e.message(4,s,Wo);e.bool(5,t.wantRows)}function Wo(e,t){e.string(1,t.name),e.message(2,t.value,gi)}function Ba(e,t){for(const s of t.steps)e.message(1,s,zo)}function zo(e,t){t.condition!==void 0&&e.message(1,t.condition,Rn),e.message(2,t.stmt,Cn)}function Rn(e,t){if(t.type==="ok")e.uint32(1,t.step);else if(t.type==="error")e.uint32(2,t.step);else if(t.type==="not")e.message(3,t.cond,Rn);else if(t.type==="and")e.message(4,t.conds,cl);else if(t.type==="or")e.message(5,t.conds,cl);else if(t.type==="is_autocommit")e.message(6,void 0,wi);else throw Q(t,"Impossible type of BatchCond")}function cl(e,t){for(const s of t)e.message(1,s,Rn)}function gi(e,t){if(t===null)e.message(1,void 0,wi);else if(typeof t=="bigint")e.sint64(2,t);else if(typeof t=="number")e.double(3,t);else if(typeof t=="string")e.string(4,t);else if(t instanceof Uint8Array)e.bytes(5,t);else if(t!==void 0)throw Q(t,"Impossible type of Value")}function wi(e,t){}function Yo(e,t){if(t.type==="hello")e.message(1,t,Jo);else if(t.type==="request")e.message(2,t,Ko);else throw Q(t,"Impossible type of ClientMsg")}function Jo(e,t){t.jwt!==void 0&&e.string(1,t.jwt)}function Ko(e,t){e.int32(1,t.requestId);const s=t.request;if(s.type==="open_stream")e.message(2,s,Qo);else if(s.type==="close_stream")e.message(3,s,Xo);else if(s.type==="execute")e.message(4,s,Zo);else if(s.type==="batch")e.message(5,s,ec);else if(s.type==="open_cursor")e.message(6,s,tc);else if(s.type==="close_cursor")e.message(7,s,sc);else if(s.type==="fetch_cursor")e.message(8,s,ac);else if(s.type==="sequence")e.message(9,s,nc);else if(s.type==="describe")e.message(10,s,lc);else if(s.type==="store_sql")e.message(11,s,ic);else if(s.type==="close_sql")e.message(12,s,rc);else if(s.type==="get_autocommit")e.message(13,s,oc);else throw Q(s,"Impossible type of Request")}function Qo(e,t){e.int32(1,t.streamId)}function Xo(e,t){e.int32(1,t.streamId)}function Zo(e,t){e.int32(1,t.streamId),e.message(2,t.stmt,Cn)}function ec(e,t){e.int32(1,t.streamId),e.message(2,t.batch,Ba)}function tc(e,t){e.int32(1,t.streamId),e.int32(2,t.cursorId),e.message(3,t.batch,Ba)}function sc(e,t){e.int32(1,t.cursorId)}function ac(e,t){e.int32(1,t.cursorId),e.uint32(2,t.maxCount)}function nc(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function lc(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function ic(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function rc(e,t){e.int32(1,t.sqlId)}function oc(e,t){e.int32(1,t.streamId)}function Ts(e){const t=qe(e.message),s=Fe(e.code);return{message:t,code:s}}function An(e){const t=Tt(e.cols,vi),s=Ia(e.rows).map(i=>Tt(i,Si)),a=Xt(e.affected_row_count),n=Fe(e.last_insert_rowid),l=n!==void 0?BigInt(n):void 0;return{cols:t,rows:s,affectedRowCount:a,lastInsertRowid:l}}function vi(e){const t=Fe(e.name),s=Fe(e.decltype);return{name:t,decltype:s}}function yi(e){const t=new Map;Ia(e.step_results).forEach((a,n)=>{a!==null&&t.set(n,An(ie(a)))});const s=new Map;return Ia(e.step_errors).forEach((a,n)=>{a!==null&&s.set(n,Ts(ie(a)))}),{stepResults:t,stepErrors:s}}function ki(e){const t=qe(e.type);if(t==="step_begin"){const s=Xt(e.step),a=Tt(e.cols,vi);return{type:"step_begin",step:s,cols:a}}else if(t==="step_end"){const s=Xt(e.affected_row_count),a=Fe(e.last_insert_rowid),n=a!==void 0?BigInt(a):void 0;return{type:"step_end",affectedRowCount:s,lastInsertRowid:n}}else if(t==="step_error"){const s=Xt(e.step),a=Ts(ie(e.error));return{type:"step_error",step:s,error:a}}else{if(t==="row")return{type:"row",row:Tt(e.row,Si)};if(t==="error")return{type:"error",error:Ts(ie(e.error))};throw new j("Unexpected type of CursorEntry")}}function _i(e){const t=Tt(e.params,cc),s=Tt(e.cols,dc),a=Qs(e.is_explain),n=Qs(e.is_readonly);return{params:t,cols:s,isExplain:a,isReadonly:n}}function cc(e){return{name:Fe(e.name)}}function dc(e){const t=qe(e.name),s=Fe(e.decltype);return{name:t,decltype:s}}function Si(e){const t=qe(e.type);if(t==="null")return null;if(t==="integer"){const s=qe(e.value);return BigInt(s)}else{if(t==="float")return Xt(e.value);if(t==="text")return qe(e.value);if(t==="blob")return Sn.toUint8Array(qe(e.base64));throw new j("Unexpected type of Value")}}function pc(e){const t=qe(e.type);if(t==="hello_ok")return{type:"hello_ok"};if(t==="hello_error")return{type:"hello_error",error:Ts(ie(e.error))};if(t==="response_ok"){const s=Xt(e.request_id),a=uc(ie(e.response));return{type:"response_ok",requestId:s,response:a}}else if(t==="response_error"){const s=Xt(e.request_id),a=Ts(ie(e.error));return{type:"response_error",requestId:s,error:a}}else throw new j("Unexpected type of ServerMsg")}function uc(e){const t=qe(e.type);if(t==="open_stream")return{type:"open_stream"};if(t==="close_stream")return{type:"close_stream"};if(t==="execute")return{type:"execute",result:An(ie(e.result))};if(t==="batch")return{type:"batch",result:yi(ie(e.result))};if(t==="open_cursor")return{type:"open_cursor"};if(t==="close_cursor")return{type:"close_cursor"};if(t==="fetch_cursor"){const s=Tt(e.entries,ki),a=Qs(e.done);return{type:"fetch_cursor",entries:s,done:a}}else{if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:_i(ie(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Qs(e.is_autocommit)};throw new j("Unexpected type of Response")}}const Je={default(){return{message:"",code:void 0}},1(e,t){t.message=e.string()},2(e,t){t.code=e.string()}},Ms={default(){return{cols:[],rows:[],affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.cols.push(e.message($i))},2(e,t){t.rows.push(e.message(Ei))},3(e,t){t.affectedRowCount=Number(e.uint64())},4(e,t){t.lastInsertRowid=e.sint64()}},$i={default(){return{name:void 0,decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},Ei={default(){return[]},1(e,t){t.push(e.message(vc))}},Aa={default(){return{stepResults:new Map,stepErrors:new Map}},1(e,t){const[s,a]=e.message(xc);t.stepResults.set(s,a)},2(e,t){const[s,a]=e.message(fc);t.stepErrors.set(s,a)}},xc={default(){return[0,Ms.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(Ms)}},fc={default(){return[0,Je.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(Je)}},Ii={default(){return{type:"none"}},1(e){return e.message(bc)},2(e){return e.message(mc)},3(e){return e.message(hc)},4(e){return{type:"row",row:e.message(Ei)}},5(e){return{type:"error",error:e.message(Je)}}},bc={default(){return{type:"step_begin",step:0,cols:[]}},1(e,t){t.step=e.uint32()},2(e,t){t.cols.push(e.message($i))}},mc={default(){return{type:"step_end",affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.affectedRowCount=e.uint32()},2(e,t){t.lastInsertRowid=e.uint64()}},hc={default(){return{type:"step_error",step:0,error:Je.default()}},1(e,t){t.step=e.uint32()},2(e,t){t.error=e.message(Je)}},Ta={default(){return{params:[],cols:[],isExplain:!1,isReadonly:!1}},1(e,t){t.params.push(e.message(gc))},2(e,t){t.cols.push(e.message(wc))},3(e,t){t.isExplain=e.bool()},4(e,t){t.isReadonly=e.bool()}},gc={default(){return{name:void 0}},1(e,t){t.name=e.string()}},wc={default(){return{name:"",decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},vc={default(){},1(e){return null},2(e){return e.sint64()},3(e){return e.double()},4(e){return e.string()},5(e){return e.bytes()}},yc={default(){return{type:"none"}},1(e){return{type:"hello_ok"}},2(e){return e.message(kc)},3(e){return e.message(Sc)},4(e){return e.message(_c)}},kc={default(){return{type:"hello_error",error:Je.default()}},1(e,t){t.error=e.message(Je)}},_c={default(){return{type:"response_error",requestId:0,error:Je.default()}},1(e,t){t.requestId=e.int32()},2(e,t){t.error=e.message(Je)}},Sc={default(){return{type:"response_ok",requestId:0,response:{type:"none"}}},1(e,t){t.requestId=e.int32()},2(e,t){t.response={type:"open_stream"}},3(e,t){t.response={type:"close_stream"}},4(e,t){t.response=e.message($c)},5(e,t){t.response=e.message(Ec)},6(e,t){t.response={type:"open_cursor"}},7(e,t){t.response={type:"close_cursor"}},8(e,t){t.response=e.message(Ic)},9(e,t){t.response={type:"sequence"}},10(e,t){t.response=e.message(Cc)},11(e,t){t.response={type:"store_sql"}},12(e,t){t.response={type:"close_sql"}},13(e,t){t.response=e.message(Rc)}},$c={default(){return{type:"execute",result:Ms.default()}},1(e,t){t.result=e.message(Ms)}},Ec={default(){return{type:"batch",result:Aa.default()}},1(e,t){t.result=e.message(Aa)}},Ic={default(){return{type:"fetch_cursor",entries:[],done:!1}},1(e,t){t.entries.push(e.message(Ii))},2(e,t){t.done=e.bool()}},Cc={default(){return{type:"describe",result:Ta.default()}},1(e,t){t.result=e.message(Ta)}},Rc={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},Ac=new Map([["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]),Ci=new Map([["hrana3-protobuf",{version:3,encoding:"protobuf"}],["hrana3",{version:3,encoding:"json"}],["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]);var re,Ge,Wt,he,zt,ge,bs,Le,yt,ms,V,dn,Ri,pn,Ai,Ti,Ve,Mi,Di,Ml;let Tc=(Ml=class extends ti{constructor(s,a){super();_(this,V);_(this,re);_(this,Ge);_(this,Wt);_(this,he);_(this,zt);_(this,ge);_(this,bs);_(this,Le);_(this,yt);q(this,"_streamIdAlloc");q(this,"_cursorIdAlloc");_(this,ms);h(this,re,s),h(this,Ge,[]),h(this,Wt,!1),h(this,he,void 0),h(this,zt,!1),h(this,ge,void 0),h(this,bs,!1),h(this,Le,new Map),h(this,yt,new Bs),this._streamIdAlloc=new Bs,this._cursorIdAlloc=new Bs,h(this,ms,new Bs),d(this,re).binaryType="arraybuffer",d(this,re).addEventListener("open",()=>S(this,V,Ri).call(this)),d(this,re).addEventListener("close",n=>S(this,V,Ti).call(this,n)),d(this,re).addEventListener("error",n=>S(this,V,Ai).call(this,n)),d(this,re).addEventListener("message",n=>S(this,V,Mi).call(this,n)),S(this,V,dn).call(this,{type:"hello",jwt:a})}getVersion(){return new Promise((s,a)=>{if(h(this,bs,!0),d(this,he)!==void 0)a(d(this,he));else if(d(this,Wt))s(d(this,ge).version);else{const n=()=>s(d(this,ge).version);d(this,Ge).push({openCallback:n,errorCallback:a})}})}_ensureVersion(s,a){if(d(this,ge)===void 0||!d(this,bs))throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the version supported by the WebSocket server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(d(this,ge).version<s)throw new Rs(`${a} is supported on protocol version ${s} and higher, but the WebSocket server only supports version ${d(this,ge).version}`)}_sendRequest(s,a){if(d(this,he)!==void 0){a.errorCallback(new Ae("Client is closed",d(this,he)));return}const n=d(this,yt).alloc();d(this,Le).set(n,{...a,type:s.type}),S(this,V,dn).call(this,{type:"request",requestId:n,request:s})}openStream(){return rn.open(this)}storeSql(s){this._ensureVersion(2,"storeSql()");const a=d(this,ms).alloc(),n=new En(this,a),l=()=>{},i=c=>n._setClosed(c),r={type:"store_sql",sqlId:a,sql:s};return this._sendRequest(r,{responseCallback:l,errorCallback:i}),n}_closeSql(s){if(d(this,he)!==void 0)return;const a=()=>d(this,ms).free(s),n=i=>S(this,V,Ve).call(this,i),l={type:"close_sql",sqlId:s};this._sendRequest(l,{responseCallback:a,errorCallback:n})}close(){S(this,V,Ve).call(this,new K("Client was manually closed"))}get closed(){return d(this,he)!==void 0}},re=new WeakMap,Ge=new WeakMap,Wt=new WeakMap,he=new WeakMap,zt=new WeakMap,ge=new WeakMap,bs=new WeakMap,Le=new WeakMap,yt=new WeakMap,ms=new WeakMap,V=new WeakSet,dn=function(s){if(d(this,he)!==void 0)throw new At("Trying to send a message on a closed client");if(d(this,Wt))S(this,V,pn).call(this,s);else{const a=()=>S(this,V,pn).call(this,s),n=()=>{};d(this,Ge).push({openCallback:a,errorCallback:n})}},Ri=function(){const s=d(this,re).protocol;if(s===void 0){S(this,V,Ve).call(this,new K("The `WebSocket.protocol` property is undefined. This most likely means that the WebSocket implementation provided by the environment is broken. If you are using Miniflare 2, please update to Miniflare 3, which fixes this problem."));return}else if(s==="")h(this,ge,{version:1,encoding:"json"});else if(h(this,ge,Ci.get(s)),d(this,ge)===void 0){S(this,V,Ve).call(this,new j(`Unrecognized WebSocket subprotocol: ${JSON.stringify(s)}`));return}for(const a of d(this,Ge))a.openCallback();d(this,Ge).length=0,h(this,Wt,!0)},pn=function(s){const a=d(this,ge).encoding;if(a==="json"){const n=ni(s,Ho);d(this,re).send(n)}else if(a==="protobuf"){const n=ii(s,Yo);d(this,re).send(n)}else throw Q(a,"Impossible encoding")},Ai=function(s){const n=s.message??"WebSocket was closed due to an error";S(this,V,Ve).call(this,new tn(n))},Ti=function(s){let a=`WebSocket was closed with code ${s.code}`;s.reason&&(a+=`: ${s.reason}`),S(this,V,Ve).call(this,new tn(a))},Ve=function(s){if(d(this,he)===void 0){h(this,he,s);for(const a of d(this,Ge))a.errorCallback(s);d(this,Ge).length=0;for(const[a,n]of d(this,Le).entries())n.errorCallback(s),d(this,yt).free(a);d(this,Le).clear(),d(this,re).close()}},Mi=function(s){if(d(this,he)===void 0)try{let a;const n=d(this,ge).encoding;if(n==="json"){if(typeof s.data!="string"){d(this,re).close(3003,"Only text messages are accepted with JSON encoding"),S(this,V,Ve).call(this,new j("Received non-text message from server with JSON encoding"));return}a=$n(JSON.parse(s.data),pc)}else if(n==="protobuf"){if(!(s.data instanceof ArrayBuffer)){d(this,re).close(3003,"Only binary messages are accepted with Protobuf encoding"),S(this,V,Ve).call(this,new j("Received non-binary message from server with Protobuf encoding"));return}a=qa(new Uint8Array(s.data),yc)}else throw Q(n,"Impossible encoding");S(this,V,Di).call(this,a)}catch(a){d(this,re).close(3007,"Could not handle message"),S(this,V,Ve).call(this,a)}},Di=function(s){if(s.type==="none")throw new j("Received an unrecognized ServerMsg");if(s.type==="hello_ok"||s.type==="hello_error"){if(d(this,zt))throw new j("Received a duplicated hello response");if(h(this,zt,!0),s.type==="hello_error")throw As(s.error);return}else if(!d(this,zt))throw new j("Received a non-hello message before a hello response");if(s.type==="response_ok"){const a=s.requestId,n=d(this,Le).get(a);if(d(this,Le).delete(a),n===void 0)throw new j("Received unexpected OK response");d(this,yt).free(a);try{if(n.type!==s.response.type)throw console.dir({responseState:n,msg:s}),new j("Received unexpected type of response");n.responseCallback(s.response)}catch(l){throw n.errorCallback(l),l}}else if(s.type==="response_error"){const a=s.requestId,n=d(this,Le).get(a);if(d(this,Le).delete(a),n===void 0)throw new j("Received unexpected error response");d(this,yt).free(a),n.errorCallback(As(s.error))}else throw Q(s,"Impossible ServerMsg type")},Ml);var ga=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Mc(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var un={exports:{}};(function(e,t){var s=typeof globalThis<"u"&&globalThis||typeof self<"u"&&self||typeof ga<"u"&&ga,a=function(){function l(){this.fetch=!1,this.DOMException=s.DOMException}return l.prototype=s,new l}();(function(l){(function(i){var r=typeof l<"u"&&l||typeof self<"u"&&self||typeof ga<"u"&&ga||{},c={searchParams:"URLSearchParams"in r,iterable:"Symbol"in r&&"iterator"in Symbol,blob:"FileReader"in r&&"Blob"in r&&function(){try{return new Blob,!0}catch{return!1}}(),formData:"FormData"in r,arrayBuffer:"ArrayBuffer"in r};function o(k){return k&&DataView.prototype.isPrototypeOf(k)}if(c.arrayBuffer)var u=["[object Int8Array]","[object Uint8Array]","[object Uint8ClampedArray]","[object Int16Array]","[object Uint16Array]","[object Int32Array]","[object Uint32Array]","[object Float32Array]","[object Float64Array]"],b=ArrayBuffer.isView||function(k){return k&&u.indexOf(Object.prototype.toString.call(k))>-1};function m(k){if(typeof k!="string"&&(k=String(k)),/[^a-z0-9\-#$%&'*+.^_`|~!]/i.test(k)||k==="")throw new TypeError('Invalid character in header field name: "'+k+'"');return k.toLowerCase()}function y(k){return typeof k!="string"&&(k=String(k)),k}function w(k){var I={next:function(){var O=k.shift();return{done:O===void 0,value:O}}};return c.iterable&&(I[Symbol.iterator]=function(){return I}),I}function f(k){this.map={},k instanceof f?k.forEach(function(I,O){this.append(O,I)},this):Array.isArray(k)?k.forEach(function(I){if(I.length!=2)throw new TypeError("Headers constructor: expected name/value pair to be length 2, found"+I.length);this.append(I[0],I[1])},this):k&&Object.getOwnPropertyNames(k).forEach(function(I){this.append(I,k[I])},this)}f.prototype.append=function(k,I){k=m(k),I=y(I);var O=this.map[k];this.map[k]=O?O+", "+I:I},f.prototype.delete=function(k){delete this.map[m(k)]},f.prototype.get=function(k){return k=m(k),this.has(k)?this.map[k]:null},f.prototype.has=function(k){return this.map.hasOwnProperty(m(k))},f.prototype.set=function(k,I){this.map[m(k)]=y(I)},f.prototype.forEach=function(k,I){for(var O in this.map)this.map.hasOwnProperty(O)&&k.call(I,this.map[O],O,this)},f.prototype.keys=function(){var k=[];return this.forEach(function(I,O){k.push(O)}),w(k)},f.prototype.values=function(){var k=[];return this.forEach(function(I){k.push(I)}),w(k)},f.prototype.entries=function(){var k=[];return this.forEach(function(I,O){k.push([O,I])}),w(k)},c.iterable&&(f.prototype[Symbol.iterator]=f.prototype.entries);function x(k){if(!k._noBody){if(k.bodyUsed)return Promise.reject(new TypeError("Already read"));k.bodyUsed=!0}}function g(k){return new Promise(function(I,O){k.onload=function(){I(k.result)},k.onerror=function(){O(k.error)}})}function E(k){var I=new FileReader,O=g(I);return I.readAsArrayBuffer(k),O}function C(k){var I=new FileReader,O=g(I),U=/charset=([A-Za-z0-9_-]+)/.exec(k.type),G=U?U[1]:"utf-8";return I.readAsText(k,G),O}function $(k){for(var I=new Uint8Array(k),O=new Array(I.length),U=0;U<I.length;U++)O[U]=String.fromCharCode(I[U]);return O.join("")}function L(k){if(k.slice)return k.slice(0);var I=new Uint8Array(k.byteLength);return I.set(new Uint8Array(k)),I.buffer}function J(){return this.bodyUsed=!1,this._initBody=function(k){this.bodyUsed=this.bodyUsed,this._bodyInit=k,k?typeof k=="string"?this._bodyText=k:c.blob&&Blob.prototype.isPrototypeOf(k)?this._bodyBlob=k:c.formData&&FormData.prototype.isPrototypeOf(k)?this._bodyFormData=k:c.searchParams&&URLSearchParams.prototype.isPrototypeOf(k)?this._bodyText=k.toString():c.arrayBuffer&&c.blob&&o(k)?(this._bodyArrayBuffer=L(k.buffer),this._bodyInit=new Blob([this._bodyArrayBuffer])):c.arrayBuffer&&(ArrayBuffer.prototype.isPrototypeOf(k)||b(k))?this._bodyArrayBuffer=L(k):this._bodyText=k=Object.prototype.toString.call(k):(this._noBody=!0,this._bodyText=""),this.headers.get("content-type")||(typeof k=="string"?this.headers.set("content-type","text/plain;charset=UTF-8"):this._bodyBlob&&this._bodyBlob.type?this.headers.set("content-type",this._bodyBlob.type):c.searchParams&&URLSearchParams.prototype.isPrototypeOf(k)&&this.headers.set("content-type","application/x-www-form-urlencoded;charset=UTF-8"))},c.blob&&(this.blob=function(){var k=x(this);if(k)return k;if(this._bodyBlob)return Promise.resolve(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve(new Blob([this._bodyArrayBuffer]));if(this._bodyFormData)throw new Error("could not read FormData body as blob");return Promise.resolve(new Blob([this._bodyText]))}),this.arrayBuffer=function(){if(this._bodyArrayBuffer){var k=x(this);return k||(ArrayBuffer.isView(this._bodyArrayBuffer)?Promise.resolve(this._bodyArrayBuffer.buffer.slice(this._bodyArrayBuffer.byteOffset,this._bodyArrayBuffer.byteOffset+this._bodyArrayBuffer.byteLength)):Promise.resolve(this._bodyArrayBuffer))}else{if(c.blob)return this.blob().then(E);throw new Error("could not read as ArrayBuffer")}},this.text=function(){var k=x(this);if(k)return k;if(this._bodyBlob)return C(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve($(this._bodyArrayBuffer));if(this._bodyFormData)throw new Error("could not read FormData body as text");return Promise.resolve(this._bodyText)},c.formData&&(this.formData=function(){return this.text().then(M)}),this.json=function(){return this.text().then(JSON.parse)},this}var bt=["CONNECT","DELETE","GET","HEAD","OPTIONS","PATCH","POST","PUT","TRACE"];function Xe(k){var I=k.toUpperCase();return bt.indexOf(I)>-1?I:k}function xe(k,I){if(!(this instanceof xe))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');I=I||{};var O=I.body;if(k instanceof xe){if(k.bodyUsed)throw new TypeError("Already read");this.url=k.url,this.credentials=k.credentials,I.headers||(this.headers=new f(k.headers)),this.method=k.method,this.mode=k.mode,this.signal=k.signal,!O&&k._bodyInit!=null&&(O=k._bodyInit,k.bodyUsed=!0)}else this.url=String(k);if(this.credentials=I.credentials||this.credentials||"same-origin",(I.headers||!this.headers)&&(this.headers=new f(I.headers)),this.method=Xe(I.method||this.method||"GET"),this.mode=I.mode||this.mode||null,this.signal=I.signal||this.signal||function(){if("AbortController"in r){var P=new AbortController;return P.signal}}(),this.referrer=null,(this.method==="GET"||this.method==="HEAD")&&O)throw new TypeError("Body not allowed for GET or HEAD requests");if(this._initBody(O),(this.method==="GET"||this.method==="HEAD")&&(I.cache==="no-store"||I.cache==="no-cache")){var U=/([?&])_=[^&]*/;if(U.test(this.url))this.url=this.url.replace(U,"$1_="+new Date().getTime());else{var G=/\?/;this.url+=(G.test(this.url)?"&":"?")+"_="+new Date().getTime()}}}xe.prototype.clone=function(){return new xe(this,{body:this._bodyInit})};function M(k){var I=new FormData;return k.trim().split("&").forEach(function(O){if(O){var U=O.split("="),G=U.shift().replace(/\+/g," "),P=U.join("=").replace(/\+/g," ");I.append(decodeURIComponent(G),decodeURIComponent(P))}}),I}function Dt(k){var I=new f,O=k.replace(/\r?\n[\t ]+/g," ");return O.split("\r").map(function(U){return U.indexOf(`
`)===0?U.substr(1,U.length):U}).forEach(function(U){var G=U.split(":"),P=G.shift().trim();if(P){var ma=G.join(":").trim();try{I.append(P,ma)}catch(Ga){console.warn("Response "+Ga.message)}}}),I}J.call(xe.prototype);function fe(k,I){if(!(this instanceof fe))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');if(I||(I={}),this.type="default",this.status=I.status===void 0?200:I.status,this.status<200||this.status>599)throw new RangeError("Failed to construct 'Response': The status provided (0) is outside the range [200, 599].");this.ok=this.status>=200&&this.status<300,this.statusText=I.statusText===void 0?"":""+I.statusText,this.headers=new f(I.headers),this.url=I.url||"",this._initBody(k)}J.call(fe.prototype),fe.prototype.clone=function(){return new fe(this._bodyInit,{status:this.status,statusText:this.statusText,headers:new f(this.headers),url:this.url})},fe.error=function(){var k=new fe(null,{status:200,statusText:""});return k.ok=!1,k.status=0,k.type="error",k};var rr=[301,302,303,307,308];fe.redirect=function(k,I){if(rr.indexOf(I)===-1)throw new RangeError("Invalid status code");return new fe(null,{status:I,headers:{location:k}})},i.DOMException=r.DOMException;try{new i.DOMException}catch{i.DOMException=function(I,O){this.message=I,this.name=O;var U=Error(I);this.stack=U.stack},i.DOMException.prototype=Object.create(Error.prototype),i.DOMException.prototype.constructor=i.DOMException}function Ha(k,I){return new Promise(function(O,U){var G=new xe(k,I);if(G.signal&&G.signal.aborted)return U(new i.DOMException("Aborted","AbortError"));var P=new XMLHttpRequest;function ma(){P.abort()}P.onload=function(){var ae={statusText:P.statusText,headers:Dt(P.getAllResponseHeaders()||"")};G.url.indexOf("file://")===0&&(P.status<200||P.status>599)?ae.status=200:ae.status=P.status,ae.url="responseURL"in P?P.responseURL:ae.headers.get("X-Request-URL");var Lt="response"in P?P.response:P.responseText;setTimeout(function(){O(new fe(Lt,ae))},0)},P.onerror=function(){setTimeout(function(){U(new TypeError("Network request failed"))},0)},P.ontimeout=function(){setTimeout(function(){U(new TypeError("Network request timed out"))},0)},P.onabort=function(){setTimeout(function(){U(new i.DOMException("Aborted","AbortError"))},0)};function Ga(ae){try{return ae===""&&r.location.href?r.location.href:ae}catch{return ae}}if(P.open(G.method,Ga(G.url),!0),G.credentials==="include"?P.withCredentials=!0:G.credentials==="omit"&&(P.withCredentials=!1),"responseType"in P&&(c.blob?P.responseType="blob":c.arrayBuffer&&(P.responseType="arraybuffer")),I&&typeof I.headers=="object"&&!(I.headers instanceof f||r.Headers&&I.headers instanceof r.Headers)){var Xn=[];Object.getOwnPropertyNames(I.headers).forEach(function(ae){Xn.push(m(ae)),P.setRequestHeader(ae,y(I.headers[ae]))}),G.headers.forEach(function(ae,Lt){Xn.indexOf(Lt)===-1&&P.setRequestHeader(Lt,ae)})}else G.headers.forEach(function(ae,Lt){P.setRequestHeader(Lt,ae)});G.signal&&(G.signal.addEventListener("abort",ma),P.onreadystatechange=function(){P.readyState===4&&G.signal.removeEventListener("abort",ma)}),P.send(typeof G._bodyInit>"u"?null:G._bodyInit)})}return Ha.polyfill=!0,r.fetch||(r.fetch=Ha,r.Headers=f,r.Request=xe,r.Response=fe),i.Headers=f,i.Request=xe,i.Response=fe,i.fetch=Ha,i})({})})(a),a.fetch.ponyfill=!0,delete a.fetch.polyfill;var n=s.fetch?s:a;t=n.fetch,t.default=n.fetch,t.fetch=n.fetch,t.Headers=n.Headers,t.Request=n.Request,t.Response=n.Response,e.exports=t})(un,un.exports);var Ma=un.exports;let ns;if(typeof queueMicrotask<"u")ns=queueMicrotask;else{const e=Promise.resolve();ns=t=>{e.then(t)}}var Ee,Oe,we,Na,Li;class Dc{constructor(t){_(this,Na);_(this,Ee);_(this,Oe);_(this,we);h(this,Ee,new Uint8Array(new ArrayBuffer(t))),h(this,Oe,0),h(this,we,0)}get length(){return d(this,we)-d(this,Oe)}data(){return d(this,Ee).slice(d(this,Oe),d(this,we))}push(t){S(this,Na,Li).call(this,t.byteLength),d(this,Ee).set(t,d(this,we)),h(this,we,d(this,we)+t.byteLength)}shift(t){h(this,Oe,d(this,Oe)+t)}}Ee=new WeakMap,Oe=new WeakMap,we=new WeakMap,Na=new WeakSet,Li=function(t){if(d(this,we)+t<=d(this,Ee).byteLength)return;const s=d(this,we)-d(this,Oe);if(s+t<=d(this,Ee).byteLength&&2*d(this,we)>=d(this,Ee).byteLength)d(this,Ee).copyWithin(0,d(this,Oe),d(this,we));else{let a=d(this,Ee).byteLength;do a*=2;while(s+t>a);const n=new Uint8Array(new ArrayBuffer(a));n.set(d(this,Ee).slice(d(this,Oe),d(this,we)),0),h(this,Ee,n)}h(this,we,s),h(this,Oe,0)};function Lc(e){const t=Fe(e.baton),s=Fe(e.base_url),a=Tt(e.results,Oc);return{baton:t,baseUrl:s,results:a}}function Oc(e){const t=qe(e.type);if(t==="ok")return{type:"ok",response:jc(ie(e.response))};if(t==="error")return{type:"error",error:Ts(ie(e.error))};throw new j("Unexpected type of StreamResult")}function jc(e){const t=qe(e.type);if(t==="close")return{type:"close"};if(t==="execute")return{type:"execute",result:An(ie(e.result))};if(t==="batch")return{type:"batch",result:yi(ie(e.result))};if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:_i(ie(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Qs(e.is_autocommit)};throw new j("Unexpected type of StreamResponse")}function Pc(e){const t=Fe(e.baton),s=Fe(e.base_url);return{baton:t,baseUrl:s}}const Nc={default(){return{baton:void 0,baseUrl:void 0,results:[]}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()},3(e,t){t.results.push(e.message(qc))}},qc={default(){return{type:"none"}},1(e){return{type:"ok",response:e.message(Bc)}},2(e){return{type:"error",error:e.message(Je)}}},Bc={default(){return{type:"none"}},1(e){return{type:"close"}},2(e){return e.message(Fc)},3(e){return e.message(Vc)},4(e){return{type:"sequence"}},5(e){return e.message(Uc)},6(e){return{type:"store_sql"}},7(e){return{type:"close_sql"}},8(e){return e.message(Hc)}},Fc={default(){return{type:"execute",result:Ms.default()}},1(e,t){t.result=e.message(Ms)}},Vc={default(){return{type:"batch",result:Aa.default()}},1(e,t){t.result=e.message(Aa)}},Uc={default(){return{type:"describe",result:Ta.default()}},1(e,t){t.result=e.message(Ta)}},Hc={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},Gc={default(){return{baton:void 0,baseUrl:void 0}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()}};var ea,Yt,lt,We,it,hs,ft,xn,Oi,ji;class Wc extends bi{constructor(s,a){super();_(this,ft);_(this,ea);_(this,Yt);_(this,lt);_(this,We);_(this,it);_(this,hs);h(this,ea,s),h(this,Yt,a),h(this,lt,void 0),h(this,We,new Dc(16*1024)),h(this,it,void 0),h(this,hs,!1)}async open(s){if(s.body===null)throw new j("No response body for cursor request");h(this,lt,s.body[Symbol.asyncIterator]());const a=await S(this,ft,xn).call(this,Pc,Gc);if(a===void 0)throw new j("Empty response to cursor request");return a}next(){return S(this,ft,xn).call(this,ki,Ii)}close(){this._setClosed(new K("Cursor was manually closed"))}_setClosed(s){d(this,it)===void 0&&(h(this,it,s),d(this,ea)._cursorClosed(this),d(this,lt)!==void 0&&d(this,lt).return())}get closed(){return d(this,it)!==void 0}}ea=new WeakMap,Yt=new WeakMap,lt=new WeakMap,We=new WeakMap,it=new WeakMap,hs=new WeakMap,ft=new WeakSet,xn=async function(s,a){for(;;){if(d(this,hs))return;if(d(this,it)!==void 0)throw new Ae("Cursor is closed",d(this,it));if(d(this,Yt)==="json"){const i=S(this,ft,Oi).call(this);if(i!==void 0){const r=new TextDecoder().decode(i),c=JSON.parse(r);return $n(c,s)}}else if(d(this,Yt)==="protobuf"){const i=S(this,ft,ji).call(this);if(i!==void 0)return qa(i,a)}else throw Q(d(this,Yt),"Impossible encoding");if(d(this,lt)===void 0)throw new At("Attempted to read from HTTP cursor before it was opened");const{value:n,done:l}=await d(this,lt).next();if(l&&d(this,We).length===0)h(this,hs,!0);else{if(l)throw new j("Unexpected end of cursor stream");d(this,We).push(n)}}},Oi=function(){const s=d(this,We).data(),n=s.indexOf(10);if(n<0)return;const l=s.slice(0,n);return d(this,We).shift(n+1),l},ji=function(){const s=d(this,We).data();let a=0,n=0;for(;;){if(n>=s.byteLength)return;const i=s[n];if(a|=(i&127)<<7*n,n+=1,!(i&128))break}if(s.byteLength<n+a)return;const l=s.slice(n,n+a);return d(this,We).shift(n+a),l};function zc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.arrayObjects("requests",t.requests,Yc)}function Yc(e,t){if(e.stringRaw("type",t.type),t.type!=="close"){if(t.type==="execute")e.object("stmt",t.stmt,In);else if(t.type==="batch")e.object("batch",t.batch,Ra);else if(t.type==="sequence")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type!=="get_autocommit")throw Q(t,"Impossible type of StreamRequest")}}function Jc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.object("batch",t.batch,Ra)}function Kc(e,t){t.baton!==void 0&&e.string(1,t.baton);for(const s of t.requests)e.message(2,s,Qc)}function Qc(e,t){if(t.type==="close")e.message(1,t,Xc);else if(t.type==="execute")e.message(2,t,Zc);else if(t.type==="batch")e.message(3,t,ed);else if(t.type==="sequence")e.message(4,t,td);else if(t.type==="describe")e.message(5,t,sd);else if(t.type==="store_sql")e.message(6,t,ad);else if(t.type==="close_sql")e.message(7,t,nd);else if(t.type==="get_autocommit")e.message(8,t,ld);else throw Q(t,"Impossible type of StreamRequest")}function Xc(e,t){}function Zc(e,t){e.message(1,t.stmt,Cn)}function ed(e,t){e.message(1,t.batch,Ba)}function td(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function sd(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function ad(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function nd(e,t){e.int32(1,t.sqlId)}function ld(e,t){}function id(e,t){t.baton!==void 0&&e.string(1,t.baton),e.message(2,t.batch,Ba)}var rt,kt,gs,ta,ws,_t,je,St,ot,ct,$t,ze,vs,N,mt,fn,Pt,Pi,Ni,bn,qi,Bi,mn;class rd extends fi{constructor(s,a,n,l,i){super(s.intMode);_(this,N);_(this,rt);_(this,kt);_(this,gs);_(this,ta);_(this,ws);_(this,_t);_(this,je);_(this,St);_(this,ot);_(this,ct);_(this,$t);_(this,ze);_(this,vs);h(this,rt,s),h(this,kt,a.toString()),h(this,gs,n),h(this,ta,l),h(this,ws,i),h(this,_t,void 0),h(this,je,new Ca),h(this,St,!1),h(this,ct,!1),h(this,$t,!1),h(this,ze,void 0),h(this,vs,new Bs)}client(){return d(this,rt)}_sqlOwner(){return this}storeSql(s){const a=d(this,vs).alloc();return S(this,N,mt).call(this,{type:"store_sql",sqlId:a,sql:s}).then(()=>{},n=>this._setClosed(n)),new En(this,a)}_closeSql(s){d(this,ze)===void 0&&S(this,N,mt).call(this,{type:"close_sql",sqlId:s}).then(()=>d(this,vs).free(s),a=>this._setClosed(a))}_execute(s){return S(this,N,mt).call(this,{type:"execute",stmt:s}).then(a=>a.result)}_batch(s){return S(this,N,mt).call(this,{type:"batch",batch:s}).then(a=>a.result)}_describe(s){return S(this,N,mt).call(this,{type:"describe",sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return S(this,N,mt).call(this,{type:"sequence",sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return d(this,rt)._ensureVersion(3,"getAutocommit()"),S(this,N,mt).call(this,{type:"get_autocommit"}).then(s=>s.isAutocommit)}_openCursor(s){return new Promise((a,n)=>{S(this,N,fn).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_cursorClosed(s){if(s!==d(this,ot))throw new At("Cursor was closed, but it was not associated with the stream");h(this,ot,void 0),ns(()=>S(this,N,Pt).call(this))}close(){this._setClosed(new K("Stream was manually closed"))}closeGracefully(){h(this,ct,!0),ns(()=>S(this,N,Pt).call(this))}get closed(){return d(this,ze)!==void 0||d(this,ct)}_setClosed(s){if(d(this,ze)===void 0){for(h(this,ze,s),d(this,ot)!==void 0&&d(this,ot)._setClosed(s),d(this,rt)._streamClosed(this);;){const a=d(this,je).shift();if(a!==void 0)a.errorCallback(s);else break}(d(this,_t)!==void 0||d(this,St))&&!d(this,$t)&&(d(this,je).push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),h(this,$t,!0),ns(()=>S(this,N,Pt).call(this)))}}}rt=new WeakMap,kt=new WeakMap,gs=new WeakMap,ta=new WeakMap,ws=new WeakMap,_t=new WeakMap,je=new WeakMap,St=new WeakMap,ot=new WeakMap,ct=new WeakMap,$t=new WeakMap,ze=new WeakMap,vs=new WeakMap,N=new WeakSet,mt=function(s){return new Promise((a,n)=>{S(this,N,fn).call(this,{type:"pipeline",request:s,responseCallback:a,errorCallback:n})})},fn=function(s){if(d(this,ze)!==void 0)throw new Ae("Stream is closed",d(this,ze));if(d(this,ct))throw new Ae("Stream is closing",void 0);d(this,je).push(s),ns(()=>S(this,N,Pt).call(this))},Pt=function(){if(d(this,St)||d(this,ot)!==void 0)return;if(d(this,ct)&&d(this,je).length===0){this._setClosed(new K("Stream was gracefully closed"));return}const s=d(this,rt)._endpoint;if(s===void 0){d(this,rt)._endpointPromise.then(()=>S(this,N,Pt).call(this),n=>this._setClosed(n));return}const a=d(this,je).shift();if(a!==void 0)if(a.type==="pipeline"){const n=[a];for(;;){const l=d(this,je).first();if(l!==void 0&&l.type==="pipeline")n.push(l),d(this,je).shift();else if(l===void 0&&d(this,ct)&&!d(this,$t)){n.push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),h(this,$t,!0);break}else break}S(this,N,Pi).call(this,s,n)}else if(a.type==="cursor")S(this,N,Ni).call(this,s,a);else throw Q(a,"Impossible type of QueueEntry")},Pi=function(s,a){S(this,N,bn).call(this,()=>S(this,N,qi).call(this,a,s),n=>cd(n,s.encoding),n=>n.baton,n=>n.baseUrl,n=>od(a,n),n=>a.forEach(l=>l.errorCallback(n)))},Ni=function(s,a){const n=new Wc(this,s.encoding);h(this,ot,n),S(this,N,bn).call(this,()=>S(this,N,Bi).call(this,a,s),l=>n.open(l),l=>l.baton,l=>l.baseUrl,l=>a.cursorCallback(n),l=>a.errorCallback(l))},bn=function(s,a,n,l,i,r){let c;try{const o=s();c=d(this,ta)(o)}catch(o){c=Promise.reject(o)}h(this,St,!0),c.then(o=>o.ok?a(o):dd(o).then(u=>{throw u})).then(o=>{h(this,_t,n(o)),h(this,kt,l(o)??d(this,kt)),i(o)}).catch(o=>{this._setClosed(o),r(o)}).finally(()=>{h(this,St,!1),S(this,N,Pt).call(this)})},qi=function(s,a){return S(this,N,mn).call(this,new URL(a.pipelinePath,d(this,kt)),{baton:d(this,_t),requests:s.map(n=>n.request)},a.encoding,zc,Kc)},Bi=function(s,a){if(a.cursorPath===void 0)throw new Rs(`Cursors are supported only on protocol version 3 and higher, but the HTTP server only supports version ${a.version}.`);return S(this,N,mn).call(this,new URL(a.cursorPath,d(this,kt)),{baton:d(this,_t),batch:s.batch},a.encoding,Jc,id)},mn=function(s,a,n,l,i){let r,c;if(n==="json")r=ni(a,l),c="application/json";else if(n==="protobuf")r=ii(a,i),c="application/x-protobuf";else throw Q(n,"Impossible encoding");const o=new Ma.Headers;return o.set("content-type",c),d(this,gs)!==void 0&&o.set("authorization",`Bearer ${d(this,gs)}`),d(this,ws)!==void 0&&o.set("x-turso-encryption-key",d(this,ws)),new Ma.Request(s.toString(),{method:"POST",headers:o,body:r})};function od(e,t){if(t.results.length!==e.length)throw new j("Server returned unexpected number of pipeline results");for(let s=0;s<e.length;++s){const a=t.results[s],n=e[s];if(a.type==="ok"){if(a.response.type!==n.request.type)throw new j("Received unexpected type of response");n.responseCallback(a.response)}else if(a.type==="error")n.errorCallback(As(a.error));else throw a.type==="none"?new j("Received unrecognized type of StreamResult"):Q(a,"Received impossible type of StreamResult")}}async function cd(e,t){var s;if(t==="json"){const a=await e.json();return $n(a,Lc)}if(t==="protobuf"){const a=await e.arrayBuffer();return qa(new Uint8Array(a),Nc)}throw await((s=e.body)==null?void 0:s.cancel()),Q(t,"Impossible encoding")}async function dd(e){var a;const t=e.headers.get("content-type")??"text/plain";let s=`Server returned HTTP status ${e.status}`;if(t==="application/json"){const n=await e.json();return"message"in n?As(n):new ya(s,e.status)}if(t==="text/plain"){const n=(await e.text()).trim();return n!==""&&(s+=`: ${n}`),new ya(s,e.status)}return await((a=e.body)==null?void 0:a.cancel()),new ya(s,e.status)}const pd=[{versionPath:"v3-protobuf",pipelinePath:"v3-protobuf/pipeline",cursorPath:"v3-protobuf/cursor",version:3,encoding:"protobuf"}],hn={versionPath:"v2",pipelinePath:"v2/pipeline",cursorPath:void 0,version:2,encoding:"json"};var ys,sa,ks,aa,dt,Jt,_s,$a,Dl;let ud=(Dl=class extends ti{constructor(s,a,n,l,i=2){super();_(this,_s);_(this,ys);_(this,sa);_(this,ks);_(this,aa);_(this,dt);_(this,Jt);q(this,"_endpointPromise");q(this,"_endpoint");h(this,ys,s),h(this,sa,a),h(this,ks,n??Ma.fetch),h(this,aa,l),h(this,dt,void 0),h(this,Jt,new Set),i==3?(this._endpointPromise=xd(d(this,ks),d(this,ys)),this._endpointPromise.then(r=>this._endpoint=r,r=>S(this,_s,$a).call(this,r))):(this._endpointPromise=Promise.resolve(hn),this._endpointPromise.then(r=>this._endpoint=r,r=>S(this,_s,$a).call(this,r)))}async getVersion(){return this._endpoint!==void 0?this._endpoint.version:(await this._endpointPromise).version}_ensureVersion(s,a){if(!(s<=hn.version)){if(this._endpoint===void 0)throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the version supported by the HTTP server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(this._endpoint.version<s)throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the HTTP server only supports version ${this._endpoint.version}.`)}}openStream(){if(d(this,dt)!==void 0)throw new Ae("Client is closed",d(this,dt));const s=new rd(this,d(this,ys),d(this,sa),d(this,ks),d(this,aa));return d(this,Jt).add(s),s}_streamClosed(s){d(this,Jt).delete(s)}close(){S(this,_s,$a).call(this,new K("Client was manually closed"))}get closed(){return d(this,dt)!==void 0}},ys=new WeakMap,sa=new WeakMap,ks=new WeakMap,aa=new WeakMap,dt=new WeakMap,Jt=new WeakMap,_s=new WeakSet,$a=function(s){if(d(this,dt)===void 0){h(this,dt,s);for(const a of Array.from(d(this,Jt)))a._setClosed(new Ae("Client was closed",s))}},Dl);async function xd(e,t){const s=e;for(const a of pd){const n=new URL(a.versionPath,t),l=new Ma.Request(n.toString(),{method:"GET"}),i=await s(l);if(await i.arrayBuffer(),i.ok)return a}return hn}function Fi(e,t,s=2){if(typeof as>"u")throw new ai("WebSockets are not supported in this environment");var a=void 0;s==3?a=Array.from(Ci.keys()):a=Array.from(Ac.keys());const n=new as(e,a);return new Tc(n,t)}function dl(e,t,s,a,n=2){return new ud(e instanceof URL?e:new URL(e),t,s,a,n)}var Ss,pt,de;class Vi{constructor(t,s){_(this,Ss);_(this,pt);_(this,de);h(this,Ss,t),h(this,pt,s),h(this,de,void 0)}execute(t){return this.batch([t]).then(s=>s[0])}async batch(t){const s=this._getStream();if(s.closed)throw new F("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{const a=t.map(Zt);let n;if(d(this,de)===void 0){this._getSqlCache().apply(a);const i=s.batch(d(this,pt)>=3),r=i.step(),c=r.run(en(d(this,Ss)));let o=r;n=a.map(u=>{const b=i.step().condition(ve.ok(o));d(this,pt)>=3&&b.condition(ve.not(ve.isAutocommit(i)));const m=b.query(u);return m.catch(()=>{}),o=b,m}),h(this,de,i.execute().then(()=>c).then(()=>{}));try{await d(this,de)}catch(u){throw this.close(),u}}else{d(this,pt)<3&&await d(this,de),this._getSqlCache().apply(a);const i=s.batch(d(this,pt)>=3);let r;n=a.map(c=>{const o=i.step();r!==void 0&&o.condition(ve.ok(r)),d(this,pt)>=3&&o.condition(ve.not(ve.isAutocommit(i)));const u=o.query(c);return u.catch(()=>{}),r=o,u}),await i.execute()}const l=[];for(let i=0;i<n.length;i++)try{const r=await n[i];if(r===void 0)throw new ls("Statement in a transaction was not executed, probably because the transaction has been rolled back",i,"TRANSACTION_CLOSED");l.push(Fa(r))}catch(r){if(r instanceof ls)throw r;const c=z(r);throw c instanceof F?new ls(c.message,i,c.code,c.extendedCode,c.rawCode,c.cause instanceof Error?c.cause:void 0):c}return l}catch(a){throw z(a)}}async executeMultiple(t){const s=this._getStream();if(s.closed)throw new F("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{if(d(this,de)===void 0){h(this,de,s.run(en(d(this,Ss))).then(()=>{}));try{await d(this,de)}catch(a){throw this.close(),a}}else await d(this,de);await s.sequence(t)}catch(a){throw z(a)}}async rollback(){try{const t=this._getStream();if(t.closed||d(this,de)===void 0)return;const s=t.run("ROLLBACK").catch(a=>{throw z(a)});t.closeGracefully(),await s}catch(t){throw z(t)}finally{this.close()}}async commit(){try{const t=this._getStream();if(t.closed)throw new F("Cannot commit the transaction because it is already closed","TRANSACTION_CLOSED");if(d(this,de)!==void 0)await d(this,de);else return;const s=t.run("COMMIT").catch(a=>{throw z(a)});t.closeGracefully(),await s}catch(t){throw z(t)}finally{this.close()}}}Ss=new WeakMap,pt=new WeakMap,de=new WeakMap;async function Da(e,t,s,a,n=!1){n&&s.step().run("PRAGMA foreign_keys=off");const l=s.step(),i=l.run(en(e));let r=l;const c=a.map(y=>{const w=s.step().condition(ve.ok(r));t>=3&&w.condition(ve.not(ve.isAutocommit(s)));const f=w.query(y);return r=w,f}),o=s.step().condition(ve.ok(r));t>=3&&o.condition(ve.not(ve.isAutocommit(s)));const u=o.run("COMMIT");s.step().condition(ve.not(ve.ok(o))).run("ROLLBACK").catch(y=>{}),n&&s.step().run("PRAGMA foreign_keys=on"),await s.execute();const m=[];await i;for(let y=0;y<c.length;y++)try{const w=await c[y];if(w===void 0)throw new ls("Statement in a batch was not executed, probably because the transaction has been rolled back",y,"TRANSACTION_CLOSED");m.push(Fa(w))}catch(w){if(w instanceof ls)throw w;const f=z(w);throw f instanceof F?new ls(f.message,y,f.code,f.extendedCode,f.rawCode,f.cause instanceof Error?f.cause:void 0):f}return await u,m}function Zt(e){let t,s;Array.isArray(e)?[t,s]=e:typeof e=="string"?t=e:(t=e.sql,s=e.args);const a=new ui(t);if(s)if(Array.isArray(s))a.bindIndexes(s);else for(const[n,l]of Object.entries(s))a.bindName(n,l);return a}function Fa(e){const t=e.columnNames.map(i=>i??""),s=e.columnDecltypes.map(i=>i??""),a=e.rows,n=e.affectedRowCount,l=e.lastInsertRowid!==void 0?e.lastInsertRowid:void 0;return new So(t,s,a,n,l)}function z(e){if(e instanceof K){const t=Ui(e);return new F(e.message,t,void 0,void 0,e)}return e}function Ui(e){return e instanceof si&&e.code!==void 0?e.code:e instanceof j?"HRANA_PROTO_ERROR":e instanceof Ae?e.cause instanceof K?Ui(e.cause):"HRANA_CLOSED_ERROR":e instanceof tn?"HRANA_WEBSOCKET_ERROR":e instanceof ya?"SERVER_ERROR":e instanceof Rs?"PROTOCOL_VERSION_ERROR":e instanceof At?"INTERNAL_ERROR":"UNKNOWN"}var na,Ye;class Tn{constructor(t,s){_(this,na);_(this,Ye);q(this,"capacity");h(this,na,t),h(this,Ye,new fd),this.capacity=s}apply(t){if(this.capacity<=0)return;const s=new Set;for(const a of t){if(typeof a.sql!="string")continue;const n=a.sql;if(n.length>=5e3)continue;let l=d(this,Ye).get(n);if(l===void 0){for(;d(this,Ye).size+1>this.capacity;){const[i,r]=d(this,Ye).peekLru();if(s.has(r))break;r.close(),d(this,Ye).delete(i)}d(this,Ye).size+1<=this.capacity&&(l=d(this,na).storeSql(n),d(this,Ye).set(n,l))}l!==void 0&&(a.sql=l,s.add(l))}}}na=new WeakMap,Ye=new WeakMap;var Pe;class fd{constructor(){_(this,Pe);h(this,Pe,new Map)}get(t){const s=d(this,Pe).get(t);return s!==void 0&&(d(this,Pe).delete(t),d(this,Pe).set(t,s)),s}set(t,s){d(this,Pe).set(t,s)}peekLru(){for(const t of d(this,Pe).entries())return t}delete(t){d(this,Pe).delete(t)}get size(){return d(this,Pe).size}}Pe=new WeakMap;function bd(e){var t=0,s=[];function a(){t--,t<e&&n()}function n(){var c=s.shift();r.queue=s.length,c&&i(c.fn).then(c.resolve).catch(c.reject)}function l(c){return new Promise(function(o,u){s.push({fn:c,resolve:o,reject:u}),r.queue=s.length})}function i(c){t++;try{return Promise.resolve(c()).then(function(o){return a(),o},function(o){throw a(),o})}catch(o){return a(),Promise.reject(o)}}var r=function(c){return t>=e?l(c):i(c)};return r}function md(e,t){var s=!1,a=this;return Promise.all(e.map(function(){var n=arguments;return a(function(){if(!s)return t.apply(void 0,n).catch(function(l){throw s=!0,l})})}))}function pl(e){return e.queue=0,e.map=md,e}var hd=function(e){return pl(e?bd(e):function(t){return t()})};const Hi=Mc(hd);function gd(e){if(e.scheme!=="wss"&&e.scheme!=="ws")throw new F(`The WebSocket client supports only "libsql:", "wss:" and "ws:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new F("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="ws"&&e.tls)throw new F('A "ws:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="wss"&&!e.tls)throw new F('A "wss:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Qa(e.scheme,e.authority,e.path);let s;try{s=Fi(t,e.authToken)}catch(a){if(a instanceof ai){const n=e.scheme==="wss"?"https":"http",l=Qa(n,e.authority,e.path);throw new F(`This environment does not support WebSockets, please switch to the HTTP client by using a "${n}:" URL (${JSON.stringify(l)}). For more information, please read ${Ks}`,"WEBSOCKETS_NOT_SUPPORTED")}throw z(a)}return new vd(s,t,e.authToken,e.intMode,e.concurrency)}const wd=60*1e3,ul=100;var la,ia,ra,ee,oe,vn,oa,Ie,ss,Us;class vd{constructor(t,s,a,n,l){_(this,Ie);_(this,la);_(this,ia);_(this,ra);_(this,ee);_(this,oe);q(this,"closed");q(this,"protocol");_(this,vn);_(this,oa);h(this,la,s),h(this,ia,a),h(this,ra,n),h(this,ee,S(this,Ie,Us).call(this,t)),h(this,oe,void 0),this.closed=!1,this.protocol="ws",h(this,oa,Hi(l))}async limit(t){return d(this,oa).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{const n=await S(this,Ie,ss).call(this);try{const l=Zt(a);n.conn.sqlCache.apply([l]);const i=n.stream.query(l);n.stream.closeGracefully();const r=await i;return Fa(r)}catch(l){throw z(l)}finally{this._closeStream(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{const a=await S(this,Ie,ss).call(this);try{const l=t.map(u=>Array.isArray(u)?{sql:u[0],args:u[1]||[]}:u).map(Zt),i=await a.conn.client.getVersion();a.conn.sqlCache.apply(l);const r=a.stream.batch(i>=3);return await Da(s,i,r,l)}catch(n){throw z(n)}finally{this._closeStream(a)}})}async migrate(t){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=t.map(Zt),n=await s.conn.client.getVersion(),l=s.stream.batch(n>=3);return await Da("deferred",n,l,a,!0)}catch(a){throw z(a)}finally{this._closeStream(s)}})}async transaction(t="write"){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=await s.conn.client.getVersion();return new yd(this,s,t,a)}catch(a){throw this._closeStream(s),z(a)}})}async executeMultiple(t){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=s.stream.sequence(t);s.stream.closeGracefully(),await a}catch(a){throw z(a)}finally{this._closeStream(s)}})}sync(){throw new F("sync not supported in ws mode","SYNC_NOT_SUPPORTED")}async reconnect(){try{for(const a of Array.from(d(this,ee).streamStates))try{a.stream.close()}catch{}d(this,ee).client.close()}catch{}if(d(this,oe)){try{d(this,oe).client.close()}catch{}h(this,oe,void 0)}const t=S(this,Ie,Us).call(this),s=await t.client.getVersion();t.useSqlCache=s>=2,t.useSqlCache&&(t.sqlCache.capacity=ul),h(this,ee,t),this.closed=!1}_closeStream(t){t.stream.close();const s=t.conn;s.streamStates.delete(t),s.streamStates.size===0&&s!==d(this,ee)&&s.client.close()}close(){if(d(this,ee).client.close(),this.closed=!0,d(this,oe)){try{d(this,oe).client.close()}catch{}h(this,oe,void 0)}this.closed=!0}}la=new WeakMap,ia=new WeakMap,ra=new WeakMap,ee=new WeakMap,oe=new WeakMap,vn=new WeakMap,oa=new WeakMap,Ie=new WeakSet,ss=async function(){if(this.closed)throw new F("The client is closed","CLIENT_CLOSED");if(new Date().valueOf()-d(this,ee).openTime.valueOf()>wd&&d(this,oe)===void 0){const n=S(this,Ie,Us).call(this);h(this,oe,n),n.client.getVersion().then(l=>{d(this,ee)!==n&&d(this,ee).streamStates.size===0&&d(this,ee).client.close(),h(this,ee,n),h(this,oe,void 0)},l=>{h(this,oe,void 0)})}if(d(this,ee).client.closed)try{d(this,oe)!==void 0?h(this,ee,d(this,oe)):h(this,ee,S(this,Ie,Us).call(this))}catch(n){throw z(n)}const a=d(this,ee);try{a.useSqlCache===void 0&&(a.useSqlCache=await a.client.getVersion()>=2,a.useSqlCache&&(a.sqlCache.capacity=ul));const n=a.client.openStream();n.intMode=d(this,ra);const l={conn:a,stream:n};return a.streamStates.add(l),l}catch(n){throw z(n)}},Us=function(t){try{return t??(t=Fi(d(this,la),d(this,ia))),{client:t,useSqlCache:void 0,sqlCache:new Tn(t,0),openTime:new Date,streamStates:new Set}}catch(s){throw z(s)}};var ca,Et;class yd extends Vi{constructor(s,a,n,l){super(n,l);_(this,ca);_(this,Et);h(this,ca,s),h(this,Et,a)}_getStream(){return d(this,Et).stream}_getSqlCache(){return d(this,Et).conn.sqlCache}close(){d(this,ca)._closeStream(d(this,Et))}get closed(){return d(this,Et).stream.closed}}ca=new WeakMap,Et=new WeakMap;function kd(e){if(e.scheme!=="https"&&e.scheme!=="http")throw new F(`The HTTP client supports only "libsql:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new F("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="http"&&e.tls)throw new F('A "http:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="https"&&!e.tls)throw new F('A "https:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Qa(e.scheme,e.authority,e.path);return new _d(t,e.authToken,e.intMode,e.fetch,e.concurrency,e.remoteEncryptionKey)}const Gi=30;var te,$s,Es,Is,da,Cs,pa,ua;class _d{constructor(t,s,a,n,l,i){_(this,te);q(this,"protocol");_(this,$s);_(this,Es);_(this,Is);_(this,da);_(this,Cs);_(this,pa);_(this,ua);h(this,$s,t),h(this,Cs,s),h(this,Es,a),h(this,Is,n),h(this,da,l),h(this,pa,i),h(this,te,dl(d(this,$s),d(this,Cs),d(this,Is),i)),d(this,te).intMode=d(this,Es),this.protocol="http",h(this,ua,Hi(d(this,da)))}async limit(t){return d(this,ua).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{try{const n=Zt(a);let l;const i=d(this,te).openStream();try{l=i.query(n)}finally{i.closeGracefully()}const r=await l;return Fa(r)}catch(n){throw z(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{try{const n=t.map(o=>Array.isArray(o)?{sql:o[0],args:o[1]||[]}:o).map(Zt),l=await d(this,te).getVersion();let i;const r=d(this,te).openStream();try{new Tn(r,Gi).apply(n);const u=r.batch(!1);i=Da(s,l,u,n)}finally{r.closeGracefully()}return await i}catch(a){throw z(a)}})}async migrate(t){return this.limit(async()=>{try{const s=t.map(Zt),a=await d(this,te).getVersion();let n;const l=d(this,te).openStream();try{const r=l.batch(!1);n=Da("deferred",a,r,s,!0)}finally{l.closeGracefully()}return await n}catch(s){throw z(s)}})}async transaction(t="write"){return this.limit(async()=>{try{const s=await d(this,te).getVersion();return new Sd(d(this,te).openStream(),t,s)}catch(s){throw z(s)}})}async executeMultiple(t){return this.limit(async()=>{try{let s;const a=d(this,te).openStream();try{s=a.sequence(t)}finally{a.closeGracefully()}await s}catch(s){throw z(s)}})}sync(){throw new F("sync not supported in http mode","SYNC_NOT_SUPPORTED")}close(){d(this,te).close()}async reconnect(){try{this.closed||d(this,te).close()}finally{h(this,te,dl(d(this,$s),d(this,Cs),d(this,Is),d(this,pa))),d(this,te).intMode=d(this,Es)}}get closed(){return d(this,te).closed}}te=new WeakMap,$s=new WeakMap,Es=new WeakMap,Is=new WeakMap,da=new WeakMap,Cs=new WeakMap,pa=new WeakMap,ua=new WeakMap;var Kt,xa;class Sd extends Vi{constructor(s,a,n){super(a,n);_(this,Kt);_(this,xa);h(this,Kt,s),h(this,xa,new Tn(s,Gi))}_getStream(){return d(this,Kt)}_getSqlCache(){return d(this,xa)}close(){d(this,Kt).close()}get closed(){return d(this,Kt).closed}}Kt=new WeakMap,xa=new WeakMap;function Wi(e){return $d(Io(e))}function $d(e){if(e.scheme==="ws"||e.scheme==="wss")return gd(e);if(e.scheme==="http"||e.scheme==="https")return kd(e);throw new F(`The client that uses Web standard APIs supports only "libsql:", "wss:", "ws:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED")}const Ed={url:"libsql://retailer-os-digitalhues.aws-ap-south-1.turso.io",authToken:"eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzAxODY2NzMsImlkIjoiNDcwMDliODAtYmJlYS00YzQ3LTk1MzQtY2NlYjg4OWUzYjFjIiwicmlkIjoiNTk1ODMwNWEtMjlkNy00OGU5LWJkNTctN2FiZWVjNzVjMWYwIn0.381aJkYkBtcCsSDyQkFNLZud9lOPi9TuT3uRZgLYS9BqrjLFb0Zc7P1qRWN0k16XkHQ7raDwhCUE9H1G8Q80BA"},Id={url:"libsql://retailer-data-digitalhues.aws-ap-south-1.turso.io",authToken:"eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzAyODMwNTgsImlkIjoiZTVmNzQ5MjMtMDFiMi00YzkxLTlmMjEtZTJhZDIxMzBmMmZmIiwicmlkIjoiZjQzNTc5NTMtN2E2OS00M2UzLWE3MWUtNDcyYzk1MWM1NTRiIn0.8dOIX1XeNnJswuRGhacgPypg_h_9_-bRAwBxtKhBX7rJ4bQuEtSz9Z6igZsvGrWxDlsYlHMo4V3KKIuIZRSuBA"},Nt=Wi(Ed),xl=Wi(Id);async function v(e,t=[]){try{return(await Nt.execute({sql:e,args:t})).rows}catch(s){throw console.error("DB Query Error:",s.message,"SQL:",e,"Params:",t),s}}async function Cd(e){try{return await Nt.batch(e)}catch(t){throw console.error("DB Transaction Error:",t),t}}function R(){return localStorage.getItem("retaileros_retailer_id")}const A={clients:{getAll:()=>{const e=R();return e?v("SELECT * FROM customers WHERE retailer_id = ?",[e]):v("SELECT * FROM customers")},add:e=>{const t=R();return v("INSERT INTO customers (id, name, phone, email, joined_at, dob, location, retailer_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",[e.id,e.name,e.phone||"",e.email||"",new Date().toISOString(),e.dob||null,e.location||"",t])},getById:e=>{const t=R();return t?v("SELECT * FROM customers WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM customers WHERE id = ?",[e])}},companies:{getAll:()=>{const e=R();return e?v("SELECT * FROM companies WHERE retailer_id = ?",[e]):v("SELECT * FROM companies")},add:e=>{const t=R();return v("INSERT INTO companies (id, name, gst_number, customer_id, created_at, retailer_id) VALUES (?, ?, ?, ?, ?, ?)",[e.id,e.name,e.gst_number,e.customer_id,new Date().toISOString(),t])},getByCustomerId:e=>{const t=R();return t?v("SELECT * FROM companies WHERE customer_id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM companies WHERE customer_id = ?",[e])},getById:e=>{const t=R();return t?v("SELECT * FROM companies WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM companies WHERE id = ?",[e])}},sales:{getAll:()=>{const e=R();return e?v("SELECT * FROM sales WHERE retailer_id = ? ORDER BY date DESC",[e]):v("SELECT * FROM sales ORDER BY date DESC")},getById:e=>{const t=R();return t?v("SELECT * FROM sales WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM sales WHERE id = ?",[e])},getDrafts:()=>{const e=R();return e?v("SELECT * FROM sales WHERE status = 'draft' AND retailer_id = ? ORDER BY date DESC",[e]):v("SELECT * FROM sales WHERE status = 'draft' ORDER BY date DESC")},add:e=>{const t=R();return v(`INSERT INTO sales (id, customer_id, customer_name, date, total_amount, status, payment_mode, payment_reference, gst_required, company_id, installation_required, installation_date, retailer_id)
    ...
    `}let rs=!1,Ea="",T=[],Be=null,ut="Select Customer",ue=!1,Ke="",Qe="",ba=!1,W="",xt="",Ct=null;const os=e=>`${e}-${Math.random().toString(36).substr(2,8).toUpperCase()}`,Rd=["appliances","air conditioners","ac","washing machines","refrigerators","tvs","television","home theater","dishwasher","microwave","geyser","water heater"];function Dn(e){if(e.installation_required===1)return!0;const t=(e.category||"").toLowerCase();return Rd.some(s=>t.includes(s))}async function Ad(e){const t=window.getCache().products,s=window.getCache().schemes||[],a=t.find(n=>n.id===e);if(a){const n=Dn(a),l=s.filter(r=>{const c=!r.brand||r.brand===a.brand,o=!r.category||r.category===a.category,u=(!r.min_price||a.mop>=r.min_price)&&(!r.max_price||a.mop<=r.max_price),b=new Date(r.start_date)<=new Date&&new Date(r.end_date)>=new Date;return c&&o&&u&&b&&r.status==="active"});T.push({...a,qty:1,imei:"",serial_number:"",mac_id:"",manufacturing_date:"",showDetails:!1,installation_required:n,installation_date:"",discount_type:null,discount_value:0,discount_amount:0,scheme_id:null,scheme_name:null,final_price:a.mop,applicableSchemes:l,showDiscount:!1,extraFields:[]});const i=document.getElementById("sales-item-search");i&&(i.value=""),window.triggerRender()}}window.toggleCartItemDiscount=e=>{if(T[e]){T[e].showDiscount=!T[e].showDiscount;const t=document.querySelector(".scrolling-content"),s=t?t.scrollTop:0;window.triggerRender(),requestAnimationFrame(()=>{t&&(t.scrollTop=s);const a=document.querySelector(`[data-cart-item="${e}"]`);a&&T[e].showDiscount&&setTimeout(()=>a.scrollIntoView({behavior:"smooth",block:"nearest"}),50)})}};window.applyStoreDiscount=(e,t)=>{if(T[e]){const s=T[e],a=parseFloat(t)||0;a>0&&a<=100?(s.discount_type="store",s.discount_value=a,s.discount_amount=Math.round(s.mop*a/100),s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop-s.discount_amount,s.showDiscount=!1):(s.discount_type=null,s.discount_value=0,s.discount_amount=0,s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop),window.triggerRender()}};window.applySchemeDiscount=(e,t)=>{if(T[e]){const s=T[e],n=(window.getCache().schemes||[]).find(l=>l.id===t);n?(s.discount_type="scheme",s.scheme_id=n.id,s.scheme_name=n.name,n.discount_type==="percentage"?(s.discount_value=n.discount_value,s.discount_amount=Math.round(s.mop*n.discount_value/100)):(s.discount_value=n.discount_value,s.discount_amount=n.discount_value),s.final_price=s.mop-s.discount_amount,s.showDiscount=!1):(s.discount_type=null,s.discount_value=0,s.discount_amount=0,s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop),window.triggerRender()}};window.clearItemDiscount=e=>{if(T[e]){const t=T[e];t.discount_type=null,t.discount_value=0,t.discount_amount=0,t.scheme_id=null,t.scheme_name=null,t.final_price=t.mop,window.triggerRender()}};function Ji(e,t){Be=e,ut=t;const s=document.getElementById("customer-dropdown-menu");s&&s.classList.add("hidden");const n=(window.getCache().companies||[]).find(l=>l.customer_id===e);n&&(Ke=n.name,Qe=n.gst_number),window.triggerRender()}window.updateCartItemDetail=(e,t,s)=>{T[e]&&(T[e][t]=s)};window.toggleCartItemDetails=e=>{if(T[e]){T[e].showDetails=!T[e].showDetails;const t=document.querySelector(".scrolling-content"),s=t?t.scrollTop:0;window.triggerRender(),requestAnimationFrame(()=>{t&&(t.scrollTop=s);const a=document.querySelector(`[data-cart-item="${e}"]`);a&&T[e].showDetails&&setTimeout(()=>a.scrollIntoView({behavior:"smooth",block:"nearest"}),50)})}};window.toggleItemInstallation=e=>{T[e]&&(T[e].installation_required=!T[e].installation_required,T[e].installation_required||(T[e].installation_date=""),window.triggerRender())};window.updateItemInstallationDate=(e,t)=>{T[e]&&(T[e].installation_date=t)};const Td="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";function Md(){return localStorage.getItem("openai_api_key")||Td}window.captureDeviceImage=async e=>{const t=Md(),s=document.createElement("input");s.type="file",s.accept="image/*",s.capture="environment",s.onchange=async a=>{const n=a.target.files[0];if(n){rs=!0,Ea="Reading image...",window.triggerRender(!1);try{const l=await Dd(n);Ea="AI analyzing...",Ld(e,Ea);const i=T[e],r={name:i.name,brand:i.brand,category:i.category},c=await Od(l,r,t);T[e]&&c&&(c.imei&&(T[e].imei=c.imei),c.serial_number&&(T[e].serial_number=c.serial_number),c.mac_id&&(T[e].mac_id=c.mac_id),c.manufacturing_date&&(T[e].manufacturing_date=c.manufacturing_date),c.extraFields&&c.extraFields.length>0&&(T[e].extraFields=[...T[e].extraFields||[],...c.extraFields])),rs=!1,window.triggerRender(!1);const o=[];c.imei&&o.push("IMEI"),c.serial_number&&o.push("Serial"),c.mac_id&&o.push("MAC ID"),c.manufacturing_date&&o.push("Mfg Date"),c.extraFields&&c.extraFields.forEach(u=>o.push(u.label)),o.length>0?window.toast.success(`Found: ${o.join(", ")}`):window.toast.warning("No device details found. Try a clearer image.")}catch(l){console.error("AI Vision Error:",l),rs=!1,window.triggerRender(!1),window.toast.error(l.message||"Error analyzing image")}}},s.click()};function Dd(e){return new Promise((t,s)=>{const a=new FileReader;a.onload=()=>{const n=a.result.split(",")[1];t(n)},a.onerror=s,a.readAsDataURL(e)})}function Ld(e,t){const s=document.getElementById(`ocr-progress-${e}`);s&&(s.textContent=t)}async function Od(e,t,s){var c,o,u,b;const a=`You are analyzing a product label/box image to extract device information.
                ...
                <div class="relative text-left">
                    ...
                    ${l?`
                        <div class="absolute top-full left-0 right-0 z-50 bg-white border border-slate-100 rounded-2xl shadow-2xl mt-2 overflow-hidden text-left max-h-60 overflow-y-auto">
                            ${i.length>0?i.map(o=>{var b;const u=Dn(o);return`
                                <button type="button" onclick="window.addProductToCart('${o.id}')" class="p-4 hover:bg-slate-50 cursor-pointer flex justify-between items-center text-left w-full border-b border-slate-50">
                                    ...
                                    <p class="text-xs font-black text-slate-900 text-right ml-2">₹${((b=o.mop)==null?void 0:b.toLocaleString())||0}</p>
                                </button>
                        ...
                        <div class="card overflow-hidden ${o.installation_required?"border-slate-300":""}" data-cart-item="${u}">
                            <div class="p-4 flex items-center gap-4 text-left">
                                ...
                                <div class="text-right shrink-0">
                                    ${o.discount_amount>0?`
                                        <p class="text-[9px] font-bold text-slate-400 line-through text-right">₹${((b=o.mop)==null?void 0:b.toLocaleString())||0}</p>
                                        <p class="text-xs font-black text-right">₹${((m=o.final_price)==null?void 0:m.toLocaleString())||0}</p>
                                    `:`
        ...
        <div class="scrolling-content px-4 sm:px-8 space-y-6 pb-12 text-left">
            ...
            <section class="space-y-4">
                ...
                <div class="flex items-center justify-between gap-3">
                    <h3 class="text-[9px] font-black text-slate-400 uppercase tracking-widest">
                        ...
                        <span class="text-slate-300 ml-1">(${b.length})</span>
                    </h3>
            ...
            `:`
                <section class="space-y-3 text-left">
                    ${i==="online"?`
                        <!-- Online Orders List -->
                        ${u.map(f=>{const x=(e.storeOrderItems||[]).filter($=>$.order_id===f.id),g=x[0]?x[0].product_name:"Order items",E=x.length>1?`+ ${x.length-1} more`:"",C=$=>{switch($){case"pending":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-200 text-slate-600">Pending</span>';case"confirmed":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-300 text-slate-700">Confirmed</span>';case"shipped":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-300 text-slate-700">Shipped</span>';default:return""}};return`
                                <button type="button" onclick="window.setApp('mystore'); window.setActiveStoreOrder('${f.id}')" class="card p-4 sm:p-6 border-2 transition-all cursor-pointer text-left w-full border-transparent hover:border-slate-200">
                                    ...
                                    <div class="space-y-1 text-left">
                                        <p class="text-[10px] font-bold text-slate-500 uppercase text-left truncate">${g} ${E}</p>
                                        <div class="flex items-center justify-between text-left">
                    ...
                    `:i==="drafts"?`
                        <!-- Drafts List -->
                        ${c.map(f=>{const x=s.filter(C=>C.sale_id===f.id),g=x[0]?x[0].product_name:"No items",E=x.length>1?`+ ${x.length-1} more`:"";return`
                                <div class="card border-2 border-dashed overflow-hidden ${p.salesHistoryId===f.id?"border-slate-900 shadow-lg":"border-slate-200"}">
                                    <button type="button" onclick="window.setSalesHistoryId('${f.id}')" class="p-5 text-left w-full">
                                        ...
                                        <div class="space-y-1 text-left">
                                            <p class="text-[10px] font-bold text-slate-500 uppercase text-left">${g} ${E}</p>
                    ...
                    `:`
                        ...
                        ${o.map(f=>{const x=s.filter(L=>L.sale_id===f.id),g=x[0]?x[0].product_name:"Custom Sale",E=x.length>1?`+ ${x.length-1} more`:"",C=y(f.payment_mode),$=w(f.payment_mode);return`
...
`,t+="Powered by RetailerOS",t}function qd(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function Bd(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function er(){const e=p.currentTab==="history",t=Va();if(!t)return`<div class="p-10 text-center opacity-40 flex flex-col items-center justify-center h-full">
                ...
                <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center text-left">
                    <div class="flex items-center gap-3 text-left">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                            <span class="material-icons-outlined text-sm">${qd(t.paymentMode)}</span>
                        </div>
                        <div class="text-left">
                            <p class="text-[9px] font-black uppercase tracking-widest text-left">Paid via ${Bd(t.paymentMode)}</p>
    ...
    `}window.updateClientSearch=e=>{const t=document.getElementById("client-search-input"),s=(t==null?void 0:t.selectionStart)||e.length;p.clientSearchQuery=e,window.triggerRender(!1),setTimeout(()=>{const a=document.getElementById("client-search-input");a&&(a.focus(),a.setSelectionRange(s,s))},0)};async function Fd(){const e=document.getElementById("client-name"),t=document.getElementById("client-phone"),s=document.getElementById("client-email"),a=document.getElementById("client-location");if(!e||!t){console.error("Form inputs not found"),window.toast.error("Form error. Please try again.");return}const n=e.value.trim(),l=t.value.trim(),i=s.value.trim(),r=a?a.value.trim():"";if(!n||!l){window.toast.warning("Name and Phone are required");return}const c=document.getElementById("save-client-btn");let o="";c&&(o=c.innerHTML,c.innerHTML='<span class="material-icons-outlined animate-spin text-xs">sync</span> Saving...',c.disabled=!0);try{const u="CL-"+Math.random().toString(36).substr(2,6).toUpperCase();console.log("Saving client:",{id:u,name:n,phone:l,email:i,location:r}),await A.clients.add({id:u,name:n,phone:l,email:i,location:r}),console.log("Client saved successfully"),await Y(),window.toast.success("Client added successfully!"),p.currentApp==="sales"?(Ji(u,n),Nl("default")):jl("directory")}catch(u){console.error("Error saving client:",u),window.toast.error("Error saving client: "+u.message),c&&(c.innerHTML=o,c.disabled=!1)}}window.saveClient=Fd;function gn(e){const t=e==="desktop";return`
    ...
    `}function hl(e){var f;const t=e==="desktop",s=window.getCache(),a=((f=s.customers)==null?void 0:f.find(x=>x.id===p.selectedClientId||x.name===p.selectedClient))||{name:p.selectedClient||"Unknown",joined_at:new Date().toISOString()},n=a.name?a.name.split(" ").map(x=>x[0]).join("").toUpperCase():"?",l=(s.sales||[]).filter(x=>x.customer_id===a.id&&x.status!=="draft").sort((x,g)=>new Date(g.date)-new Date(x.date)),i=s.saleItems||[],r=(s.inquiries||[]).filter(x=>x.customer_id===a.id||x.customer_name===a.name),c=(s.repairs||[]).filter(x=>x.customer_id===a.id||x.customer_name===a.name),o=(s.automations||[]).filter(x=>x.customer_id===a.id),u=s.automationMessages||[],b=(s.communications||[]).filter(x=>x.customer_id===a.id),m=l.reduce((x,g)=>x+(g.total_amount||0),0),y=l.length,w=[...l.map(x=>({type:"sale",date:x.date,data:x,items:i.filter(g=>g.sale_id===x.id)})),...c.map(x=>({type:"repair",date:x.created_at||x.date,data:x})),...r.map(x=>({type:"inquiry",date:x.date||x.created_at,data:x})),...o.map(x=>({type:"automation",date:x.created_at,data:x,messages:u.filter(g=>g.automation_id===x.id)})),...b.map(x=>({type:"communication",date:x.sent_at,data:x}))].sort((x,g)=>new Date(g.date)-new Date(x.date));return`
        ...
        <div class="scrolling-content px-4 sm:px-8 space-y-8 pb-12 text-left">
            ...
            <div class="grid grid-cols-2 gap-3">
                <div class="card p-4 text-center">
                    <p class="text-2xl font-black text-slate-900 tracking-tighter">₹${m.toLocaleString()}</p>
            ...
            <div class="space-y-6 text-left">
                ...
                `:`
                    ...
                    <div class="relative pl-8 sm:pl-10 space-y-6 before:absolute before:left-3 sm:before:left-4 before:top-2 before:bottom-2 before:w-px before:bg-slate-100 before:border-l before:border-dashed before:border-slate-200 text-left">
                        ${w.map(x=>{if(x.type==="sale"){const g=x.data,E=x.items;return`
                                    <div class="relative text-left">
                                ...
                                `}if(x.type==="automation"){const g=x.data,E=x.messages||[],C=E.filter(L=>L.status==="sent").length,$=E.filter(L=>L.status==="pending").length;return`
                                    <div class="relative text-left">
                                ...
                                `}if(x.type==="communication"){const g=x.data,E=g.type==="whatsapp"?"chat":g.type==="call"?"call":"mail",C=g.type==="whatsapp"?"WhatsApp":g.type==="call"?"Phone Call":"Email";return`
                                    <div class="relative text-left">
                                        <div class="absolute -left-8 sm:-left-10 top-0 w-6 h-6 sm:w-8 sm:h-8 bg-white border border-slate-100 rounded-xl flex items-center justify-center z-10 shadow-sm text-center">
                                            <span class="material-icons-outlined text-xs text-slate-500 text-center">${E}</span>
                                        </div>
                                        <div class="card p-4 sm:p-5 group hover:border-slate-300 transition-all text-left">
                                            <div class="flex justify-between items-start mb-2 text-left">
                                                <div class="text-left flex-1 min-w-0">
    ...
    `}function Gd(){const e=window.getCache(),t=e.groups||[],s=e.groupMembers||[],a=e.customers||[],n=e.sales||[],l=t.find(u=>u.id===p.selectedGroupId);if(!l)return`
        ...
        `;const i=s.filter(u=>u.group_id===l.id).map(u=>u.customer_id),r=a.filter(u=>i.includes(u.id)),o=n.filter(u=>i.includes(u.customer_id)&&u.status!=="draft").reduce((u,b)=>u+(b.total_amount||0),0);return`
        <div class="h-full flex flex-col overflow-hidden">
            ...
            <div class="flex-1 overflow-y-auto p-6 space-y-5">
                ...
                <div class="space-y-3">
                    ...
                    `:`
                        <div class="space-y-2">
                            ${r.map(u=>{const m=n.filter(y=>y.customer_id===u.id&&y.status!=="draft").reduce((y,w)=>y+(w.total_amount||0),0);return`
                                    <div class="card p-3 flex items-center justify-between">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ${m>0?`<span class="text-[9px] font-black text-slate-500">₹${m.toLocaleString()}</span>`:""}
    ...
    `}function Wd(){const e=window.getCache(),t=e.groups||[],s=e.groupMembers||[],a=e.customers||[],n=t.find(r=>r.id===p.selectedGroupId);if(!n)return p.groupViewMode="list","";const l=s.filter(r=>r.group_id===n.id).map(r=>r.customer_id),i=a.filter(r=>!l.includes(r.id));return`
        <div class="h-full flex flex-col overflow-hidden">
            <!-- Header -->
            <div class="p-6 border-b border-slate-100 flex items-center justify-between shrink-0">
                <div class="flex items-center gap-4">
    ...
    `}function gl(){return Ud()}function wl(){switch(p.groupViewMode){case"create":return Hd();case"detail":return Gd();case"add-members":return Wd();default:return`
                <div class="h-full flex items-center justify-center text-slate-300 text-center p-8">
                    <div class="text-center">
            ...
            `}}function zd(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function Yd(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function vl(e="desktop"){var u,b;const t=window.getCache(),s=p.clientInvoiceId,a=(t.sales||[]).find(m=>m.id===s);if(!a)return`
        ...
        `;const n=(t.saleItems||[]).filter(m=>m.sale_id===a.id),l=(u=t.customers)==null?void 0:u.find(m=>m.id===a.customer_id),i=a.company_id?(b=t.companies)==null?void 0:b.find(m=>m.id===a.company_id):null,r=a.total_amount||0,c=n.map(m=>{let y=[];if(m.extra_fields)try{y=JSON.parse(m.extra_fields)}catch{}return{name:m.product_name,category:m.category||"Standard",price:m.price,imei:m.imei,serial_number:m.serial_number,mac_id:m.mac_id,manufacturing_date:m.manufacturing_date,installation_date:m.installation_date,extraFields:y}}),o={id:a.id,status:a.status,customer:a.customer_name,phone:(l==null?void 0:l.phone)||"N/A",date:new Date(a.date).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"}),time:new Date(a.date).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!0})+" IST",items:c,subtotal:r/1.18,gst:r-r/1.18,total:r,paymentMode:a.payment_mode,paymentReference:a.payment_reference,gstRequired:a.gst_required,company:i,installationRequired:a.installation_required,installationDate:a.installation_date};return`
                ...
                <div class="card p-6 sm:p-8 bg-white text-slate-900 leading-relaxed shadow-sm border border-slate-100">
                        ...
                        ${o.items.map(m=>`
                            <div class="pb-4 border-b border-slate-100 last:border-0">
                                <div class="flex justify-between items-start mb-2">
                                    <div class="flex-1 min-w-0">
                                        <h4 class="text-sm font-black text-slate-900 truncate">${m.name}</h4>
                                        <p class="text-[9px] font-bold text-slate-400 uppercase mt-0.5">${m.category}</p>
                                    </div>
                                    <p class="text-sm font-black text-slate-900 shrink-0 ml-2">₹${parseInt(m.price).toLocaleString()}</p>
                                </div>
                                ${m.imei||m.serial_number||m.mac_id||m.installation_date||m.extraFields&&m.extraFields.length>0?`
                                    <div class="bg-slate-50 border border-slate-100 rounded-xl p-3 mt-2">
                                        <div class="flex items-center gap-2 text-[8px] font-black text-slate-500 uppercase tracking-widest mb-2">
                                            <span class="material-icons-outlined text-xs">verified</span> Device Info
                                        </div>
                                        <div class="grid grid-cols-2 gap-2">
                                            ${m.imei?`
                                                <div>
                                                    <p class="text-[7px] font-bold text-slate-400 uppercase">IMEI</p>
                                                    <p class="text-[9px] font-black text-slate-700 tabular-nums">${m.imei}</p>
                                                </div>
                                            `:""}
                                            ${m.serial_number?`
                                                <div>
                                                    <p class="text-[7px] font-bold text-slate-400 uppercase">Serial</p>
                                                    <p class="text-[9px] font-black text-slate-700 tabular-nums">${m.serial_number}</p>
                                                </div>
                                            `:""}
                                            ${m.mac_id?`
                                                <div>
                                                    <p class="text-[7px] font-bold text-slate-400 uppercase">MAC ID</p>
                                                    <p class="text-[9px] font-black text-slate-700 tabular-nums">${m.mac_id}</p>
                                                </div>
                                            `:""}
                                            ${m.manufacturing_date?`
                                                <div>
                                                    <p class="text-[7px] font-bold text-slate-400 uppercase">Mfg. Date</p>
                                                    <p class="text-[9px] font-black text-slate-700 tabular-nums">${new Date(m.manufacturing_date).toLocaleDateString("en-GB",{month:"short",year:"numeric"})}</p>
                                                </div>
                                            `:""}
                                            ${(m.extraFields||[]).map(y=>`
                                                <div>
                                            ...
                                            ${m.installation_date?`
                                                <div class="col-span-2 pt-2 mt-2 border-t border-slate-200">
                                                    ...
                                                    <p class="text-[9px] font-black text-slate-700">${new Date(m.installation_date).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"})}</p>
                                                </div>
                                            `:""}
                                        </div>
                                    </div>
                    ...
                    ${o.paymentMode?`
                        <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                                    <span class="material-icons-outlined text-sm">${zd(o.paymentMode)}</span>
                                </div>
                                <div>
                                    <p class="text-[9px] font-black uppercase tracking-widest">Paid via ${Yd(o.paymentMode)}</p>
...
`;window.setRepairCustomer=(e,t)=>{p.repairContext={customer_name:e,customer_phone:t},D()};function Zd(){const e=document.getElementById("repair-search-input"),t=e?e.value.trim():"",s=window.getCache?window.getCache():{customers:[]},a=t?s.customers.filter(n=>n.name.toLowerCase().includes(t.toLowerCase())||n.phone.includes(t)):[];return`
    ...
    `}async function sp(e){if(p.activeRepairId)try{await A.repairs.updateStatus(p.activeRepairId,e),await Y()}catch(t){alert("Update failed: "+t.message)}}window.updateRepairStatus=sp;window._showReassignPicker||(window._showReassignPicker=!1);window._toggleReassignPicker=()=>{window._showReassignPicker=!window._showReassignPicker,window.triggerRender()};window._reassignRepair=async e=>{window._showReassignPicker=!1,window.toast&&window.toast.success(`Reassigned to ${e}`),window.triggerRender()};function ap(){const e=window.getCache(),t=e.repairs.find(n=>n.id===p.activeRepairId)||e.repairs[0];if(!t)return'<div class="p-20 text-center opacity-30 text-[10px] font-black uppercase">No active job selected</div>';const s=[{l:"Collected",s:"COLLECTED",i:"done"},{l:"Sent to Brand",s:"SENT_TO_BRAND",i:"shipping"},{l:"At Service Center",s:"IN_REPAIR",i:"build"},{l:"Ready for Pickup",s:"READY",i:"check_circle"},{l:"Handed Over",s:"COMPLETED",i:"person"}],a=s.findIndex(n=>n.s===t.status);return`
    ...
    `}function Pn(e){const t={search:{t:"RetailerOS",s:"Repairs Management",txn:null},intake:{t:"Device Intake",s:"Repair Management",txn:"TXN-4920"},status:{t:"Job ID: #REP-2024",s:"Repair Assignment",badge:"ACTIVE"},history:{t:"Job History",s:"Service Records",badge:null}},s={search:Zd(),intake:tp(),status:ap()};if(e==="desktop-primary")return`
        ...
        `;if(e==="desktop-secondary"){const i=p.repairViewMode==="search"?"status":p.repairViewMode,r=t[i],c=i==="intake"?`<span class="text-[8px] font-black text-slate-300 bg-slate-50 px-2 py-1 rounded">${r.txn}</span>`:`<span class="bg-slate-200 text-slate-600 text-[8px] font-black px-2 py-1 rounded-full">${r.badge}</span>`;return`
            ${Ja(r.t,r.s,c)}
            <div class="scrolling-content px-8 space-y-8 pb-12">
    ...
    `}window._marketingState||(window._marketingState={generatedImageUrl:null,generatedPrompt:null,isGenerating:!1,uploadedImages:[],currentSuggestions:[],lastError:null});const lp=["Diwali special offer poster for mobile phones under ₹15,000","New iPhone launch announcement for electronics store","Independence Day sale banner with 20% off on all appliances","Grand opening celebration poster for electronics showroom","EMI offer creative for Samsung Galaxy series smartphones","Navratri festive discount poster for home appliances","Back to school deals on laptops and tablets","Summer sale poster for air conditioners and coolers","Republic Day clearance sale for TVs and home theater","Raksha Bandhan gift guide for smartphones and watches","Year end stock clearance for washing machines and fridges","New store branch opening announcement poster","Cashback offer poster for credit card payments on electronics","Exchange offer creative for old phone trade-in program","Service center launch poster for mobile and laptop repairs","Holi celebration offer on phone cases and accessories","Wedding season deals on premium home appliances","Monsoon sale on waterproof gadgets and devices","Christmas and New Year electronics mega sale poster","Flash sale countdown poster for limited stock flagship phones"];function ip(){if(window._marketingState.currentSuggestions.length===0){const e=[...lp].sort(()=>Math.random()-.5);window._marketingState.currentSuggestions=e.slice(0,5)}return window._marketingState.currentSuggestions}window._refreshMarketingSuggestions=()=>{window._marketingState.currentSuggestions=[],window.triggerRender()};window._fillMarketingPrompt=e=>{const t=document.getElementById("marketing-prompt");t&&(t.value=e)};window._uploadMarketingImage=()=>{const e=document.createElement("input");e.type="file",e.accept="image/*",e.multiple=!0,e.onchange=t=>{Array.from(t.target.files).forEach(a=>{const n=new FileReader;n.onload=l=>{window._marketingState.uploadedImages.push({base64:l.target.result,name:a.name,size:(a.size/1024).toFixed(0)+" KB"}),window.triggerRender()},n.readAsDataURL(a)})},e.click()};window._removeMarketingImage=e=>{window._marketingState.uploadedImages.splice(e,1),window.triggerRender()};const rp="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";function sr(){return localStorage.getItem("openai_api_key")||rp}window._generateCreative=async()=>{var n,l,i,r,c,o,u;const e=sr(),t=document.getElementById("marketing-prompt"),s=(n=t==null?void 0:t.value)==null?void 0:n.trim();if(!s){window.toast&&window.toast.error("Enter a prompt to generate a creative");return}const a=window._marketingState;a.isGenerating=!0,a.lastError=null,a.generatedPrompt=s,window.triggerRender();try{let b=s;if(a.uploadedImages.length>0){const f=a.uploadedImages.map(g=>({type:"image_url",image_url:{url:g.base64,detail:"low"}})),x=await fetch("https://api.openai.com/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({model:"gpt-4o-mini",messages:[{role:"user",content:[{type:"text",text:`You are a marketing creative expert for an Indian electronics retail store. The user wants to create a marketing creative with this prompt: "${s}". They have uploaded reference images. Analyze the images and create an enhanced, detailed DALL-E prompt that incorporates visual elements from the images. Keep the Indian retail context. Output ONLY the enhanced prompt, nothing else. Max 200 words.`},...f]}],max_tokens:300})});x.ok&&(b=((r=(i=(l=(await x.json()).choices)==null?void 0:l[0])==null?void 0:i.message)==null?void 0:r.content)||s)}const m=`Create a professional marketing poster/creative for an Indian electronics retail store. Style: modern, clean, vibrant, professional. ${b}. The design should be suitable for social media, WhatsApp status, and print. Include bold typography if text is needed. Indian market context.`,y=await fetch("https://api.openai.com/v1/images/generations",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({model:"dall-e-3",prompt:m,n:1,size:"1024x1024",quality:"standard"})});if(!y.ok){const f=await y.json().catch(()=>({}));throw new Error(((c=f.error)==null?void 0:c.message)||`API error: ${y.status}`)}const w=await y.json();if(a.generatedImageUrl=((u=(o=w.data)==null?void 0:o[0])==null?void 0:u.url)||null,a.generatedPrompt=s,a.generatedImageUrl)window.toast&&window.toast.success("Creative generated!");else throw new Error("No image returned from API")}catch(b){console.error("Creative generation failed:",b),a.lastError=b.message,window.toast&&window.toast.error("Generation failed: "+b.message)}finally{a.isGenerating=!1,window.triggerRender()}};function kl(){sr();const e=window._marketingState,t=ip();return`
        ${np()}
    ...
    `}if(!window._promoterCheckIns)try{window._promoterCheckIns=JSON.parse(localStorage.getItem("promoter_checkins")||"{}")}catch{window._promoterCheckIns={}}window._togglePromoterCheckIn=(e,t)=>{t&&t.stopPropagation(),window._promoterCheckIns[e]=!window._promoterCheckIns[e],localStorage.setItem("promoter_checkins",JSON.stringify(window._promoterCheckIns)),window.toast&&window.toast.success(window._promoterCheckIns[e]?"Checked in":"Checked out"),window.triggerRender()};const cp=[{id:"P1",initials:"RS",name:"Rohan S.",role:"PREMIUM BRAND"},{id:"P2",initials:"AK",name:"Ananya K.",role:"STORE STAFF"},{id:"P3",initials:"VM",name:"Vikram M.",role:"ELECTRONICS PRO"},{id:"P4",initials:"SD",name:"Sarah D.",role:"AUDIO SPECIALIST"}];function dp(){const t=(window.getCache().teamMembers||[]).filter(n=>n.status==="active"),s=[...cp,...t.map(n=>({id:n.id,initials:n.name.split(" ").map(l=>l[0]).join("").slice(0,2).toUpperCase(),name:n.name,role:(n.role||"STAFF").toUpperCase()}))],a=s.filter(n=>window._promoterCheckIns[n.id]).length;return`
        ${op()}
    ...
    `}window._confirmPromoterHire=async()=>{var n,l,i,r,c,o,u;const e=(l=(n=document.getElementById("promoter-name"))==null?void 0:n.value)==null?void 0:l.trim(),t=(r=(i=document.getElementById("promoter-phone"))==null?void 0:i.value)==null?void 0:r.trim(),s=(o=(c=document.getElementById("promoter-hire-date"))==null?void 0:c.value)==null?void 0:o.trim(),a=(u=document.getElementById("promoter-brand"))==null?void 0:u.value;if(!e){window.toast&&window.toast.error("Full name is required");return}try{const b="TM-"+Math.random().toString(36).substr(2,8).toUpperCase();await A.teamMembers.add({id:b,name:e,role:a&&a!=="Select Brand"?`${a} Promoter`:"Store Staff",phone:t||null,email:null,status:"active",joined_at:s||new Date().toISOString().split("T")[0]});const m=(()=>{var f;const y=window.getCache(),w=localStorage.getItem("retaileros_retailer_id");return((f=y.retailers)==null?void 0:f.find(x=>x.id===w))||{}})();A.activityLogs.add({action:"team",detail:`Hired new promoter: ${e}`,user_name:m.contact_person||"Owner",icon:"person_add",color:"green"}),await Y(),window.toast&&window.toast.success(`${e} added to team`),window.setPromoterViewMode("list")}catch(b){console.error("Hire failed:",b),window.toast&&window.toast.error("Failed to add team member")}};function pp(){return`
    ...
    `}function qn(e){const t=e==="desktop-secondary";return window.setPromoterViewMode=s=>{p.promoterViewMode=s,D()},t?p.promoterViewMode==="onboarding"?pp():up():dp()}function xp(){return`
    ...
    `}function gp(){const t=(window.getCache?window.getCache():{products:[]}).products||[];return`
         <div class="h-full flex flex-col relative bg-white text-left">
            <!-- Header -->
    ...
    `}function Bn(e){const t=e==="desktop-secondary";return window.setInventoryTab=s=>{p.inventoryTab=s,D()},window.setInventoryMode=s=>{p.inventoryMode=s,D()},t?p.inventoryMode==="inward"?hp():gp():`
        <div class="h-full flex flex-col relative bg-white">
            ${xp()}
            ${p.inventoryTab==="brands"?fp():bp()}
        </div>
    ...
    `}function Cp(){var u;const e=(()=>{var y;const b=window.getCache(),m=localStorage.getItem("retaileros_retailer_id");return((y=b.retailers)==null?void 0:y.find(w=>w.id===m))||{}})(),s=((u=window.getCache().retailerSettings)==null?void 0:u.taxes)||{},a={gstin:s.gstin??e.vat_number??"",pan:s.pan??e.pan_number??"",registration_type:s.registration_type??"Regular",show_tax_breakdown:s.show_tax_breakdown??!0,tax_inclusive_pricing:s.tax_inclusive_pricing??!0,invoice_prefix:s.invoice_prefix??`${(e.retailer_code||"ROS").split("-")[0]}-INV-`,e_invoice_enabled:s.e_invoice_enabled??!1},n=s.gst_rates||{smartphones:18,laptops_tablets:18,audio_wearables:18,television:28,air_conditioners:28,appliances:28,accessories:18,services_repairs:18},l=s.hsn_codes||{mobile_phones:"8517",laptops:"8471",headphones_audio:"8518",television:"8528",air_conditioners:"8415",washing_machines:"8450",refrigerators:"8418",repair_services:"9987"},i=[0,5,12,18,28],r=[{label:"Smartphones",key:"smartphones"},{label:"Laptops & Tablets",key:"laptops_tablets"},{label:"Audio & Wearables",key:"audio_wearables"},{label:"Television",key:"television"},{label:"Air Conditioners",key:"air_conditioners"},{label:"Appliances (Washing Machine, Fridge)",key:"appliances"},{label:"Accessories & Cables",key:"accessories"},{label:"Services & Repairs",key:"services_repairs"}],c=[{label:"Mobile Phones",key:"mobile_phones"},{label:"Laptops",key:"laptops"},{label:"Headphones & Audio",key:"headphones_audio"},{label:"Television",key:"television"},{label:"Air Conditioners",key:"air_conditioners"},{label:"Washing Machines",key:"washing_machines"},{label:"Refrigerators",key:"refrigerators"},{label:"Repair Services",key:"repair_services"}],o=["Regular","Composition","Unregistered"];return window.saveTaxSettings=async function(){var y,w,f,x,g,E,C;const b=document.querySelector('[data-settings-category="taxes"]');if(!b)return;const m={gstin:((y=b.querySelector('[data-field="gstin"]'))==null?void 0:y.value)||"",pan:((w=b.querySelector('[data-field="pan"]'))==null?void 0:w.value)||"",registration_type:((f=b.querySelector('[data-field="registration_type"]'))==null?void 0:f.value)||"Regular",show_tax_breakdown:((x=b.querySelector('[data-field="show_tax_breakdown"]'))==null?void 0:x.checked)??!0,tax_inclusive_pricing:((g=b.querySelector('[data-field="tax_inclusive_pricing"]'))==null?void 0:g.checked)??!0,invoice_prefix:((E=b.querySelector('[data-field="invoice_prefix"]'))==null?void 0:E.value)||"ROS-INV-",e_invoice_enabled:((C=b.querySelector('[data-field="e_invoice_enabled"]'))==null?void 0:C.checked)??!1,gst_rates:{},hsn_codes:{}};b.querySelectorAll("[data-gst-key]").forEach($=>{const L=parseInt($.value);m.gst_rates[$.dataset.gstKey]=isNaN(L)?18:L}),b.querySelectorAll("[data-hsn-key]").forEach($=>{m.hsn_codes[$.dataset.hsnKey]=$.value});try{await A.settings.save("taxes",m),window._db_cache.retailerSettings||(window._db_cache.retailerSettings={}),window._db_cache.retailerSettings.taxes=m;const $=(()=>{var bt;const L=window.getCache(),J=localStorage.getItem("retaileros_retailer_id");return((bt=L.retailers)==null?void 0:bt.find(Xe=>Xe.id===J))||{}})();A.activityLogs.add({action:"settings",detail:"Updated tax configuration",user_name:$.contact_person||"Owner",icon:"percent",color:"slate"}),window.toast&&window.toast.success("Tax settings saved")}catch($){console.error("Failed to save tax settings:",$),window.toast&&window.toast.error("Failed to save tax settings")}},`
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-left">
                        ...
                        <div class="card p-3 text-left">
                            ...
                            <select data-field="registration_type" class="w-full text-sm font-bold text-slate-900 bg-transparent border-0 p-0 focus:outline-none">
                                ${o.map(b=>`<option ${a.registration_type===b?"selected":""}>${b}</option>`).join("")}
                            </select>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="flex items-center justify-between py-3 border-b border-slate-50 text-left">
                                <div class="flex items-center gap-3 text-left">
                                    <div class="w-8 h-8 bg-slate-50 rounded-lg flex items-center justify-center">
                                        <span class="text-[10px] font-black text-slate-500">${n[b.key]}%</span>
                                    </div>
                                    <p class="text-xs font-bold text-slate-900">${b.label}</p>
                                </div>
                                <select data-gst-key="${b.key}" class="px-3 py-1.5 bg-slate-50 border-0 rounded-lg text-[10px] font-black text-slate-700 focus:outline-none">
                                    ${i.map(m=>`<option value="${m}" ${n[b.key]===m?"selected":""}>${m===0?"0% (Exempt)":m+"% GST"}</option>`).join("")}
                                </select>
                            </div>
                        `).join("")}
                    </div>
                ...
                <div class="p-6 space-y-4 border-b border-dashed border-slate-200 text-left">
                    ...
                    <div class="card p-4 space-y-1 text-left">
                        ${c.map(b=>`
                            <div class="flex items-center justify-between py-3 border-b border-slate-50 text-left">
                                <p class="text-xs font-bold text-slate-900">${b.label}</p>
                                <input type="text" data-hsn-key="${b.key}" value="${l[b.key]}" class="w-20 text-right px-2 py-1 bg-slate-50 rounded-lg text-[10px] font-black text-slate-700 focus:outline-none focus:bg-white focus:ring-1 focus:ring-slate-200">
                            </div>
                        `).join("")}
                    </div>
                </div>
    ...
    `}function Ap(){const e=(()=>{var u;const c=window.getCache(),o=localStorage.getItem("retaileros_retailer_id");return((u=c.retailers)==null?void 0:u.find(b=>b.id===o))||{}})(),t=window.getCache(),s=t.teamMembers||[],a=t.teamRoles||[],n=s.length>0?s:[{id:"owner",name:e.contact_person||"Store Owner",role:"Owner",phone:e.mobile_number||"—",status:"active"}],l=a.length>0?a.map(c=>{let o=c.permissions;try{o=typeof o=="string"?JSON.parse(o):o}catch{o={}}return{...c,permissions:o,count:n.filter(u=>u.role===c.name).length}}):[{name:"Owner",count:n.filter(c=>c.role==="Owner").length||1,color:"slate",description:"Full access to all modules, settings & billing"},{name:"Store Manager",count:n.filter(c=>c.role==="Store Manager").length,color:"slate",description:"Sales, inventory, customers, reports. No billing or team settings"},{name:"Sales Executive",count:n.filter(c=>c.role==="Sales Executive").length,color:"slate",description:"New sales, customer lookup, inquiries. No reports or settings"},{name:"Technician",count:n.filter(c=>c.role==="Technician").length,color:"slate",description:"Repairs module only. View assigned jobs, update status"}],i=l.length>0?l.map(c=>c.name):["Owner","Store Manager","Sales Executive","Technician"];window._addTeamMember=async function(){const c=prompt("Team member name:");if(!c||!c.trim())return;const o=prompt("Phone number:"),u=prompt(`Role (${i.join(", ")}):`);if(!u)return;const b=`tm_${Date.now()}_${Math.random().toString(36).substr(2,6)}`;try{await A.teamMembers.add({id:b,name:c.trim(),role:u,phone:o||null,email:null,status:"invited"}),window._db_cache.teamMembers||(window._db_cache.teamMembers=[]),window._db_cache.teamMembers.push({id:b,name:c.trim(),role:u,phone:o,status:"invited"});const m=(()=>{var f;const y=window.getCache(),w=localStorage.getItem("retaileros_retailer_id");return((f=y.retailers)==null?void 0:f.find(x=>x.id===w))||{}})();A.activityLogs.add({action:"team",detail:`Added team member ${c.trim()}`,user_name:m.contact_person||"Owner",icon:"person_add",color:"slate"}),window.toast&&window.toast.success(`${c.trim()} invited`),window.setSettingsView&&window.setSettingsView("teams")}catch(m){console.error("Add member failed:",m),window.toast&&window.toast.error("Failed to add member")}},window._removeTeamMember=async function(c,o){if(confirm(`Remove ${o} from the team?`))try{await A.teamMembers.delete(c),window._db_cache.teamMembers&&(window._db_cache.teamMembers=window._db_cache.teamMembers.filter(b=>b.id!==c));const u=(()=>{var y;const b=window.getCache(),m=localStorage.getItem("retaileros_retailer_id");return((y=b.retailers)==null?void 0:y.find(w=>w.id===m))||{}})();A.activityLogs.add({action:"team",detail:`Removed team member ${o}`,user_name:u.contact_person||"Owner",icon:"person_remove",color:"slate"}),window.toast&&window.toast.success(`${o} removed`),window.setSettingsView&&window.setSettingsView("teams")}catch(u){console.error("Remove member failed:",u),window.toast&&window.toast.error("Failed to remove member")}};const r={Owner:"slate","Store Manager":"slate","Sales Executive":"slate",Technician:"slate"};return`
        <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
                <div class="flex items-center justify-between mb-2 text-left">
                    <button onclick="window.setSettingsView(null)" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors">
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar text-left">
                ...
                <div class="p-6 space-y-4 border-b border-dashed border-slate-200 text-left">
                    ...
                    <div class="space-y-3 text-left">
                        ${l.map(c=>{const o=c.color||r[c.name]||"slate",u=c.description||(typeof c.permissions=="object"?Object.keys(c.permissions).join(", "):String(c.permissions||"")),b=c.count||0;return`
                            <div class="card p-4 text-left hover:border-slate-300 transition-all cursor-pointer" onclick="window.toast.info('Role editor coming soon')">
                                <div class="flex items-center justify-between mb-2 text-left">
                                    ...
                                    <span class="text-[8px] font-black text-slate-400 uppercase tracking-widest">${b} member${b!==1?"s":""}</span>
                                </div>
    ...
    `}function Dp(){var l,i,r,c,o,u,b;const e=window.getCache(),t={customers:((l=e.customers)==null?void 0:l.length)||0,sales:((i=e.sales)==null?void 0:i.length)||0,products:((r=e.products)==null?void 0:r.length)||0,automations:((c=e.automations)==null?void 0:c.length)||0,repairs:((o=e.repairs)==null?void 0:o.length)||0,inquiries:((u=e.inquiries)==null?void 0:u.length)||0},s=Object.values(t).reduce((m,y)=>m+y,0),a=((b=e.retailerSettings)==null?void 0:b.backup)||{},n={auto_backup_enabled:a.auto_backup_enabled??!0,backup_frequency:a.backup_frequency??"Weekly",send_to_email:a.send_to_email??!0,retention_period:a.retention_period??"90 days",export_format:a.export_format??"CSV (Excel-compatible)"};return`
        <div class="h-full flex flex-col relative bg-white animate-slide-up text-left" data-settings-category="backup">
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar text-left">
                ...
                <div class="p-6 space-y-4 border-b border-dashed border-slate-200 text-left">
                    ...
                    <div class="space-y-2 text-left">
                        ${[{date:"Feb 6, 2026 — 3:00 AM",size:"2.4 MB",type:"Auto",status:"success"},{date:"Jan 30, 2026 — 3:00 AM",size:"2.1 MB",type:"Auto",status:"success"},{date:"Jan 23, 2026 — 11:30 AM",size:"1.8 MB",type:"Manual",status:"success"}].map(m=>`
                            <div class="flex items-center justify-between py-3 border-b border-slate-50 text-left">
                                <div class="flex items-center gap-3 text-left">
                                    <span class="material-icons-outlined text-slate-500 text-sm">cloud_done</span>
                                    <div class="text-left">
                                        <p class="text-[10px] font-bold text-slate-900">${m.date}</p>
                                        <p class="text-[8px] font-bold text-slate-400">${m.size} &middot; ${m.type}</p>
                                    </div>
                                </div>
...
`),i=new Blob([l],{type:"text/csv"}),r=URL.createObjectURL(i),c=document.createElement("a");c.href=r,c.download=`${e}_scheme_transactions.csv`,c.click(),URL.revokeObjectURL(r),window.toast&&window.toast.success("CSV downloaded")};function qp(e){const t=e==="mobile",s=p.activeScheme;if(!s)return'<div class="p-10 text-center">Select a scheme to view details</div>';const n=((window.getCache?window.getCache():{sales:[]}).sales||[]).filter(u=>{const b=u.product_name||"",m=typeof s=="object"&&s.brand?s.brand:"";return b.includes(m)||u.items&&u.items.some(y=>(y.name||"").includes(m))}),l=typeof s=="object"&&s.brand?s.brand:s,i=typeof s=="object"&&s.name?s.name:"Scheme",r=typeof s=="object"&&s.payout?s.payout:"0",c=typeof s=="object"&&s.end_date?s.end_date:new Date,o={count:n.length,growth:"+0%",color:"bg-slate-950"};return`
    ...
    `}window._publishCampaign=()=>{var n,l,i,r,c,o,u,b;const e=(l=(n=document.getElementById("pb-title"))==null?void 0:n.value)==null?void 0:l.trim();if((r=(i=document.getElementById("pb-product"))==null?void 0:i.value)==null||r.trim(),(o=(c=document.getElementById("pb-deposit"))==null?void 0:c.value)==null||o.trim(),(b=(u=document.getElementById("pb-duration"))==null?void 0:u.value)==null||b.trim(),!e){window.toast&&window.toast.error("Enter a campaign title");return}const t=(e||"campaign").toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,""),a=`https://store.retaileros.in/${localStorage.getItem("retaileros_retailer_code")||"store"}/prebook/${t}`;navigator.clipboard.writeText(a).then(()=>{window.toast&&window.toast.success("Campaign published! Link copied to clipboard")}).catch(()=>{window.toast&&window.toast.success("Campaign published!")}),window.setPreBookingViewMode("dashboard")};function Xp(e){return`
        <div class="h-full flex flex-col bg-white dot-grid relative animate-slide-up text-left">
            ...
            <div class="flex-1 overflow-y-auto px-4 sm:px-6 py-6 space-y-6 text-left">
                ...
                ${Re?`
                    <div class="space-y-3 text-left">
                        ...
                        `:`
                            <div class="space-y-2 max-h-48 overflow-y-auto">
                                ${n.map(o=>{var m;const u=(t.saleItems||[]).filter(y=>y.sale_id===o.id),b=ke===o.id;return`
                                        <button type="button" onclick="window.selectAutomationSale('${o.id}')" class="card p-4 w-full text-left transition-all ${b?"border-2 border-slate-900 shadow-lg":"hover:border-slate-300"}">
                                            <div class="flex justify-between items-start">
                                                <div class="text-left">
                                                    <p class="text-xs font-black text-slate-900">${((m=u[0])==null?void 0:m.product_name)||"Sale"}</p>
                                            ...
                                            ${b?'<span class="material-icons-outlined text-slate-900 text-sm mt-2">check_circle</span>':""}
                                        </button>
                                    `}).join("")}
                            </div>
                        `}
    ...
    `}window.sendAutomationMessage=async e=>{var t,s,a,n,l;try{const i=window.getCache(),r=(t=i.automationMessages)==null?void 0:t.find(f=>f.id===e),c=(s=i.automations)==null?void 0:s.find(f=>f.id===(r==null?void 0:r.automation_id)),o=(a=i.customers)==null?void 0:a.find(f=>f.id===(c==null?void 0:c.customer_id));if(!r||!c){window.toast.error("Message not found");return}if(!(o!=null&&o.phone)){window.toast.error("Customer phone number not found");return}window.toast.info("Sending WhatsApp message...");const b=((l=(((n=i.saleItems)==null?void 0:n.filter(f=>f.sale_id===c.sale_id))||[])[0])==null?void 0:l.product_name)||"your product",m=r.content.replace(/\{product\}/g,b).replace(/\{name\}/g,o.name.split(" ")[0]);let y="sent",w=null;try{w=await window.sendWhatsAppMessage(o.phone,m),w.success?(y="delivered",window.toast.success("WhatsApp message sent!")):(y="failed",window.toast.warning("Message queued but may not have been delivered"))}catch(f){console.error("WATI Error:",f),y="failed",window.toast.error("WhatsApp send failed: "+f.message)}await A.automations.updateMessageStatus(e,y==="failed"?"pending":"sent",new Date().toISOString()),await A.communications.add({id:`COMM-${Math.random().toString(36).substr(2,8).toUpperCase()}`,customer_id:c.customer_id,type:"whatsapp",direction:"outgoing",content:m,sent_at:new Date().toISOString(),automation_id:c.id,sale_id:c.sale_id,status:y}),await Y()}catch(i){console.error("Error sending message:",i),window.toast.error("Failed to send message: "+i.message)}};window.toggleAutomationStatus=async e=>{var t;try{const a=(t=window.getCache().automations)==null?void 0:t.find(l=>l.id===e);if(!a)return;const n=a.status==="active"?"paused":"active";await A.automations.update(e,{status:n}),await Y(),window.toast.success(`Automation ${n==="active"?"resumed":"paused"}`)}catch(s){console.error("Error toggling automation:",s),window.toast.error("Failed to update automation")}};window.deleteAutomation=async e=>{window.showConfirm("Are you sure you want to delete this automation? All scheduled messages will be cancelled.",async()=>{try{await A.automations.deleteMessages(e),await A.automations.delete(e),await Y(),window.toast.success("Automation deleted"),window.setAutomationMode("dashboard")}catch(t){console.error("Error deleting automation:",t),window.toast.error("Failed to delete automation")}})};window.openWhatsAppMessage=(e,t)=>{const s=`https://wa.me/${(e==null?void 0:e.replace(/\D/g,""))||""}?text=${encodeURIComponent(t)}`;window.open(s,"_blank")};function $l(e,t=!1){var b,m,y;const s=window.getCache(),a=(b=s.automations)==null?void 0:b.find(w=>w.id===e);if(!a)return`
            <div class="h-full flex items-center justify-center text-slate-300 text-center">
                <div class="text-center">
            ...
            <div class="flex-1 overflow-y-auto px-4 sm:px-6 py-6 space-y-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="relative pl-8 space-y-4 before:absolute before:left-3 before:top-4 before:bottom-4 before:w-px before:bg-slate-200">
                        ${n.map((w,f)=>{const x=u(w.message_type),g=w.status==="sent",E=new Date(w.scheduled_date).toDateString()===new Date().toDateString();return new Date(w.scheduled_date)<new Date,`
                                <div class="relative">
                                    ...
                                    <div class="card p-4 ${g?"bg-slate-50 border-slate-100":E?"border-slate-900 shadow-lg":"border-slate-100"}">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center justify-between mb-1">
                                                    <span class="text-[8px] font-black ${g?"text-slate-400":E?"text-slate-900":"text-slate-400"} uppercase">
                                                        Day ${w.day_offset} • ${w.message_type}
                                                    </span>
                                                    <span class="text-[8px] font-bold ${g?"text-slate-400":E?"text-slate-900":"text-slate-300"}">
                                                        ${g?"Sent":E?"Today":new Date(w.scheduled_date).toLocaleDateString("en-GB",{day:"2-digit",month:"short"})}
                                                    </span>
                                                </div>
    ...
    `}function Wn(e){const t=e==="mobile",s=e==="desktop-secondary";return window.setAutomationMode=(a,n=null)=>{p.automationViewMode=a,n!==null&&(p.activeAutomationId=n),D()},s?p.automationViewMode==="create"?Sl():p.automationViewMode==="details"&&p.activeAutomationId?$l(p.activeAutomationId):`
        ...
        `:t&&p.automationViewMode==="create"?Sl(!0):t&&p.automationViewMode==="details"?$l(p.activeAutomationId,!0):tu()}function su(){const t=window.getCache().storeOrders||[],s=t.filter(n=>n.order_status==="pending"||n.order_status==="confirmed").length,a=t.filter(n=>n.order_status==="confirmed").length;return`
        <header class="p-4 sm:p-8 pb-4 shrink-0">
            <div class="flex items-center justify-between mb-6">
                <button type="button" onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors">
                    <span class="material-icons-outlined">chevron_left</span>
    ...
    `}function au(e){const t=window.getCache(),s=t.storeListings||[],a=t.storeOrders||[],n=t.storeOrderItems||[],l=localStorage.getItem("retaileros_retailer_id"),i=(t.retailers||[]).find($=>$.id===l)||{},c=`https://store.retaileros.in/${localStorage.getItem("retaileros_retailer_code")||"your-store"}`,o=s.filter($=>$.status==="active").length,u=a.length,m=a.filter($=>$.order_status==="delivered").reduce(($,L)=>$+(parseInt(L.total_amount)||0),0),y=a.filter($=>$.order_status==="pending").length,w=a.filter($=>$.order_status==="confirmed").length,f=a.filter($=>$.order_status==="shipped").length,x=a.slice(0,5),g={};n.forEach($=>{const L=$.product_name||"Unknown";g[L]=(g[L]||0)+($.quantity||1)});const E=Object.entries(g).sort(($,L)=>L[1]-$[1]).slice(0,3);window._copyStoreUrl=async()=>{try{await navigator.clipboard.writeText(c),window.toast&&window.toast.success("Store URL copied!")}catch{window.toast&&window.toast.error("Failed to copy")}};const C=$=>{switch($){case"pending":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-200 text-slate-600">Pending</span>';case"confirmed":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-300 text-slate-700">Confirmed</span>';case"shipped":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-300 text-slate-700">Shipped</span>';case"delivered":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-900 text-white">Delivered</span>';case"cancelled":return'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-full bg-slate-100 text-slate-400">Cancelled</span>';default:return""}};return`
        <div class="scrolling-content px-4 sm:px-8 space-y-6 pb-12 text-left flex-1 overflow-y-auto">
            ...
            <div class="grid grid-cols-2 gap-3 text-left">
                ...
                <div class="card p-4 text-left">
                    ...
                    <p class="text-2xl font-black text-slate-900 tracking-tighter">${m>0?"₹"+m.toLocaleString():"₹0"}</p>
            ...
            ${E.length>0?`
                <section class="space-y-3 text-left">
                    ...
                    <div class="card p-4 space-y-3">
                        ${E.map(([$,L],J)=>`
                            <div class="flex items-center justify-between ${J<E.length-1?"pb-3 border-b border-slate-50":""} text-left">
                                <div class="flex items-center gap-3 text-left">
    ...
    `}function nu(e){const s=window.getCache().storeListings||[],a=s.filter(i=>i.status==="active").length,n=s.filter(i=>i.status==="draft").length;s.filter(i=>i.status==="inactive").length;const l=i=>{switch(i){case"active":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-900 text-white">Active</span>';case"draft":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-200 text-slate-600">Draft</span>';case"inactive":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-100 text-slate-400">Inactive</span>';default:return""}};return window._deleteStoreListing=async(i,r)=>{if(confirm(`Remove "${r}" from your store?`))try{await A.storeListings.delete(i),window._db_cache.storeListings&&(window._db_cache.storeListings=window._db_cache.storeListings.filter(o=>o.id!==i));const c=(()=>{var b;const o=window.getCache(),u=localStorage.getItem("retaileros_retailer_id");return((b=o.retailers)==null?void 0:b.find(m=>m.id===u))||{}})();A.activityLogs.add({action:"store",detail:`Removed listing: ${r}`,user_name:c.contact_person||"Owner",icon:"remove_shopping_cart",color:"red"}),window.toast&&window.toast.success("Listing removed"),window.triggerRender()}catch(c){console.error("Delete listing failed:",c),window.toast&&window.toast.error("Failed to remove listing")}},window._toggleListingStatus=async(i,r)=>{const c=r==="active"?"inactive":"active";try{const o=s.find(b=>b.id===i);if(!o)return;await A.storeListings.update(i,{listing_price:o.listing_price,description:o.description,status:c,stock_qty:o.stock_qty});const u=window._db_cache.storeListings.findIndex(b=>b.id===i);u>=0&&(window._db_cache.storeListings[u].status=c),window.toast&&window.toast.success(c==="active"?"Listing activated":"Listing deactivated"),window.triggerRender()}catch(o){console.error("Toggle listing failed:",o),window.toast&&window.toast.error("Failed to update listing")}},`
    ...
    `}function El(){const e=window.getCache(),t=e.products||[],a=(e.storeListings||[]).map(l=>l.product_id),n=t.filter(l=>!a.includes(l.id));return window._saveStoreListing=async()=>{var y,w,f,x,g;const l=document.getElementById("add-listing-form");if(!l)return;const i=(y=l.querySelector('[data-field="product_id"]'))==null?void 0:y.value;if(!i){window.toast&&window.toast.error("Select a product");return}const r=t.find(E=>E.id===i);if(!r)return;const c=parseFloat((w=l.querySelector('[data-field="listing_price"]'))==null?void 0:w.value)||r.mop||r.price,o=((f=l.querySelector('[data-field="description"]'))==null?void 0:f.value)||"",u=parseInt((x=l.querySelector('[data-field="stock_qty"]'))==null?void 0:x.value)||0,b=((g=l.querySelector('[data-field="status"]'))==null?void 0:g.value)||"draft",m=`sl_${Date.now()}_${Math.random().toString(36).substr(2,6)}`;try{await A.storeListings.add({id:m,product_id:r.id,product_name:r.name,brand:r.brand,category:r.category,base_price:r.price,listing_price:c,description:o,status:b,stock_qty:u}),window._db_cache.storeListings||(window._db_cache.storeListings=[]),window._db_cache.storeListings.unshift({id:m,product_id:r.id,product_name:r.name,brand:r.brand,category:r.category,base_price:r.price,listing_price:c,description:o,status:b,stock_qty:u,created_at:new Date().toISOString()});const E=(()=>{var L;const C=window.getCache(),$=localStorage.getItem("retaileros_retailer_id");return((L=C.retailers)==null?void 0:L.find(J=>J.id===$))||{}})();A.activityLogs.add({action:"store",detail:`Listed product: ${r.name}`,user_name:E.contact_person||"Owner",icon:"add_shopping_cart",color:"green"}),window.toast&&window.toast.success("Product listed on store"),window.setMyStoreViewMode("list")}catch(E){console.error("Save listing failed:",E),window.toast&&window.toast.error("Failed to save listing")}},window._onProductSelect=l=>{const i=t.find(o=>o.id===l.value);if(!i)return;const r=document.querySelector('[data-field="listing_price"]'),c=document.querySelector('[data-field="stock_qty"]');r&&(r.value=i.mop||i.price||0),c&&(c.value=i.in_stock||0)},`
    ...
    `}function lu(){const e=window.getCache(),s=(e.storeListings||[]).find(o=>o.id===p.activeListingId);if(!s)return`<div class="h-full flex items-center justify-center text-slate-300">
        ...
        </div>`;const a=o=>{switch(o){case"active":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-900 text-white">Active</span>';case"draft":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-200 text-slate-600">Draft</span>';case"inactive":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-100 text-slate-400">Inactive</span>';default:return""}},l=(e.storeOrderItems||[]).filter(o=>o.listing_id===s.id),i=l.reduce((o,u)=>o+(u.quantity||1),0),r=l.reduce((o,u)=>o+(parseInt(u.final_price)||0),0);window._saveListingEdit=async()=>{const o=document.getElementById("edit-listing-price"),u=document.getElementById("edit-listing-desc"),b=document.getElementById("edit-listing-stock");if(o)try{await A.storeListings.update(s.id,{listing_price:parseInt(o.value)||s.listing_price,description:u.value||s.description,status:s.status,stock_qty:parseInt(b.value)||s.stock_qty});const m=window._db_cache.storeListings.findIndex(y=>y.id===s.id);m>=0&&(window._db_cache.storeListings[m].listing_price=parseInt(o.value)||s.listing_price,window._db_cache.storeListings[m].description=u.value||s.description,window._db_cache.storeListings[m].stock_qty=parseInt(b.value)||s.stock_qty),window.toast&&window.toast.success("Listing updated"),window.triggerRender()}catch(m){console.error("Save listing edit failed:",m),window.toast&&window.toast.error("Failed to save")}};const c=o=>o?new Date(o).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"}):"—";return`
    ...
    `}function iu(e){const t=window.getCache(),s=t.storeOrders||[],a=t.storeOrderItems||[];window._storeOrderFilter=window._storeOrderFilter||"all",window._setOrderFilter=u=>{window._storeOrderFilter=u,window.triggerRender()};const n=window._storeOrderFilter,l=n==="all"?s:s.filter(u=>u.order_status===n),i={all:s.length,pending:s.filter(u=>u.order_status==="pending").length,confirmed:s.filter(u=>u.order_status==="confirmed").length,shipped:s.filter(u=>u.order_status==="shipped").length,delivered:s.filter(u=>u.order_status==="delivered").length,cancelled:s.filter(u=>u.order_status==="cancelled").length},r=u=>{switch(u){case"pending":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-200 text-slate-600">Pending</span>';case"confirmed":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-300 text-slate-700">Confirmed</span>';case"shipped":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-300 text-slate-700">Shipped</span>';case"delivered":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-900 text-white">Delivered</span>';case"cancelled":return'<span class="text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-full bg-slate-100 text-slate-400">Cancelled</span>';default:return""}},c=u=>u==="paid"?'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded bg-slate-900 text-white">Paid</span>':u==="failed"?'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded bg-slate-100 text-slate-400">Failed</span>':'<span class="text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded bg-slate-200 text-slate-600">COD</span>';return window._createTestOrder=async()=>{const b=(window.getCache().storeListings||[]).filter(C=>C.status==="active");if(b.length===0){window.toast&&window.toast.error("No active listings to order from");return}const m=b[0],y=`so_${Date.now()}_${Math.random().toString(36).substr(2,6)}`,w=`WEB-${new Date().toISOString().slice(0,10).replace(/-/g,"")}-${String(s.length+1).padStart(4,"0")}`,f=["Aarav Patel","Sneha Gupta","Rohan Mehta","Kavya Sharma","Vikram Singh"],x=["Mumbai","Delhi","Bangalore","Pune","Chennai"],g=f[Math.floor(Math.random()*f.length)],E=x[Math.floor(Math.random()*x.length)];try{const C={id:y,order_number:w,customer_name:g,customer_phone:"98"+Math.floor(1e7+Math.random()*9e7),customer_email:g.split(" ")[0].toLowerCase()+"@gmail.com",shipping_address_line1:Math.floor(100+Math.random()*900)+", Sector "+Math.floor(1+Math.random()*30),shipping_city:E,shipping_state:E==="Mumbai"?"Maharashtra":E==="Delhi"?"Delhi":E==="Bangalore"?"Karnataka":E==="Pune"?"Maharashtra":"Tamil Nadu",shipping_pincode:String(1e5+Math.floor(Math.random()*5e5)),order_date:new Date().toISOString(),total_amount:m.listing_price,order_status:"pending",payment_status:Math.random()>.3?"paid":"pending",payment_mode:Math.random()>.5?"online":"cod"};await A.storeOrders.add(C);const $=`soi_${Date.now()}_${Math.random().toString(36).substr(2,6)}`;await A.storeOrders.addItem({id:$,order_id:y,listing_id:m.id,product_id:m.product_id,product_name:m.product_name,category:m.category,quantity:1,unit_price:m.listing_price,final_price:m.listing_price}),window._db_cache.storeOrders||(window._db_cache.storeOrders=[]),window._db_cache.storeOrders.unshift(C),window._db_cache.storeOrderItems||(window._db_cache.storeOrderItems=[]),window._db_cache.storeOrderItems.push({id:$,order_id:y,listing_id:m.id,product_id:m.product_id,product_name:m.product_name,category:m.category,quantity:1,unit_price:m.listing_price,discount_amount:0,final_price:m.listing_price}),A.activityLogs.add({action:"store",detail:`New online order ${w} from ${g}`,user_name:"System",icon:"shopping_bag",color:"blue"}),window.toast&&window.toast.success(`Test order ${w} created`),window.triggerRender()}catch(C){console.error("Create test order failed:",C),window.toast&&window.toast.error("Failed to create test order")}},`
        <div class="scrolling-content px-4 sm:px-8 space-y-6 pb-12 text-left flex-1 overflow-y-auto">
            ...
            `:`
                <section class="space-y-3 text-left">
                    ${l.map(u=>{const b=a.filter(w=>w.order_id===u.id),m=b[0]?b[0].product_name:"Order items",y=b.length>1?`+ ${b.length-1} more`:"";return`
                            <button type="button" onclick="window.setActiveStoreOrder('${u.id}')" class="card p-4 sm:p-5 border-2 transition-all cursor-pointer text-left w-full ${p.activeStoreOrderId===u.id?"border-slate-900 shadow-lg":"border-transparent hover:border-slate-200"}">
                                ...
                                <div class="space-y-1 text-left">
                                    <p class="text-[10px] font-bold text-slate-500 uppercase truncate text-left">${m} ${y}</p>
                                    <div class="flex items-center justify-between text-left">
    ...
    `}function ru(e){switch(e){case"cash":case"cod":return"payments";case"card":return"credit_card";case"upi":return"qr_code";case"online":return"language";default:return"account_balance_wallet"}}function ou(e){switch(e){case"cash":case"cod":return"Cash on Delivery";case"card":return"Card";case"upi":return"UPI";case"online":return"Online Payment";default:return"Payment"}}function Il(){const e=window.getCache(),t=e.storeOrders||[],s=e.storeOrderItems||[],a=t.find(f=>f.id===p.activeStoreOrderId);if(!a)return`<div class="h-full flex items-center justify-center text-slate-300">
        ...
        </div>`;const n=s.filter(f=>f.order_id===a.id),l=a.order_status==="cancelled",i=a.order_status==="delivered",r=a.payment_status==="paid",c=parseInt(a.total_amount)||0,o=c/1.18,u=c-o,b=["pending","confirmed","shipped","delivered"],m=b.indexOf(a.order_status),y=f=>f?new Date(f).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"}):"—",w=f=>f?new Date(f).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!0}):"";return window._confirmOrder=async f=>{try{await A.storeOrders.updateStatus(f,"confirmed");const x=window._db_cache.storeOrders.findIndex(E=>E.id===f);x>=0&&(window._db_cache.storeOrders[x].order_status="confirmed");const g=(()=>{var $;const E=window.getCache(),C=localStorage.getItem("retaileros_retailer_id");return(($=E.retailers)==null?void 0:$.find(L=>L.id===C))||{}})();A.activityLogs.add({action:"store",detail:`Confirmed order ${a.order_number}`,user_name:g.contact_person||"Owner",icon:"check_circle",color:"blue"}),window.toast&&window.toast.success("Order confirmed"),window.triggerRender()}catch(x){console.error("Confirm order failed:",x),window.toast&&window.toast.error("Failed to confirm order")}},window._shipOrder=async f=>{var C,$;const x=document.getElementById("shipping-form"),g=((C=x==null?void 0:x.querySelector('[data-field="tracking_number"]'))==null?void 0:C.value)||"",E=(($=x==null?void 0:x.querySelector('[data-field="courier_name"]'))==null?void 0:$.value)||"";if(!g){window.toast&&window.toast.error("Enter tracking number");return}if(!E){window.toast&&window.toast.error("Enter courier name");return}try{const L=new Date().toISOString();await A.storeOrders.updateStatus(f,"shipped",{tracking_number:g,courier_name:E,shipped_date:L});const J=window._db_cache.storeOrders.findIndex(Xe=>Xe.id===f);J>=0&&(window._db_cache.storeOrders[J].order_status="shipped",window._db_cache.storeOrders[J].tracking_number=g,window._db_cache.storeOrders[J].courier_name=E,window._db_cache.storeOrders[J].shipped_date=L);const bt=(()=>{var M;const Xe=window.getCache(),xe=localStorage.getItem("retaileros_retailer_id");return((M=Xe.retailers)==null?void 0:M.find(Dt=>Dt.id===xe))||{}})();A.activityLogs.add({action:"store",detail:`Shipped order ${a.order_number} via ${E}`,user_name:bt.contact_person||"Owner",icon:"local_shipping",color:"purple"}),window.toast&&window.toast.success("Order marked as shipped"),window.triggerRender()}catch(L){console.error("Ship order failed:",L),window.toast&&window.toast.error("Failed to update shipping")}},window._deliverOrder=async f=>{try{const x=new Date().toISOString(),g=`sale_${Date.now()}_${Math.random().toString(36).substr(2,6)}`;await A.sales.add({id:g,customer_id:null,customer_name:a.customer_name,date:x,total_amount:a.total_amount,status:"completed",payment_mode:a.payment_mode==="cod"?"cash":a.payment_mode==="upi"?"upi":"card",payment_reference:a.payment_reference||a.order_number,gst_required:0,company_id:null,installation_required:0,installation_date:null,source:"online"});for(const C of n){const $=`si_${Date.now()}_${Math.random().toString(36).substr(2,6)}`;await A.sales.addItem({id:$,sale_id:g,product_id:C.product_id,product_name:C.product_name,category:C.category||null,quantity:C.quantity,price:C.unit_price,discount_type:null,discount_value:0,discount_amount:C.discount_amount||0,scheme_id:null,final_price:C.final_price,imei:null,serial_number:null,mac_id:null,manufacturing_date:null,installation_date:null,extra_fields:null})}await A.storeOrders.updateStatus(f,"delivered",{delivered_date:x,sale_id:g,payment_status:"paid"}),await Y();const E=(()=>{var L;const C=window.getCache(),$=localStorage.getItem("retaileros_retailer_id");return((L=C.retailers)==null?void 0:L.find(J=>J.id===$))||{}})();A.activityLogs.add({action:"store",detail:`Order ${a.order_number} delivered & invoice created`,user_name:E.contact_person||"Owner",icon:"check_circle",color:"green"}),window.toast&&window.toast.success("Order delivered & sale recorded")}catch(x){console.error("Deliver order failed:",x),window.toast&&window.toast.error("Failed to mark as delivered")}},window._cancelOrder=async f=>{if(confirm("Cancel this order?"))try{await A.storeOrders.updateStatus(f,"cancelled");const x=window._db_cache.storeOrders.findIndex(E=>E.id===f);x>=0&&(window._db_cache.storeOrders[x].order_status="cancelled");const g=(()=>{var $;const E=window.getCache(),C=localStorage.getItem("retaileros_retailer_id");return(($=E.retailers)==null?void 0:$.find(L=>L.id===C))||{}})();A.activityLogs.add({action:"store",detail:`Cancelled order ${a.order_number}`,user_name:g.contact_person||"Owner",icon:"cancel",color:"red"}),window.toast&&window.toast.success("Order cancelled"),window.triggerRender()}catch(x){console.error("Cancel order failed:",x),window.toast&&window.toast.error("Failed to cancel order")}},window._shareOrderWhatsApp=()=>{let f=`ORDER #${a.order_number}
`;f+=`━━━━━━━━━━━━━━━━━━━━
`,f+=`${y(a.order_date)}
...
Powered by RetailerOS`,window.open(`https://wa.me/?text=${encodeURIComponent(f)}`,"_blank")},window._printOrder=()=>{window.print()},`
                ...
                <div class="flex items-center justify-between mb-6 px-2">
                    ${b.map((f,x)=>`
                        <div class="flex flex-col items-center gap-1">
                            <div class="w-6 h-6 rounded-full flex items-center justify-center text-[10px] ${x<=m?"bg-slate-900 text-white":"bg-slate-100 text-slate-300"}">
                                ${x<=m?'<span class="material-icons-outlined text-xs">check</span>':'<span class="material-icons-outlined text-xs">circle</span>'}
                            </div>
                            <p class="text-[6px] font-black uppercase tracking-widest ${x<=m?"text-slate-700":"text-slate-300"}">${f}</p>
                        </div>
                        ${x<b.length-1?`<div class="flex-1 h-0.5 mx-1 ${x<m?"bg-slate-900":"bg-slate-100"}"></div>`:""}
                    `).join("")}
                </div>
            `}
    ...
    `}function cu(e){const t=window.getCache(),s=t.storeOrders||[],a=t.storeOrderItems||[],n=s.filter(c=>c.order_status==="confirmed"),l=s.filter(c=>c.order_status==="shipped"),i=s.filter(c=>c.order_status==="delivered"),r=(c,o)=>{const u=a.filter(m=>m.order_id===c.id),b=u[0]?u[0].product_name:"Order items";return`
            <button type="button" onclick="window.setActiveStoreOrder('${c.id}')" class="card p-4 border-2 transition-all cursor-pointer text-left w-full ${p.activeStoreOrderId===c.id?"border-slate-900 shadow-lg":"border-transparent hover:border-slate-200"}">
                ...
                <div class="flex items-center justify-between text-left">
                    <p class="text-[10px] font-bold text-slate-500 truncate">${b}</p>
    ...
    `}function zn(e){const t=e==="mobile";if(e==="desktop-secondary"){if(p.myStoreViewMode==="order-detail"&&p.activeStoreOrderId)return Il();if(p.myStoreViewMode==="add-listing")return El();if(p.activeListingId&&p.myStoreTab==="listings")return lu();if(p.myStoreTab==="dashboard"){const l=window.getCache().storeListings||[];return`<div class="h-full flex flex-col p-6 sm:p-8 text-left">
                <div class="text-center border-b border-dashed border-slate-200 pb-6 mb-6">
        ...
        </div>`}if(t){if(p.myStoreViewMode==="order-detail"&&p.activeStoreOrderId)return Il();if(p.myStoreViewMode==="add-listing")return El()}const a=()=>{switch(p.myStoreTab){case"dashboard":return au();case"orders":return iu();case"shipping":return cu();default:return nu()}};return`
        <div class="h-full flex flex-col relative bg-white">
            ${su()}
            ${a()}
        </div>
    `}function Yn(){const e=window.getCache(),t=[],s=new Date,a=(e.storeOrders||[]).filter(x=>x.order_status==="pending");if(a.length>0){const x=e.storeOrderItems||[];t.push({key:"store-orders",icon:"local_shipping",title:"Pending Orders",subtitle:`${a.length} order${a.length!==1?"s":""} awaiting action`,items:a.map(g=>{const E=x.filter(L=>L.order_id===g.id),C=E[0],$=g.created_at?new Date(g.created_at).toLocaleDateString("en-GB",{day:"2-digit",month:"short",hour:"2-digit",minute:"2-digit"}):"";return{id:g.id,primary:g.customer_name||"Walk-in Customer",secondary:C?`${C.product_name}${E.length>1?` +${E.length-1} more`:""}`:`Order #${g.order_number||g.id}`,amount:`₹${Number(g.total_amount||0).toLocaleString()}`,date:$,status:"Pending",actions:[{label:"View Order",icon:"visibility",handler:()=>{window.setMyStoreTab("orders"),window.setActiveStoreOrder(g.id),window.setApp("mystore")}}]}})})}const n=e.products||[],l=e.inventoryLogs||[],i=n.filter(x=>{const g=l.filter($=>$.product_id===x.id&&$.type==="inward").reduce(($,L)=>$+(parseInt(L.quantity)||0),0),E=l.filter($=>$.product_id===x.id&&$.type==="outward").reduce(($,L)=>$+(parseInt(L.quantity)||0),0),C=g-E;return C<=5&&C>=0}).map(x=>{const g=l.filter(C=>C.product_id===x.id&&C.type==="inward").reduce((C,$)=>C+(parseInt($.quantity)||0),0),E=l.filter(C=>C.product_id===x.id&&C.type==="outward").reduce((C,$)=>C+(parseInt($.quantity)||0),0);return{...x,netStock:g-E}});i.length>0&&t.push({key:"low-stock",icon:"inventory_2",title:"Low Stock",subtitle:`${i.length} item${i.length!==1?"s":""} running low`,items:i.map(x=>({id:x.id,primary:x.name,secondary:`${x.brand||""} · ${x.category||"General"}`.replace(/^ · /,""),amount:x.mop?`MOP ₹${Number(x.mop).toLocaleString()}`:"",date:`${x.netStock} unit${x.netStock!==1?"s":""} remaining`,status:x.netStock<=2?"Critical":"Low",actions:[{label:"Restock",icon:"add_circle",handler:()=>{window.setInventoryMode&&window.setInventoryMode("inward"),window.setApp("inventory")}}]}))});const r=(e.sales||[]).filter(x=>x.status==="draft");if(r.length>0){const x=e.saleItems||[];t.push({key:"draft-sales",icon:"edit_note",title:"Incomplete Drafts",subtitle:`${r.length} sale${r.length!==1?"s":""} waiting to complete`,items:r.map(g=>{const E=x.filter(L=>L.sale_id===g.id),C=E[0],$=g.created_at?new Date(g.created_at).toLocaleDateString("en-GB",{day:"2-digit",month:"short"}):"";return{id:g.id,primary:g.customer_name||"Draft Sale",secondary:C?`${C.product_name}${E.length>1?` +${E.length-1} more`:""}`:`${E.length} item${E.length!==1?"s":""}`,amount:`₹${Number(g.total||0).toLocaleString()}`,date:$,status:"Draft",actions:[{label:"Complete Sale",icon:"shopping_cart_checkout",handler:()=>{window.setHistoryViewMode("drafts"),window.setHistoryDateFilter("all"),window.setSalesHistoryId(g.id),window.setTab("history"),window.setApp("sales")}}]}})})}const c=(e.inquiries||[]).filter(x=>x.status==="PENDING");c.length>0&&t.push({key:"inquiries",icon:"help_outline",title:"Unresolved Inquiries",subtitle:`${c.length} question${c.length!==1?"s":""} needing response`,items:c.map(x=>{const g=x.created_at?new Date(x.created_at).toLocaleDateString("en-GB",{day:"2-digit",month:"short"}):"";return{id:x.id,primary:x.customer_name||"Unknown Customer",secondary:x.product_name||x.description||"General inquiry",amount:"",date:g,status:"Pending",actions:[{label:"Resolve",icon:"check_circle",handler:()=>{window.setActiveInquiry(x),window.setInquiryViewMode("resolve"),window.setApp("inquiries")}},...x.phone?[{label:"Call",icon:"phone",handler:()=>{window.open(`tel:${x.phone}`)}}]:[]]}})});const o=(e.repairs||[]).filter(x=>x.status==="active");o.length>0&&t.push({key:"repairs",icon:"build",title:"Active Repairs",subtitle:`${o.length} device${o.length!==1?"s":""} being serviced`,items:o.map(x=>{const g=x.created_at?new Date(x.created_at).toLocaleDateString("en-GB",{day:"2-digit",month:"short"}):"";return{id:x.id,primary:x.customer_name||"Walk-in",secondary:`${x.device_name||x.device_type||"Device"} — ${x.issue||"Repair"}`,amount:x.estimated_cost?`₹${Number(x.estimated_cost).toLocaleString()}`:"",date:g,status:"In Progress",actions:[{label:"View Status",icon:"visibility",handler:()=>{window.setActiveRepairJob&&window.setActiveRepairJob(x.id),window.setRepairTab("active"),window.setApp("repairs")}}]}})});const u=new Date(s.getTime()+7*864e5),b=e.automations||[],m=(e.automationMessages||[]).filter(x=>{if(x.status!=="pending")return!1;const g=new Date(x.scheduled_date);return g>=s&&g<=u}).sort((x,g)=>new Date(x.scheduled_date)-new Date(g.scheduled_date));m.length>0&&t.push({key:"automation",icon:"smart_toy",title:"Scheduled Messages",subtitle:`${m.length} message${m.length!==1?"s":""} queued this week`,iconSymbol:!0,items:m.map(x=>{const g=b.find(J=>J.id===x.automation_id),E=new Date(x.scheduled_date),C=E.toDateString()===s.toDateString(),$=E.toDateString()===new Date(Date.now()+864e5).toDateString(),L=C?"Today":$?"Tomorrow":E.toLocaleDateString("en-GB",{day:"2-digit",month:"short"});return{id:x.id,primary:(g==null?void 0:g.customer_name)||"Customer",secondary:x.title||"Scheduled Message",amount:"",date:L,status:"Scheduled",actions:[{label:"View",icon:"visibility",handler:()=>{window.setActiveAutomation(x.automation_id),window.setAutomationViewMode("details"),window.setApp("automation")}}]}})});const y=(e.campaigns||[]).filter(x=>{if(!x.start_date||!x.end_date)return x.status==="active";const g=new Date(x.start_date),E=new Date(x.end_date);return s>=g&&s<=E});y.length>0&&t.push({key:"campaigns",icon:"rocket_launch",title:"Live Campaigns",subtitle:`${y.length} active pre-booking campaign${y.length!==1?"s":""}`,items:y.map(x=>({id:x.id,primary:x.name||x.title||"Campaign",secondary:x.product_name||"Pre-booking",amount:x.deposit_amount?`₹${Number(x.deposit_amount).toLocaleString()} deposit`:"",date:x.end_date?`Ends ${new Date(x.end_date).toLocaleDateString("en-GB",{day:"2-digit",month:"short"})}`:"Active",status:"Live",actions:[{label:"View Campaign",icon:"visibility",handler:()=>{window.setActiveCampaign(x),window.setPreBookingViewMode("details"),window.setApp("prebooking")}}]}))});const w=`${String(s.getMonth()+1).padStart(2,"0")}-${String(s.getDate()).padStart(2,"0")}`,f=(e.customers||[]).filter(x=>{if(!x.dob)return!1;const E=(x.dob.includes("T")?x.dob.split("T")[0]:x.dob).split("-");return E.length<3?!1:`${E[1]}-${E[2]}`===w});return f.length>0&&t.push({key:"birthdays",icon:"cake",title:"Birthdays Today",subtitle:`${f.length} customer${f.length!==1?"s":""} celebrating today`,items:f.map(x=>({id:x.id,primary:x.name,secondary:x.phone||x.email||"No contact info",amount:"",date:"Today",status:"Birthday",actions:[{label:"View Profile",icon:"person",handler:()=>{window.setClientMode("profile",x.name,x.id),window.setApp("clients")}},...x.phone?[{label:"Wish",icon:"chat",handler:()=>{window.open(`https://wa.me/91${x.phone.replace(/\D/g,"").slice(-10)}?text=${encodeURIComponent(`Happy Birthday, ${x.name}! Wishing you a wonderful day. 🎂`)}`)}}]:[]]}))}),t}function ar(){return Yn().reduce((e,t)=>e+t.items.length,0)}window.getNotificationCount=ar;window._notifExpanded||(window._notifExpanded={});window._toggleNotifGroup=function(e){window._notifExpanded[e]=!window._notifExpanded[e],window.triggerRender()};window._notifActions=[];function du(){const e=window._pushNotificationsEnabled!==!1,t=ar();return`
    ...
    `}function Jn(e){if(e==="desktop-secondary")return bu();const t=Yn();window._notifActions=[],t.forEach(n=>n.items.forEach(l=>{l.actions&&l.actions.forEach(i=>window._notifActions.push(i.handler))}));let s=0;const a=t.map(n=>{const l=xu(n,s);return s+=n.items.reduce((i,r)=>i+(r.actions?r.actions.length:0),0),l}).join("");return`
        <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            ${du()}
    ...
    `,document.body.appendChild(n);const l=n.querySelector("div > div"),i=n.querySelector("#prompt-input");requestAnimationFrame(()=>{l.classList.remove("scale-95","opacity-0"),l.classList.add("scale-100","opacity-100"),i.focus(),i.select()}),i.onkeydown=r=>{if(r.key==="Enter"){const c=i.value.trim();ht(n),c&&s&&s(c)}else r.key==="Escape"&&(ht(n),a&&a())},n.querySelector("#prompt-cancel").onclick=()=>{ht(n),a&&a()},n.querySelector("#prompt-ok").onclick=()=>{const r=i.value.trim();ht(n),r&&s&&s(r)},n.onclick=r=>{r.target===n&&(ht(n),a&&a())}}window.toast=$u;window.showToast=Gs;window.showConfirm=Eu;window.showPrompt=Iu;function Cu(){return p.currentApp==="sales"?p.currentTab==="new-sale"?Qi():Xi():p.currentApp==="clients"?On("desktop-primary"):p.currentApp==="reports"?jn("desktop-primary"):p.currentApp==="repairs"?Pn("desktop-primary"):p.currentApp==="marketing"?Nn("desktop-primary"):p.currentApp==="promoters"?qn("desktop-primary"):p.currentApp==="inventory"?Bn("desktop-primary"):p.currentApp==="settings"?Fn("desktop-primary"):p.currentApp==="schemes"?Vn("desktop-primary"):p.currentApp==="marketplace"?Un("desktop-primary"):p.currentApp==="inquiries"?Hn("desktop-primary"):p.currentApp==="prebooking"?Gn("desktop-primary"):p.currentApp==="automation"?Wn("desktop-primary"):p.currentApp==="mystore"?zn("desktop-primary"):p.currentApp==="notifications"?Jn("desktop-primary"):'<div class="p-10 flex items-center justify-center h-full text-slate-300 font-bold uppercase tracking-widest">App Module Not Found</div>'}function Ru(){return p.currentApp==="sales"?p.salesMode==="add-customer"?gn("desktop"):er():p.currentApp==="clients"?On("desktop-secondary"):p.currentApp==="reports"?jn("desktop-secondary"):p.currentApp==="repairs"?Pn("desktop-secondary"):p.currentApp==="marketing"?Nn("desktop-secondary"):p.currentApp==="promoters"?qn("desktop-secondary"):p.currentApp==="inventory"?Bn("desktop-secondary"):p.currentApp==="settings"?Fn("desktop-secondary"):p.currentApp==="schemes"?Vn("desktop-secondary"):p.currentApp==="marketplace"?Un("desktop-secondary"):p.currentApp==="inquiries"?Hn("desktop-secondary"):p.currentApp==="prebooking"?Gn("desktop-secondary"):p.currentApp==="automation"?Wn("desktop-secondary"):p.currentApp==="mystore"?zn("desktop-secondary"):p.currentApp==="notifications"?Jn("desktop-secondary"):'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-2 opacity-50">grid_view</span><p class="text-[10px] font-black uppercase tracking-widest">Select an app to view details</p></div></div>'}function nr(){return Fl("desktop")}function Au(){return`
    ...
    `}function lr(){if(p.currentApp==="sales"){const t=window.getActiveCart&&window.getActiveCart().length>0,s=p.currentTab==="new-sale"&&t||p.currentTab==="history"&&p.salesHistoryId;return p.showMobileReceipt&&s?`
    ...
    `}function Tu(){return`
        <div class="h-full flex flex-row divide-x divide-slate-200 bg-white">
            ...
            <div class="flex-1 bg-white h-full overflow-hidden flex flex-col relative">
                ${p.isLoggedIn?p.currentApp==="launcher"?'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-4 opacity-20">arrow_back</span><p class="text-[10px] font-black uppercase tracking-widest opacity-40">Select an App from the Menu</p></div></div>':lr():'<div class="h-full w-full bg-slate-950 flex flex-col items-center justify-center text-white/5 font-black text-[15vw] leading-none overflow-hidden select-none pointer-events-none"><div>OS</div></div>'}
            </div>
        </div>
    `}function ir(){return p.isLoggedIn?p.currentApp==="launcher"?Fl("mobile"):lr():`
            <div class="h-full w-full bg-white">
                ${Bl()}
            </div>
        `}function Oa(){const e=document.getElementById("app");if(e)try{const t=window.innerWidth;t<768?e.innerHTML=ir():t>=768&&t<1024?e.innerHTML=Tu():e.innerHTML=Au()}catch(t){console.error(t),e.innerHTML=`< div class="p-4 text-slate-500 font-bold" > Error: ${t.message} <br><small>${t.stack}</small></div>`}}function Mu(){const e=window.innerWidth;if(e<768){const t=document.getElementById("app");t&&(t.innerHTML=ir())}else{const t=document.querySelector(".flex-1.bg-white.h-full.overflow-hidden.flex.flex-col.relative.z-10")||document.querySelector(".flex-1.bg-white.h-full.overflow-hidden.flex.flex-col.relative"),s=document.querySelector(".w-\\[30\\%\\].shrink-0.bg-slate-50\\/50.h-full.overflow-hidden.flex.flex-col.relative.dot-grid.border-l.border-slate-200");t&&(t.innerHTML=p.authMode==="register"?Js("desktop-primary"):'<div class="h-full w-full bg-slate-950 flex flex-col items-center justify-center text-white/5 font-black text-[20vw] leading-none overflow-hidden select-none pointer-events-none"><div>OS</div></div>'),s&&e>=1024&&(s.innerHTML=p.authMode==="register"?Js("desktop-secondary"):'<div class="h-full w-full bg-slate-950/95 flex flex-col items-center justify-center text-white/5 font-black text-[15vw] leading-none overflow-hidden select-none pointer-events-none"><div>RETAILER</div></div>')}}window.updateAuthContent=Mu;Ol(Oa);Ol(mu);hu();window.addEventListener("resize",()=>{window.innerWidth!==p.viewportWidth&&(p.viewportWidth=window.innerWidth,p.gridCols=window.innerWidth<768?4:3,Oa())});Y().then(()=>{console.log("Initial data sync complete"),Oa()}).catch(e=>{console.error("Initial sync failed:",e),Oa()});
