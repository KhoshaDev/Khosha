...
Error: `+s.message)}};window.verifyOtp=function(){const e=[];for(let a=0;a<6;a++){const n=document.getElementById(`otp-${a}`);n&&e.push(n.value)}const t=e.join("");if(t.length!==6){alert("Please enter all 6 digits");return}const s="444619";console.log("Verifying OTP:",t),t===s?console.log("✅ Default OTP accepted:",s):console.log("ℹ️  Development mode: Any OTP accepted"),window.setRegistrationStep(3)};window.resendOtp=function(){for(let t=0;t<6;t++){const s=document.getElementById(`otp-${t}`);s&&(s.value="")}const e=document.getElementById("otp-0");e&&e.focus(),console.log("Resending OTP..."),alert("OTP has been resent successfully!")};window.finalizeRegistration=async function(){try{const e=window._approvedRetailerData;if(!e){alert("Session expired. Please start registration again."),window.setRegistrationStep(1);return}const{db:t}=await Ys(async()=>{const{db:n}=await Promise.resolve().then(()=>Mn);return{db:n}},void 0),s=await t.retailers.add(e);window.setRetailer(s.id,s.retailerCode,e.RetailerName),localStorage.setItem("retaileros_logged_in","true"),delete window._approvedRetailerData;const{syncData:a}=await Ys(async()=>{const{syncData:n}=await Promise.resolve().then(()=>Gi);return{syncData:n}},void 0);await a(),window.setLoginStatus(!0),console.log("Registration completed successfully:",s)}catch(e){console.error("Registration failed:",e),alert("Registration failed. Please try again.")}};function Nl(){return p.authMode==="register"?Js():Pl()}const Kr=[{n:"SALES DESK",i:"account_balance_wallet",k:"sales"},{n:"CLIENTS",i:"group",k:"clients"},{n:"INQUIRIES",i:"help_outline",k:"inquiries"},{n:"PROMOTERS",i:"business_center",k:"promoters"},{n:"MY STORE",i:"storefront",k:"mystore"},{n:"INVENTORY",i:"inventory_2",k:"inventory"},{n:"REPAIRS",i:"build",k:"repairs"},{n:"MARKETPLACE",i:"swap_horizontal_circle",k:"marketplace"},{n:"CLAIMS",i:"verified_user"},{n:"SCHEMES",i:"percent",k:"schemes"},{n:"MARKETING",i:"campaign",k:"marketing"},{n:"AUTOMATION",i:"smart_toy",s:!0,k:"automation"},{n:"PRE-BOOKING",i:"rocket_launch",k:"prebooking"},{n:"REPORTS",i:"bar_chart",k:"reports"},{n:"SETTINGS",i:"settings",k:"settings"}];function Qr(e){const t=e?p.gridCols:4;return`
            ...
            <div class="grid ${e&&{2:"grid-cols-2",3:"grid-cols-3",4:"grid-cols-4"}[t]||"grid-cols-4"} divide-x divide-y divide-slate-100">
                ${Kr.map(a=>`
                    <button onclick="setApp('${a.k||"launcher"}')" class="aspect-square flex flex-col items-center justify-center p-1.5 hover:bg-slate-50 transition-all ${p.currentApp===a.k?"bg-slate-100":""}">
                        <span class="${a.s?"material-symbols-outlined":"material-icons-outlined"} text-2xl ${p.currentApp===a.k?"text-slate-900 font-bold":"text-slate-500"} mb-1">${a.i}</span>
    ...
    `}function ql(e){const t=e==="mobile";return`
    ...
    `}class F extends Error{constructor(s,a,n,l,i){a!==void 0&&(s=`${a}: ${s}`);super(s,{cause:i});q(this,"code");q(this,"extendedCode");q(this,"rawCode");this.code=a,this.extendedCode=n,this.rawCode=l,this.name="LibsqlError"}}class ls extends F{constructor(s,a,n,l,i,r){super(s,n,l,i,r);q(this,"statementIndex");this.statementIndex=a,this.name="LibsqlBatchError"}}function Zr(e){const t=eo.exec(e);if(t===null)throw new F(`The URL '${e}' is not in a valid format`,"URL_INVALID");const s=t.groups,a=s.scheme,n=s.authority!==void 0?to(s.authority):void 0,l=Qt(s.path),i=s.query!==void 0?ao(s.query):void 0,r=s.fragment!==void 0?Qt(s.fragment):void 0;return{scheme:a,authority:n,path:l,query:i,fragment:r}}const eo=(()=>{const e="(?<scheme>[A-Za-z][A-Za-z.+-]*)",t="(?<authority>[^/?#]*)",s="(?<path>[^?#]*)",a="(?<query>[^#]*)",n="(?<fragment>.*)";return new RegExp(`^${e}:(//${t})?${s}(\\?${a})?(#${n})?$`,"su")})();function to(e){const t=so.exec(e);if(t===null)throw new F("The authority part of the URL is not in a valid format","URL_INVALID");const s=t.groups,a=Qt(s.host_br??s.host),n=s.port?parseInt(s.port,10):void 0,l=s.username!==void 0?{username:Qt(s.username),password:s.password!==void 0?Qt(s.password):void 0}:void 0;return{host:a,port:n,userinfo:l}}const so=new RegExp("^((?<username>[^:]*)(:(?<password>.*))?@)?((?<host>[^:\\[\\]]*)|(\\[(?<host_br>[^\\[\\]]*)\\]))(:(?<port>[0-9]*))?$","su");function ao(e){const t=e.split("&"),s=[];for(const a of t){if(a==="")continue;let n,l;const i=a.indexOf("=");i<0?(n=a,l=""):(n=a.substring(0,i),l=a.substring(i+1)),s.push({key:Qt(n.replaceAll("+"," ")),value:Qt(l.replaceAll("+"," "))})}return{pairs:s}}function Qt(e){try{return decodeURIComponent(e)}catch(t){throw t instanceof URIError?new F(`URL component has invalid percent encoding: ${t}`,"URL_INVALID",void 0,void 0,t):t}}function Qa(e,t,s){if(t===void 0)throw new F(`URL with scheme ${JSON.stringify(e+":")} requires authority (the "//" part)`,"URL_INVALID");const a=`${e}:`,n=no(t.host),l=lo(t.port),r=`//${io(t.userinfo)}${n}${l}`;let d=s.split("/").map(encodeURIComponent).join("/");return d!==""&&!d.startsWith("/")&&(d="/"+d),new URL(`${a}${r}${d}`)}function no(e){return e.includes(":")?`[${encodeURI(e)}]`:encodeURI(e)}function lo(e){return e!==void 0?`:${e}`:""}function io(e){if(e===void 0)return"";const t=encodeURIComponent(e.username),s=e.password!==void 0?`:${encodeURIComponent(e.password)}`:"";return`${t}${s}@`}const Bl="3.7.8",ro=Bl,Ds=typeof Buffer=="function",Zn=typeof TextDecoder=="function"?new TextDecoder:void 0,el=typeof TextEncoder=="function"?new TextEncoder:void 0,oo="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",js=Array.prototype.slice.call(oo),ha=(e=>{let t={};return e.forEach((s,a)=>t[s]=a),t})(js),co=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,le=String.fromCharCode.bind(String),tl=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):e=>new Uint8Array(Array.prototype.slice.call(e,0)),Fl=e=>e.replace(/=/g,"").replace(/[+\/]/g,t=>t=="+"?"-":"_"),Ul=e=>e.replace(/[^A-Za-z0-9\+\/]/g,""),Vl=e=>{let t,s,a,n,l="";const i=e.length%3;for(let r=0;r<e.length;){if((s=e.charCodeAt(r++))>255||(a=e.charCodeAt(r++))>255||(n=e.charCodeAt(r++))>255)throw new TypeError("invalid character found");t=s<<16|a<<8|n,l+=js[t>>18&63]+js[t>>12&63]+js[t>>6&63]+js[t&63]}return i?l.slice(0,i-3)+"===".substring(i):l},kn=typeof btoa=="function"?e=>btoa(e):Ds?e=>Buffer.from(e,"binary").toString("base64"):Vl,Xa=Ds?e=>Buffer.from(e).toString("base64"):e=>{let s=[];for(let a=0,n=e.length;a<n;a+=4096)s.push(le.apply(null,e.subarray(a,a+4096)));return kn(s.join(""))},wa=(e,t=!1)=>t?Fl(Xa(e)):Xa(e),po=e=>{if(e.length<2){var t=e.charCodeAt(0);return t<128?e:t<2048?le(192|t>>>6)+le(128|t&63):le(224|t>>>12&15)+le(128|t>>>6&63)+le(128|t&63)}else{var t=65536+(e.charCodeAt(0)-55296)*1024+(e.charCodeAt(1)-56320);return le(240|t>>>18&7)+le(128|t>>>12&63)+le(128|t>>>6&63)+le(128|t&63)}},uo=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,Hl=e=>e.replace(uo,po),sl=Ds?e=>Buffer.from(e,"utf8").toString("base64"):el?e=>Xa(el.encode(e)):e=>kn(Hl(e)),is=(e,t=!1)=>t?Fl(sl(e)):sl(e),al=e=>is(e,!0),xo=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,fo=e=>{switch(e.length){case 4:var t=(7&e.charCodeAt(0))<<18|(63&e.charCodeAt(1))<<12|(63&e.charCodeAt(2))<<6|63&e.charCodeAt(3),s=t-65536;return le((s>>>10)+55296)+le((s&1023)+56320);case 3:return le((15&e.charCodeAt(0))<<12|(63&e.charCodeAt(1))<<6|63&e.charCodeAt(2));default:return le((31&e.charCodeAt(0))<<6|63&e.charCodeAt(1))}},Gl=e=>e.replace(xo,fo),Wl=e=>{if(e=e.replace(/\s+/g,""),!co.test(e))throw new TypeError("malformed base64.");e+="==".slice(2-(e.length&3));let t,s,a,n=[];for(let l=0;l<e.length;)t=ha[e.charAt(l++)]<<18|ha[e.charAt(l++)]<<12|(s=ha[e.charAt(l++)])<<6|(a=ha[e.charAt(l++)]),s===64?n.push(le(t>>16&255)):a===64?n.push(le(t>>16&255,t>>8&255)):n.push(le(t>>16&255,t>>8&255,t&255));return n.join("")},_n=typeof atob=="function"?e=>atob(Ul(e)):Ds?e=>Buffer.from(e,"base64").toString("binary"):Wl,zl=Ds?e=>tl(Buffer.from(e,"base64")):e=>tl(_n(e).split("").map(t=>t.charCodeAt(0))),Yl=e=>zl(Jl(e)),bo=Ds?e=>Buffer.from(e,"base64").toString("utf8"):Zn?e=>Zn.decode(zl(e)):e=>Gl(_n(e)),Jl=e=>Ul(e.replace(/[-_]/g,t=>t=="-"?"+":"/")),Za=e=>bo(Jl(e)),mo=e=>{if(typeof e!="string")return!1;const t=e.replace(/\s+/g,"").replace(/={0,2}$/,"");return!/[^\s0-9a-zA-Z\+/]/.test(t)||!/[^\s0-9a-zA-Z\-_]/.test(t)},Kl=e=>({value:e,enumerable:!1,writable:!0,configurable:!0}),Ql=function(){const e=(t,s)=>Object.defineProperty(String.prototype,t,Kl(s));e("fromBase64",function(){return Za(this)}),e("toBase64",function(t){return is(this,t)}),e("toBase64URI",function(){return is(this,!0)}),e("toBase64URL",function(){return is(this,!0)}),e("toUint8Array",function(){return Yl(this)})},Xl=function(){const e=(t,s)=>Object.defineProperty(Uint8Array.prototype,t,Kl(s));e("toBase64",function(t){return wa(this,t)}),e("toBase64URI",function(){return wa(this,!0)}),e("toBase64URL",function(){return wa(this,!0)})},ho=()=>{Ql(),Xl()},Sn={version:Bl,VERSION:ro,atob:_n,atobPolyfill:Wl,btoa:kn,btoaPolyfill:Vl,fromBase64:Za,toBase64:is,encode:is,encodeURI:al,encodeURL:al,utob:Hl,btou:Gl,decode:Za,isValid:mo,fromUint8Array:wa,toUint8Array:Yl,extendString:Ql,extendUint8Array:Xl,extendBuiltins:ho},Ks="https://github.com/libsql/libsql-client-ts#supported-urls";function en(e){if(e==="write")return"BEGIN IMMEDIATE";if(e==="read")return"BEGIN TRANSACTION READONLY";if(e==="deferred")return"BEGIN DEFERRED";throw RangeError('Unknown transaction mode, supported values are "write", "read" and "deferred"')}class go{constructor(t,s,a,n,l){q(this,"columns");q(this,"columnTypes");q(this,"rows");q(this,"rowsAffected");q(this,"lastInsertRowid");this.columns=t,this.columnTypes=s,this.rows=a,this.rowsAffected=n,this.lastInsertRowid=l}toJSON(){return{columns:this.columns,columnTypes:this.columnTypes,rows:this.rows.map(vo),rowsAffected:this.rowsAffected,lastInsertRowid:this.lastInsertRowid!==void 0?""+this.lastInsertRowid:null}}}function vo(e){return Array.prototype.map.call(e,wo)}function wo(e){return typeof e=="bigint"?""+e:e instanceof ArrayBuffer?Sn.fromUint8Array(new Uint8Array(e)):e}const nl=":memory:";function yo(e,t){var x,y;if(typeof e!="object")throw new TypeError(`Expected client configuration as object, got ${typeof e}`);let{url:s,authToken:a,tls:n,intMode:l,concurrency:i}=e;i=Math.max(0,i||20),l??(l="number");let r=[];s===nl&&(s="file::memory:");const d=Zr(s),o=d.scheme.toLowerCase(),u=o==="file"&&d.path===nl&&d.authority===void 0;let f;u?f={cache:{values:["shared","private"],update:(_,R)=>r.push(`${_}=${R}`)}}:f={tls:{values:["0","1"],update:(_,R)=>n=R==="1"},authToken:{update:(_,R)=>a=R}};for(const{key:_,value:R}of((x=d.query)==null?void 0:x.pairs)??[]){if(!Object.hasOwn(f,_))throw new F(`Unsupported URL query parameter ${JSON.stringify(_)}`,"URL_PARAM_NOT_SUPPORTED");const M=f[_];if(M.values!==void 0&&!M.values.includes(R))throw new F(`Unknown value for the "${_}" query argument: ${JSON.stringify(R)}. Supported values are: [${M.values.map(E=>'"'+E+'"').join(", ")}]`,"URL_INVALID");M.update!==void 0&&(M==null||M.update(_,R))}const b=r.length===0?"":`?${r.join("&")}`,h=d.path+b;let v;if(o==="libsql")if(n===!1){if(((y=d.authority)==null?void 0:y.port)===void 0)throw new F('A "libsql:" URL with ?tls=0 must specify an explicit port',"URL_INVALID");v="http"}else v="https";else v=o;if(v==="http"||v==="ws"?n??(n=!1):n??(n=!0),v!=="http"&&v!=="ws"&&v!=="https"&&v!=="wss"&&v!=="file")throw new F(`The client supports only "libsql:", "wss:", "ws:", "https:", "http:" and "file:" URLs, got ${JSON.stringify(d.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(l!=="number"&&l!=="bigint"&&l!=="string")throw new TypeError(`Invalid value for intMode, expected "number", "bigint" or "string", got ${JSON.stringify(l)}`);if(d.fragment!==void 0)throw new F(`URL fragments are not supported: ${JSON.stringify("#"+d.fragment)}`,"URL_INVALID");return u?{scheme:"file",tls:!1,path:h,intMode:l,concurrency:i,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch,authToken:void 0,encryptionKey:void 0,remoteEncryptionKey:void 0,authority:void 0}:{scheme:v,tls:n,authority:d.authority,path:h,authToken:a,intMode:l,concurrency:i,encryptionKey:e.encryptionKey,remoteEncryptionKey:e.remoteEncryptionKey,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch}}let as;typeof WebSocket<"u"?as=WebSocket:typeof global<"u"?as=global.WebSocket:typeof window<"u"?as=window.WebSocket:typeof self<"u"&&(as=self.WebSocket);class Zl{constructor(){q(this,"intMode");this.intMode="number"}}class Y extends Error{constructor(t){super(t),this.name="ClientError"}}class j extends Y{constructor(t){super(t),this.name="ProtoError"}}class ei extends Y{constructor(s,a){super(s);q(this,"code");q(this,"proto");this.name="ResponseError",this.code=a.code,this.proto=a,this.stack=void 0}}class Ae extends Y{constructor(t,s){s!==void 0?(super(`${t}: ${s}`),this.cause=s):super(t),this.name="ClosedError"}}class ti extends Y{constructor(t){super(t),this.name="WebSocketUnsupportedError"}}class tn extends Y{constructor(t){super(t),this.name="WebSocketError"}}class ya extends Y{constructor(s,a){super(s);q(this,"status");this.status=a,this.name="HttpServerError"}}class Rs extends Y{constructor(t){super(t),this.name="ProtocolVersionError"}}class At extends Y{constructor(t){super(t),this.name="InternalError"}}class Os extends Y{constructor(t){super(t),this.name="MisuseError"}}function qe(e){if(typeof e=="string")return e;throw Ls(e,"string")}function Fe(e){if(e!=null){if(typeof e=="string")return e;throw Ls(e,"string or null")}}function Xt(e){if(typeof e=="number")return e;throw Ls(e,"number")}function Qs(e){if(typeof e=="boolean")return e;throw Ls(e,"boolean")}function Ia(e){if(Array.isArray(e))return e;throw Ls(e,"array")}function ie(e){if(e!==null&&typeof e=="object"&&!Array.isArray(e))return e;throw Ls(e,"object")}function Tt(e,t){return Ia(e).map(s=>t(ie(s)))}function Ls(e,t){if(e===void 0)return new j(`Expected ${t}, but the property was missing`);let s=typeof e;return e===null?s="null":Array.isArray(e)&&(s="array"),new j(`Expected ${t}, received ${s}`)}function $n(e,t){return t(ie(e))}var X,gt,Ze,Lt;class ko{constructor(t){k(this,Ze);k(this,X);k(this,gt);m(this,X,t),m(this,gt,!1)}begin(){c(this,X).push("{"),m(this,gt,!0)}end(){c(this,X).push("}"),m(this,gt,!1)}string(t,s){S(this,Ze,Lt).call(this,t),c(this,X).push(JSON.stringify(s))}stringRaw(t,s){S(this,Ze,Lt).call(this,t),c(this,X).push('"'),c(this,X).push(s),c(this,X).push('"')}number(t,s){S(this,Ze,Lt).call(this,t),c(this,X).push(""+s)}boolean(t,s){S(this,Ze,Lt).call(this,t),c(this,X).push(s?"true":"false")}object(t,s,a){S(this,Ze,Lt).call(this,t),this.begin(),a(this,s),this.end()}arrayObjects(t,s,a){S(this,Ze,Lt).call(this,t),c(this,X).push("[");for(let n=0;n<s.length;++n)n!==0&&c(this,X).push(","),this.begin(),a(this,s[n]),this.end();c(this,X).push("]")}}X=new WeakMap,gt=new WeakMap,Ze=new WeakSet,Lt=function(t){c(this,gt)?(c(this,X).push('"'),m(this,gt,!1)):c(this,X).push(',"'),c(this,X).push(t),c(this,X).push('":')};function si(e,t){const s=[],a=new ko(s);return a.begin(),t(a,e),a.end(),s.join("")}const Ws=0,sn=1,an=2,_o=5;var Ve,Xs,_e;class So{constructor(t){k(this,Ve);k(this,Xs);k(this,_e);m(this,Ve,t),m(this,Xs,new DataView(t.buffer,t.byteOffset,t.byteLength)),m(this,_e,0)}varint(){let t=0;for(let s=0;;s+=7){const a=c(this,Ve)[es(this,_e)._++];if(t|=(a&127)<<s,!(a&128))break}return t}varintBig(){let t=0n;for(let s=0n;;s+=7n){const a=c(this,Ve)[es(this,_e)._++];if(t|=BigInt(a&127)<<s,!(a&128))break}return t}bytes(t){const s=new Uint8Array(c(this,Ve).buffer,c(this,Ve).byteOffset+c(this,_e),t);return m(this,_e,c(this,_e)+t),s}double(){const t=c(this,Xs).getFloat64(c(this,_e),!0);return m(this,_e,c(this,_e)+8),t}skipVarint(){for(;c(this,Ve)[es(this,_e)._++]&128;);}skip(t){m(this,_e,c(this,_e)+t)}eof(){return c(this,_e)>=c(this,Ve).byteLength}}Ve=new WeakMap,Xs=new WeakMap,_e=new WeakMap;var be,ce,Bt,Ps;class $o{constructor(t){k(this,Bt);k(this,be);k(this,ce);m(this,be,t),m(this,ce,-1)}setup(t){m(this,ce,t)}bytes(){S(this,Bt,Ps).call(this,an);const t=c(this,be).varint();return c(this,be).bytes(t)}string(){return new TextDecoder().decode(this.bytes())}message(t){return qa(this.bytes(),t)}int32(){return S(this,Bt,Ps).call(this,Ws),c(this,be).varint()}uint32(){return this.int32()}bool(){return this.int32()!==0}uint64(){return S(this,Bt,Ps).call(this,Ws),c(this,be).varintBig()}sint64(){const t=this.uint64();return t>>1n^-(t&1n)}double(){return S(this,Bt,Ps).call(this,sn),c(this,be).double()}maybeSkip(){if(!(c(this,ce)<0)){if(c(this,ce)===Ws)c(this,be).skipVarint();else if(c(this,ce)===sn)c(this,be).skip(8);else if(c(this,ce)===an){const t=c(this,be).varint();c(this,be).skip(t)}else if(c(this,ce)===_o)c(this,be).skip(4);else throw new j(`Unexpected wire type ${c(this,ce)}`);m(this,ce,-1)}}}be=new WeakMap,ce=new WeakMap,Bt=new WeakSet,Ps=function(t){if(c(this,ce)!==t)throw new j(`Expected wire type ${t}, got ${c(this,ce)}`);m(this,ce,-1)};function qa(e,t){const s=new So(e),a=new $o(s);let n=t.default();for(;!s.eof();){const l=s.varint(),i=l>>3,r=l&7;a.setup(r);const d=t[i];if(d!==void 0){const o=d(a,n);o!==void 0&&(n=o)}a.maybeSkip()}return n}var Te,vt,cs,me,se,Ns,ka,ai,qs;const Yn=class Yn{constructor(){k(this,se);k(this,Te);k(this,vt);k(this,cs);k(this,me);m(this,Te,new ArrayBuffer(256)),m(this,vt,new Uint8Array(c(this,Te))),m(this,cs,new DataView(c(this,Te))),m(this,me,0)}bytes(t,s){S(this,se,qs).call(this,t,an),S(this,se,ka).call(this,s.byteLength),S(this,se,Ns).call(this,s.byteLength),c(this,vt).set(s,c(this,me)),m(this,me,c(this,me)+s.byteLength)}string(t,s){this.bytes(t,new TextEncoder().encode(s))}message(t,s,a){const n=new Yn;a(n,s),this.bytes(t,n.data())}int32(t,s){S(this,se,qs).call(this,t,Ws),S(this,se,ka).call(this,s)}uint32(t,s){this.int32(t,s)}bool(t,s){this.int32(t,s?1:0)}sint64(t,s){S(this,se,qs).call(this,t,Ws),S(this,se,ai).call(this,s<<1n^s>>63n)}double(t,s){S(this,se,qs).call(this,t,sn),S(this,se,Ns).call(this,8),c(this,cs).setFloat64(c(this,me),s,!0),m(this,me,c(this,me)+8)}data(){return new Uint8Array(c(this,Te),0,c(this,me))}};Te=new WeakMap,vt=new WeakMap,cs=new WeakMap,me=new WeakMap,se=new WeakSet,Ns=function(t){if(c(this,me)+t<=c(this,Te).byteLength)return;let s=c(this,Te).byteLength;for(;s<c(this,me)+t;)s*=2;const a=new ArrayBuffer(s),n=new Uint8Array(a),l=new DataView(a);n.set(new Uint8Array(c(this,Te),0,c(this,me))),m(this,Te,a),m(this,vt,n),m(this,cs,l)},ka=function(t){S(this,se,Ns).call(this,5),t=0|t;do{let s=t&127;t>>>=7,s|=t?128:0,c(this,vt)[es(this,me)._++]=s}while(t)},ai=function(t){S(this,se,Ns).call(this,10),t=t&0xffffffffffffffffn;do{let s=Number(t&0x7fn);t>>=7n,s|=t?128:0,c(this,vt)[es(this,me)._++]=s}while(t)},qs=function(t,s){S(this,se,ka).call(this,t<<3|s)};let nn=Yn;function ni(e,t){const s=new nn;return t(s,e),s.data()}var Se,et;class Bs{constructor(){k(this,Se);k(this,et);m(this,Se,new Set),m(this,et,new Set)}alloc(){for(const s of c(this,et))return c(this,et).delete(s),c(this,Se).add(s),c(this,Se).has(c(this,Se).size-1)||c(this,et).add(c(this,Se).size-1),s;const t=c(this,Se).size;return c(this,Se).add(t),t}free(t){if(!c(this,Se).delete(t))throw new At("Freeing an id that is not allocated");c(this,et).delete(c(this,Se).size),t<c(this,Se).size&&c(this,et).add(t)}}Se=new WeakMap,et=new WeakMap;function J(e,t){throw new At(t)}function zs(e){if(e===null)return null;if(typeof e=="string")return e;if(typeof e=="number"){if(!Number.isFinite(e))throw new RangeError("Only finite numbers (not Infinity or NaN) can be passed as arguments");return e}else if(typeof e=="bigint"){if(e<Eo||e>Io)throw new RangeError("This bigint value is too large to be represented as a 64-bit integer and passed as argument");return e}else{if(typeof e=="boolean")return e?1n:0n;if(e instanceof ArrayBuffer)return new Uint8Array(e);if(e instanceof Uint8Array)return e;if(e instanceof Date)return+e.valueOf();if(typeof e=="object")return""+e.toString();throw new TypeError("Unsupported type of value")}}const Eo=-9223372036854775808n,Io=9223372036854775807n;function li(e,t){if(e===null)return null;if(typeof e=="number")return e;if(typeof e=="string")return e;if(typeof e=="bigint")if(t==="number"){const s=Number(e);if(!Number.isSafeInteger(s))throw new RangeError("Received integer which is too large to be safely represented as a JavaScript number");return s}else{if(t==="bigint")return e;if(t==="string")return""+e;throw new Os("Invalid value for IntMode")}else{if(e instanceof Uint8Array)return e.slice().buffer;throw e===void 0?new j("Received unrecognized type of Value"):J(e,"Impossible type of Value")}}function fa(e){return{affectedRowCount:e.affectedRowCount,lastInsertRowid:e.lastInsertRowid,columnNames:e.cols.map(t=>t.name),columnDecltypes:e.cols.map(t=>t.decltype)}}function ii(e,t){const s=fa(e),a=e.rows.map(n=>ci(s.columnNames,n,t));return{...s,rows:a}}function ri(e,t){const s=fa(e);let a;return e.rows.length>0&&(a=ci(s.columnNames,e.rows[0],t)),{...s,row:a}}function oi(e,t){const s=fa(e);let a;return e.rows.length>0&&s.columnNames.length>0&&(a=li(e.rows[0][0],t)),{...s,value:a}}function ci(e,t,s){const a={};Object.defineProperty(a,"length",{value:t.length});for(let n=0;n<t.length;++n){const l=li(t[n],s);Object.defineProperty(a,n,{value:l});const i=e[n];i!==void 0&&!Object.hasOwn(a,i)&&Object.defineProperty(a,i,{value:l,enumerable:!0,configurable:!0,writable:!0})}return a}function As(e){return new ei(e.message,e)}var ds,ps,tt;class En{constructor(t,s){k(this,ds);k(this,ps);k(this,tt);m(this,ds,t),m(this,ps,s),m(this,tt,void 0)}_getSqlId(t){if(c(this,ds)!==t)throw new Os("Attempted to use SQL text opened with other object");if(c(this,tt)!==void 0)throw new Ae("SQL text is closed",c(this,tt));return c(this,ps)}close(){this._setClosed(new Y("SQL text was manually closed"))}_setClosed(t){c(this,tt)===void 0&&(m(this,tt,t),c(this,ds)._closeSql(c(this,ps)))}get closed(){return c(this,tt)!==void 0}}ds=new WeakMap,ps=new WeakMap,tt=new WeakMap;function ln(e,t){return t instanceof En?{sqlId:t._getSqlId(e)}:{sql:""+t}}var He,Me;class Ca{constructor(){k(this,He);k(this,Me);m(this,He,[]),m(this,Me,[])}get length(){return c(this,He).length+c(this,Me).length}push(t){c(this,He).push(t)}shift(){return c(this,Me).length===0&&c(this,He).length>0&&(m(this,Me,c(this,He).reverse()),m(this,He,[])),c(this,Me).pop()}first(){return c(this,Me).length!==0?c(this,Me)[c(this,Me).length-1]:c(this,He)[0]}}He=new WeakMap,Me=new WeakMap;let di=class{constructor(t){q(this,"sql");q(this,"_args");q(this,"_namedArgs");this.sql=t,this._args=[],this._namedArgs=new Map}bindIndexes(t){this._args.length=0;for(const s of t)this._args.push(zs(s));return this}bindIndex(t,s){if(t!==(t|0)||t<=0)throw new RangeError("Index of a positional argument must be positive integer");for(;this._args.length<t;)this._args.push(null);return this._args[t-1]=zs(s),this}bindName(t,s){return this._namedArgs.set(t,zs(s)),this}unbindAll(){return this._args.length=0,this._namedArgs.clear(),this}};function pi(e,t,s){let a,n=[],l=[];if(t instanceof di){a=t.sql,n=t._args;for(const[d,o]of t._namedArgs.entries())l.push({name:d,value:o})}else Array.isArray(t)?(a=t[0],Array.isArray(t[1])?n=t[1].map(d=>zs(d)):l=Object.entries(t[1]).map(([d,o])=>({name:d,value:zs(o)}))):a=t;const{sql:i,sqlId:r}=ln(e,a);return{sql:i,sqlId:r,args:n,namedArgs:l,wantRows:s}}var Zs,us,Cl;let Co=(Cl=class{constructor(t,s){q(this,"_stream");k(this,Zs);q(this,"_steps");k(this,us);this._stream=t,m(this,Zs,s),this._steps=[],m(this,us,!1)}step(){return new To(this)}execute(){if(c(this,us))throw new Os("This batch has already been executed");m(this,us,!0);const t={steps:this._steps.map(s=>s.proto)};return c(this,Zs)?Ao(this._stream,this._steps,t):Ro(this._stream,this._steps,t)}},Zs=new WeakMap,us=new WeakMap,Cl);function Ro(e,t,s){return e._batch(s).then(a=>{for(let n=0;n<t.length;++n){const l=a.stepResults.get(n),i=a.stepErrors.get(n);t[n].callback(l,i)}})}async function Ao(e,t,s){const a=await e._openCursor(s);try{let n=0,l,i=[];for(;;){const r=await a.next();if(r===void 0)break;if(r.type==="step_begin"){if(r.step<n||r.step>=t.length)throw new j("Server produced StepBeginEntry for unexpected step");if(l!==void 0)throw new j("Server produced StepBeginEntry before terminating previous step");for(let d=n;d<r.step;++d)t[d].callback(void 0,void 0);n=r.step+1,l=r,i=[]}else if(r.type==="step_end"){if(l===void 0)throw new j("Server produced StepEndEntry but no step is active");const d={cols:l.cols,rows:i,affectedRowCount:r.affectedRowCount,lastInsertRowid:r.lastInsertRowid};t[l.step].callback(d,void 0),l=void 0,i=[]}else if(r.type==="step_error"){if(l===void 0){if(r.step>=t.length)throw new j("Server produced StepErrorEntry for unexpected step");for(let d=n;d<r.step;++d)t[d].callback(void 0,void 0)}else{if(r.step!==l.step)throw new j("Server produced StepErrorEntry for unexpected step");l=void 0,i=[]}t[r.step].callback(void 0,r.error),n=r.step+1}else if(r.type==="row"){if(l===void 0)throw new j("Server produced RowEntry but no step is active");i.push(r.row)}else throw r.type==="error"?As(r.error):r.type==="none"?new j("Server produced unrecognized CursorEntry"):J(r,"Impossible CursorEntry")}if(l!==void 0)throw new j("Server closed Cursor before terminating active step");for(let r=n;r<t.length;++r)t[r].callback(void 0,void 0)}finally{a.close()}}var st,Ft,Fs,Rl;let To=(Rl=class{constructor(t){k(this,Ft);q(this,"_batch");k(this,st);q(this,"_index");this._batch=t,m(this,st,[]),this._index=void 0}condition(t){return c(this,st).push(t._proto),this}query(t){return S(this,Ft,Fs).call(this,t,!0,ii)}queryRow(t){return S(this,Ft,Fs).call(this,t,!0,ri)}queryValue(t){return S(this,Ft,Fs).call(this,t,!0,oi)}run(t){return S(this,Ft,Fs).call(this,t,!1,fa)}},st=new WeakMap,Ft=new WeakSet,Fs=function(t,s,a){if(this._index!==void 0)throw new Os("This BatchStep has already been added to the batch");const n=pi(this._batch._stream._sqlOwner(),t,s);let l;c(this,st).length===0?l=void 0:c(this,st).length===1?l=c(this,st)[0]:l={type:"and",conds:c(this,st).slice()};const i={stmt:n,condition:l};return new Promise((r,d)=>{const o=(u,f)=>{u!==void 0&&f!==void 0?d(new j("Server returned both result and error")):f!==void 0?d(As(f)):r(u!==void 0?a(u,this._batch._stream.intMode):void 0)};this._index=this._batch._steps.length,this._batch._steps.push({proto:i,callback:o})})},Rl),we=class jt{constructor(t,s){q(this,"_batch");q(this,"_proto");this._batch=t,this._proto=s}static ok(t){return new jt(t._batch,{type:"ok",step:ll(t)})}static error(t){return new jt(t._batch,{type:"error",step:ll(t)})}static not(t){return new jt(t._batch,{type:"not",cond:t._proto})}static and(t,s){for(const a of s)il(t,a);return new jt(t,{type:"and",conds:s.map(a=>a._proto)})}static or(t,s){for(const a of s)il(t,a);return new jt(t,{type:"or",conds:s.map(a=>a._proto)})}static isAutocommit(t){return t._stream.client()._ensureVersion(3,"BatchCond.isAutocommit()"),new jt(t,{type:"is_autocommit"})}};function ll(e){if(e._index===void 0)throw new Os("Cannot add a condition referencing a step that has not been added to the batch");return e._index}function il(e,t){if(t._batch!==e)throw new Os("Cannot mix BatchCond objects for different Batch objects")}function Mo(e){return{paramNames:e.params.map(t=>t.name),columns:e.cols,isExplain:e.isExplain,isReadonly:e.isReadonly}}var Ut,Us;class ui{constructor(t){k(this,Ut);q(this,"intMode");this.intMode=t}query(t){return S(this,Ut,Us).call(this,t,!0,ii)}queryRow(t){return S(this,Ut,Us).call(this,t,!0,ri)}queryValue(t){return S(this,Ut,Us).call(this,t,!0,oi)}run(t){return S(this,Ut,Us).call(this,t,!1,fa)}batch(t=!1){return new Co(this,t)}describe(t){const s=ln(this._sqlOwner(),t);return this._describe(s).then(Mo)}sequence(t){const s=ln(this._sqlOwner(),t);return this._sequence(s)}}Ut=new WeakSet,Us=function(t,s,a){const n=pi(this._sqlOwner(),t,s);return this._execute(n).then(l=>a(l,this.intMode))};class xi{}const Do=1e3,Oo=10;var ja,Vt,xs,fs,Ht,at,Gt,Pa,fi;class Lo extends xi{constructor(s,a,n){super();k(this,Pa);k(this,ja);k(this,Vt);k(this,xs);k(this,fs);k(this,Ht);k(this,at);k(this,Gt);m(this,ja,s),m(this,Vt,a),m(this,xs,n),m(this,fs,new Ca),m(this,Ht,new Ca),m(this,at,void 0),m(this,Gt,!1)}async next(){for(;;){if(c(this,at)!==void 0)throw new Ae("Cursor is closed",c(this,at));for(;!c(this,Gt)&&c(this,Ht).length<Oo;)c(this,Ht).push(S(this,Pa,fi).call(this));const s=c(this,fs).shift();if(c(this,Gt)||s!==void 0)return s;await c(this,Ht).shift().then(a=>{if(a!==void 0){for(const n of a.entries)c(this,fs).push(n);c(this,Gt)||m(this,Gt,a.done)}})}}_setClosed(s){c(this,at)===void 0&&(m(this,at,s),c(this,Vt)._sendCursorRequest(this,{type:"close_cursor",cursorId:c(this,xs)}).catch(()=>{}),c(this,Vt)._cursorClosed(this))}close(){this._setClosed(new Y("Cursor was manually closed"))}get closed(){return c(this,at)!==void 0}}ja=new WeakMap,Vt=new WeakMap,xs=new WeakMap,fs=new WeakMap,Ht=new WeakMap,at=new WeakMap,Gt=new WeakMap,Pa=new WeakSet,fi=function(){return c(this,Vt)._sendCursorRequest(this,{type:"fetch_cursor",cursorId:c(this,xs),maxCount:Do}).then(s=>s,s=>{this._setClosed(s)})};var ne,Ce,nt,$e,wt,De,Z,ts,on,_a,Sa;const Jn=class Jn extends ui{constructor(s,a){super(s.intMode);k(this,Z);k(this,ne);k(this,Ce);k(this,nt);k(this,$e);k(this,wt);k(this,De);m(this,ne,s),m(this,Ce,a),m(this,nt,new Ca),m(this,$e,void 0),m(this,wt,!1),m(this,De,void 0)}static open(s){const a=s._streamIdAlloc.alloc(),n=new Jn(s,a),l=()=>{},i=d=>{var o;return S(o=n,Z,Sa).call(o,d)},r={type:"open_stream",streamId:a};return s._sendRequest(r,{responseCallback:l,errorCallback:i}),n}client(){return c(this,ne)}_sqlOwner(){return c(this,ne)}_execute(s){return S(this,Z,ts).call(this,{type:"execute",streamId:c(this,Ce),stmt:s}).then(a=>a.result)}_batch(s){return S(this,Z,ts).call(this,{type:"batch",streamId:c(this,Ce),batch:s}).then(a=>a.result)}_describe(s){return c(this,ne)._ensureVersion(2,"describe()"),S(this,Z,ts).call(this,{type:"describe",streamId:c(this,Ce),sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return c(this,ne)._ensureVersion(2,"sequence()"),S(this,Z,ts).call(this,{type:"sequence",streamId:c(this,Ce),sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return c(this,ne)._ensureVersion(3,"getAutocommit()"),S(this,Z,ts).call(this,{type:"get_autocommit",streamId:c(this,Ce)}).then(s=>s.isAutocommit)}_openCursor(s){return c(this,ne)._ensureVersion(3,"cursor"),new Promise((a,n)=>{S(this,Z,on).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_sendCursorRequest(s,a){if(s!==c(this,$e))throw new At("Cursor not associated with the stream attempted to execute a request");return new Promise((n,l)=>{c(this,De)!==void 0?l(new Ae("Stream is closed",c(this,De))):c(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})})}_cursorClosed(s){if(s!==c(this,$e))throw new At("Cursor was closed, but it was not associated with the stream");m(this,$e,void 0),S(this,Z,_a).call(this)}close(){S(this,Z,Sa).call(this,new Y("Stream was manually closed"))}closeGracefully(){m(this,wt,!0),S(this,Z,_a).call(this)}get closed(){return c(this,De)!==void 0||c(this,wt)}};ne=new WeakMap,Ce=new WeakMap,nt=new WeakMap,$e=new WeakMap,wt=new WeakMap,De=new WeakMap,Z=new WeakSet,ts=function(s){return new Promise((a,n)=>{S(this,Z,on).call(this,{type:"request",request:s,responseCallback:a,errorCallback:n})})},on=function(s){c(this,De)!==void 0?s.errorCallback(new Ae("Stream is closed",c(this,De))):c(this,wt)?s.errorCallback(new Ae("Stream is closing",void 0)):(c(this,nt).push(s),S(this,Z,_a).call(this))},_a=function(){for(;;){const s=c(this,nt).first();if(s===void 0&&c(this,$e)===void 0&&c(this,wt)){S(this,Z,Sa).call(this,new Y("Stream was gracefully closed"));break}else if((s==null?void 0:s.type)==="request"&&c(this,$e)===void 0){const{request:a,responseCallback:n,errorCallback:l}=s;c(this,nt).shift(),c(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})}else if((s==null?void 0:s.type)==="cursor"&&c(this,$e)===void 0){const{batch:a,cursorCallback:n}=s;c(this,nt).shift();const l=c(this,ne)._cursorIdAlloc.alloc(),i=new Lo(c(this,ne),this,l),r={type:"open_cursor",streamId:c(this,Ce),cursorId:l,batch:a},d=()=>{},o=u=>i._setClosed(u);c(this,ne)._sendRequest(r,{responseCallback:d,errorCallback:o}),m(this,$e,i),n(i)}else break}},Sa=function(s){if(c(this,De)!==void 0)return;for(m(this,De,s),c(this,$e)!==void 0&&c(this,$e)._setClosed(s);;){const i=c(this,nt).shift();if(i!==void 0)i.errorCallback(s);else break}const a={type:"close_stream",streamId:c(this,Ce)},n=()=>c(this,ne)._streamIdAlloc.free(c(this,Ce)),l=()=>{};c(this,ne)._sendRequest(a,{responseCallback:n,errorCallback:l})};let rn=Jn;function In(e,t){t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId),e.arrayObjects("args",t.args,bi),e.arrayObjects("named_args",t.namedArgs,jo),e.boolean("want_rows",t.wantRows)}function jo(e,t){e.string("name",t.name),e.object("value",t.value,bi)}function Ra(e,t){e.arrayObjects("steps",t.steps,Po)}function Po(e,t){t.condition!==void 0&&e.object("condition",t.condition,cn),e.object("stmt",t.stmt,In)}function cn(e,t){if(e.stringRaw("type",t.type),t.type==="ok"||t.type==="error")e.number("step",t.step);else if(t.type==="not")e.object("cond",t.cond,cn);else if(t.type==="and"||t.type==="or")e.arrayObjects("conds",t.conds,cn);else if(t.type!=="is_autocommit")throw J(t,"Impossible type of BatchCond")}function bi(e,t){if(t===null)e.stringRaw("type","null");else if(typeof t=="bigint")e.stringRaw("type","integer"),e.stringRaw("value",""+t);else if(typeof t=="number")e.stringRaw("type","float"),e.number("value",t);else if(typeof t=="string")e.stringRaw("type","text"),e.string("value",t);else if(t instanceof Uint8Array)e.stringRaw("type","blob"),e.stringRaw("base64",Sn.fromUint8Array(t));else if(t!==void 0)throw J(t,"Impossible type of Value")}function No(e,t){if(e.stringRaw("type",t.type),t.type==="hello")t.jwt!==void 0&&e.string("jwt",t.jwt);else if(t.type==="request")e.number("request_id",t.requestId),e.object("request",t.request,qo);else throw J(t,"Impossible type of ClientMsg")}function qo(e,t){if(e.stringRaw("type",t.type),t.type==="open_stream")e.number("stream_id",t.streamId);else if(t.type==="close_stream")e.number("stream_id",t.streamId);else if(t.type==="execute")e.number("stream_id",t.streamId),e.object("stmt",t.stmt,In);else if(t.type==="batch")e.number("stream_id",t.streamId),e.object("batch",t.batch,Ra);else if(t.type==="open_cursor")e.number("stream_id",t.streamId),e.number("cursor_id",t.cursorId),e.object("batch",t.batch,Ra);else if(t.type==="close_cursor")e.number("cursor_id",t.cursorId);else if(t.type==="fetch_cursor")e.number("cursor_id",t.cursorId),e.number("max_count",t.maxCount);else if(t.type==="sequence")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type==="get_autocommit")e.number("stream_id",t.streamId);else throw J(t,"Impossible type of Request")}function Cn(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId);for(const s of t.args)e.message(3,s,mi);for(const s of t.namedArgs)e.message(4,s,Bo);e.bool(5,t.wantRows)}function Bo(e,t){e.string(1,t.name),e.message(2,t.value,mi)}function Ba(e,t){for(const s of t.steps)e.message(1,s,Fo)}function Fo(e,t){t.condition!==void 0&&e.message(1,t.condition,Rn),e.message(2,t.stmt,Cn)}function Rn(e,t){if(t.type==="ok")e.uint32(1,t.step);else if(t.type==="error")e.uint32(2,t.step);else if(t.type==="not")e.message(3,t.cond,Rn);else if(t.type==="and")e.message(4,t.conds,rl);else if(t.type==="or")e.message(5,t.conds,rl);else if(t.type==="is_autocommit")e.message(6,void 0,hi);else throw J(t,"Impossible type of BatchCond")}function rl(e,t){for(const s of t)e.message(1,s,Rn)}function mi(e,t){if(t===null)e.message(1,void 0,hi);else if(typeof t=="bigint")e.sint64(2,t);else if(typeof t=="number")e.double(3,t);else if(typeof t=="string")e.string(4,t);else if(t instanceof Uint8Array)e.bytes(5,t);else if(t!==void 0)throw J(t,"Impossible type of Value")}function hi(e,t){}function Uo(e,t){if(t.type==="hello")e.message(1,t,Vo);else if(t.type==="request")e.message(2,t,Ho);else throw J(t,"Impossible type of ClientMsg")}function Vo(e,t){t.jwt!==void 0&&e.string(1,t.jwt)}function Ho(e,t){e.int32(1,t.requestId);const s=t.request;if(s.type==="open_stream")e.message(2,s,Go);else if(s.type==="close_stream")e.message(3,s,Wo);else if(s.type==="execute")e.message(4,s,zo);else if(s.type==="batch")e.message(5,s,Yo);else if(s.type==="open_cursor")e.message(6,s,Jo);else if(s.type==="close_cursor")e.message(7,s,Ko);else if(s.type==="fetch_cursor")e.message(8,s,Qo);else if(s.type==="sequence")e.message(9,s,Xo);else if(s.type==="describe")e.message(10,s,Zo);else if(s.type==="store_sql")e.message(11,s,ec);else if(s.type==="close_sql")e.message(12,s,tc);else if(s.type==="get_autocommit")e.message(13,s,sc);else throw J(s,"Impossible type of Request")}function Go(e,t){e.int32(1,t.streamId)}function Wo(e,t){e.int32(1,t.streamId)}function zo(e,t){e.int32(1,t.streamId),e.message(2,t.stmt,Cn)}function Yo(e,t){e.int32(1,t.streamId),e.message(2,t.batch,Ba)}function Jo(e,t){e.int32(1,t.streamId),e.int32(2,t.cursorId),e.message(3,t.batch,Ba)}function Ko(e,t){e.int32(1,t.cursorId)}function Qo(e,t){e.int32(1,t.cursorId),e.uint32(2,t.maxCount)}function Xo(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function Zo(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function ec(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function tc(e,t){e.int32(1,t.sqlId)}function sc(e,t){e.int32(1,t.streamId)}function Ts(e){const t=qe(e.message),s=Fe(e.code);return{message:t,code:s}}function An(e){const t=Tt(e.cols,gi),s=Ia(e.rows).map(i=>Tt(i,ki)),a=Xt(e.affected_row_count),n=Fe(e.last_insert_rowid),l=n!==void 0?BigInt(n):void 0;return{cols:t,rows:s,affectedRowCount:a,lastInsertRowid:l}}function gi(e){const t=Fe(e.name),s=Fe(e.decltype);return{name:t,decltype:s}}function vi(e){const t=new Map;Ia(e.step_results).forEach((a,n)=>{a!==null&&t.set(n,An(ie(a)))});const s=new Map;return Ia(e.step_errors).forEach((a,n)=>{a!==null&&s.set(n,Ts(ie(a)))}),{stepResults:t,stepErrors:s}}function wi(e){const t=qe(e.type);if(t==="step_begin"){const s=Xt(e.step),a=Tt(e.cols,gi);return{type:"step_begin",step:s,cols:a}}else if(t==="step_end"){const s=Xt(e.affected_row_count),a=Fe(e.last_insert_rowid),n=a!==void 0?BigInt(a):void 0;return{type:"step_end",affectedRowCount:s,lastInsertRowid:n}}else if(t==="step_error"){const s=Xt(e.step),a=Ts(ie(e.error));return{type:"step_error",step:s,error:a}}else{if(t==="row")return{type:"row",row:Tt(e.row,ki)};if(t==="error")return{type:"error",error:Ts(ie(e.error))};throw new j("Unexpected type of CursorEntry")}}function yi(e){const t=Tt(e.params,ac),s=Tt(e.cols,nc),a=Qs(e.is_explain),n=Qs(e.is_readonly);return{params:t,cols:s,isExplain:a,isReadonly:n}}function ac(e){return{name:Fe(e.name)}}function nc(e){const t=qe(e.name),s=Fe(e.decltype);return{name:t,decltype:s}}function ki(e){const t=qe(e.type);if(t==="null")return null;if(t==="integer"){const s=qe(e.value);return BigInt(s)}else{if(t==="float")return Xt(e.value);if(t==="text")return qe(e.value);if(t==="blob")return Sn.toUint8Array(qe(e.base64));throw new j("Unexpected type of Value")}}function lc(e){const t=qe(e.type);if(t==="hello_ok")return{type:"hello_ok"};if(t==="hello_error")return{type:"hello_error",error:Ts(ie(e.error))};if(t==="response_ok"){const s=Xt(e.request_id),a=ic(ie(e.response));return{type:"response_ok",requestId:s,response:a}}else if(t==="response_error"){const s=Xt(e.request_id),a=Ts(ie(e.error));return{type:"response_error",requestId:s,error:a}}else throw new j("Unexpected type of ServerMsg")}function ic(e){const t=qe(e.type);if(t==="open_stream")return{type:"open_stream"};if(t==="close_stream")return{type:"close_stream"};if(t==="execute")return{type:"execute",result:An(ie(e.result))};if(t==="batch")return{type:"batch",result:vi(ie(e.result))};if(t==="open_cursor")return{type:"open_cursor"};if(t==="close_cursor")return{type:"close_cursor"};if(t==="fetch_cursor"){const s=Tt(e.entries,wi),a=Qs(e.done);return{type:"fetch_cursor",entries:s,done:a}}else{if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:yi(ie(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Qs(e.is_autocommit)};throw new j("Unexpected type of Response")}}const Je={default(){return{message:"",code:void 0}},1(e,t){t.message=e.string()},2(e,t){t.code=e.string()}},Ms={default(){return{cols:[],rows:[],affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.cols.push(e.message(_i))},2(e,t){t.rows.push(e.message(Si))},3(e,t){t.affectedRowCount=Number(e.uint64())},4(e,t){t.lastInsertRowid=e.sint64()}},_i={default(){return{name:void 0,decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},Si={default(){return[]},1(e,t){t.push(e.message(fc))}},Aa={default(){return{stepResults:new Map,stepErrors:new Map}},1(e,t){const[s,a]=e.message(rc);t.stepResults.set(s,a)},2(e,t){const[s,a]=e.message(oc);t.stepErrors.set(s,a)}},rc={default(){return[0,Ms.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(Ms)}},oc={default(){return[0,Je.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(Je)}},$i={default(){return{type:"none"}},1(e){return e.message(cc)},2(e){return e.message(dc)},3(e){return e.message(pc)},4(e){return{type:"row",row:e.message(Si)}},5(e){return{type:"error",error:e.message(Je)}}},cc={default(){return{type:"step_begin",step:0,cols:[]}},1(e,t){t.step=e.uint32()},2(e,t){t.cols.push(e.message(_i))}},dc={default(){return{type:"step_end",affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.affectedRowCount=e.uint32()},2(e,t){t.lastInsertRowid=e.uint64()}},pc={default(){return{type:"step_error",step:0,error:Je.default()}},1(e,t){t.step=e.uint32()},2(e,t){t.error=e.message(Je)}},Ta={default(){return{params:[],cols:[],isExplain:!1,isReadonly:!1}},1(e,t){t.params.push(e.message(uc))},2(e,t){t.cols.push(e.message(xc))},3(e,t){t.isExplain=e.bool()},4(e,t){t.isReadonly=e.bool()}},uc={default(){return{name:void 0}},1(e,t){t.name=e.string()}},xc={default(){return{name:"",decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},fc={default(){},1(e){return null},2(e){return e.sint64()},3(e){return e.double()},4(e){return e.string()},5(e){return e.bytes()}},bc={default(){return{type:"none"}},1(e){return{type:"hello_ok"}},2(e){return e.message(mc)},3(e){return e.message(gc)},4(e){return e.message(hc)}},mc={default(){return{type:"hello_error",error:Je.default()}},1(e,t){t.error=e.message(Je)}},hc={default(){return{type:"response_error",requestId:0,error:Je.default()}},1(e,t){t.requestId=e.int32()},2(e,t){t.error=e.message(Je)}},gc={default(){return{type:"response_ok",requestId:0,response:{type:"none"}}},1(e,t){t.requestId=e.int32()},2(e,t){t.response={type:"open_stream"}},3(e,t){t.response={type:"close_stream"}},4(e,t){t.response=e.message(vc)},5(e,t){t.response=e.message(wc)},6(e,t){t.response={type:"open_cursor"}},7(e,t){t.response={type:"close_cursor"}},8(e,t){t.response=e.message(yc)},9(e,t){t.response={type:"sequence"}},10(e,t){t.response=e.message(kc)},11(e,t){t.response={type:"store_sql"}},12(e,t){t.response={type:"close_sql"}},13(e,t){t.response=e.message(_c)}},vc={default(){return{type:"execute",result:Ms.default()}},1(e,t){t.result=e.message(Ms)}},wc={default(){return{type:"batch",result:Aa.default()}},1(e,t){t.result=e.message(Aa)}},yc={default(){return{type:"fetch_cursor",entries:[],done:!1}},1(e,t){t.entries.push(e.message($i))},2(e,t){t.done=e.bool()}},kc={default(){return{type:"describe",result:Ta.default()}},1(e,t){t.result=e.message(Ta)}},_c={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},Sc=new Map([["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]),Ei=new Map([["hrana3-protobuf",{version:3,encoding:"protobuf"}],["hrana3",{version:3,encoding:"json"}],["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]);var re,Ge,Wt,he,zt,ge,bs,Oe,yt,ms,U,dn,Ii,pn,Ci,Ri,Ue,Ai,Ti,Al;let $c=(Al=class extends Zl{constructor(s,a){super();k(this,U);k(this,re);k(this,Ge);k(this,Wt);k(this,he);k(this,zt);k(this,ge);k(this,bs);k(this,Oe);k(this,yt);q(this,"_streamIdAlloc");q(this,"_cursorIdAlloc");k(this,ms);m(this,re,s),m(this,Ge,[]),m(this,Wt,!1),m(this,he,void 0),m(this,zt,!1),m(this,ge,void 0),m(this,bs,!1),m(this,Oe,new Map),m(this,yt,new Bs),this._streamIdAlloc=new Bs,this._cursorIdAlloc=new Bs,m(this,ms,new Bs),c(this,re).binaryType="arraybuffer",c(this,re).addEventListener("open",()=>S(this,U,Ii).call(this)),c(this,re).addEventListener("close",n=>S(this,U,Ri).call(this,n)),c(this,re).addEventListener("error",n=>S(this,U,Ci).call(this,n)),c(this,re).addEventListener("message",n=>S(this,U,Ai).call(this,n)),S(this,U,dn).call(this,{type:"hello",jwt:a})}getVersion(){return new Promise((s,a)=>{if(m(this,bs,!0),c(this,he)!==void 0)a(c(this,he));else if(c(this,Wt))s(c(this,ge).version);else{const n=()=>s(c(this,ge).version);c(this,Ge).push({openCallback:n,errorCallback:a})}})}_ensureVersion(s,a){if(c(this,ge)===void 0||!c(this,bs))throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the version supported by the WebSocket server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(c(this,ge).version<s)throw new Rs(`${a} is supported on protocol version ${s} and higher, but the WebSocket server only supports version ${c(this,ge).version}`)}_sendRequest(s,a){if(c(this,he)!==void 0){a.errorCallback(new Ae("Client is closed",c(this,he)));return}const n=c(this,yt).alloc();c(this,Oe).set(n,{...a,type:s.type}),S(this,U,dn).call(this,{type:"request",requestId:n,request:s})}openStream(){return rn.open(this)}storeSql(s){this._ensureVersion(2,"storeSql()");const a=c(this,ms).alloc(),n=new En(this,a),l=()=>{},i=d=>n._setClosed(d),r={type:"store_sql",sqlId:a,sql:s};return this._sendRequest(r,{responseCallback:l,errorCallback:i}),n}_closeSql(s){if(c(this,he)!==void 0)return;const a=()=>c(this,ms).free(s),n=i=>S(this,U,Ue).call(this,i),l={type:"close_sql",sqlId:s};this._sendRequest(l,{responseCallback:a,errorCallback:n})}close(){S(this,U,Ue).call(this,new Y("Client was manually closed"))}get closed(){return c(this,he)!==void 0}},re=new WeakMap,Ge=new WeakMap,Wt=new WeakMap,he=new WeakMap,zt=new WeakMap,ge=new WeakMap,bs=new WeakMap,Oe=new WeakMap,yt=new WeakMap,ms=new WeakMap,U=new WeakSet,dn=function(s){if(c(this,he)!==void 0)throw new At("Trying to send a message on a closed client");if(c(this,Wt))S(this,U,pn).call(this,s);else{const a=()=>S(this,U,pn).call(this,s),n=()=>{};c(this,Ge).push({openCallback:a,errorCallback:n})}},Ii=function(){const s=c(this,re).protocol;if(s===void 0){S(this,U,Ue).call(this,new Y("The `WebSocket.protocol` property is undefined. This most likely means that the WebSocket implementation provided by the environment is broken. If you are using Miniflare 2, please update to Miniflare 3, which fixes this problem."));return}else if(s==="")m(this,ge,{version:1,encoding:"json"});else if(m(this,ge,Ei.get(s)),c(this,ge)===void 0){S(this,U,Ue).call(this,new j(`Unrecognized WebSocket subprotocol: ${JSON.stringify(s)}`));return}for(const a of c(this,Ge))a.openCallback();c(this,Ge).length=0,m(this,Wt,!0)},pn=function(s){const a=c(this,ge).encoding;if(a==="json"){const n=si(s,No);c(this,re).send(n)}else if(a==="protobuf"){const n=ni(s,Uo);c(this,re).send(n)}else throw J(a,"Impossible encoding")},Ci=function(s){const n=s.message??"WebSocket was closed due to an error";S(this,U,Ue).call(this,new tn(n))},Ri=function(s){let a=`WebSocket was closed with code ${s.code}`;s.reason&&(a+=`: ${s.reason}`),S(this,U,Ue).call(this,new tn(a))},Ue=function(s){if(c(this,he)===void 0){m(this,he,s);for(const a of c(this,Ge))a.errorCallback(s);c(this,Ge).length=0;for(const[a,n]of c(this,Oe).entries())n.errorCallback(s),c(this,yt).free(a);c(this,Oe).clear(),c(this,re).close()}},Ai=function(s){if(c(this,he)===void 0)try{let a;const n=c(this,ge).encoding;if(n==="json"){if(typeof s.data!="string"){c(this,re).close(3003,"Only text messages are accepted with JSON encoding"),S(this,U,Ue).call(this,new j("Received non-text message from server with JSON encoding"));return}a=$n(JSON.parse(s.data),lc)}else if(n==="protobuf"){if(!(s.data instanceof ArrayBuffer)){c(this,re).close(3003,"Only binary messages are accepted with Protobuf encoding"),S(this,U,Ue).call(this,new j("Received non-binary message from server with Protobuf encoding"));return}a=qa(new Uint8Array(s.data),bc)}else throw J(n,"Impossible encoding");S(this,U,Ti).call(this,a)}catch(a){c(this,re).close(3007,"Could not handle message"),S(this,U,Ue).call(this,a)}},Ti=function(s){if(s.type==="none")throw new j("Received an unrecognized ServerMsg");if(s.type==="hello_ok"||s.type==="hello_error"){if(c(this,zt))throw new j("Received a duplicated hello response");if(m(this,zt,!0),s.type==="hello_error")throw As(s.error);return}else if(!c(this,zt))throw new j("Received a non-hello message before a hello response");if(s.type==="response_ok"){const a=s.requestId,n=c(this,Oe).get(a);if(c(this,Oe).delete(a),n===void 0)throw new j("Received unexpected OK response");c(this,yt).free(a);try{if(n.type!==s.response.type)throw console.dir({responseState:n,msg:s}),new j("Received unexpected type of response");n.responseCallback(s.response)}catch(l){throw n.errorCallback(l),l}}else if(s.type==="response_error"){const a=s.requestId,n=c(this,Oe).get(a);if(c(this,Oe).delete(a),n===void 0)throw new j("Received unexpected error response");c(this,yt).free(a),n.errorCallback(As(s.error))}else throw J(s,"Impossible ServerMsg type")},Al);var ga=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Ec(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var un={exports:{}};(function(e,t){var s=typeof globalThis<"u"&&globalThis||typeof self<"u"&&self||typeof ga<"u"&&ga,a=function(){function l(){this.fetch=!1,this.DOMException=s.DOMException}return l.prototype=s,new l}();(function(l){(function(i){var r=typeof l<"u"&&l||typeof self<"u"&&self||typeof ga<"u"&&ga||{},d={searchParams:"URLSearchParams"in r,iterable:"Symbol"in r&&"iterator"in Symbol,blob:"FileReader"in r&&"Blob"in r&&function(){try{return new Blob,!0}catch{return!1}}(),formData:"FormData"in r,arrayBuffer:"ArrayBuffer"in r};function o(w){return w&&DataView.prototype.isPrototypeOf(w)}if(d.arrayBuffer)var u=["[object Int8Array]","[object Uint8Array]","[object Uint8ClampedArray]","[object Int16Array]","[object Uint16Array]","[object Int32Array]","[object Uint32Array]","[object Float32Array]","[object Float64Array]"],f=ArrayBuffer.isView||function(w){return w&&u.indexOf(Object.prototype.toString.call(w))>-1};function b(w){if(typeof w!="string"&&(w=String(w)),/[^a-z0-9\-#$%&'*+.^_`|~!]/i.test(w)||w==="")throw new TypeError('Invalid character in header field name: "'+w+'"');return w.toLowerCase()}function h(w){return typeof w!="string"&&(w=String(w)),w}function v(w){var $={next:function(){var L=w.shift();return{done:L===void 0,value:L}}};return d.iterable&&($[Symbol.iterator]=function(){return $}),$}function x(w){this.map={},w instanceof x?w.forEach(function($,L){this.append(L,$)},this):Array.isArray(w)?w.forEach(function($){if($.length!=2)throw new TypeError("Headers constructor: expected name/value pair to be length 2, found"+$.length);this.append($[0],$[1])},this):w&&Object.getOwnPropertyNames(w).forEach(function($){this.append($,w[$])},this)}x.prototype.append=function(w,$){w=b(w),$=h($);var L=this.map[w];this.map[w]=L?L+", "+$:$},x.prototype.delete=function(w){delete this.map[b(w)]},x.prototype.get=function(w){return w=b(w),this.has(w)?this.map[w]:null},x.prototype.has=function(w){return this.map.hasOwnProperty(b(w))},x.prototype.set=function(w,$){this.map[b(w)]=h($)},x.prototype.forEach=function(w,$){for(var L in this.map)this.map.hasOwnProperty(L)&&w.call($,this.map[L],L,this)},x.prototype.keys=function(){var w=[];return this.forEach(function($,L){w.push(L)}),v(w)},x.prototype.values=function(){var w=[];return this.forEach(function($){w.push($)}),v(w)},x.prototype.entries=function(){var w=[];return this.forEach(function($,L){w.push([L,$])}),v(w)},d.iterable&&(x.prototype[Symbol.iterator]=x.prototype.entries);function y(w){if(!w._noBody){if(w.bodyUsed)return Promise.reject(new TypeError("Already read"));w.bodyUsed=!0}}function _(w){return new Promise(function($,L){w.onload=function(){$(w.result)},w.onerror=function(){L(w.error)}})}function R(w){var $=new FileReader,L=_($);return $.readAsArrayBuffer(w),L}function M(w){var $=new FileReader,L=_($),V=/charset=([A-Za-z0-9_-]+)/.exec(w.type),G=V?V[1]:"utf-8";return $.readAsText(w,G),L}function E(w){for(var $=new Uint8Array(w),L=new Array($.length),V=0;V<$.length;V++)L[V]=String.fromCharCode($[V]);return L.join("")}function O(w){if(w.slice)return w.slice(0);var $=new Uint8Array(w.byteLength);return $.set(new Uint8Array(w)),$.buffer}function Q(){return this.bodyUsed=!1,this._initBody=function(w){this.bodyUsed=this.bodyUsed,this._bodyInit=w,w?typeof w=="string"?this._bodyText=w:d.blob&&Blob.prototype.isPrototypeOf(w)?this._bodyBlob=w:d.formData&&FormData.prototype.isPrototypeOf(w)?this._bodyFormData=w:d.searchParams&&URLSearchParams.prototype.isPrototypeOf(w)?this._bodyText=w.toString():d.arrayBuffer&&d.blob&&o(w)?(this._bodyArrayBuffer=O(w.buffer),this._bodyInit=new Blob([this._bodyArrayBuffer])):d.arrayBuffer&&(ArrayBuffer.prototype.isPrototypeOf(w)||f(w))?this._bodyArrayBuffer=O(w):this._bodyText=w=Object.prototype.toString.call(w):(this._noBody=!0,this._bodyText=""),this.headers.get("content-type")||(typeof w=="string"?this.headers.set("content-type","text/plain;charset=UTF-8"):this._bodyBlob&&this._bodyBlob.type?this.headers.set("content-type",this._bodyBlob.type):d.searchParams&&URLSearchParams.prototype.isPrototypeOf(w)&&this.headers.set("content-type","application/x-www-form-urlencoded;charset=UTF-8"))},d.blob&&(this.blob=function(){var w=y(this);if(w)return w;if(this._bodyBlob)return Promise.resolve(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve(new Blob([this._bodyArrayBuffer]));if(this._bodyFormData)throw new Error("could not read FormData body as blob");return Promise.resolve(new Blob([this._bodyText]))}),this.arrayBuffer=function(){if(this._bodyArrayBuffer){var w=y(this);return w||(ArrayBuffer.isView(this._bodyArrayBuffer)?Promise.resolve(this._bodyArrayBuffer.buffer.slice(this._bodyArrayBuffer.byteOffset,this._bodyArrayBuffer.byteOffset+this._bodyArrayBuffer.byteLength)):Promise.resolve(this._bodyArrayBuffer))}else{if(d.blob)return this.blob().then(R);throw new Error("could not read as ArrayBuffer")}},this.text=function(){var w=y(this);if(w)return w;if(this._bodyBlob)return M(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve(E(this._bodyArrayBuffer));if(this._bodyFormData)throw new Error("could not read FormData body as text");return Promise.resolve(this._bodyText)},d.formData&&(this.formData=function(){return this.text().then(T)}),this.json=function(){return this.text().then(JSON.parse)},this}var bt=["CONNECT","DELETE","GET","HEAD","OPTIONS","PATCH","POST","PUT","TRACE"];function Xe(w){var $=w.toUpperCase();return bt.indexOf($)>-1?$:w}function xe(w,$){if(!(this instanceof xe))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');$=$||{};var L=$.body;if(w instanceof xe){if(w.bodyUsed)throw new TypeError("Already read");this.url=w.url,this.credentials=w.credentials,$.headers||(this.headers=new x(w.headers)),this.method=w.method,this.mode=w.mode,this.signal=w.signal,!L&&w._bodyInit!=null&&(L=w._bodyInit,w.bodyUsed=!0)}else this.url=String(w);if(this.credentials=$.credentials||this.credentials||"same-origin",($.headers||!this.headers)&&(this.headers=new x($.headers)),this.method=Xe($.method||this.method||"GET"),this.mode=$.mode||this.mode||null,this.signal=$.signal||this.signal||function(){if("AbortController"in r){var P=new AbortController;return P.signal}}(),this.referrer=null,(this.method==="GET"||this.method==="HEAD")&&L)throw new TypeError("Body not allowed for GET or HEAD requests");if(this._initBody(L),(this.method==="GET"||this.method==="HEAD")&&($.cache==="no-store"||$.cache==="no-cache")){var V=/([?&])_=[^&]*/;if(V.test(this.url))this.url=this.url.replace(V,"$1_="+new Date().getTime());else{var G=/\?/;this.url+=(G.test(this.url)?"&":"?")+"_="+new Date().getTime()}}}xe.prototype.clone=function(){return new xe(this,{body:this._bodyInit})};function T(w){var $=new FormData;return w.trim().split("&").forEach(function(L){if(L){var V=L.split("="),G=V.shift().replace(/\+/g," "),P=V.join("=").replace(/\+/g," ");$.append(decodeURIComponent(G),decodeURIComponent(P))}}),$}function Dt(w){var $=new x,L=w.replace(/\r?\n[\t ]+/g," ");return L.split("\r").map(function(V){return V.indexOf(`
`)===0?V.substr(1,V.length):V}).forEach(function(V){var G=V.split(":"),P=G.shift().trim();if(P){var ma=G.join(":").trim();try{$.append(P,ma)}catch(Ga){console.warn("Response "+Ga.message)}}}),$}Q.call(xe.prototype);function fe(w,$){if(!(this instanceof fe))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');if($||($={}),this.type="default",this.status=$.status===void 0?200:$.status,this.status<200||this.status>599)throw new RangeError("Failed to construct 'Response': The status provided (0) is outside the range [200, 599].");this.ok=this.status>=200&&this.status<300,this.statusText=$.statusText===void 0?"":""+$.statusText,this.headers=new x($.headers),this.url=$.url||"",this._initBody(w)}Q.call(fe.prototype),fe.prototype.clone=function(){return new fe(this._bodyInit,{status:this.status,statusText:this.statusText,headers:new x(this.headers),url:this.url})},fe.error=function(){var w=new fe(null,{status:200,statusText:""});return w.ok=!1,w.status=0,w.type="error",w};var ar=[301,302,303,307,308];fe.redirect=function(w,$){if(ar.indexOf($)===-1)throw new RangeError("Invalid status code");return new fe(null,{status:$,headers:{location:w}})},i.DOMException=r.DOMException;try{new i.DOMException}catch{i.DOMException=function($,L){this.message=$,this.name=L;var V=Error($);this.stack=V.stack},i.DOMException.prototype=Object.create(Error.prototype),i.DOMException.prototype.constructor=i.DOMException}function Ha(w,$){return new Promise(function(L,V){var G=new xe(w,$);if(G.signal&&G.signal.aborted)return V(new i.DOMException("Aborted","AbortError"));var P=new XMLHttpRequest;function ma(){P.abort()}P.onload=function(){var ae={statusText:P.statusText,headers:Dt(P.getAllResponseHeaders()||"")};G.url.indexOf("file://")===0&&(P.status<200||P.status>599)?ae.status=200:ae.status=P.status,ae.url="responseURL"in P?P.responseURL:ae.headers.get("X-Request-URL");var Ot="response"in P?P.response:P.responseText;setTimeout(function(){L(new fe(Ot,ae))},0)},P.onerror=function(){setTimeout(function(){V(new TypeError("Network request failed"))},0)},P.ontimeout=function(){setTimeout(function(){V(new TypeError("Network request timed out"))},0)},P.onabort=function(){setTimeout(function(){V(new i.DOMException("Aborted","AbortError"))},0)};function Ga(ae){try{return ae===""&&r.location.href?r.location.href:ae}catch{return ae}}if(P.open(G.method,Ga(G.url),!0),G.credentials==="include"?P.withCredentials=!0:G.credentials==="omit"&&(P.withCredentials=!1),"responseType"in P&&(d.blob?P.responseType="blob":d.arrayBuffer&&(P.responseType="arraybuffer")),$&&typeof $.headers=="object"&&!($.headers instanceof x||r.Headers&&$.headers instanceof r.Headers)){var Kn=[];Object.getOwnPropertyNames($.headers).forEach(function(ae){Kn.push(b(ae)),P.setRequestHeader(ae,h($.headers[ae]))}),G.headers.forEach(function(ae,Ot){Kn.indexOf(Ot)===-1&&P.setRequestHeader(Ot,ae)})}else G.headers.forEach(function(ae,Ot){P.setRequestHeader(Ot,ae)});G.signal&&(G.signal.addEventListener("abort",ma),P.onreadystatechange=function(){P.readyState===4&&G.signal.removeEventListener("abort",ma)}),P.send(typeof G._bodyInit>"u"?null:G._bodyInit)})}return Ha.polyfill=!0,r.fetch||(r.fetch=Ha,r.Headers=x,r.Request=xe,r.Response=fe),i.Headers=x,i.Request=xe,i.Response=fe,i.fetch=Ha,i})({})})(a),a.fetch.ponyfill=!0,delete a.fetch.polyfill;var n=s.fetch?s:a;t=n.fetch,t.default=n.fetch,t.fetch=n.fetch,t.Headers=n.Headers,t.Request=n.Request,t.Response=n.Response,e.exports=t})(un,un.exports);var Ma=un.exports;let ns;if(typeof queueMicrotask<"u")ns=queueMicrotask;else{const e=Promise.resolve();ns=t=>{e.then(t)}}var Ee,Le,ve,Na,Mi;class Ic{constructor(t){k(this,Na);k(this,Ee);k(this,Le);k(this,ve);m(this,Ee,new Uint8Array(new ArrayBuffer(t))),m(this,Le,0),m(this,ve,0)}get length(){return c(this,ve)-c(this,Le)}data(){return c(this,Ee).slice(c(this,Le),c(this,ve))}push(t){S(this,Na,Mi).call(this,t.byteLength),c(this,Ee).set(t,c(this,ve)),m(this,ve,c(this,ve)+t.byteLength)}shift(t){m(this,Le,c(this,Le)+t)}}Ee=new WeakMap,Le=new WeakMap,ve=new WeakMap,Na=new WeakSet,Mi=function(t){if(c(this,ve)+t<=c(this,Ee).byteLength)return;const s=c(this,ve)-c(this,Le);if(s+t<=c(this,Ee).byteLength&&2*c(this,ve)>=c(this,Ee).byteLength)c(this,Ee).copyWithin(0,c(this,Le),c(this,ve));else{let a=c(this,Ee).byteLength;do a*=2;while(s+t>a);const n=new Uint8Array(new ArrayBuffer(a));n.set(c(this,Ee).slice(c(this,Le),c(this,ve)),0),m(this,Ee,n)}m(this,ve,s),m(this,Le,0)};function Cc(e){const t=Fe(e.baton),s=Fe(e.base_url),a=Tt(e.results,Rc);return{baton:t,baseUrl:s,results:a}}function Rc(e){const t=qe(e.type);if(t==="ok")return{type:"ok",response:Ac(ie(e.response))};if(t==="error")return{type:"error",error:Ts(ie(e.error))};throw new j("Unexpected type of StreamResult")}function Ac(e){const t=qe(e.type);if(t==="close")return{type:"close"};if(t==="execute")return{type:"execute",result:An(ie(e.result))};if(t==="batch")return{type:"batch",result:vi(ie(e.result))};if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:yi(ie(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Qs(e.is_autocommit)};throw new j("Unexpected type of StreamResponse")}function Tc(e){const t=Fe(e.baton),s=Fe(e.base_url);return{baton:t,baseUrl:s}}const Mc={default(){return{baton:void 0,baseUrl:void 0,results:[]}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()},3(e,t){t.results.push(e.message(Dc))}},Dc={default(){return{type:"none"}},1(e){return{type:"ok",response:e.message(Oc)}},2(e){return{type:"error",error:e.message(Je)}}},Oc={default(){return{type:"none"}},1(e){return{type:"close"}},2(e){return e.message(Lc)},3(e){return e.message(jc)},4(e){return{type:"sequence"}},5(e){return e.message(Pc)},6(e){return{type:"store_sql"}},7(e){return{type:"close_sql"}},8(e){return e.message(Nc)}},Lc={default(){return{type:"execute",result:Ms.default()}},1(e,t){t.result=e.message(Ms)}},jc={default(){return{type:"batch",result:Aa.default()}},1(e,t){t.result=e.message(Aa)}},Pc={default(){return{type:"describe",result:Ta.default()}},1(e,t){t.result=e.message(Ta)}},Nc={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},qc={default(){return{baton:void 0,baseUrl:void 0}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()}};var ea,Yt,lt,We,it,hs,ft,xn,Di,Oi;class Bc extends xi{constructor(s,a){super();k(this,ft);k(this,ea);k(this,Yt);k(this,lt);k(this,We);k(this,it);k(this,hs);m(this,ea,s),m(this,Yt,a),m(this,lt,void 0),m(this,We,new Ic(16*1024)),m(this,it,void 0),m(this,hs,!1)}async open(s){if(s.body===null)throw new j("No response body for cursor request");m(this,lt,s.body[Symbol.asyncIterator]());const a=await S(this,ft,xn).call(this,Tc,qc);if(a===void 0)throw new j("Empty response to cursor request");return a}next(){return S(this,ft,xn).call(this,wi,$i)}close(){this._setClosed(new Y("Cursor was manually closed"))}_setClosed(s){c(this,it)===void 0&&(m(this,it,s),c(this,ea)._cursorClosed(this),c(this,lt)!==void 0&&c(this,lt).return())}get closed(){return c(this,it)!==void 0}}ea=new WeakMap,Yt=new WeakMap,lt=new WeakMap,We=new WeakMap,it=new WeakMap,hs=new WeakMap,ft=new WeakSet,xn=async function(s,a){for(;;){if(c(this,hs))return;if(c(this,it)!==void 0)throw new Ae("Cursor is closed",c(this,it));if(c(this,Yt)==="json"){const i=S(this,ft,Di).call(this);if(i!==void 0){const r=new TextDecoder().decode(i),d=JSON.parse(r);return $n(d,s)}}else if(c(this,Yt)==="protobuf"){const i=S(this,ft,Oi).call(this);if(i!==void 0)return qa(i,a)}else throw J(c(this,Yt),"Impossible encoding");if(c(this,lt)===void 0)throw new At("Attempted to read from HTTP cursor before it was opened");const{value:n,done:l}=await c(this,lt).next();if(l&&c(this,We).length===0)m(this,hs,!0);else{if(l)throw new j("Unexpected end of cursor stream");c(this,We).push(n)}}},Di=function(){const s=c(this,We).data(),n=s.indexOf(10);if(n<0)return;const l=s.slice(0,n);return c(this,We).shift(n+1),l},Oi=function(){const s=c(this,We).data();let a=0,n=0;for(;;){if(n>=s.byteLength)return;const i=s[n];if(a|=(i&127)<<7*n,n+=1,!(i&128))break}if(s.byteLength<n+a)return;const l=s.slice(n,n+a);return c(this,We).shift(n+a),l};function Fc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.arrayObjects("requests",t.requests,Uc)}function Uc(e,t){if(e.stringRaw("type",t.type),t.type!=="close"){if(t.type==="execute")e.object("stmt",t.stmt,In);else if(t.type==="batch")e.object("batch",t.batch,Ra);else if(t.type==="sequence")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type!=="get_autocommit")throw J(t,"Impossible type of StreamRequest")}}function Vc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.object("batch",t.batch,Ra)}function Hc(e,t){t.baton!==void 0&&e.string(1,t.baton);for(const s of t.requests)e.message(2,s,Gc)}function Gc(e,t){if(t.type==="close")e.message(1,t,Wc);else if(t.type==="execute")e.message(2,t,zc);else if(t.type==="batch")e.message(3,t,Yc);else if(t.type==="sequence")e.message(4,t,Jc);else if(t.type==="describe")e.message(5,t,Kc);else if(t.type==="store_sql")e.message(6,t,Qc);else if(t.type==="close_sql")e.message(7,t,Xc);else if(t.type==="get_autocommit")e.message(8,t,Zc);else throw J(t,"Impossible type of StreamRequest")}function Wc(e,t){}function zc(e,t){e.message(1,t.stmt,Cn)}function Yc(e,t){e.message(1,t.batch,Ba)}function Jc(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function Kc(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function Qc(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function Xc(e,t){e.int32(1,t.sqlId)}function Zc(e,t){}function ed(e,t){t.baton!==void 0&&e.string(1,t.baton),e.message(2,t.batch,Ba)}var rt,kt,gs,ta,vs,_t,je,St,ot,ct,$t,ze,ws,N,mt,fn,Pt,Li,ji,bn,Pi,Ni,mn;class td extends ui{constructor(s,a,n,l,i){super(s.intMode);k(this,N);k(this,rt);k(this,kt);k(this,gs);k(this,ta);k(this,vs);k(this,_t);k(this,je);k(this,St);k(this,ot);k(this,ct);k(this,$t);k(this,ze);k(this,ws);m(this,rt,s),m(this,kt,a.toString()),m(this,gs,n),m(this,ta,l),m(this,vs,i),m(this,_t,void 0),m(this,je,new Ca),m(this,St,!1),m(this,ct,!1),m(this,$t,!1),m(this,ze,void 0),m(this,ws,new Bs)}client(){return c(this,rt)}_sqlOwner(){return this}storeSql(s){const a=c(this,ws).alloc();return S(this,N,mt).call(this,{type:"store_sql",sqlId:a,sql:s}).then(()=>{},n=>this._setClosed(n)),new En(this,a)}_closeSql(s){c(this,ze)===void 0&&S(this,N,mt).call(this,{type:"close_sql",sqlId:s}).then(()=>c(this,ws).free(s),a=>this._setClosed(a))}_execute(s){return S(this,N,mt).call(this,{type:"execute",stmt:s}).then(a=>a.result)}_batch(s){return S(this,N,mt).call(this,{type:"batch",batch:s}).then(a=>a.result)}_describe(s){return S(this,N,mt).call(this,{type:"describe",sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return S(this,N,mt).call(this,{type:"sequence",sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return c(this,rt)._ensureVersion(3,"getAutocommit()"),S(this,N,mt).call(this,{type:"get_autocommit"}).then(s=>s.isAutocommit)}_openCursor(s){return new Promise((a,n)=>{S(this,N,fn).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_cursorClosed(s){if(s!==c(this,ot))throw new At("Cursor was closed, but it was not associated with the stream");m(this,ot,void 0),ns(()=>S(this,N,Pt).call(this))}close(){this._setClosed(new Y("Stream was manually closed"))}closeGracefully(){m(this,ct,!0),ns(()=>S(this,N,Pt).call(this))}get closed(){return c(this,ze)!==void 0||c(this,ct)}_setClosed(s){if(c(this,ze)===void 0){for(m(this,ze,s),c(this,ot)!==void 0&&c(this,ot)._setClosed(s),c(this,rt)._streamClosed(this);;){const a=c(this,je).shift();if(a!==void 0)a.errorCallback(s);else break}(c(this,_t)!==void 0||c(this,St))&&!c(this,$t)&&(c(this,je).push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),m(this,$t,!0),ns(()=>S(this,N,Pt).call(this)))}}}rt=new WeakMap,kt=new WeakMap,gs=new WeakMap,ta=new WeakMap,vs=new WeakMap,_t=new WeakMap,je=new WeakMap,St=new WeakMap,ot=new WeakMap,ct=new WeakMap,$t=new WeakMap,ze=new WeakMap,ws=new WeakMap,N=new WeakSet,mt=function(s){return new Promise((a,n)=>{S(this,N,fn).call(this,{type:"pipeline",request:s,responseCallback:a,errorCallback:n})})},fn=function(s){if(c(this,ze)!==void 0)throw new Ae("Stream is closed",c(this,ze));if(c(this,ct))throw new Ae("Stream is closing",void 0);c(this,je).push(s),ns(()=>S(this,N,Pt).call(this))},Pt=function(){if(c(this,St)||c(this,ot)!==void 0)return;if(c(this,ct)&&c(this,je).length===0){this._setClosed(new Y("Stream was gracefully closed"));return}const s=c(this,rt)._endpoint;if(s===void 0){c(this,rt)._endpointPromise.then(()=>S(this,N,Pt).call(this),n=>this._setClosed(n));return}const a=c(this,je).shift();if(a!==void 0)if(a.type==="pipeline"){const n=[a];for(;;){const l=c(this,je).first();if(l!==void 0&&l.type==="pipeline")n.push(l),c(this,je).shift();else if(l===void 0&&c(this,ct)&&!c(this,$t)){n.push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),m(this,$t,!0);break}else break}S(this,N,Li).call(this,s,n)}else if(a.type==="cursor")S(this,N,ji).call(this,s,a);else throw J(a,"Impossible type of QueueEntry")},Li=function(s,a){S(this,N,bn).call(this,()=>S(this,N,Pi).call(this,a,s),n=>ad(n,s.encoding),n=>n.baton,n=>n.baseUrl,n=>sd(a,n),n=>a.forEach(l=>l.errorCallback(n)))},ji=function(s,a){const n=new Bc(this,s.encoding);m(this,ot,n),S(this,N,bn).call(this,()=>S(this,N,Ni).call(this,a,s),l=>n.open(l),l=>l.baton,l=>l.baseUrl,l=>a.cursorCallback(n),l=>a.errorCallback(l))},bn=function(s,a,n,l,i,r){let d;try{const o=s();d=c(this,ta)(o)}catch(o){d=Promise.reject(o)}m(this,St,!0),d.then(o=>o.ok?a(o):nd(o).then(u=>{throw u})).then(o=>{m(this,_t,n(o)),m(this,kt,l(o)??c(this,kt)),i(o)}).catch(o=>{this._setClosed(o),r(o)}).finally(()=>{m(this,St,!1),S(this,N,Pt).call(this)})},Pi=function(s,a){return S(this,N,mn).call(this,new URL(a.pipelinePath,c(this,kt)),{baton:c(this,_t),requests:s.map(n=>n.request)},a.encoding,Fc,Hc)},Ni=function(s,a){if(a.cursorPath===void 0)throw new Rs(`Cursors are supported only on protocol version 3 and higher, but the HTTP server only supports version ${a.version}.`);return S(this,N,mn).call(this,new URL(a.cursorPath,c(this,kt)),{baton:c(this,_t),batch:s.batch},a.encoding,Vc,ed)},mn=function(s,a,n,l,i){let r,d;if(n==="json")r=si(a,l),d="application/json";else if(n==="protobuf")r=ni(a,i),d="application/x-protobuf";else throw J(n,"Impossible encoding");const o=new Ma.Headers;return o.set("content-type",d),c(this,gs)!==void 0&&o.set("authorization",`Bearer ${c(this,gs)}`),c(this,vs)!==void 0&&o.set("x-turso-encryption-key",c(this,vs)),new Ma.Request(s.toString(),{method:"POST",headers:o,body:r})};function sd(e,t){if(t.results.length!==e.length)throw new j("Server returned unexpected number of pipeline results");for(let s=0;s<e.length;++s){const a=t.results[s],n=e[s];if(a.type==="ok"){if(a.response.type!==n.request.type)throw new j("Received unexpected type of response");n.responseCallback(a.response)}else if(a.type==="error")n.errorCallback(As(a.error));else throw a.type==="none"?new j("Received unrecognized type of StreamResult"):J(a,"Received impossible type of StreamResult")}}async function ad(e,t){var s;if(t==="json"){const a=await e.json();return $n(a,Cc)}if(t==="protobuf"){const a=await e.arrayBuffer();return qa(new Uint8Array(a),Mc)}throw await((s=e.body)==null?void 0:s.cancel()),J(t,"Impossible encoding")}async function nd(e){var a;const t=e.headers.get("content-type")??"text/plain";let s=`Server returned HTTP status ${e.status}`;if(t==="application/json"){const n=await e.json();return"message"in n?As(n):new ya(s,e.status)}if(t==="text/plain"){const n=(await e.text()).trim();return n!==""&&(s+=`: ${n}`),new ya(s,e.status)}return await((a=e.body)==null?void 0:a.cancel()),new ya(s,e.status)}const ld=[{versionPath:"v3-protobuf",pipelinePath:"v3-protobuf/pipeline",cursorPath:"v3-protobuf/cursor",version:3,encoding:"protobuf"}],hn={versionPath:"v2",pipelinePath:"v2/pipeline",cursorPath:void 0,version:2,encoding:"json"};var ys,sa,ks,aa,dt,Jt,_s,$a,Tl;let id=(Tl=class extends Zl{constructor(s,a,n,l,i=2){super();k(this,_s);k(this,ys);k(this,sa);k(this,ks);k(this,aa);k(this,dt);k(this,Jt);q(this,"_endpointPromise");q(this,"_endpoint");m(this,ys,s),m(this,sa,a),m(this,ks,n??Ma.fetch),m(this,aa,l),m(this,dt,void 0),m(this,Jt,new Set),i==3?(this._endpointPromise=rd(c(this,ks),c(this,ys)),this._endpointPromise.then(r=>this._endpoint=r,r=>S(this,_s,$a).call(this,r))):(this._endpointPromise=Promise.resolve(hn),this._endpointPromise.then(r=>this._endpoint=r,r=>S(this,_s,$a).call(this,r)))}async getVersion(){return this._endpoint!==void 0?this._endpoint.version:(await this._endpointPromise).version}_ensureVersion(s,a){if(!(s<=hn.version)){if(this._endpoint===void 0)throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the version supported by the HTTP server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(this._endpoint.version<s)throw new Rs(`${a} is supported only on protocol version ${s} and higher, but the HTTP server only supports version ${this._endpoint.version}.`)}}openStream(){if(c(this,dt)!==void 0)throw new Ae("Client is closed",c(this,dt));const s=new td(this,c(this,ys),c(this,sa),c(this,ks),c(this,aa));return c(this,Jt).add(s),s}_streamClosed(s){c(this,Jt).delete(s)}close(){S(this,_s,$a).call(this,new Y("Client was manually closed"))}get closed(){return c(this,dt)!==void 0}},ys=new WeakMap,sa=new WeakMap,ks=new WeakMap,aa=new WeakMap,dt=new WeakMap,Jt=new WeakMap,_s=new WeakSet,$a=function(s){if(c(this,dt)===void 0){m(this,dt,s);for(const a of Array.from(c(this,Jt)))a._setClosed(new Ae("Client was closed",s))}},Tl);async function rd(e,t){const s=e;for(const a of ld){const n=new URL(a.versionPath,t),l=new Ma.Request(n.toString(),{method:"GET"}),i=await s(l);if(await i.arrayBuffer(),i.ok)return a}return hn}function qi(e,t,s=2){if(typeof as>"u")throw new ti("WebSockets are not supported in this environment");var a=void 0;s==3?a=Array.from(Ei.keys()):a=Array.from(Sc.keys());const n=new as(e,a);return new $c(n,t)}function ol(e,t,s,a,n=2){return new id(e instanceof URL?e:new URL(e),t,s,a,n)}var Ss,pt,de;class Bi{constructor(t,s){k(this,Ss);k(this,pt);k(this,de);m(this,Ss,t),m(this,pt,s),m(this,de,void 0)}execute(t){return this.batch([t]).then(s=>s[0])}async batch(t){const s=this._getStream();if(s.closed)throw new F("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{const a=t.map(Zt);let n;if(c(this,de)===void 0){this._getSqlCache().apply(a);const i=s.batch(c(this,pt)>=3),r=i.step(),d=r.run(en(c(this,Ss)));let o=r;n=a.map(u=>{const f=i.step().condition(we.ok(o));c(this,pt)>=3&&f.condition(we.not(we.isAutocommit(i)));const b=f.query(u);return b.catch(()=>{}),o=f,b}),m(this,de,i.execute().then(()=>d).then(()=>{}));try{await c(this,de)}catch(u){throw this.close(),u}}else{c(this,pt)<3&&await c(this,de),this._getSqlCache().apply(a);const i=s.batch(c(this,pt)>=3);let r;n=a.map(d=>{const o=i.step();r!==void 0&&o.condition(we.ok(r)),c(this,pt)>=3&&o.condition(we.not(we.isAutocommit(i)));const u=o.query(d);return u.catch(()=>{}),r=o,u}),await i.execute()}const l=[];for(let i=0;i<n.length;i++)try{const r=await n[i];if(r===void 0)throw new ls("Statement in a transaction was not executed, probably because the transaction has been rolled back",i,"TRANSACTION_CLOSED");l.push(Fa(r))}catch(r){if(r instanceof ls)throw r;const d=z(r);throw d instanceof F?new ls(d.message,i,d.code,d.extendedCode,d.rawCode,d.cause instanceof Error?d.cause:void 0):d}return l}catch(a){throw z(a)}}async executeMultiple(t){const s=this._getStream();if(s.closed)throw new F("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{if(c(this,de)===void 0){m(this,de,s.run(en(c(this,Ss))).then(()=>{}));try{await c(this,de)}catch(a){throw this.close(),a}}else await c(this,de);await s.sequence(t)}catch(a){throw z(a)}}async rollback(){try{const t=this._getStream();if(t.closed||c(this,de)===void 0)return;const s=t.run("ROLLBACK").catch(a=>{throw z(a)});t.closeGracefully(),await s}catch(t){throw z(t)}finally{this.close()}}async commit(){try{const t=this._getStream();if(t.closed)throw new F("Cannot commit the transaction because it is already closed","TRANSACTION_CLOSED");if(c(this,de)!==void 0)await c(this,de);else return;const s=t.run("COMMIT").catch(a=>{throw z(a)});t.closeGracefully(),await s}catch(t){throw z(t)}finally{this.close()}}}Ss=new WeakMap,pt=new WeakMap,de=new WeakMap;async function Da(e,t,s,a,n=!1){n&&s.step().run("PRAGMA foreign_keys=off");const l=s.step(),i=l.run(en(e));let r=l;const d=a.map(h=>{const v=s.step().condition(we.ok(r));t>=3&&v.condition(we.not(we.isAutocommit(s)));const x=v.query(h);return r=v,x}),o=s.step().condition(we.ok(r));t>=3&&o.condition(we.not(we.isAutocommit(s)));const u=o.run("COMMIT");s.step().condition(we.not(we.ok(o))).run("ROLLBACK").catch(h=>{}),n&&s.step().run("PRAGMA foreign_keys=on"),await s.execute();const b=[];await i;for(let h=0;h<d.length;h++)try{const v=await d[h];if(v===void 0)throw new ls("Statement in a batch was not executed, probably because the transaction has been rolled back",h,"TRANSACTION_CLOSED");b.push(Fa(v))}catch(v){if(v instanceof ls)throw v;const x=z(v);throw x instanceof F?new ls(x.message,h,x.code,x.extendedCode,x.rawCode,x.cause instanceof Error?x.cause:void 0):x}return await u,b}function Zt(e){let t,s;Array.isArray(e)?[t,s]=e:typeof e=="string"?t=e:(t=e.sql,s=e.args);const a=new di(t);if(s)if(Array.isArray(s))a.bindIndexes(s);else for(const[n,l]of Object.entries(s))a.bindName(n,l);return a}function Fa(e){const t=e.columnNames.map(i=>i??""),s=e.columnDecltypes.map(i=>i??""),a=e.rows,n=e.affectedRowCount,l=e.lastInsertRowid!==void 0?e.lastInsertRowid:void 0;return new go(t,s,a,n,l)}function z(e){if(e instanceof Y){const t=Fi(e);return new F(e.message,t,void 0,void 0,e)}return e}function Fi(e){return e instanceof ei&&e.code!==void 0?e.code:e instanceof j?"HRANA_PROTO_ERROR":e instanceof Ae?e.cause instanceof Y?Fi(e.cause):"HRANA_CLOSED_ERROR":e instanceof tn?"HRANA_WEBSOCKET_ERROR":e instanceof ya?"SERVER_ERROR":e instanceof Rs?"PROTOCOL_VERSION_ERROR":e instanceof At?"INTERNAL_ERROR":"UNKNOWN"}var na,Ye;class Tn{constructor(t,s){k(this,na);k(this,Ye);q(this,"capacity");m(this,na,t),m(this,Ye,new od),this.capacity=s}apply(t){if(this.capacity<=0)return;const s=new Set;for(const a of t){if(typeof a.sql!="string")continue;const n=a.sql;if(n.length>=5e3)continue;let l=c(this,Ye).get(n);if(l===void 0){for(;c(this,Ye).size+1>this.capacity;){const[i,r]=c(this,Ye).peekLru();if(s.has(r))break;r.close(),c(this,Ye).delete(i)}c(this,Ye).size+1<=this.capacity&&(l=c(this,na).storeSql(n),c(this,Ye).set(n,l))}l!==void 0&&(a.sql=l,s.add(l))}}}na=new WeakMap,Ye=new WeakMap;var Pe;class od{constructor(){k(this,Pe);m(this,Pe,new Map)}get(t){const s=c(this,Pe).get(t);return s!==void 0&&(c(this,Pe).delete(t),c(this,Pe).set(t,s)),s}set(t,s){c(this,Pe).set(t,s)}peekLru(){for(const t of c(this,Pe).entries())return t}delete(t){c(this,Pe).delete(t)}get size(){return c(this,Pe).size}}Pe=new WeakMap;function cd(e){var t=0,s=[];function a(){t--,t<e&&n()}function n(){var d=s.shift();r.queue=s.length,d&&i(d.fn).then(d.resolve).catch(d.reject)}function l(d){return new Promise(function(o,u){s.push({fn:d,resolve:o,reject:u}),r.queue=s.length})}function i(d){t++;try{return Promise.resolve(d()).then(function(o){return a(),o},function(o){throw a(),o})}catch(o){return a(),Promise.reject(o)}}var r=function(d){return t>=e?l(d):i(d)};return r}function dd(e,t){var s=!1,a=this;return Promise.all(e.map(function(){var n=arguments;return a(function(){if(!s)return t.apply(void 0,n).catch(function(l){throw s=!0,l})})}))}function cl(e){return e.queue=0,e.map=dd,e}var pd=function(e){return cl(e?cd(e):function(t){return t()})};const Ui=Ec(pd);function ud(e){if(e.scheme!=="wss"&&e.scheme!=="ws")throw new F(`The WebSocket client supports only "libsql:", "wss:" and "ws:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new F("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="ws"&&e.tls)throw new F('A "ws:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="wss"&&!e.tls)throw new F('A "wss:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Qa(e.scheme,e.authority,e.path);let s;try{s=qi(t,e.authToken)}catch(a){if(a instanceof ti){const n=e.scheme==="wss"?"https":"http",l=Qa(n,e.authority,e.path);throw new F(`This environment does not support WebSockets, please switch to the HTTP client by using a "${n}:" URL (${JSON.stringify(l)}). For more information, please read ${Ks}`,"WEBSOCKETS_NOT_SUPPORTED")}throw z(a)}return new fd(s,t,e.authToken,e.intMode,e.concurrency)}const xd=60*1e3,dl=100;var la,ia,ra,ee,oe,wn,oa,Ie,ss,Vs;class fd{constructor(t,s,a,n,l){k(this,Ie);k(this,la);k(this,ia);k(this,ra);k(this,ee);k(this,oe);q(this,"closed");q(this,"protocol");k(this,wn);k(this,oa);m(this,la,s),m(this,ia,a),m(this,ra,n),m(this,ee,S(this,Ie,Vs).call(this,t)),m(this,oe,void 0),this.closed=!1,this.protocol="ws",m(this,oa,Ui(l))}async limit(t){return c(this,oa).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{const n=await S(this,Ie,ss).call(this);try{const l=Zt(a);n.conn.sqlCache.apply([l]);const i=n.stream.query(l);n.stream.closeGracefully();const r=await i;return Fa(r)}catch(l){throw z(l)}finally{this._closeStream(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{const a=await S(this,Ie,ss).call(this);try{const l=t.map(u=>Array.isArray(u)?{sql:u[0],args:u[1]||[]}:u).map(Zt),i=await a.conn.client.getVersion();a.conn.sqlCache.apply(l);const r=a.stream.batch(i>=3);return await Da(s,i,r,l)}catch(n){throw z(n)}finally{this._closeStream(a)}})}async migrate(t){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=t.map(Zt),n=await s.conn.client.getVersion(),l=s.stream.batch(n>=3);return await Da("deferred",n,l,a,!0)}catch(a){throw z(a)}finally{this._closeStream(s)}})}async transaction(t="write"){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=await s.conn.client.getVersion();return new bd(this,s,t,a)}catch(a){throw this._closeStream(s),z(a)}})}async executeMultiple(t){return this.limit(async()=>{const s=await S(this,Ie,ss).call(this);try{const a=s.stream.sequence(t);s.stream.closeGracefully(),await a}catch(a){throw z(a)}finally{this._closeStream(s)}})}sync(){throw new F("sync not supported in ws mode","SYNC_NOT_SUPPORTED")}async reconnect(){try{for(const a of Array.from(c(this,ee).streamStates))try{a.stream.close()}catch{}c(this,ee).client.close()}catch{}if(c(this,oe)){try{c(this,oe).client.close()}catch{}m(this,oe,void 0)}const t=S(this,Ie,Vs).call(this),s=await t.client.getVersion();t.useSqlCache=s>=2,t.useSqlCache&&(t.sqlCache.capacity=dl),m(this,ee,t),this.closed=!1}_closeStream(t){t.stream.close();const s=t.conn;s.streamStates.delete(t),s.streamStates.size===0&&s!==c(this,ee)&&s.client.close()}close(){if(c(this,ee).client.close(),this.closed=!0,c(this,oe)){try{c(this,oe).client.close()}catch{}m(this,oe,void 0)}this.closed=!0}}la=new WeakMap,ia=new WeakMap,ra=new WeakMap,ee=new WeakMap,oe=new WeakMap,wn=new WeakMap,oa=new WeakMap,Ie=new WeakSet,ss=async function(){if(this.closed)throw new F("The client is closed","CLIENT_CLOSED");if(new Date().valueOf()-c(this,ee).openTime.valueOf()>xd&&c(this,oe)===void 0){const n=S(this,Ie,Vs).call(this);m(this,oe,n),n.client.getVersion().then(l=>{c(this,ee)!==n&&c(this,ee).streamStates.size===0&&c(this,ee).client.close(),m(this,ee,n),m(this,oe,void 0)},l=>{m(this,oe,void 0)})}if(c(this,ee).client.closed)try{c(this,oe)!==void 0?m(this,ee,c(this,oe)):m(this,ee,S(this,Ie,Vs).call(this))}catch(n){throw z(n)}const a=c(this,ee);try{a.useSqlCache===void 0&&(a.useSqlCache=await a.client.getVersion()>=2,a.useSqlCache&&(a.sqlCache.capacity=dl));const n=a.client.openStream();n.intMode=c(this,ra);const l={conn:a,stream:n};return a.streamStates.add(l),l}catch(n){throw z(n)}},Vs=function(t){try{return t??(t=qi(c(this,la),c(this,ia))),{client:t,useSqlCache:void 0,sqlCache:new Tn(t,0),openTime:new Date,streamStates:new Set}}catch(s){throw z(s)}};var ca,Et;class bd extends Bi{constructor(s,a,n,l){super(n,l);k(this,ca);k(this,Et);m(this,ca,s),m(this,Et,a)}_getStream(){return c(this,Et).stream}_getSqlCache(){return c(this,Et).conn.sqlCache}close(){c(this,ca)._closeStream(c(this,Et))}get closed(){return c(this,Et).stream.closed}}ca=new WeakMap,Et=new WeakMap;function md(e){if(e.scheme!=="https"&&e.scheme!=="http")throw new F(`The HTTP client supports only "libsql:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new F("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="http"&&e.tls)throw new F('A "http:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="https"&&!e.tls)throw new F('A "https:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Qa(e.scheme,e.authority,e.path);return new hd(t,e.authToken,e.intMode,e.fetch,e.concurrency,e.remoteEncryptionKey)}const Vi=30;var te,$s,Es,Is,da,Cs,pa,ua;class hd{constructor(t,s,a,n,l,i){k(this,te);q(this,"protocol");k(this,$s);k(this,Es);k(this,Is);k(this,da);k(this,Cs);k(this,pa);k(this,ua);m(this,$s,t),m(this,Cs,s),m(this,Es,a),m(this,Is,n),m(this,da,l),m(this,pa,i),m(this,te,ol(c(this,$s),c(this,Cs),c(this,Is),i)),c(this,te).intMode=c(this,Es),this.protocol="http",m(this,ua,Ui(c(this,da)))}async limit(t){return c(this,ua).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{try{const n=Zt(a);let l;const i=c(this,te).openStream();try{l=i.query(n)}finally{i.closeGracefully()}const r=await l;return Fa(r)}catch(n){throw z(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{try{const n=t.map(o=>Array.isArray(o)?{sql:o[0],args:o[1]||[]}:o).map(Zt),l=await c(this,te).getVersion();let i;const r=c(this,te).openStream();try{new Tn(r,Vi).apply(n);const u=r.batch(!1);i=Da(s,l,u,n)}finally{r.closeGracefully()}return await i}catch(a){throw z(a)}})}async migrate(t){return this.limit(async()=>{try{const s=t.map(Zt),a=await c(this,te).getVersion();let n;const l=c(this,te).openStream();try{const r=l.batch(!1);n=Da("deferred",a,r,s,!0)}finally{l.closeGracefully()}return await n}catch(s){throw z(s)}})}async transaction(t="write"){return this.limit(async()=>{try{const s=await c(this,te).getVersion();return new gd(c(this,te).openStream(),t,s)}catch(s){throw z(s)}})}async executeMultiple(t){return this.limit(async()=>{try{let s;const a=c(this,te).openStream();try{s=a.sequence(t)}finally{a.closeGracefully()}await s}catch(s){throw z(s)}})}sync(){throw new F("sync not supported in http mode","SYNC_NOT_SUPPORTED")}close(){c(this,te).close()}async reconnect(){try{this.closed||c(this,te).close()}finally{m(this,te,ol(c(this,$s),c(this,Cs),c(this,Is),c(this,pa))),c(this,te).intMode=c(this,Es)}}get closed(){return c(this,te).closed}}te=new WeakMap,$s=new WeakMap,Es=new WeakMap,Is=new WeakMap,da=new WeakMap,Cs=new WeakMap,pa=new WeakMap,ua=new WeakMap;var Kt,xa;class gd extends Bi{constructor(s,a,n){super(a,n);k(this,Kt);k(this,xa);m(this,Kt,s),m(this,xa,new Tn(s,Vi))}_getStream(){return c(this,Kt)}_getSqlCache(){return c(this,xa)}close(){c(this,Kt).close()}get closed(){return c(this,Kt).closed}}Kt=new WeakMap,xa=new WeakMap;function Hi(e){return vd(yo(e))}function vd(e){if(e.scheme==="ws"||e.scheme==="wss")return ud(e);if(e.scheme==="http"||e.scheme==="https")return md(e);throw new F(`The client that uses Web standard APIs supports only "libsql:", "wss:", "ws:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Ks}`,"URL_SCHEME_NOT_SUPPORTED")}const wd={url:"libsql://retailer-os-digitalhues.aws-ap-south-1.turso.io",authToken:"eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzAxODY2NzMsImlkIjoiNDcwMDliODAtYmJlYS00YzQ3LTk1MzQtY2NlYjg4OWUzYjFjIiwicmlkIjoiNTk1ODMwNWEtMjlkNy00OGU5LWJkNTctN2FiZWVjNzVjMWYwIn0.381aJkYkBtcCsSDyQkFNLZud9lOPi9TuT3uRZgLYS9BqrjLFb0Zc7P1qRWN0k16XkHQ7raDwhCUE9H1G8Q80BA"},yd={url:"libsql://retailer-data-digitalhues.aws-ap-south-1.turso.io",authToken:"eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzAyODMwNTgsImlkIjoiZTVmNzQ5MjMtMDFiMi00YzkxLTlmMjEtZTJhZDIxMzBmMmZmIiwicmlkIjoiZjQzNTc5NTMtN2E2OS00M2UzLWE3MWUtNDcyYzk1MWM1NTRiIn0.8dOIX1XeNnJswuRGhacgPypg_h_9_-bRAwBxtKhBX7rJ4bQuEtSz9Z6igZsvGrWxDlsYlHMo4V3KKIuIZRSuBA"},Nt=Hi(wd),pl=Hi(yd);async function g(e,t=[]){try{return(await Nt.execute({sql:e,args:t})).rows}catch(s){throw console.error("DB Query Error:",s.message,"SQL:",e,"Params:",t),s}}async function kd(e){try{return await Nt.batch(e)}catch(t){throw console.error("DB Transaction Error:",t),t}}function I(){return localStorage.getItem("retaileros_retailer_id")}const C={clients:{getAll:()=>{const e=I();return e?g("SELECT * FROM customers WHERE retailer_id = ?",[e]):g("SELECT * FROM customers")},add:e=>{const t=I();return g("INSERT INTO customers (id, name, phone, email, joined_at, dob, location, retailer_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",[e.id,e.name,e.phone||"",e.email||"",new Date().toISOString(),e.dob||null,e.location||"",t])},getById:e=>{const t=I();return t?g("SELECT * FROM customers WHERE id = ? AND retailer_id = ?",[e,t]):g("SELECT * FROM customers WHERE id = ?",[e])}},companies:{getAll:()=>{const e=I();return e?g("SELECT * FROM companies WHERE retailer_id = ?",[e]):g("SELECT * FROM companies")},add:e=>{const t=I();return g("INSERT INTO companies (id, name, gst_number, customer_id, created_at, retailer_id) VALUES (?, ?, ?, ?, ?, ?)",[e.id,e.name,e.gst_number,e.customer_id,new Date().toISOString(),t])},getByCustomerId:e=>{const t=I();return t?g("SELECT * FROM companies WHERE customer_id = ? AND retailer_id = ?",[e,t]):g("SELECT * FROM companies WHERE customer_id = ?",[e])},getById:e=>{const t=I();return t?g("SELECT * FROM companies WHERE id = ? AND retailer_id = ?",[e,t]):g("SELECT * FROM companies WHERE id = ?",[e])}},sales:{getAll:()=>{const e=I();return e?g("SELECT * FROM sales WHERE retailer_id = ? ORDER BY date DESC",[e]):g("SELECT * FROM sales ORDER BY date DESC")},getById:e=>{const t=I();return t?g("SELECT * FROM sales WHERE id = ? AND retailer_id = ?",[e,t]):g("SELECT * FROM sales WHERE id = ?",[e])},getDrafts:()=>{const e=I();return e?g("SELECT * FROM sales WHERE status = 'draft' AND retailer_id = ? ORDER BY date DESC",[e]):g("SELECT * FROM sales WHERE status = 'draft' ORDER BY date DESC")},add:e=>{const t=I();return g(`INSERT INTO sales (id, customer_id, customer_name, date, total_amount, status, payment_mode, payment_reference, gst_required, company_id, installation_required, installation_date, retailer_id)
                ...
                <div class="relative text-left">
                    ...
                    ${l?`
                        <div class="absolute top-full left-0 right-0 z-50 bg-white border border-slate-100 rounded-2xl shadow-2xl mt-2 overflow-hidden text-left max-h-60 overflow-y-auto">
                            ${i.length>0?i.map(o=>{var f;const u=Dn(o);return`
...
`,t+="Powered by RetailerOS",t}function Dd(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function Od(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function Xi(){const e=p.currentTab==="history",t=Ua();if(!t)return`<div class="p-10 text-center opacity-40 flex flex-col items-center justify-center h-full">
    ...
    `}function fl(){const e=window.getCache(),t=e.customers||[],s=p.clientSearchQuery||"",n=[...s?t.filter(l=>l.name.toLowerCase().includes(s.toLowerCase())||l.phone&&l.phone.includes(s)||l.email&&l.email.toLowerCase().includes(s.toLowerCase())):t].sort((l,i)=>new Date(i.joined_at||0)-new Date(l.joined_at||0));return`
    ...
    `}function ml(){return Pd()}function hl(){switch(p.groupViewMode){case"create":return Nd();case"detail":return qd();case"add-members":return Bd();default:return`
                <div class="h-full flex items-center justify-center text-slate-300 text-center p-8">
                    <div class="text-center">
            ...
            `}}function Fd(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function Ud(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function gl(e="desktop"){var u,f;const t=window.getCache(),s=p.clientInvoiceId,a=(t.sales||[]).find(b=>b.id===s);if(!a)return`
...
`,l+="Powered by RetailerOS";const i=`https://wa.me/${((d=a==null?void 0:a.phone)==null?void 0:d.replace(/\D/g,""))||""}?text=${encodeURIComponent(l)}`;window.open(i,"_blank")};function Ln(e){const t=e==="desktop-secondary",s=e==="desktop-primary";return t?p.clientViewMode==="add"?gn("desktop"):p.clientViewMode==="invoice"?gl("desktop"):p.clientViewMode==="profile"?bl("desktop"):p.clientViewMode==="groups"?hl():`
            <div class="h-full flex items-center justify-center text-slate-300 text-center">
                <div class="text-center">
        ...
        `:s?p.clientViewMode==="groups"?ml():fl():p.clientViewMode==="add"?gn("mobile"):p.clientViewMode==="invoice"?gl("mobile"):p.clientViewMode==="profile"?bl("mobile"):p.clientViewMode==="groups"?p.groupViewMode==="detail"||p.groupViewMode==="create"||p.groupViewMode==="add-members"?hl():ml():fl()}const Ya=(e,t,s=[])=>`
...
`;window.setRepairCustomer=(e,t)=>{p.repairContext={customer_name:e,customer_phone:t},D()};function zd(){const e=document.getElementById("repair-search-input"),t=e?e.value.trim():"",s=window.getCache?window.getCache():{customers:[]},a=t?s.customers.filter(n=>n.name.toLowerCase().includes(t.toLowerCase())||n.phone.includes(t)):[];return`
    ...
    `}function vl(){const t=window.getCache().repairs||[];return`
    ...
    `}function Pn(e){const t={search:{t:"RetailerOS",s:"Repairs Management",txn:null},intake:{t:"Device Intake",s:"Repair Management",txn:"TXN-4920"},status:{t:"Job ID: #REP-2024",s:"Repair Assignment",badge:"ACTIVE"},history:{t:"Job History",s:"Service Records",badge:null}},s={search:zd(),intake:Jd(),status:Qd()};if(e==="desktop-primary")return`
            ...
            <div class="scrolling-content px-8 space-y-8 pb-12">
                ${p.repairTab==="active"?s.search:vl()}
            </div>
        ...
        ${Ja(n.t,n.s,l,!0)}
        <div class="scrolling-content px-8 space-y-8 pb-12">
            ${p.repairTab==="history"?vl():s[p.repairViewMode]}
        </div>
    `}function Xd(){return`
        <header class="p-4 sm:p-8 pb-4 shrink-0">
             <div class="flex items-center justify-between mb-6">
    ...
    `}function Nn(e){const t=e==="desktop-secondary",s=e==="mobile";if(t)return yl();if(s){const a=window._marketingState||{},n=a.generatedImageUrl||a.isGenerating||a.lastError;return`
            ${wl()}
            ${n?`
                <div class="px-4 pb-8">
                    ${yl()}
    ...
    `}function qn(e){const t=e==="desktop-secondary";return window.setPromoterViewMode=s=>{p.promoterViewMode=s,D()},t?p.promoterViewMode==="onboarding"?ap():np():sp()}function lp(){return`
    ...
    `}function Bn(e){const t=e==="desktop-secondary";return window.setInventoryTab=s=>{p.inventoryTab=s,D()},window.setInventoryMode=s=>{p.inventoryMode=s,D()},t?p.inventoryMode==="inward"?cp():dp():`
    ...
    `}function Fn(e){const t=e==="mobile",s=e==="desktop-secondary";if(window.setSettingsView=a=>{p.settingsView=a,p.settingsSubView=null,D()},window.setSettingsSubView=a=>{p.settingsSubView=a,D()},window.setSettingsRole=a=>{p.settingsActiveRole=a,p.settingsSubView="detail",D()},window.saveNewRole=()=>{const a=document.querySelector('input[placeholder="e.g. Floor Supervisor"]');a&&a.value?(p.settingsActiveRole=a.value,p.settingsSubView="detail",window.toast.success(`Role "${a.value}" created successfully!`),D()):window.toast.warning("Please enter a role name")},window.updateRole=()=>{window.toast.success("Role profile updated successfully!"),window.setSettingsSubView("detail")},s||t&&p.settingsView){if(p.settingsView==="roles")return up();if(p.settingsView==="accounting")return xp();if(p.settingsView==="ledger")return fp();if(p.settingsView==="ai")return mp();if(p.settingsView==="store")return hp();if(p.settingsView==="security")return gp();if(p.settingsView==="alerts")return vp();if(p.settingsView==="taxes")return wp();if(p.settingsView==="plugins")return yp();if(p.settingsView==="teams")return kp();if(p.settingsView==="logs")return _p();if(p.settingsView==="lang")return Sp();if(p.settingsView==="backup")return $p();if(p.settingsView==="updates")return Ep();if(p.settingsView==="theme")return Ip();if(p.settingsView==="help")return Cp();if(s)return""}return pp(e)}function Rp(){return`
        <div class="space-y-4 text-left">
    ...
    `}function Vn(e){if(e==="desktop-secondary"||e==="mobile"&&p.marketplaceViewMode==="add")return Lp(e);const a=p.marketplaceTab==="browse";return`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            ${Mp()}
    ...
    `:'<div class="p-20 text-center uppercase text-[10px] font-black opacity-30">No inquiry selected</div>'}function Hn(e){return e==="desktop-secondary"||e==="mobile"&&p.inquiryViewMode==="add"?Bp():p.inquiryViewMode==="resolve"&&p.activeInquiry?Up():`
        <div class="h-full flex flex-col bg-white overflow-hidden relative text-left">
            ${jp()}
    ...
    `}function Wn(e){const t=e==="mobile",s=e==="desktop-secondary";return window.setAutomationMode=(a,n=null)=>{p.automationViewMode=a,n!==null&&(p.activeAutomationId=n),D()},s?p.automationViewMode==="create"?kl():p.automationViewMode==="details"&&p.activeAutomationId?_l(p.activeAutomationId):`
            <div class="h-full flex items-center justify-center text-slate-300 text-center">
                <div class="text-center">
        ...
        `:t&&p.automationViewMode==="create"?kl(!0):t&&p.automationViewMode==="details"?_l(p.activeAutomationId,!0):zp()}function Yp(){const t=window.getCache().storeOrders||[],s=t.filter(n=>n.order_status==="pending"||n.order_status==="confirmed").length,a=t.filter(n=>n.order_status==="confirmed").length;return`
        <header class="p-4 sm:p-8 pb-4 shrink-0">
            <div class="flex items-center justify-between mb-6">
                <button type="button" onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors">
                    <span class="material-icons-outlined">chevron_left</span>
...
Powered by RetailerOS`,window.open(`https://wa.me/?text=${encodeURIComponent(x)}`,"_blank")},window._printOrder=()=>{window.print()},`
    ...
    `}function zn(e){const t=e==="mobile";if(e==="desktop-secondary"){if(p.myStoreViewMode==="order-detail"&&p.activeStoreOrderId)return $l();if(p.myStoreViewMode==="add-listing")return Sl();if(p.activeListingId&&p.myStoreTab==="listings")return Qp();if(p.myStoreTab==="dashboard"){const l=window.getCache().storeListings||[];return`<div class="h-full flex flex-col p-6 sm:p-8 text-left">
                <div class="text-center border-b border-dashed border-slate-200 pb-6 mb-6">
    ...
    `,document.body.appendChild(n);const l=n.querySelector("div > div"),i=n.querySelector("#prompt-input");requestAnimationFrame(()=>{l.classList.remove("scale-95","opacity-0"),l.classList.add("scale-100","opacity-100"),i.focus(),i.select()}),i.onkeydown=r=>{if(r.key==="Enter"){const d=i.value.trim();ht(n),d&&s&&s(d)}else r.key==="Escape"&&(ht(n),a&&a())},n.querySelector("#prompt-cancel").onclick=()=>{ht(n),a&&a()},n.querySelector("#prompt-ok").onclick=()=>{const r=i.value.trim();ht(n),r&&s&&s(r)},n.onclick=r=>{r.target===n&&(ht(n),a&&a())}}window.toast=pu;window.showToast=Gs;window.showConfirm=uu;window.showPrompt=xu;function fu(){return p.currentApp==="sales"?p.currentTab==="new-sale"?Ji():Ki():p.currentApp==="clients"?Ln("desktop-primary"):p.currentApp==="reports"?jn("desktop-primary"):p.currentApp==="repairs"?Pn("desktop-primary"):p.currentApp==="marketing"?Nn("desktop-primary"):p.currentApp==="promoters"?qn("desktop-primary"):p.currentApp==="inventory"?Bn("desktop-primary"):p.currentApp==="settings"?Fn("desktop-primary"):p.currentApp==="schemes"?Un("desktop-primary"):p.currentApp==="marketplace"?Vn("desktop-primary"):p.currentApp==="inquiries"?Hn("desktop-primary"):p.currentApp==="prebooking"?Gn("desktop-primary"):p.currentApp==="automation"?Wn("desktop-primary"):p.currentApp==="mystore"?zn("desktop-primary"):'<div class="p-10 flex items-center justify-center h-full text-slate-300 font-bold uppercase tracking-widest">App Module Not Found</div>'}function bu(){return p.currentApp==="sales"?p.salesMode==="add-customer"?gn("desktop"):Xi():p.currentApp==="clients"?Ln("desktop-secondary"):p.currentApp==="reports"?jn("desktop-secondary"):p.currentApp==="repairs"?Pn("desktop-secondary"):p.currentApp==="marketing"?Nn("desktop-secondary"):p.currentApp==="promoters"?qn("desktop-secondary"):p.currentApp==="inventory"?Bn("desktop-secondary"):p.currentApp==="settings"?Fn("desktop-secondary"):p.currentApp==="schemes"?Un("desktop-secondary"):p.currentApp==="marketplace"?Vn("desktop-secondary"):p.currentApp==="inquiries"?Hn("desktop-secondary"):p.currentApp==="prebooking"?Gn("desktop-secondary"):p.currentApp==="automation"?Wn("desktop-secondary"):p.currentApp==="mystore"?zn("desktop-secondary"):'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-2 opacity-50">grid_view</span><p class="text-[10px] font-black uppercase tracking-widest">Select an app to view details</p></div></div>'}function er(){return ql("desktop")}function mu(){return`
    ...
    `}function tr(){if(p.currentApp==="sales"){const t=window.getActiveCart&&window.getActiveCart().length>0,s=p.currentTab==="new-sale"&&t||p.currentTab==="history"&&p.salesHistoryId;return p.showMobileReceipt&&s?`
        ...
        `:""}
        `}let e="";if(p.currentApp==="clients")e=Ln("mobile");else if(p.currentApp==="reports")e=jn("mobile");else if(p.currentApp==="repairs")e=Pn("mobile");else if(p.currentApp==="marketing")e=Nn("mobile");else if(p.currentApp==="promoters")e=qn("mobile");else if(p.currentApp==="inventory")e=Bn("mobile");else if(p.currentApp==="settings")e=Fn("mobile");else if(p.currentApp==="schemes")e=Un("mobile");else if(p.currentApp==="marketplace")e=Vn("mobile");else if(p.currentApp==="inquiries")e=Hn("mobile");else if(p.currentApp==="prebooking")e=Gn("mobile");else if(p.currentApp==="automation")e=Wn("mobile");else if(p.currentApp==="mystore")e=zn("mobile");else return'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-2 opacity-50">grid_view</span><p class="text-[10px] font-black uppercase tracking-widest">App Module Not Found</p></div></div>';return`
        <div class="flex flex-col w-full h-full overflow-hidden bg-slate-50 relative">
            ${e}
        </div>
    `}function hu(){return`
        <div class="h-full flex flex-row divide-x divide-slate-200 bg-white">
            ...
            <div class="flex-1 bg-white h-full overflow-hidden flex flex-col relative">
                ${p.isLoggedIn?p.currentApp==="launcher"?'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-4 opacity-20">arrow_back</span><p class="text-[10px] font-black uppercase tracking-widest opacity-40">Select an App from the Menu</p></div></div>':tr():'<div class="h-full w-full bg-slate-950 flex flex-col items-center justify-center text-white/5 font-black text-[15vw] leading-none overflow-hidden select-none pointer-events-none"><div>OS</div></div>'}
            </div>
        </div>
    `}function sr(){return p.isLoggedIn?p.currentApp==="launcher"?ql("mobile"):tr():`
            <div class="h-full w-full bg-white">
                ${Nl()}
            </div>
        `}function La(){const e=document.getElementById("app");if(e)try{const t=window.innerWidth;t<768?e.innerHTML=sr():t>=768&&t<1024?e.innerHTML=hu():e.innerHTML=mu()}catch(t){console.error(t),e.innerHTML=`< div class="p-4 text-slate-500 font-bold" > Error: ${t.message} <br><small>${t.stack}</small></div>`}}function gu(){const e=window.innerWidth;if(e<768){const t=document.getElementById("app");t&&(t.innerHTML=sr())}else{const t=document.querySelector(".flex-1.bg-white.h-full.overflow-hidden.flex.flex-col.relative.z-10")||document.querySelector(".flex-1.bg-white.h-full.overflow-hidden.flex.flex-col.relative"),s=document.querySelector(".w-\\[30\\%\\].shrink-0.bg-slate-50\\/50.h-full.overflow-hidden.flex.flex-col.relative.dot-grid.border-l.border-slate-200");t&&(t.innerHTML=p.authMode==="register"?Js("desktop-primary"):'<div class="h-full w-full bg-slate-950 flex flex-col items-center justify-center text-white/5 font-black text-[20vw] leading-none overflow-hidden select-none pointer-events-none"><div>OS</div></div>'),s&&e>=1024&&(s.innerHTML=p.authMode==="register"?Js("desktop-secondary"):'<div class="h-full w-full bg-slate-950/95 flex flex-col items-center justify-center text-white/5 font-black text-[15vw] leading-none overflow-hidden select-none pointer-events-none"><div>RETAILER</div></div>')}}window.updateAuthContent=gu;Dl(La);Dl(su);au();window.addEventListener("resize",()=>{window.innerWidth!==p.viewportWidth&&(p.viewportWidth=window.innerWidth,p.gridCols=window.innerWidth<768?4:3,La())});K().then(()=>{console.log("Initial data sync complete"),La()}).catch(e=>{console.error("Initial sync failed:",e),La()});
