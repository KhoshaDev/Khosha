var Zr=Object.defineProperty;var zn=e=>{throw TypeError(e)};var ei=(e,t,s)=>t in e?Zr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var L=(e,t,s)=>ei(e,typeof t!="symbol"?t+"":t,s),Fa=(e,t,s)=>t.has(e)||zn("Cannot "+s);var r=(e,t,s)=>(Fa(e,t,"read from private field"),s?s.call(e):t.get(e)),b=(e,t,s)=>t.has(e)?zn("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),x=(e,t,s,a)=>(Fa(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),g=(e,t,s)=>(Fa(e,t,"access private method"),s);var Jt=(e,t,s,a)=>({set _(n){x(e,t,n,s)},get _(){return r(e,t,a)}});(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const l of n)if(l.type==="childList")for(const d of l.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function s(n){const l={};return n.integrity&&(l.integrity=n.integrity),n.referrerPolicy&&(l.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?l.credentials="include":n.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(n){if(n.ep)return;n.ep=!0;const l=s(n);fetch(n.href,l)}})();const ti=localStorage.getItem("retaileros_logged_in")==="true",si=localStorage.getItem("retaileros_retailer_id")||null,ai=localStorage.getItem("retaileros_retailer_code")||null,ni=localStorage.getItem("retaileros_retailer_name")||null,c={retailerId:si,retailerCode:ai,retailerName:ni,currentApp:window.innerWidth<768?"launcher":"sales",currentTab:"new-sale",salesMode:"default",salesHistoryId:"ORD-99281",historyViewMode:"completed",historyDateFilter:"today",historyFromDate:"",historyToDate:"",showMobileReceipt:!1,reportsTab:"sales",repairTab:"active",repairViewMode:"search",selectedRepairDevice:null,activeRepairId:null,repairContext:null,selectedClient:null,selectedClientId:null,clientViewMode:"directory",clientSearchQuery:"",clientInvoiceId:null,selectedGroupId:null,groupViewMode:"list",groupSearchQuery:"",promoterViewMode:"performance",inventoryTab:"brands",inventoryMode:"details",activeCategory:null,settingsView:"roles",viewportWidth:window.innerWidth,gridCols:window.innerWidth<768?4:3,schemesTab:"list",activeSchemeBrand:"Apple",activeScheme:"June Activation Bonus",showSchemeDetails:!1,marketplaceTab:"browse",marketplaceViewMode:"list",isLoggedIn:ti,authMode:"login",registrationStep:1,inquiryViewMode:"list",activeInquiry:null,preBookingViewMode:"dashboard",activeCampaign:null,automationViewMode:"dashboard",activeAutomationId:null},El=[],Il=e=>{El.push(e)},R=(e=!0)=>{El.forEach(t=>t(e))};function li(e){c.currentApp=e,e==="clients"&&(c.clientViewMode="directory"),R()}function ri(e){c.currentTab=e,R()}function ii(e){c.salesHistoryId=e,e&&window.innerWidth<768&&(c.showMobileReceipt=!0),R()}function oi(e){c.showMobileReceipt=e,R()}function ci(e){c.reportsTab=e,R()}function di(e){c.repairTab=e,R()}function pi(e,t=null){c.repairViewMode=e,t&&(c.selectedRepairDevice=t),R()}function ui(e){c.gridCols=e,R()}function Rl(e,t=null,s=null){c.clientViewMode=e,t&&(c.selectedClient=t),s&&(c.selectedClientId=s),e!=="invoice"&&(c.clientInvoiceId=null),R()}function xi(e){c.clientInvoiceId=e,c.clientViewMode="invoice",R()}function fi(e){c.schemesTab=e,R()}function bi(e){c.activeSchemeBrand=e,R()}function mi(e){c.activeScheme=e,R()}function hi(e){c.showSchemeDetails=e,R()}function gi(e){c.marketplaceTab=e,R()}function wi(e){c.marketplaceViewMode=e,R()}function vi(e,t,s){c.retailerId=e,c.retailerCode=t,c.retailerName=s,localStorage.setItem("retaileros_retailer_id",e),localStorage.setItem("retaileros_retailer_code",t),localStorage.setItem("retaileros_retailer_name",s)}function Cl(){c.retailerId=null,c.retailerCode=null,c.retailerName=null,localStorage.removeItem("retaileros_retailer_id"),localStorage.removeItem("retaileros_retailer_code"),localStorage.removeItem("retaileros_retailer_name")}function yi(){return c.retailerId}function ki(e){c.isLoggedIn=e,e?localStorage.setItem("retaileros_logged_in","true"):(localStorage.removeItem("retaileros_logged_in"),Cl());const t=window.innerWidth<768;c.currentApp=e?t?"launcher":"sales":"launcher",R()}function _i(e){c.authMode=e,c.registrationStep=1,R()}function Si(e){c.registrationStep=e,window.updateAuthContent?window.updateAuthContent():R()}function Ei(e){c.inquiryViewMode=e,R()}function Ii(e){c.activeInquiry=e,R()}function Ri(e){c.preBookingViewMode=e,R()}function Ci(e){c.activeCampaign=e,R()}function $i(e){c.automationViewMode=e,R()}function Ai(e){c.activeAutomationId=e,R()}window.triggerRender=R;window.setApp=li;window.setTab=ri;window.setSalesHistoryId=ii;window.toggleMobileReceipt=oi;window.setReportsTab=ci;window.setRepairTab=di;function $l(e){c.salesMode=e,R()}window.setSalesMode=$l;function Ti(e){c.historyViewMode=e,R()}function Mi(e){c.historyDateFilter=e,e!=="custom"&&(c.historyFromDate="",c.historyToDate=""),R()}function Di(e,t){c.historyFromDate=e,c.historyToDate=t,c.historyDateFilter="custom",R()}window.setHistoryViewMode=Ti;window.setHistoryDateFilter=Mi;window.setHistoryCustomDates=Di;window.setRepairMode=pi;window.setGridCols=ui;window.setClientMode=Rl;window.viewClientInvoice=xi;window.setSchemesTab=fi;window.setSchemeBrand=bi;window.setScheme=mi;window.toggleSchemeDetails=hi;window.setMarketplaceTab=gi;window.setMarketplaceViewMode=wi;window.setRetailer=vi;window.clearRetailer=Cl;window.getRetailerId=yi;window.setLoginStatus=ki;window.setAuthMode=_i;window.setRegistrationStep=Si;window.setInquiryViewMode=Ei;window.setActiveInquiry=Ii;window.setPreBookingViewMode=Ri;window.setActiveCampaign=Ci;window.setAutomationViewMode=$i;window.setActiveAutomation=Ai;function Li(e){c.groupViewMode=e,R()}function Oi(e){c.selectedGroupId=e,R()}window.setGroupViewMode=Li;window.setSelectedGroup=Oi;const ji="modulepreload",qi=function(e){return"/"+e},Jn={},Vs=function(t,s,a){let n=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),i=(d==null?void 0:d.nonce)||(d==null?void 0:d.getAttribute("nonce"));n=Promise.allSettled(s.map(p=>{if(p=qi(p),p in Jn)return;Jn[p]=!0;const o=p.endsWith(".css"),u=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${u}`))return;const y=document.createElement("link");if(y.rel=o?"stylesheet":ji,o||(y.as="script"),y.crossOrigin="",y.href=p,i&&y.setAttribute("nonce",i),document.head.appendChild(y),o)return new Promise((w,k)=>{y.addEventListener("load",w),y.addEventListener("error",()=>k(new Error(`Unable to preload CSS for ${p}`)))})}))}function l(d){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=d,window.dispatchEvent(i),!i.defaultPrevented)throw d}return n.then(d=>{for(const i of d||[])i.status==="rejected"&&l(i.reason);return t().catch(l)})};function Al(){return`
    ...
    `}window.loginWithCredentials=async function(){const e=document.getElementById("login-identifier"),t=e?e.value.trim():"",s=document.getElementById("login-error"),a=document.getElementById("login-error-text"),n=document.getElementById("login-btn");if(!t){s&&a&&(a.textContent="Please enter your mobile number or store code.",s.classList.remove("hidden"));return}s&&s.classList.add("hidden"),n&&(n.disabled=!0,n.textContent="Authenticating...");try{const{query:l}=await Vs(async()=>{const{query:p}=await Promise.resolve().then(()=>Rn);return{query:p}},void 0);let d=null;if(/^\d{10}$/.test(t)){const p=await l("SELECT * FROM retailers WHERE mobile_number = ? AND status = 'active' LIMIT 1",[t]);p.length>0&&(d=p[0])}if(!d){const p=await l("SELECT * FROM retailers WHERE retailer_code = ? AND status = 'active' LIMIT 1",[t.toUpperCase()]);p.length>0&&(d=p[0])}if(!d){s&&a&&(a.textContent="No registered store found. Please check your mobile number or store code, or register first.",s.classList.remove("hidden"));return}window.setRetailer(d.id,d.retailer_code,d.retailer_name);const{syncData:i}=await Vs(async()=>{const{syncData:p}=await Promise.resolve().then(()=>qr);return{syncData:p}},void 0);await i(),window.setLoginStatus(!0)}catch(l){console.error("Login failed:",l),s&&a&&(a.textContent="Login failed: "+l.message,s.classList.remove("hidden"))}finally{n&&(n.disabled=!1,n.textContent="Authenticate")}};function Hs(e="mobile"){return e==="desktop-primary"?Pi():e==="desktop-secondary"?Ni():Bi()}function Pi(){const e=c.registrationStep;return e===3?`
...
Error: `+s.message)}};window.verifyOtp=function(){const e=[];for(let a=0;a<6;a++){const n=document.getElementById(`otp-${a}`);n&&e.push(n.value)}const t=e.join("");if(t.length!==6){alert("Please enter all 6 digits");return}const s="444619";console.log("Verifying OTP:",t),t===s?console.log("✅ Default OTP accepted:",s):console.log("ℹ️  Development mode: Any OTP accepted"),window.setRegistrationStep(3)};window.resendOtp=function(){for(let t=0;t<6;t++){const s=document.getElementById(`otp-${t}`);s&&(s.value="")}const e=document.getElementById("otp-0");e&&e.focus(),console.log("Resending OTP..."),alert("OTP has been resent successfully!")};window.finalizeRegistration=async function(){try{const e=window._approvedRetailerData;if(!e){alert("Session expired. Please start registration again."),window.setRegistrationStep(1);return}const{db:t}=await Vs(async()=>{const{db:n}=await Promise.resolve().then(()=>Rn);return{db:n}},void 0),s=await t.retailers.add(e);window.setRetailer(s.id,s.retailerCode,e.RetailerName),localStorage.setItem("retaileros_logged_in","true"),delete window._approvedRetailerData;const{syncData:a}=await Vs(async()=>{const{syncData:n}=await Promise.resolve().then(()=>qr);return{syncData:n}},void 0);await a(),window.setLoginStatus(!0),console.log("Registration completed successfully:",s)}catch(e){console.error("Registration failed:",e),alert("Registration failed. Please try again.")}};function Tl(){return c.authMode==="register"?Hs():Al()}const Fi=[{n:"SALES DESK",i:"account_balance_wallet",k:"sales"},{n:"CLIENTS",i:"group",k:"clients"},{n:"INQUIRIES",i:"help_outline",k:"inquiries"},{n:"PROMOTERS",i:"business_center",k:"promoters"},{n:"INTERNAL STORE",i:"storefront"},{n:"INVENTORY",i:"inventory_2",k:"inventory"},{n:"REPAIRS",i:"build",k:"repairs"},{n:"MARKETPLACE",i:"swap_horizontal_circle",k:"marketplace"},{n:"CLAIMS",i:"verified_user"},{n:"SCHEMES",i:"percent",k:"schemes"},{n:"MARKETING",i:"campaign",k:"marketing"},{n:"AUTOMATION",i:"smart_toy",s:!0,k:"automation"},{n:"PRE-BOOKING",i:"rocket_launch",k:"prebooking"},{n:"REPORTS",i:"bar_chart",k:"reports"},{n:"SETTINGS",i:"settings",k:"settings"}];function Ui(e){const t=e?c.gridCols:4;return`
    ...
    `}class j extends Error{constructor(s,a,n,l,d){a!==void 0&&(s=`${a}: ${s}`);super(s,{cause:d});L(this,"code");L(this,"extendedCode");L(this,"rawCode");this.code=a,this.extendedCode=n,this.rawCode=l,this.name="LibsqlError"}}class Zt extends j{constructor(s,a,n,l,d,i){super(s,n,l,d,i);L(this,"statementIndex");this.statementIndex=a,this.name="LibsqlBatchError"}}function Hi(e){const t=Gi.exec(e);if(t===null)throw new j(`The URL '${e}' is not in a valid format`,"URL_INVALID");const s=t.groups,a=s.scheme,n=s.authority!==void 0?Wi(s.authority):void 0,l=Ht(s.path),d=s.query!==void 0?Ji(s.query):void 0,i=s.fragment!==void 0?Ht(s.fragment):void 0;return{scheme:a,authority:n,path:l,query:d,fragment:i}}const Gi=(()=>{const e="(?<scheme>[A-Za-z][A-Za-z.+-]*)",t="(?<authority>[^/?#]*)",s="(?<path>[^?#]*)",a="(?<query>[^#]*)",n="(?<fragment>.*)";return new RegExp(`^${e}:(//${t})?${s}(\\?${a})?(#${n})?$`,"su")})();function Wi(e){const t=zi.exec(e);if(t===null)throw new j("The authority part of the URL is not in a valid format","URL_INVALID");const s=t.groups,a=Ht(s.host_br??s.host),n=s.port?parseInt(s.port,10):void 0,l=s.username!==void 0?{username:Ht(s.username),password:s.password!==void 0?Ht(s.password):void 0}:void 0;return{host:a,port:n,userinfo:l}}const zi=new RegExp("^((?<username>[^:]*)(:(?<password>.*))?@)?((?<host>[^:\\[\\]]*)|(\\[(?<host_br>[^\\[\\]]*)\\]))(:(?<port>[0-9]*))?$","su");function Ji(e){const t=e.split("&"),s=[];for(const a of t){if(a==="")continue;let n,l;const d=a.indexOf("=");d<0?(n=a,l=""):(n=a.substring(0,d),l=a.substring(d+1)),s.push({key:Ht(n.replaceAll("+"," ")),value:Ht(l.replaceAll("+"," "))})}return{pairs:s}}function Ht(e){try{return decodeURIComponent(e)}catch(t){throw t instanceof URIError?new j(`URL component has invalid percent encoding: ${t}`,"URL_INVALID",void 0,void 0,t):t}}function Wa(e,t,s){if(t===void 0)throw new j(`URL with scheme ${JSON.stringify(e+":")} requires authority (the "//" part)`,"URL_INVALID");const a=`${e}:`,n=Yi(t.host),l=Ki(t.port),i=`//${Qi(t.userinfo)}${n}${l}`;let p=s.split("/").map(encodeURIComponent).join("/");return p!==""&&!p.startsWith("/")&&(p="/"+p),new URL(`${a}${i}${p}`)}function Yi(e){return e.includes(":")?`[${encodeURI(e)}]`:encodeURI(e)}function Ki(e){return e!==void 0?`:${e}`:""}function Qi(e){if(e===void 0)return"";const t=encodeURIComponent(e.username),s=e.password!==void 0?`:${encodeURIComponent(e.password)}`:"";return`${t}${s}@`}const Ml="3.7.8",Xi=Ml,Rs=typeof Buffer=="function",Yn=typeof TextDecoder=="function"?new TextDecoder:void 0,Kn=typeof TextEncoder=="function"?new TextEncoder:void 0,Zi="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",Ts=Array.prototype.slice.call(Zi),ua=(e=>{let t={};return e.forEach((s,a)=>t[s]=a),t})(Ts),eo=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,te=String.fromCharCode.bind(String),Qn=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):e=>new Uint8Array(Array.prototype.slice.call(e,0)),Dl=e=>e.replace(/=/g,"").replace(/[+\/]/g,t=>t=="+"?"-":"_"),Ll=e=>e.replace(/[^A-Za-z0-9\+\/]/g,""),Ol=e=>{let t,s,a,n,l="";const d=e.length%3;for(let i=0;i<e.length;){if((s=e.charCodeAt(i++))>255||(a=e.charCodeAt(i++))>255||(n=e.charCodeAt(i++))>255)throw new TypeError("invalid character found");t=s<<16|a<<8|n,l+=Ts[t>>18&63]+Ts[t>>12&63]+Ts[t>>6&63]+Ts[t&63]}return d?l.slice(0,d-3)+"===".substring(d):l},hn=typeof btoa=="function"?e=>btoa(e):Rs?e=>Buffer.from(e,"binary").toString("base64"):Ol,za=Rs?e=>Buffer.from(e).toString("base64"):e=>{let s=[];for(let a=0,n=e.length;a<n;a+=4096)s.push(te.apply(null,e.subarray(a,a+4096)));return hn(s.join(""))},ba=(e,t=!1)=>t?Dl(za(e)):za(e),to=e=>{if(e.length<2){var t=e.charCodeAt(0);return t<128?e:t<2048?te(192|t>>>6)+te(128|t&63):te(224|t>>>12&15)+te(128|t>>>6&63)+te(128|t&63)}else{var t=65536+(e.charCodeAt(0)-55296)*1024+(e.charCodeAt(1)-56320);return te(240|t>>>18&7)+te(128|t>>>12&63)+te(128|t>>>6&63)+te(128|t&63)}},so=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,jl=e=>e.replace(so,to),Xn=Rs?e=>Buffer.from(e,"utf8").toString("base64"):Kn?e=>za(Kn.encode(e)):e=>hn(jl(e)),es=(e,t=!1)=>t?Dl(Xn(e)):Xn(e),Zn=e=>es(e,!0),ao=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,no=e=>{switch(e.length){case 4:var t=(7&e.charCodeAt(0))<<18|(63&e.charCodeAt(1))<<12|(63&e.charCodeAt(2))<<6|63&e.charCodeAt(3),s=t-65536;return te((s>>>10)+55296)+te((s&1023)+56320);case 3:return te((15&e.charCodeAt(0))<<12|(63&e.charCodeAt(1))<<6|63&e.charCodeAt(2));default:return te((31&e.charCodeAt(0))<<6|63&e.charCodeAt(1))}},ql=e=>e.replace(ao,no),Pl=e=>{if(e=e.replace(/\s+/g,""),!eo.test(e))throw new TypeError("malformed base64.");e+="==".slice(2-(e.length&3));let t,s,a,n=[];for(let l=0;l<e.length;)t=ua[e.charAt(l++)]<<18|ua[e.charAt(l++)]<<12|(s=ua[e.charAt(l++)])<<6|(a=ua[e.charAt(l++)]),s===64?n.push(te(t>>16&255)):a===64?n.push(te(t>>16&255,t>>8&255)):n.push(te(t>>16&255,t>>8&255,t&255));return n.join("")},gn=typeof atob=="function"?e=>atob(Ll(e)):Rs?e=>Buffer.from(e,"base64").toString("binary"):Pl,Nl=Rs?e=>Qn(Buffer.from(e,"base64")):e=>Qn(gn(e).split("").map(t=>t.charCodeAt(0))),Bl=e=>Nl(Fl(e)),lo=Rs?e=>Buffer.from(e,"base64").toString("utf8"):Yn?e=>Yn.decode(Nl(e)):e=>ql(gn(e)),Fl=e=>Ll(e.replace(/[-_]/g,t=>t=="-"?"+":"/")),Ja=e=>lo(Fl(e)),ro=e=>{if(typeof e!="string")return!1;const t=e.replace(/\s+/g,"").replace(/={0,2}$/,"");return!/[^\s0-9a-zA-Z\+/]/.test(t)||!/[^\s0-9a-zA-Z\-_]/.test(t)},Ul=e=>({value:e,enumerable:!1,writable:!0,configurable:!0}),Vl=function(){const e=(t,s)=>Object.defineProperty(String.prototype,t,Ul(s));e("fromBase64",function(){return Ja(this)}),e("toBase64",function(t){return es(this,t)}),e("toBase64URI",function(){return es(this,!0)}),e("toBase64URL",function(){return es(this,!0)}),e("toUint8Array",function(){return Bl(this)})},Hl=function(){const e=(t,s)=>Object.defineProperty(Uint8Array.prototype,t,Ul(s));e("toBase64",function(t){return ba(this,t)}),e("toBase64URI",function(){return ba(this,!0)}),e("toBase64URL",function(){return ba(this,!0)})},io=()=>{Vl(),Hl()},wn={version:Ml,VERSION:Xi,atob:gn,atobPolyfill:Pl,btoa:hn,btoaPolyfill:Ol,fromBase64:Ja,toBase64:es,encode:es,encodeURI:Zn,encodeURL:Zn,utob:jl,btou:ql,decode:Ja,isValid:ro,fromUint8Array:ba,toUint8Array:Bl,extendString:Vl,extendUint8Array:Hl,extendBuiltins:io},Gs="https://github.com/libsql/libsql-client-ts#supported-urls";function Ya(e){if(e==="write")return"BEGIN IMMEDIATE";if(e==="read")return"BEGIN TRANSACTION READONLY";if(e==="deferred")return"BEGIN DEFERRED";throw RangeError('Unknown transaction mode, supported values are "write", "read" and "deferred"')}class oo{constructor(t,s,a,n,l){L(this,"columns");L(this,"columnTypes");L(this,"rows");L(this,"rowsAffected");L(this,"lastInsertRowid");this.columns=t,this.columnTypes=s,this.rows=a,this.rowsAffected=n,this.lastInsertRowid=l}toJSON(){return{columns:this.columns,columnTypes:this.columnTypes,rows:this.rows.map(co),rowsAffected:this.rowsAffected,lastInsertRowid:this.lastInsertRowid!==void 0?""+this.lastInsertRowid:null}}}function co(e){return Array.prototype.map.call(e,po)}function po(e){return typeof e=="bigint"?""+e:e instanceof ArrayBuffer?wn.fromUint8Array(new Uint8Array(e)):e}const el=":memory:";function uo(e,t){var E,S;if(typeof e!="object")throw new TypeError(`Expected client configuration as object, got ${typeof e}`);let{url:s,authToken:a,tls:n,intMode:l,concurrency:d}=e;d=Math.max(0,d||20),l??(l="number");let i=[];s===el&&(s="file::memory:");const p=Hi(s),o=p.scheme.toLowerCase(),u=o==="file"&&p.path===el&&p.authority===void 0;let y;u?y={cache:{values:["shared","private"],update:(h,q)=>i.push(`${h}=${q}`)}}:y={tls:{values:["0","1"],update:(h,q)=>n=q==="1"},authToken:{update:(h,q)=>a=q}};for(const{key:h,value:q}of((E=p.query)==null?void 0:E.pairs)??[]){if(!Object.hasOwn(y,h))throw new j(`Unsupported URL query parameter ${JSON.stringify(h)}`,"URL_PARAM_NOT_SUPPORTED");const U=y[h];if(U.values!==void 0&&!U.values.includes(q))throw new j(`Unknown value for the "${h}" query argument: ${JSON.stringify(q)}. Supported values are: [${U.values.map(As=>'"'+As+'"').join(", ")}]`,"URL_INVALID");U.update!==void 0&&(U==null||U.update(h,q))}const w=i.length===0?"":`?${i.join("&")}`,k=p.path+w;let m;if(o==="libsql")if(n===!1){if(((S=p.authority)==null?void 0:S.port)===void 0)throw new j('A "libsql:" URL with ?tls=0 must specify an explicit port',"URL_INVALID");m="http"}else m="https";else m=o;if(m==="http"||m==="ws"?n??(n=!1):n??(n=!0),m!=="http"&&m!=="ws"&&m!=="https"&&m!=="wss"&&m!=="file")throw new j(`The client supports only "libsql:", "wss:", "ws:", "https:", "http:" and "file:" URLs, got ${JSON.stringify(p.scheme+":")}. For more information, please read ${Gs}`,"URL_SCHEME_NOT_SUPPORTED");if(l!=="number"&&l!=="bigint"&&l!=="string")throw new TypeError(`Invalid value for intMode, expected "number", "bigint" or "string", got ${JSON.stringify(l)}`);if(p.fragment!==void 0)throw new j(`URL fragments are not supported: ${JSON.stringify("#"+p.fragment)}`,"URL_INVALID");return u?{scheme:"file",tls:!1,path:k,intMode:l,concurrency:d,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch,authToken:void 0,encryptionKey:void 0,remoteEncryptionKey:void 0,authority:void 0}:{scheme:m,tls:n,authority:p.authority,path:k,authToken:a,intMode:l,concurrency:d,encryptionKey:e.encryptionKey,remoteEncryptionKey:e.remoteEncryptionKey,syncUrl:e.syncUrl,syncInterval:e.syncInterval,readYourWrites:e.readYourWrites,offline:e.offline,fetch:e.fetch}}let Qt;typeof WebSocket<"u"?Qt=WebSocket:typeof global<"u"?Qt=global.WebSocket:typeof window<"u"?Qt=window.WebSocket:typeof self<"u"&&(Qt=self.WebSocket);class Gl{constructor(){L(this,"intMode");this.intMode="number"}}class G extends Error{constructor(t){super(t),this.name="ClientError"}}class A extends G{constructor(t){super(t),this.name="ProtoError"}}class Wl extends G{constructor(s,a){super(s);L(this,"code");L(this,"proto");this.name="ResponseError",this.code=a.code,this.proto=a,this.stack=void 0}}class Se extends G{constructor(t,s){s!==void 0?(super(`${t}: ${s}`),this.cause=s):super(t),this.name="ClosedError"}}class zl extends G{constructor(t){super(t),this.name="WebSocketUnsupportedError"}}class Ka extends G{constructor(t){super(t),this.name="WebSocketError"}}class ma extends G{constructor(s,a){super(s);L(this,"status");this.status=a,this.name="HttpServerError"}}class _s extends G{constructor(t){super(t),this.name="ProtocolVersionError"}}class St extends G{constructor(t){super(t),this.name="InternalError"}}class Cs extends G{constructor(t){super(t),this.name="MisuseError"}}function Le(e){if(typeof e=="string")return e;throw $s(e,"string")}function je(e){if(e!=null){if(typeof e=="string")return e;throw $s(e,"string or null")}}function Gt(e){if(typeof e=="number")return e;throw $s(e,"number")}function Ws(e){if(typeof e=="boolean")return e;throw $s(e,"boolean")}function ka(e){if(Array.isArray(e))return e;throw $s(e,"array")}function se(e){if(e!==null&&typeof e=="object"&&!Array.isArray(e))return e;throw $s(e,"object")}function Et(e,t){return ka(e).map(s=>t(se(s)))}function $s(e,t){if(e===void 0)return new A(`Expected ${t}, but the property was missing`);let s=typeof e;return e===null?s="null":Array.isArray(e)&&(s="array"),new A(`Expected ${t}, received ${s}`)}function vn(e,t){return t(se(e))}var z,ut,ze,Ct;class xo{constructor(t){b(this,ze);b(this,z);b(this,ut);x(this,z,t),x(this,ut,!1)}begin(){r(this,z).push("{"),x(this,ut,!0)}end(){r(this,z).push("}"),x(this,ut,!1)}string(t,s){g(this,ze,Ct).call(this,t),r(this,z).push(JSON.stringify(s))}stringRaw(t,s){g(this,ze,Ct).call(this,t),r(this,z).push('"'),r(this,z).push(s),r(this,z).push('"')}number(t,s){g(this,ze,Ct).call(this,t),r(this,z).push(""+s)}boolean(t,s){g(this,ze,Ct).call(this,t),r(this,z).push(s?"true":"false")}object(t,s,a){g(this,ze,Ct).call(this,t),this.begin(),a(this,s),this.end()}arrayObjects(t,s,a){g(this,ze,Ct).call(this,t),r(this,z).push("[");for(let n=0;n<s.length;++n)n!==0&&r(this,z).push(","),this.begin(),a(this,s[n]),this.end();r(this,z).push("]")}}z=new WeakMap,ut=new WeakMap,ze=new WeakSet,Ct=function(t){r(this,ut)?(r(this,z).push('"'),x(this,ut,!1)):r(this,z).push(',"'),r(this,z).push(t),r(this,z).push('":')};function Jl(e,t){const s=[],a=new xo(s);return a.begin(),t(a,e),a.end(),s.join("")}const Fs=0,Qa=1,Xa=2,fo=5;var Pe,zs,he;class bo{constructor(t){b(this,Pe);b(this,zs);b(this,he);x(this,Pe,t),x(this,zs,new DataView(t.buffer,t.byteOffset,t.byteLength)),x(this,he,0)}varint(){let t=0;for(let s=0;;s+=7){const a=r(this,Pe)[Jt(this,he)._++];if(t|=(a&127)<<s,!(a&128))break}return t}varintBig(){let t=0n;for(let s=0n;;s+=7n){const a=r(this,Pe)[Jt(this,he)._++];if(t|=BigInt(a&127)<<s,!(a&128))break}return t}bytes(t){const s=new Uint8Array(r(this,Pe).buffer,r(this,Pe).byteOffset+r(this,he),t);return x(this,he,r(this,he)+t),s}double(){const t=r(this,zs).getFloat64(r(this,he),!0);return x(this,he,r(this,he)+8),t}skipVarint(){for(;r(this,Pe)[Jt(this,he)._++]&128;);}skip(t){x(this,he,r(this,he)+t)}eof(){return r(this,he)>=r(this,Pe).byteLength}}Pe=new WeakMap,zs=new WeakMap,he=new WeakMap;var ce,le,Dt,Ms;class mo{constructor(t){b(this,Dt);b(this,ce);b(this,le);x(this,ce,t),x(this,le,-1)}setup(t){x(this,le,t)}bytes(){g(this,Dt,Ms).call(this,Xa);const t=r(this,ce).varint();return r(this,ce).bytes(t)}string(){return new TextDecoder().decode(this.bytes())}message(t){return La(this.bytes(),t)}int32(){return g(this,Dt,Ms).call(this,Fs),r(this,ce).varint()}uint32(){return this.int32()}bool(){return this.int32()!==0}uint64(){return g(this,Dt,Ms).call(this,Fs),r(this,ce).varintBig()}sint64(){const t=this.uint64();return t>>1n^-(t&1n)}double(){return g(this,Dt,Ms).call(this,Qa),r(this,ce).double()}maybeSkip(){if(!(r(this,le)<0)){if(r(this,le)===Fs)r(this,ce).skipVarint();else if(r(this,le)===Qa)r(this,ce).skip(8);else if(r(this,le)===Xa){const t=r(this,ce).varint();r(this,ce).skip(t)}else if(r(this,le)===fo)r(this,ce).skip(4);else throw new A(`Unexpected wire type ${r(this,le)}`);x(this,le,-1)}}}ce=new WeakMap,le=new WeakMap,Dt=new WeakSet,Ms=function(t){if(r(this,le)!==t)throw new A(`Expected wire type ${t}, got ${r(this,le)}`);x(this,le,-1)};function La(e,t){const s=new bo(e),a=new mo(s);let n=t.default();for(;!s.eof();){const l=s.varint(),d=l>>3,i=l&7;a.setup(i);const p=t[d];if(p!==void 0){const o=p(a,n);o!==void 0&&(n=o)}a.maybeSkip()}return n}var Ie,xt,as,de,X,Ds,ha,Yl,Ls;const Vn=class Vn{constructor(){b(this,X);b(this,Ie);b(this,xt);b(this,as);b(this,de);x(this,Ie,new ArrayBuffer(256)),x(this,xt,new Uint8Array(r(this,Ie))),x(this,as,new DataView(r(this,Ie))),x(this,de,0)}bytes(t,s){g(this,X,Ls).call(this,t,Xa),g(this,X,ha).call(this,s.byteLength),g(this,X,Ds).call(this,s.byteLength),r(this,xt).set(s,r(this,de)),x(this,de,r(this,de)+s.byteLength)}string(t,s){this.bytes(t,new TextEncoder().encode(s))}message(t,s,a){const n=new Vn;a(n,s),this.bytes(t,n.data())}int32(t,s){g(this,X,Ls).call(this,t,Fs),g(this,X,ha).call(this,s)}uint32(t,s){this.int32(t,s)}bool(t,s){this.int32(t,s?1:0)}sint64(t,s){g(this,X,Ls).call(this,t,Fs),g(this,X,Yl).call(this,s<<1n^s>>63n)}double(t,s){g(this,X,Ls).call(this,t,Qa),g(this,X,Ds).call(this,8),r(this,as).setFloat64(r(this,de),s,!0),x(this,de,r(this,de)+8)}data(){return new Uint8Array(r(this,Ie),0,r(this,de))}};Ie=new WeakMap,xt=new WeakMap,as=new WeakMap,de=new WeakMap,X=new WeakSet,Ds=function(t){if(r(this,de)+t<=r(this,Ie).byteLength)return;let s=r(this,Ie).byteLength;for(;s<r(this,de)+t;)s*=2;const a=new ArrayBuffer(s),n=new Uint8Array(a),l=new DataView(a);n.set(new Uint8Array(r(this,Ie),0,r(this,de))),x(this,Ie,a),x(this,xt,n),x(this,as,l)},ha=function(t){g(this,X,Ds).call(this,5),t=0|t;do{let s=t&127;t>>>=7,s|=t?128:0,r(this,xt)[Jt(this,de)._++]=s}while(t)},Yl=function(t){g(this,X,Ds).call(this,10),t=t&0xffffffffffffffffn;do{let s=Number(t&0x7fn);t>>=7n,s|=t?128:0,r(this,xt)[Jt(this,de)._++]=s}while(t)},Ls=function(t,s){g(this,X,ha).call(this,t<<3|s)};let Za=Vn;function Kl(e,t){const s=new Za;return t(s,e),s.data()}var ge,Je;class Os{constructor(){b(this,ge);b(this,Je);x(this,ge,new Set),x(this,Je,new Set)}alloc(){for(const s of r(this,Je))return r(this,Je).delete(s),r(this,ge).add(s),r(this,ge).has(r(this,ge).size-1)||r(this,Je).add(r(this,ge).size-1),s;const t=r(this,ge).size;return r(this,ge).add(t),t}free(t){if(!r(this,ge).delete(t))throw new St("Freeing an id that is not allocated");r(this,Je).delete(r(this,ge).size),t<r(this,ge).size&&r(this,Je).add(t)}}ge=new WeakMap,Je=new WeakMap;function W(e,t){throw new St(t)}function Us(e){if(e===null)return null;if(typeof e=="string")return e;if(typeof e=="number"){if(!Number.isFinite(e))throw new RangeError("Only finite numbers (not Infinity or NaN) can be passed as arguments");return e}else if(typeof e=="bigint"){if(e<ho||e>go)throw new RangeError("This bigint value is too large to be represented as a 64-bit integer and passed as argument");return e}else{if(typeof e=="boolean")return e?1n:0n;if(e instanceof ArrayBuffer)return new Uint8Array(e);if(e instanceof Uint8Array)return e;if(e instanceof Date)return+e.valueOf();if(typeof e=="object")return""+e.toString();throw new TypeError("Unsupported type of value")}}const ho=-9223372036854775808n,go=9223372036854775807n;function Ql(e,t){if(e===null)return null;if(typeof e=="number")return e;if(typeof e=="string")return e;if(typeof e=="bigint")if(t==="number"){const s=Number(e);if(!Number.isSafeInteger(s))throw new RangeError("Received integer which is too large to be safely represented as a JavaScript number");return s}else{if(t==="bigint")return e;if(t==="string")return""+e;throw new Cs("Invalid value for IntMode")}else{if(e instanceof Uint8Array)return e.slice().buffer;throw e===void 0?new A("Received unrecognized type of Value"):W(e,"Impossible type of Value")}}function ca(e){return{affectedRowCount:e.affectedRowCount,lastInsertRowid:e.lastInsertRowid,columnNames:e.cols.map(t=>t.name),columnDecltypes:e.cols.map(t=>t.decltype)}}function Xl(e,t){const s=ca(e),a=e.rows.map(n=>tr(s.columnNames,n,t));return{...s,rows:a}}function Zl(e,t){const s=ca(e);let a;return e.rows.length>0&&(a=tr(s.columnNames,e.rows[0],t)),{...s,row:a}}function er(e,t){const s=ca(e);let a;return e.rows.length>0&&s.columnNames.length>0&&(a=Ql(e.rows[0][0],t)),{...s,value:a}}function tr(e,t,s){const a={};Object.defineProperty(a,"length",{value:t.length});for(let n=0;n<t.length;++n){const l=Ql(t[n],s);Object.defineProperty(a,n,{value:l});const d=e[n];d!==void 0&&!Object.hasOwn(a,d)&&Object.defineProperty(a,d,{value:l,enumerable:!0,configurable:!0,writable:!0})}return a}function Ss(e){return new Wl(e.message,e)}var ns,ls,Ye;class yn{constructor(t,s){b(this,ns);b(this,ls);b(this,Ye);x(this,ns,t),x(this,ls,s),x(this,Ye,void 0)}_getSqlId(t){if(r(this,ns)!==t)throw new Cs("Attempted to use SQL text opened with other object");if(r(this,Ye)!==void 0)throw new Se("SQL text is closed",r(this,Ye));return r(this,ls)}close(){this._setClosed(new G("SQL text was manually closed"))}_setClosed(t){r(this,Ye)===void 0&&(x(this,Ye,t),r(this,ns)._closeSql(r(this,ls)))}get closed(){return r(this,Ye)!==void 0}}ns=new WeakMap,ls=new WeakMap,Ye=new WeakMap;function en(e,t){return t instanceof yn?{sqlId:t._getSqlId(e)}:{sql:""+t}}var Ne,Re;class _a{constructor(){b(this,Ne);b(this,Re);x(this,Ne,[]),x(this,Re,[])}get length(){return r(this,Ne).length+r(this,Re).length}push(t){r(this,Ne).push(t)}shift(){return r(this,Re).length===0&&r(this,Ne).length>0&&(x(this,Re,r(this,Ne).reverse()),x(this,Ne,[])),r(this,Re).pop()}first(){return r(this,Re).length!==0?r(this,Re)[r(this,Re).length-1]:r(this,Ne)[0]}}Ne=new WeakMap,Re=new WeakMap;let sr=class{constructor(t){L(this,"sql");L(this,"_args");L(this,"_namedArgs");this.sql=t,this._args=[],this._namedArgs=new Map}bindIndexes(t){this._args.length=0;for(const s of t)this._args.push(Us(s));return this}bindIndex(t,s){if(t!==(t|0)||t<=0)throw new RangeError("Index of a positional argument must be positive integer");for(;this._args.length<t;)this._args.push(null);return this._args[t-1]=Us(s),this}bindName(t,s){return this._namedArgs.set(t,Us(s)),this}unbindAll(){return this._args.length=0,this._namedArgs.clear(),this}};function ar(e,t,s){let a,n=[],l=[];if(t instanceof sr){a=t.sql,n=t._args;for(const[p,o]of t._namedArgs.entries())l.push({name:p,value:o})}else Array.isArray(t)?(a=t[0],Array.isArray(t[1])?n=t[1].map(p=>Us(p)):l=Object.entries(t[1]).map(([p,o])=>({name:p,value:Us(o)}))):a=t;const{sql:d,sqlId:i}=en(e,a);return{sql:d,sqlId:i,args:n,namedArgs:l,wantRows:s}}var Js,rs,yl;let wo=(yl=class{constructor(t,s){L(this,"_stream");b(this,Js);L(this,"_steps");b(this,rs);this._stream=t,x(this,Js,s),this._steps=[],x(this,rs,!1)}step(){return new ko(this)}execute(){if(r(this,rs))throw new Cs("This batch has already been executed");x(this,rs,!0);const t={steps:this._steps.map(s=>s.proto)};return r(this,Js)?yo(this._stream,this._steps,t):vo(this._stream,this._steps,t)}},Js=new WeakMap,rs=new WeakMap,yl);function vo(e,t,s){return e._batch(s).then(a=>{for(let n=0;n<t.length;++n){const l=a.stepResults.get(n),d=a.stepErrors.get(n);t[n].callback(l,d)}})}async function yo(e,t,s){const a=await e._openCursor(s);try{let n=0,l,d=[];for(;;){const i=await a.next();if(i===void 0)break;if(i.type==="step_begin"){if(i.step<n||i.step>=t.length)throw new A("Server produced StepBeginEntry for unexpected step");if(l!==void 0)throw new A("Server produced StepBeginEntry before terminating previous step");for(let p=n;p<i.step;++p)t[p].callback(void 0,void 0);n=i.step+1,l=i,d=[]}else if(i.type==="step_end"){if(l===void 0)throw new A("Server produced StepEndEntry but no step is active");const p={cols:l.cols,rows:d,affectedRowCount:i.affectedRowCount,lastInsertRowid:i.lastInsertRowid};t[l.step].callback(p,void 0),l=void 0,d=[]}else if(i.type==="step_error"){if(l===void 0){if(i.step>=t.length)throw new A("Server produced StepErrorEntry for unexpected step");for(let p=n;p<i.step;++p)t[p].callback(void 0,void 0)}else{if(i.step!==l.step)throw new A("Server produced StepErrorEntry for unexpected step");l=void 0,d=[]}t[i.step].callback(void 0,i.error),n=i.step+1}else if(i.type==="row"){if(l===void 0)throw new A("Server produced RowEntry but no step is active");d.push(i.row)}else throw i.type==="error"?Ss(i.error):i.type==="none"?new A("Server produced unrecognized CursorEntry"):W(i,"Impossible CursorEntry")}if(l!==void 0)throw new A("Server closed Cursor before terminating active step");for(let i=n;i<t.length;++i)t[i].callback(void 0,void 0)}finally{a.close()}}var Ke,Lt,js,kl;let ko=(kl=class{constructor(t){b(this,Lt);L(this,"_batch");b(this,Ke);L(this,"_index");this._batch=t,x(this,Ke,[]),this._index=void 0}condition(t){return r(this,Ke).push(t._proto),this}query(t){return g(this,Lt,js).call(this,t,!0,Xl)}queryRow(t){return g(this,Lt,js).call(this,t,!0,Zl)}queryValue(t){return g(this,Lt,js).call(this,t,!0,er)}run(t){return g(this,Lt,js).call(this,t,!1,ca)}},Ke=new WeakMap,Lt=new WeakSet,js=function(t,s,a){if(this._index!==void 0)throw new Cs("This BatchStep has already been added to the batch");const n=ar(this._batch._stream._sqlOwner(),t,s);let l;r(this,Ke).length===0?l=void 0:r(this,Ke).length===1?l=r(this,Ke)[0]:l={type:"and",conds:r(this,Ke).slice()};const d={stmt:n,condition:l};return new Promise((i,p)=>{const o=(u,y)=>{u!==void 0&&y!==void 0?p(new A("Server returned both result and error")):y!==void 0?p(Ss(y)):i(u!==void 0?a(u,this._batch._stream.intMode):void 0)};this._index=this._batch._steps.length,this._batch._steps.push({proto:d,callback:o})})},kl),fe=class $t{constructor(t,s){L(this,"_batch");L(this,"_proto");this._batch=t,this._proto=s}static ok(t){return new $t(t._batch,{type:"ok",step:tl(t)})}static error(t){return new $t(t._batch,{type:"error",step:tl(t)})}static not(t){return new $t(t._batch,{type:"not",cond:t._proto})}static and(t,s){for(const a of s)sl(t,a);return new $t(t,{type:"and",conds:s.map(a=>a._proto)})}static or(t,s){for(const a of s)sl(t,a);return new $t(t,{type:"or",conds:s.map(a=>a._proto)})}static isAutocommit(t){return t._stream.client()._ensureVersion(3,"BatchCond.isAutocommit()"),new $t(t,{type:"is_autocommit"})}};function tl(e){if(e._index===void 0)throw new Cs("Cannot add a condition referencing a step that has not been added to the batch");return e._index}function sl(e,t){if(t._batch!==e)throw new Cs("Cannot mix BatchCond objects for different Batch objects")}function _o(e){return{paramNames:e.params.map(t=>t.name),columns:e.cols,isExplain:e.isExplain,isReadonly:e.isReadonly}}var Ot,qs;class nr{constructor(t){b(this,Ot);L(this,"intMode");this.intMode=t}query(t){return g(this,Ot,qs).call(this,t,!0,Xl)}queryRow(t){return g(this,Ot,qs).call(this,t,!0,Zl)}queryValue(t){return g(this,Ot,qs).call(this,t,!0,er)}run(t){return g(this,Ot,qs).call(this,t,!1,ca)}batch(t=!1){return new wo(this,t)}describe(t){const s=en(this._sqlOwner(),t);return this._describe(s).then(_o)}sequence(t){const s=en(this._sqlOwner(),t);return this._sequence(s)}}Ot=new WeakSet,qs=function(t,s,a){const n=ar(this._sqlOwner(),t,s);return this._execute(n).then(l=>a(l,this.intMode))};class lr{}const So=1e3,Eo=10;var Ta,jt,is,os,qt,Qe,Pt,Ma,rr;class Io extends lr{constructor(s,a,n){super();b(this,Ma);b(this,Ta);b(this,jt);b(this,is);b(this,os);b(this,qt);b(this,Qe);b(this,Pt);x(this,Ta,s),x(this,jt,a),x(this,is,n),x(this,os,new _a),x(this,qt,new _a),x(this,Qe,void 0),x(this,Pt,!1)}async next(){for(;;){if(r(this,Qe)!==void 0)throw new Se("Cursor is closed",r(this,Qe));for(;!r(this,Pt)&&r(this,qt).length<Eo;)r(this,qt).push(g(this,Ma,rr).call(this));const s=r(this,os).shift();if(r(this,Pt)||s!==void 0)return s;await r(this,qt).shift().then(a=>{if(a!==void 0){for(const n of a.entries)r(this,os).push(n);r(this,Pt)||x(this,Pt,a.done)}})}}_setClosed(s){r(this,Qe)===void 0&&(x(this,Qe,s),r(this,jt)._sendCursorRequest(this,{type:"close_cursor",cursorId:r(this,is)}).catch(()=>{}),r(this,jt)._cursorClosed(this))}close(){this._setClosed(new G("Cursor was manually closed"))}get closed(){return r(this,Qe)!==void 0}}Ta=new WeakMap,jt=new WeakMap,is=new WeakMap,os=new WeakMap,qt=new WeakMap,Qe=new WeakMap,Pt=new WeakMap,Ma=new WeakSet,rr=function(){return r(this,jt)._sendCursorRequest(this,{type:"fetch_cursor",cursorId:r(this,is),maxCount:So}).then(s=>s,s=>{this._setClosed(s)})};var ee,ke,Xe,we,ft,Ce,J,Yt,sn,ga,wa;const Hn=class Hn extends nr{constructor(s,a){super(s.intMode);b(this,J);b(this,ee);b(this,ke);b(this,Xe);b(this,we);b(this,ft);b(this,Ce);x(this,ee,s),x(this,ke,a),x(this,Xe,new _a),x(this,we,void 0),x(this,ft,!1),x(this,Ce,void 0)}static open(s){const a=s._streamIdAlloc.alloc(),n=new Hn(s,a),l=()=>{},d=p=>{var o;return g(o=n,J,wa).call(o,p)},i={type:"open_stream",streamId:a};return s._sendRequest(i,{responseCallback:l,errorCallback:d}),n}client(){return r(this,ee)}_sqlOwner(){return r(this,ee)}_execute(s){return g(this,J,Yt).call(this,{type:"execute",streamId:r(this,ke),stmt:s}).then(a=>a.result)}_batch(s){return g(this,J,Yt).call(this,{type:"batch",streamId:r(this,ke),batch:s}).then(a=>a.result)}_describe(s){return r(this,ee)._ensureVersion(2,"describe()"),g(this,J,Yt).call(this,{type:"describe",streamId:r(this,ke),sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return r(this,ee)._ensureVersion(2,"sequence()"),g(this,J,Yt).call(this,{type:"sequence",streamId:r(this,ke),sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return r(this,ee)._ensureVersion(3,"getAutocommit()"),g(this,J,Yt).call(this,{type:"get_autocommit",streamId:r(this,ke)}).then(s=>s.isAutocommit)}_openCursor(s){return r(this,ee)._ensureVersion(3,"cursor"),new Promise((a,n)=>{g(this,J,sn).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_sendCursorRequest(s,a){if(s!==r(this,we))throw new St("Cursor not associated with the stream attempted to execute a request");return new Promise((n,l)=>{r(this,Ce)!==void 0?l(new Se("Stream is closed",r(this,Ce))):r(this,ee)._sendRequest(a,{responseCallback:n,errorCallback:l})})}_cursorClosed(s){if(s!==r(this,we))throw new St("Cursor was closed, but it was not associated with the stream");x(this,we,void 0),g(this,J,ga).call(this)}close(){g(this,J,wa).call(this,new G("Stream was manually closed"))}closeGracefully(){x(this,ft,!0),g(this,J,ga).call(this)}get closed(){return r(this,Ce)!==void 0||r(this,ft)}};ee=new WeakMap,ke=new WeakMap,Xe=new WeakMap,we=new WeakMap,ft=new WeakMap,Ce=new WeakMap,J=new WeakSet,Yt=function(s){return new Promise((a,n)=>{g(this,J,sn).call(this,{type:"request",request:s,responseCallback:a,errorCallback:n})})},sn=function(s){r(this,Ce)!==void 0?s.errorCallback(new Se("Stream is closed",r(this,Ce))):r(this,ft)?s.errorCallback(new Se("Stream is closing",void 0)):(r(this,Xe).push(s),g(this,J,ga).call(this))},ga=function(){for(;;){const s=r(this,Xe).first();if(s===void 0&&r(this,we)===void 0&&r(this,ft)){g(this,J,wa).call(this,new G("Stream was gracefully closed"));break}else if((s==null?void 0:s.type)==="request"&&r(this,we)===void 0){const{request:a,responseCallback:n,errorCallback:l}=s;r(this,Xe).shift(),r(this,ee)._sendRequest(a,{responseCallback:n,errorCallback:l})}else if((s==null?void 0:s.type)==="cursor"&&r(this,we)===void 0){const{batch:a,cursorCallback:n}=s;r(this,Xe).shift();const l=r(this,ee)._cursorIdAlloc.alloc(),d=new Io(r(this,ee),this,l),i={type:"open_cursor",streamId:r(this,ke),cursorId:l,batch:a},p=()=>{},o=u=>d._setClosed(u);r(this,ee)._sendRequest(i,{responseCallback:p,errorCallback:o}),x(this,we,d),n(d)}else break}},wa=function(s){if(r(this,Ce)!==void 0)return;for(x(this,Ce,s),r(this,we)!==void 0&&r(this,we)._setClosed(s);;){const d=r(this,Xe).shift();if(d!==void 0)d.errorCallback(s);else break}const a={type:"close_stream",streamId:r(this,ke)},n=()=>r(this,ee)._streamIdAlloc.free(r(this,ke)),l=()=>{};r(this,ee)._sendRequest(a,{responseCallback:n,errorCallback:l})};let tn=Hn;function kn(e,t){t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId),e.arrayObjects("args",t.args,ir),e.arrayObjects("named_args",t.namedArgs,Ro),e.boolean("want_rows",t.wantRows)}function Ro(e,t){e.string("name",t.name),e.object("value",t.value,ir)}function Sa(e,t){e.arrayObjects("steps",t.steps,Co)}function Co(e,t){t.condition!==void 0&&e.object("condition",t.condition,an),e.object("stmt",t.stmt,kn)}function an(e,t){if(e.stringRaw("type",t.type),t.type==="ok"||t.type==="error")e.number("step",t.step);else if(t.type==="not")e.object("cond",t.cond,an);else if(t.type==="and"||t.type==="or")e.arrayObjects("conds",t.conds,an);else if(t.type!=="is_autocommit")throw W(t,"Impossible type of BatchCond")}function ir(e,t){if(t===null)e.stringRaw("type","null");else if(typeof t=="bigint")e.stringRaw("type","integer"),e.stringRaw("value",""+t);else if(typeof t=="number")e.stringRaw("type","float"),e.number("value",t);else if(typeof t=="string")e.stringRaw("type","text"),e.string("value",t);else if(t instanceof Uint8Array)e.stringRaw("type","blob"),e.stringRaw("base64",wn.fromUint8Array(t));else if(t!==void 0)throw W(t,"Impossible type of Value")}function $o(e,t){if(e.stringRaw("type",t.type),t.type==="hello")t.jwt!==void 0&&e.string("jwt",t.jwt);else if(t.type==="request")e.number("request_id",t.requestId),e.object("request",t.request,Ao);else throw W(t,"Impossible type of ClientMsg")}function Ao(e,t){if(e.stringRaw("type",t.type),t.type==="open_stream")e.number("stream_id",t.streamId);else if(t.type==="close_stream")e.number("stream_id",t.streamId);else if(t.type==="execute")e.number("stream_id",t.streamId),e.object("stmt",t.stmt,kn);else if(t.type==="batch")e.number("stream_id",t.streamId),e.object("batch",t.batch,Sa);else if(t.type==="open_cursor")e.number("stream_id",t.streamId),e.number("cursor_id",t.cursorId),e.object("batch",t.batch,Sa);else if(t.type==="close_cursor")e.number("cursor_id",t.cursorId);else if(t.type==="fetch_cursor")e.number("cursor_id",t.cursorId),e.number("max_count",t.maxCount);else if(t.type==="sequence")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")e.number("stream_id",t.streamId),t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type==="get_autocommit")e.number("stream_id",t.streamId);else throw W(t,"Impossible type of Request")}function _n(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId);for(const s of t.args)e.message(3,s,or);for(const s of t.namedArgs)e.message(4,s,To);e.bool(5,t.wantRows)}function To(e,t){e.string(1,t.name),e.message(2,t.value,or)}function Oa(e,t){for(const s of t.steps)e.message(1,s,Mo)}function Mo(e,t){t.condition!==void 0&&e.message(1,t.condition,Sn),e.message(2,t.stmt,_n)}function Sn(e,t){if(t.type==="ok")e.uint32(1,t.step);else if(t.type==="error")e.uint32(2,t.step);else if(t.type==="not")e.message(3,t.cond,Sn);else if(t.type==="and")e.message(4,t.conds,al);else if(t.type==="or")e.message(5,t.conds,al);else if(t.type==="is_autocommit")e.message(6,void 0,cr);else throw W(t,"Impossible type of BatchCond")}function al(e,t){for(const s of t)e.message(1,s,Sn)}function or(e,t){if(t===null)e.message(1,void 0,cr);else if(typeof t=="bigint")e.sint64(2,t);else if(typeof t=="number")e.double(3,t);else if(typeof t=="string")e.string(4,t);else if(t instanceof Uint8Array)e.bytes(5,t);else if(t!==void 0)throw W(t,"Impossible type of Value")}function cr(e,t){}function Do(e,t){if(t.type==="hello")e.message(1,t,Lo);else if(t.type==="request")e.message(2,t,Oo);else throw W(t,"Impossible type of ClientMsg")}function Lo(e,t){t.jwt!==void 0&&e.string(1,t.jwt)}function Oo(e,t){e.int32(1,t.requestId);const s=t.request;if(s.type==="open_stream")e.message(2,s,jo);else if(s.type==="close_stream")e.message(3,s,qo);else if(s.type==="execute")e.message(4,s,Po);else if(s.type==="batch")e.message(5,s,No);else if(s.type==="open_cursor")e.message(6,s,Bo);else if(s.type==="close_cursor")e.message(7,s,Fo);else if(s.type==="fetch_cursor")e.message(8,s,Uo);else if(s.type==="sequence")e.message(9,s,Vo);else if(s.type==="describe")e.message(10,s,Ho);else if(s.type==="store_sql")e.message(11,s,Go);else if(s.type==="close_sql")e.message(12,s,Wo);else if(s.type==="get_autocommit")e.message(13,s,zo);else throw W(s,"Impossible type of Request")}function jo(e,t){e.int32(1,t.streamId)}function qo(e,t){e.int32(1,t.streamId)}function Po(e,t){e.int32(1,t.streamId),e.message(2,t.stmt,_n)}function No(e,t){e.int32(1,t.streamId),e.message(2,t.batch,Oa)}function Bo(e,t){e.int32(1,t.streamId),e.int32(2,t.cursorId),e.message(3,t.batch,Oa)}function Fo(e,t){e.int32(1,t.cursorId)}function Uo(e,t){e.int32(1,t.cursorId),e.uint32(2,t.maxCount)}function Vo(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function Ho(e,t){e.int32(1,t.streamId),t.sql!==void 0&&e.string(2,t.sql),t.sqlId!==void 0&&e.int32(3,t.sqlId)}function Go(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function Wo(e,t){e.int32(1,t.sqlId)}function zo(e,t){e.int32(1,t.streamId)}function Es(e){const t=Le(e.message),s=je(e.code);return{message:t,code:s}}function En(e){const t=Et(e.cols,dr),s=ka(e.rows).map(d=>Et(d,fr)),a=Gt(e.affected_row_count),n=je(e.last_insert_rowid),l=n!==void 0?BigInt(n):void 0;return{cols:t,rows:s,affectedRowCount:a,lastInsertRowid:l}}function dr(e){const t=je(e.name),s=je(e.decltype);return{name:t,decltype:s}}function pr(e){const t=new Map;ka(e.step_results).forEach((a,n)=>{a!==null&&t.set(n,En(se(a)))});const s=new Map;return ka(e.step_errors).forEach((a,n)=>{a!==null&&s.set(n,Es(se(a)))}),{stepResults:t,stepErrors:s}}function ur(e){const t=Le(e.type);if(t==="step_begin"){const s=Gt(e.step),a=Et(e.cols,dr);return{type:"step_begin",step:s,cols:a}}else if(t==="step_end"){const s=Gt(e.affected_row_count),a=je(e.last_insert_rowid),n=a!==void 0?BigInt(a):void 0;return{type:"step_end",affectedRowCount:s,lastInsertRowid:n}}else if(t==="step_error"){const s=Gt(e.step),a=Es(se(e.error));return{type:"step_error",step:s,error:a}}else{if(t==="row")return{type:"row",row:Et(e.row,fr)};if(t==="error")return{type:"error",error:Es(se(e.error))};throw new A("Unexpected type of CursorEntry")}}function xr(e){const t=Et(e.params,Jo),s=Et(e.cols,Yo),a=Ws(e.is_explain),n=Ws(e.is_readonly);return{params:t,cols:s,isExplain:a,isReadonly:n}}function Jo(e){return{name:je(e.name)}}function Yo(e){const t=Le(e.name),s=je(e.decltype);return{name:t,decltype:s}}function fr(e){const t=Le(e.type);if(t==="null")return null;if(t==="integer"){const s=Le(e.value);return BigInt(s)}else{if(t==="float")return Gt(e.value);if(t==="text")return Le(e.value);if(t==="blob")return wn.toUint8Array(Le(e.base64));throw new A("Unexpected type of Value")}}function Ko(e){const t=Le(e.type);if(t==="hello_ok")return{type:"hello_ok"};if(t==="hello_error")return{type:"hello_error",error:Es(se(e.error))};if(t==="response_ok"){const s=Gt(e.request_id),a=Qo(se(e.response));return{type:"response_ok",requestId:s,response:a}}else if(t==="response_error"){const s=Gt(e.request_id),a=Es(se(e.error));return{type:"response_error",requestId:s,error:a}}else throw new A("Unexpected type of ServerMsg")}function Qo(e){const t=Le(e.type);if(t==="open_stream")return{type:"open_stream"};if(t==="close_stream")return{type:"close_stream"};if(t==="execute")return{type:"execute",result:En(se(e.result))};if(t==="batch")return{type:"batch",result:pr(se(e.result))};if(t==="open_cursor")return{type:"open_cursor"};if(t==="close_cursor")return{type:"close_cursor"};if(t==="fetch_cursor"){const s=Et(e.entries,ur),a=Ws(e.done);return{type:"fetch_cursor",entries:s,done:a}}else{if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:xr(se(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Ws(e.is_autocommit)};throw new A("Unexpected type of Response")}}const He={default(){return{message:"",code:void 0}},1(e,t){t.message=e.string()},2(e,t){t.code=e.string()}},Is={default(){return{cols:[],rows:[],affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.cols.push(e.message(br))},2(e,t){t.rows.push(e.message(mr))},3(e,t){t.affectedRowCount=Number(e.uint64())},4(e,t){t.lastInsertRowid=e.sint64()}},br={default(){return{name:void 0,decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},mr={default(){return[]},1(e,t){t.push(e.message(lc))}},Ea={default(){return{stepResults:new Map,stepErrors:new Map}},1(e,t){const[s,a]=e.message(Xo);t.stepResults.set(s,a)},2(e,t){const[s,a]=e.message(Zo);t.stepErrors.set(s,a)}},Xo={default(){return[0,Is.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(Is)}},Zo={default(){return[0,He.default()]},1(e,t){t[0]=e.uint32()},2(e,t){t[1]=e.message(He)}},hr={default(){return{type:"none"}},1(e){return e.message(ec)},2(e){return e.message(tc)},3(e){return e.message(sc)},4(e){return{type:"row",row:e.message(mr)}},5(e){return{type:"error",error:e.message(He)}}},ec={default(){return{type:"step_begin",step:0,cols:[]}},1(e,t){t.step=e.uint32()},2(e,t){t.cols.push(e.message(br))}},tc={default(){return{type:"step_end",affectedRowCount:0,lastInsertRowid:void 0}},1(e,t){t.affectedRowCount=e.uint32()},2(e,t){t.lastInsertRowid=e.uint64()}},sc={default(){return{type:"step_error",step:0,error:He.default()}},1(e,t){t.step=e.uint32()},2(e,t){t.error=e.message(He)}},Ia={default(){return{params:[],cols:[],isExplain:!1,isReadonly:!1}},1(e,t){t.params.push(e.message(ac))},2(e,t){t.cols.push(e.message(nc))},3(e,t){t.isExplain=e.bool()},4(e,t){t.isReadonly=e.bool()}},ac={default(){return{name:void 0}},1(e,t){t.name=e.string()}},nc={default(){return{name:"",decltype:void 0}},1(e,t){t.name=e.string()},2(e,t){t.decltype=e.string()}},lc={default(){},1(e){return null},2(e){return e.sint64()},3(e){return e.double()},4(e){return e.string()},5(e){return e.bytes()}},rc={default(){return{type:"none"}},1(e){return{type:"hello_ok"}},2(e){return e.message(ic)},3(e){return e.message(cc)},4(e){return e.message(oc)}},ic={default(){return{type:"hello_error",error:He.default()}},1(e,t){t.error=e.message(He)}},oc={default(){return{type:"response_error",requestId:0,error:He.default()}},1(e,t){t.requestId=e.int32()},2(e,t){t.error=e.message(He)}},cc={default(){return{type:"response_ok",requestId:0,response:{type:"none"}}},1(e,t){t.requestId=e.int32()},2(e,t){t.response={type:"open_stream"}},3(e,t){t.response={type:"close_stream"}},4(e,t){t.response=e.message(dc)},5(e,t){t.response=e.message(pc)},6(e,t){t.response={type:"open_cursor"}},7(e,t){t.response={type:"close_cursor"}},8(e,t){t.response=e.message(uc)},9(e,t){t.response={type:"sequence"}},10(e,t){t.response=e.message(xc)},11(e,t){t.response={type:"store_sql"}},12(e,t){t.response={type:"close_sql"}},13(e,t){t.response=e.message(fc)}},dc={default(){return{type:"execute",result:Is.default()}},1(e,t){t.result=e.message(Is)}},pc={default(){return{type:"batch",result:Ea.default()}},1(e,t){t.result=e.message(Ea)}},uc={default(){return{type:"fetch_cursor",entries:[],done:!1}},1(e,t){t.entries.push(e.message(hr))},2(e,t){t.done=e.bool()}},xc={default(){return{type:"describe",result:Ia.default()}},1(e,t){t.result=e.message(Ia)}},fc={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},bc=new Map([["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]),gr=new Map([["hrana3-protobuf",{version:3,encoding:"protobuf"}],["hrana3",{version:3,encoding:"json"}],["hrana2",{version:2,encoding:"json"}],["hrana1",{version:1,encoding:"json"}]]);var ae,Be,Nt,pe,Bt,ue,cs,$e,bt,ds,P,nn,wr,ln,vr,yr,qe,kr,_r,_l;let mc=(_l=class extends Gl{constructor(s,a){super();b(this,P);b(this,ae);b(this,Be);b(this,Nt);b(this,pe);b(this,Bt);b(this,ue);b(this,cs);b(this,$e);b(this,bt);L(this,"_streamIdAlloc");L(this,"_cursorIdAlloc");b(this,ds);x(this,ae,s),x(this,Be,[]),x(this,Nt,!1),x(this,pe,void 0),x(this,Bt,!1),x(this,ue,void 0),x(this,cs,!1),x(this,$e,new Map),x(this,bt,new Os),this._streamIdAlloc=new Os,this._cursorIdAlloc=new Os,x(this,ds,new Os),r(this,ae).binaryType="arraybuffer",r(this,ae).addEventListener("open",()=>g(this,P,wr).call(this)),r(this,ae).addEventListener("close",n=>g(this,P,yr).call(this,n)),r(this,ae).addEventListener("error",n=>g(this,P,vr).call(this,n)),r(this,ae).addEventListener("message",n=>g(this,P,kr).call(this,n)),g(this,P,nn).call(this,{type:"hello",jwt:a})}getVersion(){return new Promise((s,a)=>{if(x(this,cs,!0),r(this,pe)!==void 0)a(r(this,pe));else if(r(this,Nt))s(r(this,ue).version);else{const n=()=>s(r(this,ue).version);r(this,Be).push({openCallback:n,errorCallback:a})}})}_ensureVersion(s,a){if(r(this,ue)===void 0||!r(this,cs))throw new _s(`${a} is supported only on protocol version ${s} and higher, but the version supported by the WebSocket server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(r(this,ue).version<s)throw new _s(`${a} is supported on protocol version ${s} and higher, but the WebSocket server only supports version ${r(this,ue).version}`)}_sendRequest(s,a){if(r(this,pe)!==void 0){a.errorCallback(new Se("Client is closed",r(this,pe)));return}const n=r(this,bt).alloc();r(this,$e).set(n,{...a,type:s.type}),g(this,P,nn).call(this,{type:"request",requestId:n,request:s})}openStream(){return tn.open(this)}storeSql(s){this._ensureVersion(2,"storeSql()");const a=r(this,ds).alloc(),n=new yn(this,a),l=()=>{},d=p=>n._setClosed(p),i={type:"store_sql",sqlId:a,sql:s};return this._sendRequest(i,{responseCallback:l,errorCallback:d}),n}_closeSql(s){if(r(this,pe)!==void 0)return;const a=()=>r(this,ds).free(s),n=d=>g(this,P,qe).call(this,d),l={type:"close_sql",sqlId:s};this._sendRequest(l,{responseCallback:a,errorCallback:n})}close(){g(this,P,qe).call(this,new G("Client was manually closed"))}get closed(){return r(this,pe)!==void 0}},ae=new WeakMap,Be=new WeakMap,Nt=new WeakMap,pe=new WeakMap,Bt=new WeakMap,ue=new WeakMap,cs=new WeakMap,$e=new WeakMap,bt=new WeakMap,ds=new WeakMap,P=new WeakSet,nn=function(s){if(r(this,pe)!==void 0)throw new St("Trying to send a message on a closed client");if(r(this,Nt))g(this,P,ln).call(this,s);else{const a=()=>g(this,P,ln).call(this,s),n=()=>{};r(this,Be).push({openCallback:a,errorCallback:n})}},wr=function(){const s=r(this,ae).protocol;if(s===void 0){g(this,P,qe).call(this,new G("The `WebSocket.protocol` property is undefined. This most likely means that the WebSocket implementation provided by the environment is broken. If you are using Miniflare 2, please update to Miniflare 3, which fixes this problem."));return}else if(s==="")x(this,ue,{version:1,encoding:"json"});else if(x(this,ue,gr.get(s)),r(this,ue)===void 0){g(this,P,qe).call(this,new A(`Unrecognized WebSocket subprotocol: ${JSON.stringify(s)}`));return}for(const a of r(this,Be))a.openCallback();r(this,Be).length=0,x(this,Nt,!0)},ln=function(s){const a=r(this,ue).encoding;if(a==="json"){const n=Jl(s,$o);r(this,ae).send(n)}else if(a==="protobuf"){const n=Kl(s,Do);r(this,ae).send(n)}else throw W(a,"Impossible encoding")},vr=function(s){const n=s.message??"WebSocket was closed due to an error";g(this,P,qe).call(this,new Ka(n))},yr=function(s){let a=`WebSocket was closed with code ${s.code}`;s.reason&&(a+=`: ${s.reason}`),g(this,P,qe).call(this,new Ka(a))},qe=function(s){if(r(this,pe)===void 0){x(this,pe,s);for(const a of r(this,Be))a.errorCallback(s);r(this,Be).length=0;for(const[a,n]of r(this,$e).entries())n.errorCallback(s),r(this,bt).free(a);r(this,$e).clear(),r(this,ae).close()}},kr=function(s){if(r(this,pe)===void 0)try{let a;const n=r(this,ue).encoding;if(n==="json"){if(typeof s.data!="string"){r(this,ae).close(3003,"Only text messages are accepted with JSON encoding"),g(this,P,qe).call(this,new A("Received non-text message from server with JSON encoding"));return}a=vn(JSON.parse(s.data),Ko)}else if(n==="protobuf"){if(!(s.data instanceof ArrayBuffer)){r(this,ae).close(3003,"Only binary messages are accepted with Protobuf encoding"),g(this,P,qe).call(this,new A("Received non-binary message from server with Protobuf encoding"));return}a=La(new Uint8Array(s.data),rc)}else throw W(n,"Impossible encoding");g(this,P,_r).call(this,a)}catch(a){r(this,ae).close(3007,"Could not handle message"),g(this,P,qe).call(this,a)}},_r=function(s){if(s.type==="none")throw new A("Received an unrecognized ServerMsg");if(s.type==="hello_ok"||s.type==="hello_error"){if(r(this,Bt))throw new A("Received a duplicated hello response");if(x(this,Bt,!0),s.type==="hello_error")throw Ss(s.error);return}else if(!r(this,Bt))throw new A("Received a non-hello message before a hello response");if(s.type==="response_ok"){const a=s.requestId,n=r(this,$e).get(a);if(r(this,$e).delete(a),n===void 0)throw new A("Received unexpected OK response");r(this,bt).free(a);try{if(n.type!==s.response.type)throw console.dir({responseState:n,msg:s}),new A("Received unexpected type of response");n.responseCallback(s.response)}catch(l){throw n.errorCallback(l),l}}else if(s.type==="response_error"){const a=s.requestId,n=r(this,$e).get(a);if(r(this,$e).delete(a),n===void 0)throw new A("Received unexpected error response");r(this,bt).free(a),n.errorCallback(Ss(s.error))}else throw W(s,"Impossible ServerMsg type")},_l);var xa=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function hc(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var rn={exports:{}};(function(e,t){var s=typeof globalThis<"u"&&globalThis||typeof self<"u"&&self||typeof xa<"u"&&xa,a=function(){function l(){this.fetch=!1,this.DOMException=s.DOMException}return l.prototype=s,new l}();(function(l){(function(d){var i=typeof l<"u"&&l||typeof self<"u"&&self||typeof xa<"u"&&xa||{},p={searchParams:"URLSearchParams"in i,iterable:"Symbol"in i&&"iterator"in Symbol,blob:"FileReader"in i&&"Blob"in i&&function(){try{return new Blob,!0}catch{return!1}}(),formData:"FormData"in i,arrayBuffer:"ArrayBuffer"in i};function o(f){return f&&DataView.prototype.isPrototypeOf(f)}if(p.arrayBuffer)var u=["[object Int8Array]","[object Uint8Array]","[object Uint8ClampedArray]","[object Int16Array]","[object Uint16Array]","[object Int32Array]","[object Uint32Array]","[object Float32Array]","[object Float64Array]"],y=ArrayBuffer.isView||function(f){return f&&u.indexOf(Object.prototype.toString.call(f))>-1};function w(f){if(typeof f!="string"&&(f=String(f)),/[^a-z0-9\-#$%&'*+.^_`|~!]/i.test(f)||f==="")throw new TypeError('Invalid character in header field name: "'+f+'"');return f.toLowerCase()}function k(f){return typeof f!="string"&&(f=String(f)),f}function m(f){var _={next:function(){var $=f.shift();return{done:$===void 0,value:$}}};return p.iterable&&(_[Symbol.iterator]=function(){return _}),_}function E(f){this.map={},f instanceof E?f.forEach(function(_,$){this.append($,_)},this):Array.isArray(f)?f.forEach(function(_){if(_.length!=2)throw new TypeError("Headers constructor: expected name/value pair to be length 2, found"+_.length);this.append(_[0],_[1])},this):f&&Object.getOwnPropertyNames(f).forEach(function(_){this.append(_,f[_])},this)}E.prototype.append=function(f,_){f=w(f),_=k(_);var $=this.map[f];this.map[f]=$?$+", "+_:_},E.prototype.delete=function(f){delete this.map[w(f)]},E.prototype.get=function(f){return f=w(f),this.has(f)?this.map[f]:null},E.prototype.has=function(f){return this.map.hasOwnProperty(w(f))},E.prototype.set=function(f,_){this.map[w(f)]=k(_)},E.prototype.forEach=function(f,_){for(var $ in this.map)this.map.hasOwnProperty($)&&f.call(_,this.map[$],$,this)},E.prototype.keys=function(){var f=[];return this.forEach(function(_,$){f.push($)}),m(f)},E.prototype.values=function(){var f=[];return this.forEach(function(_){f.push(_)}),m(f)},E.prototype.entries=function(){var f=[];return this.forEach(function(_,$){f.push([$,_])}),m(f)},p.iterable&&(E.prototype[Symbol.iterator]=E.prototype.entries);function S(f){if(!f._noBody){if(f.bodyUsed)return Promise.reject(new TypeError("Already read"));f.bodyUsed=!0}}function h(f){return new Promise(function(_,$){f.onload=function(){_(f.result)},f.onerror=function(){$(f.error)}})}function q(f){var _=new FileReader,$=h(_);return _.readAsArrayBuffer(f),$}function U(f){var _=new FileReader,$=h(_),N=/charset=([A-Za-z0-9_-]+)/.exec(f.type),F=N?N[1]:"utf-8";return _.readAsText(f,F),$}function As(f){for(var _=new Uint8Array(f),$=new Array(_.length),N=0;N<_.length;N++)$[N]=String.fromCharCode(_[N]);return $.join("")}function zt(f){if(f.slice)return f.slice(0);var _=new Uint8Array(f.byteLength);return _.set(new Uint8Array(f)),_.buffer}function Gn(){return this.bodyUsed=!1,this._initBody=function(f){this.bodyUsed=this.bodyUsed,this._bodyInit=f,f?typeof f=="string"?this._bodyText=f:p.blob&&Blob.prototype.isPrototypeOf(f)?this._bodyBlob=f:p.formData&&FormData.prototype.isPrototypeOf(f)?this._bodyFormData=f:p.searchParams&&URLSearchParams.prototype.isPrototypeOf(f)?this._bodyText=f.toString():p.arrayBuffer&&p.blob&&o(f)?(this._bodyArrayBuffer=zt(f.buffer),this._bodyInit=new Blob([this._bodyArrayBuffer])):p.arrayBuffer&&(ArrayBuffer.prototype.isPrototypeOf(f)||y(f))?this._bodyArrayBuffer=zt(f):this._bodyText=f=Object.prototype.toString.call(f):(this._noBody=!0,this._bodyText=""),this.headers.get("content-type")||(typeof f=="string"?this.headers.set("content-type","text/plain;charset=UTF-8"):this._bodyBlob&&this._bodyBlob.type?this.headers.set("content-type",this._bodyBlob.type):p.searchParams&&URLSearchParams.prototype.isPrototypeOf(f)&&this.headers.set("content-type","application/x-www-form-urlencoded;charset=UTF-8"))},p.blob&&(this.blob=function(){var f=S(this);if(f)return f;if(this._bodyBlob)return Promise.resolve(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve(new Blob([this._bodyArrayBuffer]));if(this._bodyFormData)throw new Error("could not read FormData body as blob");return Promise.resolve(new Blob([this._bodyText]))}),this.arrayBuffer=function(){if(this._bodyArrayBuffer){var f=S(this);return f||(ArrayBuffer.isView(this._bodyArrayBuffer)?Promise.resolve(this._bodyArrayBuffer.buffer.slice(this._bodyArrayBuffer.byteOffset,this._bodyArrayBuffer.byteOffset+this._bodyArrayBuffer.byteLength)):Promise.resolve(this._bodyArrayBuffer))}else{if(p.blob)return this.blob().then(q);throw new Error("could not read as ArrayBuffer")}},this.text=function(){var f=S(this);if(f)return f;if(this._bodyBlob)return U(this._bodyBlob);if(this._bodyArrayBuffer)return Promise.resolve(As(this._bodyArrayBuffer));if(this._bodyFormData)throw new Error("could not read FormData body as text");return Promise.resolve(this._bodyText)},p.formData&&(this.formData=function(){return this.text().then(Kr)}),this.json=function(){return this.text().then(JSON.parse)},this}var Jr=["CONNECT","DELETE","GET","HEAD","OPTIONS","PATCH","POST","PUT","TRACE"];function Yr(f){var _=f.toUpperCase();return Jr.indexOf(_)>-1?_:f}function ct(f,_){if(!(this instanceof ct))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');_=_||{};var $=_.body;if(f instanceof ct){if(f.bodyUsed)throw new TypeError("Already read");this.url=f.url,this.credentials=f.credentials,_.headers||(this.headers=new E(f.headers)),this.method=f.method,this.mode=f.mode,this.signal=f.signal,!$&&f._bodyInit!=null&&($=f._bodyInit,f.bodyUsed=!0)}else this.url=String(f);if(this.credentials=_.credentials||this.credentials||"same-origin",(_.headers||!this.headers)&&(this.headers=new E(_.headers)),this.method=Yr(_.method||this.method||"GET"),this.mode=_.mode||this.mode||null,this.signal=_.signal||this.signal||function(){if("AbortController"in i){var M=new AbortController;return M.signal}}(),this.referrer=null,(this.method==="GET"||this.method==="HEAD")&&$)throw new TypeError("Body not allowed for GET or HEAD requests");if(this._initBody($),(this.method==="GET"||this.method==="HEAD")&&(_.cache==="no-store"||_.cache==="no-cache")){var N=/([?&])_=[^&]*/;if(N.test(this.url))this.url=this.url.replace(N,"$1_="+new Date().getTime());else{var F=/\?/;this.url+=(F.test(this.url)?"&":"?")+"_="+new Date().getTime()}}}ct.prototype.clone=function(){return new ct(this,{body:this._bodyInit})};function Kr(f){var _=new FormData;return f.trim().split("&").forEach(function($){if($){var N=$.split("="),F=N.shift().replace(/\+/g," "),M=N.join("=").replace(/\+/g," ");_.append(decodeURIComponent(F),decodeURIComponent(M))}}),_}function Qr(f){var _=new E,$=f.replace(/\r?\n[\t ]+/g," ");return $.split("\r").map(function(N){return N.indexOf(`
`)===0?N.substr(1,N.length):N}).forEach(function(N){var F=N.split(":"),M=F.shift().trim();if(M){var pa=F.join(":").trim();try{_.append(M,pa)}catch(Ba){console.warn("Response "+Ba.message)}}}),_}Gn.call(ct.prototype);function Ee(f,_){if(!(this instanceof Ee))throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');if(_||(_={}),this.type="default",this.status=_.status===void 0?200:_.status,this.status<200||this.status>599)throw new RangeError("Failed to construct 'Response': The status provided (0) is outside the range [200, 599].");this.ok=this.status>=200&&this.status<300,this.statusText=_.statusText===void 0?"":""+_.statusText,this.headers=new E(_.headers),this.url=_.url||"",this._initBody(f)}Gn.call(Ee.prototype),Ee.prototype.clone=function(){return new Ee(this._bodyInit,{status:this.status,statusText:this.statusText,headers:new E(this.headers),url:this.url})},Ee.error=function(){var f=new Ee(null,{status:200,statusText:""});return f.ok=!1,f.status=0,f.type="error",f};var Xr=[301,302,303,307,308];Ee.redirect=function(f,_){if(Xr.indexOf(_)===-1)throw new RangeError("Invalid status code");return new Ee(null,{status:_,headers:{location:f}})},d.DOMException=i.DOMException;try{new d.DOMException}catch{d.DOMException=function(_,$){this.message=_,this.name=$;var N=Error(_);this.stack=N.stack},d.DOMException.prototype=Object.create(Error.prototype),d.DOMException.prototype.constructor=d.DOMException}function Na(f,_){return new Promise(function($,N){var F=new ct(f,_);if(F.signal&&F.signal.aborted)return N(new d.DOMException("Aborted","AbortError"));var M=new XMLHttpRequest;function pa(){M.abort()}M.onload=function(){var Z={statusText:M.statusText,headers:Qr(M.getAllResponseHeaders()||"")};F.url.indexOf("file://")===0&&(M.status<200||M.status>599)?Z.status=200:Z.status=M.status,Z.url="responseURL"in M?M.responseURL:Z.headers.get("X-Request-URL");var Rt="response"in M?M.response:M.responseText;setTimeout(function(){$(new Ee(Rt,Z))},0)},M.onerror=function(){setTimeout(function(){N(new TypeError("Network request failed"))},0)},M.ontimeout=function(){setTimeout(function(){N(new TypeError("Network request timed out"))},0)},M.onabort=function(){setTimeout(function(){N(new d.DOMException("Aborted","AbortError"))},0)};function Ba(Z){try{return Z===""&&i.location.href?i.location.href:Z}catch{return Z}}if(M.open(F.method,Ba(F.url),!0),F.credentials==="include"?M.withCredentials=!0:F.credentials==="omit"&&(M.withCredentials=!1),"responseType"in M&&(p.blob?M.responseType="blob":p.arrayBuffer&&(M.responseType="arraybuffer")),_&&typeof _.headers=="object"&&!(_.headers instanceof E||i.Headers&&_.headers instanceof i.Headers)){var Wn=[];Object.getOwnPropertyNames(_.headers).forEach(function(Z){Wn.push(w(Z)),M.setRequestHeader(Z,k(_.headers[Z]))}),F.headers.forEach(function(Z,Rt){Wn.indexOf(Rt)===-1&&M.setRequestHeader(Rt,Z)})}else F.headers.forEach(function(Z,Rt){M.setRequestHeader(Rt,Z)});F.signal&&(F.signal.addEventListener("abort",pa),M.onreadystatechange=function(){M.readyState===4&&F.signal.removeEventListener("abort",pa)}),M.send(typeof F._bodyInit>"u"?null:F._bodyInit)})}return Na.polyfill=!0,i.fetch||(i.fetch=Na,i.Headers=E,i.Request=ct,i.Response=Ee),d.Headers=E,d.Request=ct,d.Response=Ee,d.fetch=Na,d})({})})(a),a.fetch.ponyfill=!0,delete a.fetch.polyfill;var n=s.fetch?s:a;t=n.fetch,t.default=n.fetch,t.fetch=n.fetch,t.Headers=n.Headers,t.Request=n.Request,t.Response=n.Response,e.exports=t})(rn,rn.exports);var Ra=rn.exports;let Xt;if(typeof queueMicrotask<"u")Xt=queueMicrotask;else{const e=Promise.resolve();Xt=t=>{e.then(t)}}var ve,Ae,xe,Da,Sr;class gc{constructor(t){b(this,Da);b(this,ve);b(this,Ae);b(this,xe);x(this,ve,new Uint8Array(new ArrayBuffer(t))),x(this,Ae,0),x(this,xe,0)}get length(){return r(this,xe)-r(this,Ae)}data(){return r(this,ve).slice(r(this,Ae),r(this,xe))}push(t){g(this,Da,Sr).call(this,t.byteLength),r(this,ve).set(t,r(this,xe)),x(this,xe,r(this,xe)+t.byteLength)}shift(t){x(this,Ae,r(this,Ae)+t)}}ve=new WeakMap,Ae=new WeakMap,xe=new WeakMap,Da=new WeakSet,Sr=function(t){if(r(this,xe)+t<=r(this,ve).byteLength)return;const s=r(this,xe)-r(this,Ae);if(s+t<=r(this,ve).byteLength&&2*r(this,xe)>=r(this,ve).byteLength)r(this,ve).copyWithin(0,r(this,Ae),r(this,xe));else{let a=r(this,ve).byteLength;do a*=2;while(s+t>a);const n=new Uint8Array(new ArrayBuffer(a));n.set(r(this,ve).slice(r(this,Ae),r(this,xe)),0),x(this,ve,n)}x(this,xe,s),x(this,Ae,0)};function wc(e){const t=je(e.baton),s=je(e.base_url),a=Et(e.results,vc);return{baton:t,baseUrl:s,results:a}}function vc(e){const t=Le(e.type);if(t==="ok")return{type:"ok",response:yc(se(e.response))};if(t==="error")return{type:"error",error:Es(se(e.error))};throw new A("Unexpected type of StreamResult")}function yc(e){const t=Le(e.type);if(t==="close")return{type:"close"};if(t==="execute")return{type:"execute",result:En(se(e.result))};if(t==="batch")return{type:"batch",result:pr(se(e.result))};if(t==="sequence")return{type:"sequence"};if(t==="describe")return{type:"describe",result:xr(se(e.result))};if(t==="store_sql")return{type:"store_sql"};if(t==="close_sql")return{type:"close_sql"};if(t==="get_autocommit")return{type:"get_autocommit",isAutocommit:Ws(e.is_autocommit)};throw new A("Unexpected type of StreamResponse")}function kc(e){const t=je(e.baton),s=je(e.base_url);return{baton:t,baseUrl:s}}const _c={default(){return{baton:void 0,baseUrl:void 0,results:[]}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()},3(e,t){t.results.push(e.message(Sc))}},Sc={default(){return{type:"none"}},1(e){return{type:"ok",response:e.message(Ec)}},2(e){return{type:"error",error:e.message(He)}}},Ec={default(){return{type:"none"}},1(e){return{type:"close"}},2(e){return e.message(Ic)},3(e){return e.message(Rc)},4(e){return{type:"sequence"}},5(e){return e.message(Cc)},6(e){return{type:"store_sql"}},7(e){return{type:"close_sql"}},8(e){return e.message($c)}},Ic={default(){return{type:"execute",result:Is.default()}},1(e,t){t.result=e.message(Is)}},Rc={default(){return{type:"batch",result:Ea.default()}},1(e,t){t.result=e.message(Ea)}},Cc={default(){return{type:"describe",result:Ia.default()}},1(e,t){t.result=e.message(Ia)}},$c={default(){return{type:"get_autocommit",isAutocommit:!1}},1(e,t){t.isAutocommit=e.bool()}},Ac={default(){return{baton:void 0,baseUrl:void 0}},1(e,t){t.baton=e.string()},2(e,t){t.baseUrl=e.string()}};var Ys,Ft,Ze,Fe,et,ps,ot,on,Er,Ir;class Tc extends lr{constructor(s,a){super();b(this,ot);b(this,Ys);b(this,Ft);b(this,Ze);b(this,Fe);b(this,et);b(this,ps);x(this,Ys,s),x(this,Ft,a),x(this,Ze,void 0),x(this,Fe,new gc(16*1024)),x(this,et,void 0),x(this,ps,!1)}async open(s){if(s.body===null)throw new A("No response body for cursor request");x(this,Ze,s.body[Symbol.asyncIterator]());const a=await g(this,ot,on).call(this,kc,Ac);if(a===void 0)throw new A("Empty response to cursor request");return a}next(){return g(this,ot,on).call(this,ur,hr)}close(){this._setClosed(new G("Cursor was manually closed"))}_setClosed(s){r(this,et)===void 0&&(x(this,et,s),r(this,Ys)._cursorClosed(this),r(this,Ze)!==void 0&&r(this,Ze).return())}get closed(){return r(this,et)!==void 0}}Ys=new WeakMap,Ft=new WeakMap,Ze=new WeakMap,Fe=new WeakMap,et=new WeakMap,ps=new WeakMap,ot=new WeakSet,on=async function(s,a){for(;;){if(r(this,ps))return;if(r(this,et)!==void 0)throw new Se("Cursor is closed",r(this,et));if(r(this,Ft)==="json"){const d=g(this,ot,Er).call(this);if(d!==void 0){const i=new TextDecoder().decode(d),p=JSON.parse(i);return vn(p,s)}}else if(r(this,Ft)==="protobuf"){const d=g(this,ot,Ir).call(this);if(d!==void 0)return La(d,a)}else throw W(r(this,Ft),"Impossible encoding");if(r(this,Ze)===void 0)throw new St("Attempted to read from HTTP cursor before it was opened");const{value:n,done:l}=await r(this,Ze).next();if(l&&r(this,Fe).length===0)x(this,ps,!0);else{if(l)throw new A("Unexpected end of cursor stream");r(this,Fe).push(n)}}},Er=function(){const s=r(this,Fe).data(),n=s.indexOf(10);if(n<0)return;const l=s.slice(0,n);return r(this,Fe).shift(n+1),l},Ir=function(){const s=r(this,Fe).data();let a=0,n=0;for(;;){if(n>=s.byteLength)return;const d=s[n];if(a|=(d&127)<<7*n,n+=1,!(d&128))break}if(s.byteLength<n+a)return;const l=s.slice(n,n+a);return r(this,Fe).shift(n+a),l};function Mc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.arrayObjects("requests",t.requests,Dc)}function Dc(e,t){if(e.stringRaw("type",t.type),t.type!=="close"){if(t.type==="execute")e.object("stmt",t.stmt,kn);else if(t.type==="batch")e.object("batch",t.batch,Sa);else if(t.type==="sequence")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="describe")t.sql!==void 0&&e.string("sql",t.sql),t.sqlId!==void 0&&e.number("sql_id",t.sqlId);else if(t.type==="store_sql")e.number("sql_id",t.sqlId),e.string("sql",t.sql);else if(t.type==="close_sql")e.number("sql_id",t.sqlId);else if(t.type!=="get_autocommit")throw W(t,"Impossible type of StreamRequest")}}function Lc(e,t){t.baton!==void 0&&e.string("baton",t.baton),e.object("batch",t.batch,Sa)}function Oc(e,t){t.baton!==void 0&&e.string(1,t.baton);for(const s of t.requests)e.message(2,s,jc)}function jc(e,t){if(t.type==="close")e.message(1,t,qc);else if(t.type==="execute")e.message(2,t,Pc);else if(t.type==="batch")e.message(3,t,Nc);else if(t.type==="sequence")e.message(4,t,Bc);else if(t.type==="describe")e.message(5,t,Fc);else if(t.type==="store_sql")e.message(6,t,Uc);else if(t.type==="close_sql")e.message(7,t,Vc);else if(t.type==="get_autocommit")e.message(8,t,Hc);else throw W(t,"Impossible type of StreamRequest")}function qc(e,t){}function Pc(e,t){e.message(1,t.stmt,_n)}function Nc(e,t){e.message(1,t.batch,Oa)}function Bc(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function Fc(e,t){t.sql!==void 0&&e.string(1,t.sql),t.sqlId!==void 0&&e.int32(2,t.sqlId)}function Uc(e,t){e.int32(1,t.sqlId),e.string(2,t.sql)}function Vc(e,t){e.int32(1,t.sqlId)}function Hc(e,t){}function Gc(e,t){t.baton!==void 0&&e.string(1,t.baton),e.message(2,t.batch,Oa)}var tt,mt,us,Ks,xs,ht,Te,gt,st,at,wt,Ue,fs,D,dt,cn,At,Rr,Cr,dn,$r,Ar,pn;class Wc extends nr{constructor(s,a,n,l,d){super(s.intMode);b(this,D);b(this,tt);b(this,mt);b(this,us);b(this,Ks);b(this,xs);b(this,ht);b(this,Te);b(this,gt);b(this,st);b(this,at);b(this,wt);b(this,Ue);b(this,fs);x(this,tt,s),x(this,mt,a.toString()),x(this,us,n),x(this,Ks,l),x(this,xs,d),x(this,ht,void 0),x(this,Te,new _a),x(this,gt,!1),x(this,at,!1),x(this,wt,!1),x(this,Ue,void 0),x(this,fs,new Os)}client(){return r(this,tt)}_sqlOwner(){return this}storeSql(s){const a=r(this,fs).alloc();return g(this,D,dt).call(this,{type:"store_sql",sqlId:a,sql:s}).then(()=>{},n=>this._setClosed(n)),new yn(this,a)}_closeSql(s){r(this,Ue)===void 0&&g(this,D,dt).call(this,{type:"close_sql",sqlId:s}).then(()=>r(this,fs).free(s),a=>this._setClosed(a))}_execute(s){return g(this,D,dt).call(this,{type:"execute",stmt:s}).then(a=>a.result)}_batch(s){return g(this,D,dt).call(this,{type:"batch",batch:s}).then(a=>a.result)}_describe(s){return g(this,D,dt).call(this,{type:"describe",sql:s.sql,sqlId:s.sqlId}).then(a=>a.result)}_sequence(s){return g(this,D,dt).call(this,{type:"sequence",sql:s.sql,sqlId:s.sqlId}).then(a=>{})}getAutocommit(){return r(this,tt)._ensureVersion(3,"getAutocommit()"),g(this,D,dt).call(this,{type:"get_autocommit"}).then(s=>s.isAutocommit)}_openCursor(s){return new Promise((a,n)=>{g(this,D,cn).call(this,{type:"cursor",batch:s,cursorCallback:a,errorCallback:n})})}_cursorClosed(s){if(s!==r(this,st))throw new St("Cursor was closed, but it was not associated with the stream");x(this,st,void 0),Xt(()=>g(this,D,At).call(this))}close(){this._setClosed(new G("Stream was manually closed"))}closeGracefully(){x(this,at,!0),Xt(()=>g(this,D,At).call(this))}get closed(){return r(this,Ue)!==void 0||r(this,at)}_setClosed(s){if(r(this,Ue)===void 0){for(x(this,Ue,s),r(this,st)!==void 0&&r(this,st)._setClosed(s),r(this,tt)._streamClosed(this);;){const a=r(this,Te).shift();if(a!==void 0)a.errorCallback(s);else break}(r(this,ht)!==void 0||r(this,gt))&&!r(this,wt)&&(r(this,Te).push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),x(this,wt,!0),Xt(()=>g(this,D,At).call(this)))}}}tt=new WeakMap,mt=new WeakMap,us=new WeakMap,Ks=new WeakMap,xs=new WeakMap,ht=new WeakMap,Te=new WeakMap,gt=new WeakMap,st=new WeakMap,at=new WeakMap,wt=new WeakMap,Ue=new WeakMap,fs=new WeakMap,D=new WeakSet,dt=function(s){return new Promise((a,n)=>{g(this,D,cn).call(this,{type:"pipeline",request:s,responseCallback:a,errorCallback:n})})},cn=function(s){if(r(this,Ue)!==void 0)throw new Se("Stream is closed",r(this,Ue));if(r(this,at))throw new Se("Stream is closing",void 0);r(this,Te).push(s),Xt(()=>g(this,D,At).call(this))},At=function(){if(r(this,gt)||r(this,st)!==void 0)return;if(r(this,at)&&r(this,Te).length===0){this._setClosed(new G("Stream was gracefully closed"));return}const s=r(this,tt)._endpoint;if(s===void 0){r(this,tt)._endpointPromise.then(()=>g(this,D,At).call(this),n=>this._setClosed(n));return}const a=r(this,Te).shift();if(a!==void 0)if(a.type==="pipeline"){const n=[a];for(;;){const l=r(this,Te).first();if(l!==void 0&&l.type==="pipeline")n.push(l),r(this,Te).shift();else if(l===void 0&&r(this,at)&&!r(this,wt)){n.push({type:"pipeline",request:{type:"close"},responseCallback:()=>{},errorCallback:()=>{}}),x(this,wt,!0);break}else break}g(this,D,Rr).call(this,s,n)}else if(a.type==="cursor")g(this,D,Cr).call(this,s,a);else throw W(a,"Impossible type of QueueEntry")},Rr=function(s,a){g(this,D,dn).call(this,()=>g(this,D,$r).call(this,a,s),n=>Jc(n,s.encoding),n=>n.baton,n=>n.baseUrl,n=>zc(a,n),n=>a.forEach(l=>l.errorCallback(n)))},Cr=function(s,a){const n=new Tc(this,s.encoding);x(this,st,n),g(this,D,dn).call(this,()=>g(this,D,Ar).call(this,a,s),l=>n.open(l),l=>l.baton,l=>l.baseUrl,l=>a.cursorCallback(n),l=>a.errorCallback(l))},dn=function(s,a,n,l,d,i){let p;try{const o=s();p=r(this,Ks)(o)}catch(o){p=Promise.reject(o)}x(this,gt,!0),p.then(o=>o.ok?a(o):Yc(o).then(u=>{throw u})).then(o=>{x(this,ht,n(o)),x(this,mt,l(o)??r(this,mt)),d(o)}).catch(o=>{this._setClosed(o),i(o)}).finally(()=>{x(this,gt,!1),g(this,D,At).call(this)})},$r=function(s,a){return g(this,D,pn).call(this,new URL(a.pipelinePath,r(this,mt)),{baton:r(this,ht),requests:s.map(n=>n.request)},a.encoding,Mc,Oc)},Ar=function(s,a){if(a.cursorPath===void 0)throw new _s(`Cursors are supported only on protocol version 3 and higher, but the HTTP server only supports version ${a.version}.`);return g(this,D,pn).call(this,new URL(a.cursorPath,r(this,mt)),{baton:r(this,ht),batch:s.batch},a.encoding,Lc,Gc)},pn=function(s,a,n,l,d){let i,p;if(n==="json")i=Jl(a,l),p="application/json";else if(n==="protobuf")i=Kl(a,d),p="application/x-protobuf";else throw W(n,"Impossible encoding");const o=new Ra.Headers;return o.set("content-type",p),r(this,us)!==void 0&&o.set("authorization",`Bearer ${r(this,us)}`),r(this,xs)!==void 0&&o.set("x-turso-encryption-key",r(this,xs)),new Ra.Request(s.toString(),{method:"POST",headers:o,body:i})};function zc(e,t){if(t.results.length!==e.length)throw new A("Server returned unexpected number of pipeline results");for(let s=0;s<e.length;++s){const a=t.results[s],n=e[s];if(a.type==="ok"){if(a.response.type!==n.request.type)throw new A("Received unexpected type of response");n.responseCallback(a.response)}else if(a.type==="error")n.errorCallback(Ss(a.error));else throw a.type==="none"?new A("Received unrecognized type of StreamResult"):W(a,"Received impossible type of StreamResult")}}async function Jc(e,t){var s;if(t==="json"){const a=await e.json();return vn(a,wc)}if(t==="protobuf"){const a=await e.arrayBuffer();return La(new Uint8Array(a),_c)}throw await((s=e.body)==null?void 0:s.cancel()),W(t,"Impossible encoding")}async function Yc(e){var a;const t=e.headers.get("content-type")??"text/plain";let s=`Server returned HTTP status ${e.status}`;if(t==="application/json"){const n=await e.json();return"message"in n?Ss(n):new ma(s,e.status)}if(t==="text/plain"){const n=(await e.text()).trim();return n!==""&&(s+=`: ${n}`),new ma(s,e.status)}return await((a=e.body)==null?void 0:a.cancel()),new ma(s,e.status)}const Kc=[{versionPath:"v3-protobuf",pipelinePath:"v3-protobuf/pipeline",cursorPath:"v3-protobuf/cursor",version:3,encoding:"protobuf"}],un={versionPath:"v2",pipelinePath:"v2/pipeline",cursorPath:void 0,version:2,encoding:"json"};var bs,Qs,ms,Xs,nt,Ut,hs,va,Sl;let Qc=(Sl=class extends Gl{constructor(s,a,n,l,d=2){super();b(this,hs);b(this,bs);b(this,Qs);b(this,ms);b(this,Xs);b(this,nt);b(this,Ut);L(this,"_endpointPromise");L(this,"_endpoint");x(this,bs,s),x(this,Qs,a),x(this,ms,n??Ra.fetch),x(this,Xs,l),x(this,nt,void 0),x(this,Ut,new Set),d==3?(this._endpointPromise=Xc(r(this,ms),r(this,bs)),this._endpointPromise.then(i=>this._endpoint=i,i=>g(this,hs,va).call(this,i))):(this._endpointPromise=Promise.resolve(un),this._endpointPromise.then(i=>this._endpoint=i,i=>g(this,hs,va).call(this,i)))}async getVersion(){return this._endpoint!==void 0?this._endpoint.version:(await this._endpointPromise).version}_ensureVersion(s,a){if(!(s<=un.version)){if(this._endpoint===void 0)throw new _s(`${a} is supported only on protocol version ${s} and higher, but the version supported by the HTTP server is not yet known. Use Client.getVersion() to wait until the version is available.`);if(this._endpoint.version<s)throw new _s(`${a} is supported only on protocol version ${s} and higher, but the HTTP server only supports version ${this._endpoint.version}.`)}}openStream(){if(r(this,nt)!==void 0)throw new Se("Client is closed",r(this,nt));const s=new Wc(this,r(this,bs),r(this,Qs),r(this,ms),r(this,Xs));return r(this,Ut).add(s),s}_streamClosed(s){r(this,Ut).delete(s)}close(){g(this,hs,va).call(this,new G("Client was manually closed"))}get closed(){return r(this,nt)!==void 0}},bs=new WeakMap,Qs=new WeakMap,ms=new WeakMap,Xs=new WeakMap,nt=new WeakMap,Ut=new WeakMap,hs=new WeakSet,va=function(s){if(r(this,nt)===void 0){x(this,nt,s);for(const a of Array.from(r(this,Ut)))a._setClosed(new Se("Client was closed",s))}},Sl);async function Xc(e,t){const s=e;for(const a of Kc){const n=new URL(a.versionPath,t),l=new Ra.Request(n.toString(),{method:"GET"}),d=await s(l);if(await d.arrayBuffer(),d.ok)return a}return un}function Tr(e,t,s=2){if(typeof Qt>"u")throw new zl("WebSockets are not supported in this environment");var a=void 0;s==3?a=Array.from(gr.keys()):a=Array.from(bc.keys());const n=new Qt(e,a);return new mc(n,t)}function nl(e,t,s,a,n=2){return new Qc(e instanceof URL?e:new URL(e),t,s,a,n)}var gs,lt,re;class Mr{constructor(t,s){b(this,gs);b(this,lt);b(this,re);x(this,gs,t),x(this,lt,s),x(this,re,void 0)}execute(t){return this.batch([t]).then(s=>s[0])}async batch(t){const s=this._getStream();if(s.closed)throw new j("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{const a=t.map(Wt);let n;if(r(this,re)===void 0){this._getSqlCache().apply(a);const d=s.batch(r(this,lt)>=3),i=d.step(),p=i.run(Ya(r(this,gs)));let o=i;n=a.map(u=>{const y=d.step().condition(fe.ok(o));r(this,lt)>=3&&y.condition(fe.not(fe.isAutocommit(d)));const w=y.query(u);return w.catch(()=>{}),o=y,w}),x(this,re,d.execute().then(()=>p).then(()=>{}));try{await r(this,re)}catch(u){throw this.close(),u}}else{r(this,lt)<3&&await r(this,re),this._getSqlCache().apply(a);const d=s.batch(r(this,lt)>=3);let i;n=a.map(p=>{const o=d.step();i!==void 0&&o.condition(fe.ok(i)),r(this,lt)>=3&&o.condition(fe.not(fe.isAutocommit(d)));const u=o.query(p);return u.catch(()=>{}),i=o,u}),await d.execute()}const l=[];for(let d=0;d<n.length;d++)try{const i=await n[d];if(i===void 0)throw new Zt("Statement in a transaction was not executed, probably because the transaction has been rolled back",d,"TRANSACTION_CLOSED");l.push(ja(i))}catch(i){if(i instanceof Zt)throw i;const p=H(i);throw p instanceof j?new Zt(p.message,d,p.code,p.extendedCode,p.rawCode,p.cause instanceof Error?p.cause:void 0):p}return l}catch(a){throw H(a)}}async executeMultiple(t){const s=this._getStream();if(s.closed)throw new j("Cannot execute statements because the transaction is closed","TRANSACTION_CLOSED");try{if(r(this,re)===void 0){x(this,re,s.run(Ya(r(this,gs))).then(()=>{}));try{await r(this,re)}catch(a){throw this.close(),a}}else await r(this,re);await s.sequence(t)}catch(a){throw H(a)}}async rollback(){try{const t=this._getStream();if(t.closed||r(this,re)===void 0)return;const s=t.run("ROLLBACK").catch(a=>{throw H(a)});t.closeGracefully(),await s}catch(t){throw H(t)}finally{this.close()}}async commit(){try{const t=this._getStream();if(t.closed)throw new j("Cannot commit the transaction because it is already closed","TRANSACTION_CLOSED");if(r(this,re)!==void 0)await r(this,re);else return;const s=t.run("COMMIT").catch(a=>{throw H(a)});t.closeGracefully(),await s}catch(t){throw H(t)}finally{this.close()}}}gs=new WeakMap,lt=new WeakMap,re=new WeakMap;async function Ca(e,t,s,a,n=!1){n&&s.step().run("PRAGMA foreign_keys=off");const l=s.step(),d=l.run(Ya(e));let i=l;const p=a.map(k=>{const m=s.step().condition(fe.ok(i));t>=3&&m.condition(fe.not(fe.isAutocommit(s)));const E=m.query(k);return i=m,E}),o=s.step().condition(fe.ok(i));t>=3&&o.condition(fe.not(fe.isAutocommit(s)));const u=o.run("COMMIT");s.step().condition(fe.not(fe.ok(o))).run("ROLLBACK").catch(k=>{}),n&&s.step().run("PRAGMA foreign_keys=on"),await s.execute();const w=[];await d;for(let k=0;k<p.length;k++)try{const m=await p[k];if(m===void 0)throw new Zt("Statement in a batch was not executed, probably because the transaction has been rolled back",k,"TRANSACTION_CLOSED");w.push(ja(m))}catch(m){if(m instanceof Zt)throw m;const E=H(m);throw E instanceof j?new Zt(E.message,k,E.code,E.extendedCode,E.rawCode,E.cause instanceof Error?E.cause:void 0):E}return await u,w}function Wt(e){let t,s;Array.isArray(e)?[t,s]=e:typeof e=="string"?t=e:(t=e.sql,s=e.args);const a=new sr(t);if(s)if(Array.isArray(s))a.bindIndexes(s);else for(const[n,l]of Object.entries(s))a.bindName(n,l);return a}function ja(e){const t=e.columnNames.map(d=>d??""),s=e.columnDecltypes.map(d=>d??""),a=e.rows,n=e.affectedRowCount,l=e.lastInsertRowid!==void 0?e.lastInsertRowid:void 0;return new oo(t,s,a,n,l)}function H(e){if(e instanceof G){const t=Dr(e);return new j(e.message,t,void 0,void 0,e)}return e}function Dr(e){return e instanceof Wl&&e.code!==void 0?e.code:e instanceof A?"HRANA_PROTO_ERROR":e instanceof Se?e.cause instanceof G?Dr(e.cause):"HRANA_CLOSED_ERROR":e instanceof Ka?"HRANA_WEBSOCKET_ERROR":e instanceof ma?"SERVER_ERROR":e instanceof _s?"PROTOCOL_VERSION_ERROR":e instanceof St?"INTERNAL_ERROR":"UNKNOWN"}var Zs,Ve;class In{constructor(t,s){b(this,Zs);b(this,Ve);L(this,"capacity");x(this,Zs,t),x(this,Ve,new Zc),this.capacity=s}apply(t){if(this.capacity<=0)return;const s=new Set;for(const a of t){if(typeof a.sql!="string")continue;const n=a.sql;if(n.length>=5e3)continue;let l=r(this,Ve).get(n);if(l===void 0){for(;r(this,Ve).size+1>this.capacity;){const[d,i]=r(this,Ve).peekLru();if(s.has(i))break;i.close(),r(this,Ve).delete(d)}r(this,Ve).size+1<=this.capacity&&(l=r(this,Zs).storeSql(n),r(this,Ve).set(n,l))}l!==void 0&&(a.sql=l,s.add(l))}}}Zs=new WeakMap,Ve=new WeakMap;var Me;class Zc{constructor(){b(this,Me);x(this,Me,new Map)}get(t){const s=r(this,Me).get(t);return s!==void 0&&(r(this,Me).delete(t),r(this,Me).set(t,s)),s}set(t,s){r(this,Me).set(t,s)}peekLru(){for(const t of r(this,Me).entries())return t}delete(t){r(this,Me).delete(t)}get size(){return r(this,Me).size}}Me=new WeakMap;function ed(e){var t=0,s=[];function a(){t--,t<e&&n()}function n(){var p=s.shift();i.queue=s.length,p&&d(p.fn).then(p.resolve).catch(p.reject)}function l(p){return new Promise(function(o,u){s.push({fn:p,resolve:o,reject:u}),i.queue=s.length})}function d(p){t++;try{return Promise.resolve(p()).then(function(o){return a(),o},function(o){throw a(),o})}catch(o){return a(),Promise.reject(o)}}var i=function(p){return t>=e?l(p):d(p)};return i}function td(e,t){var s=!1,a=this;return Promise.all(e.map(function(){var n=arguments;return a(function(){if(!s)return t.apply(void 0,n).catch(function(l){throw s=!0,l})})}))}function ll(e){return e.queue=0,e.map=td,e}var sd=function(e){return ll(e?ed(e):function(t){return t()})};const Lr=hc(sd);function ad(e){if(e.scheme!=="wss"&&e.scheme!=="ws")throw new j(`The WebSocket client supports only "libsql:", "wss:" and "ws:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Gs}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new j("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="ws"&&e.tls)throw new j('A "ws:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="wss"&&!e.tls)throw new j('A "wss:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Wa(e.scheme,e.authority,e.path);let s;try{s=Tr(t,e.authToken)}catch(a){if(a instanceof zl){const n=e.scheme==="wss"?"https":"http",l=Wa(n,e.authority,e.path);throw new j(`This environment does not support WebSockets, please switch to the HTTP client by using a "${n}:" URL (${JSON.stringify(l)}). For more information, please read ${Gs}`,"WEBSOCKETS_NOT_SUPPORTED")}throw H(a)}return new ld(s,t,e.authToken,e.intMode,e.concurrency)}const nd=60*1e3,rl=100;var ea,ta,sa,K,ne,bn,aa,ye,Kt,Ps;class ld{constructor(t,s,a,n,l){b(this,ye);b(this,ea);b(this,ta);b(this,sa);b(this,K);b(this,ne);L(this,"closed");L(this,"protocol");b(this,bn);b(this,aa);x(this,ea,s),x(this,ta,a),x(this,sa,n),x(this,K,g(this,ye,Ps).call(this,t)),x(this,ne,void 0),this.closed=!1,this.protocol="ws",x(this,aa,Lr(l))}async limit(t){return r(this,aa).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{const n=await g(this,ye,Kt).call(this);try{const l=Wt(a);n.conn.sqlCache.apply([l]);const d=n.stream.query(l);n.stream.closeGracefully();const i=await d;return ja(i)}catch(l){throw H(l)}finally{this._closeStream(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{const a=await g(this,ye,Kt).call(this);try{const l=t.map(u=>Array.isArray(u)?{sql:u[0],args:u[1]||[]}:u).map(Wt),d=await a.conn.client.getVersion();a.conn.sqlCache.apply(l);const i=a.stream.batch(d>=3);return await Ca(s,d,i,l)}catch(n){throw H(n)}finally{this._closeStream(a)}})}async migrate(t){return this.limit(async()=>{const s=await g(this,ye,Kt).call(this);try{const a=t.map(Wt),n=await s.conn.client.getVersion(),l=s.stream.batch(n>=3);return await Ca("deferred",n,l,a,!0)}catch(a){throw H(a)}finally{this._closeStream(s)}})}async transaction(t="write"){return this.limit(async()=>{const s=await g(this,ye,Kt).call(this);try{const a=await s.conn.client.getVersion();return new rd(this,s,t,a)}catch(a){throw this._closeStream(s),H(a)}})}async executeMultiple(t){return this.limit(async()=>{const s=await g(this,ye,Kt).call(this);try{const a=s.stream.sequence(t);s.stream.closeGracefully(),await a}catch(a){throw H(a)}finally{this._closeStream(s)}})}sync(){throw new j("sync not supported in ws mode","SYNC_NOT_SUPPORTED")}async reconnect(){try{for(const a of Array.from(r(this,K).streamStates))try{a.stream.close()}catch{}r(this,K).client.close()}catch{}if(r(this,ne)){try{r(this,ne).client.close()}catch{}x(this,ne,void 0)}const t=g(this,ye,Ps).call(this),s=await t.client.getVersion();t.useSqlCache=s>=2,t.useSqlCache&&(t.sqlCache.capacity=rl),x(this,K,t),this.closed=!1}_closeStream(t){t.stream.close();const s=t.conn;s.streamStates.delete(t),s.streamStates.size===0&&s!==r(this,K)&&s.client.close()}close(){if(r(this,K).client.close(),this.closed=!0,r(this,ne)){try{r(this,ne).client.close()}catch{}x(this,ne,void 0)}this.closed=!0}}ea=new WeakMap,ta=new WeakMap,sa=new WeakMap,K=new WeakMap,ne=new WeakMap,bn=new WeakMap,aa=new WeakMap,ye=new WeakSet,Kt=async function(){if(this.closed)throw new j("The client is closed","CLIENT_CLOSED");if(new Date().valueOf()-r(this,K).openTime.valueOf()>nd&&r(this,ne)===void 0){const n=g(this,ye,Ps).call(this);x(this,ne,n),n.client.getVersion().then(l=>{r(this,K)!==n&&r(this,K).streamStates.size===0&&r(this,K).client.close(),x(this,K,n),x(this,ne,void 0)},l=>{x(this,ne,void 0)})}if(r(this,K).client.closed)try{r(this,ne)!==void 0?x(this,K,r(this,ne)):x(this,K,g(this,ye,Ps).call(this))}catch(n){throw H(n)}const a=r(this,K);try{a.useSqlCache===void 0&&(a.useSqlCache=await a.client.getVersion()>=2,a.useSqlCache&&(a.sqlCache.capacity=rl));const n=a.client.openStream();n.intMode=r(this,sa);const l={conn:a,stream:n};return a.streamStates.add(l),l}catch(n){throw H(n)}},Ps=function(t){try{return t??(t=Tr(r(this,ea),r(this,ta))),{client:t,useSqlCache:void 0,sqlCache:new In(t,0),openTime:new Date,streamStates:new Set}}catch(s){throw H(s)}};var na,vt;class rd extends Mr{constructor(s,a,n,l){super(n,l);b(this,na);b(this,vt);x(this,na,s),x(this,vt,a)}_getStream(){return r(this,vt).stream}_getSqlCache(){return r(this,vt).conn.sqlCache}close(){r(this,na)._closeStream(r(this,vt))}get closed(){return r(this,vt).stream.closed}}na=new WeakMap,vt=new WeakMap;function id(e){if(e.scheme!=="https"&&e.scheme!=="http")throw new j(`The HTTP client supports only "libsql:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Gs}`,"URL_SCHEME_NOT_SUPPORTED");if(e.encryptionKey!==void 0)throw new j("Encryption key is not supported by the remote client.","ENCRYPTION_KEY_NOT_SUPPORTED");if(e.scheme==="http"&&e.tls)throw new j('A "http:" URL cannot opt into TLS by using ?tls=1',"URL_INVALID");if(e.scheme==="https"&&!e.tls)throw new j('A "https:" URL cannot opt out of TLS by using ?tls=0',"URL_INVALID");const t=Wa(e.scheme,e.authority,e.path);return new od(t,e.authToken,e.intMode,e.fetch,e.concurrency,e.remoteEncryptionKey)}const Or=30;var Q,ws,vs,ys,la,ks,ra,ia;class od{constructor(t,s,a,n,l,d){b(this,Q);L(this,"protocol");b(this,ws);b(this,vs);b(this,ys);b(this,la);b(this,ks);b(this,ra);b(this,ia);x(this,ws,t),x(this,ks,s),x(this,vs,a),x(this,ys,n),x(this,la,l),x(this,ra,d),x(this,Q,nl(r(this,ws),r(this,ks),r(this,ys),d)),r(this,Q).intMode=r(this,vs),this.protocol="http",x(this,ia,Lr(r(this,la)))}async limit(t){return r(this,ia).call(this,t)}async execute(t,s){let a;return typeof t=="string"?a={sql:t,args:s||[]}:a=t,this.limit(async()=>{try{const n=Wt(a);let l;const d=r(this,Q).openStream();try{l=d.query(n)}finally{d.closeGracefully()}const i=await l;return ja(i)}catch(n){throw H(n)}})}async batch(t,s="deferred"){return this.limit(async()=>{try{const n=t.map(o=>Array.isArray(o)?{sql:o[0],args:o[1]||[]}:o).map(Wt),l=await r(this,Q).getVersion();let d;const i=r(this,Q).openStream();try{new In(i,Or).apply(n);const u=i.batch(!1);d=Ca(s,l,u,n)}finally{i.closeGracefully()}return await d}catch(a){throw H(a)}})}async migrate(t){return this.limit(async()=>{try{const s=t.map(Wt),a=await r(this,Q).getVersion();let n;const l=r(this,Q).openStream();try{const i=l.batch(!1);n=Ca("deferred",a,i,s,!0)}finally{l.closeGracefully()}return await n}catch(s){throw H(s)}})}async transaction(t="write"){return this.limit(async()=>{try{const s=await r(this,Q).getVersion();return new cd(r(this,Q).openStream(),t,s)}catch(s){throw H(s)}})}async executeMultiple(t){return this.limit(async()=>{try{let s;const a=r(this,Q).openStream();try{s=a.sequence(t)}finally{a.closeGracefully()}await s}catch(s){throw H(s)}})}sync(){throw new j("sync not supported in http mode","SYNC_NOT_SUPPORTED")}close(){r(this,Q).close()}async reconnect(){try{this.closed||r(this,Q).close()}finally{x(this,Q,nl(r(this,ws),r(this,ks),r(this,ys),r(this,ra))),r(this,Q).intMode=r(this,vs)}}get closed(){return r(this,Q).closed}}Q=new WeakMap,ws=new WeakMap,vs=new WeakMap,ys=new WeakMap,la=new WeakMap,ks=new WeakMap,ra=new WeakMap,ia=new WeakMap;var Vt,oa;class cd extends Mr{constructor(s,a,n){super(a,n);b(this,Vt);b(this,oa);x(this,Vt,s),x(this,oa,new In(s,Or))}_getStream(){return r(this,Vt)}_getSqlCache(){return r(this,oa)}close(){r(this,Vt).close()}get closed(){return r(this,Vt).closed}}Vt=new WeakMap,oa=new WeakMap;function jr(e){return dd(uo(e))}function dd(e){if(e.scheme==="ws"||e.scheme==="wss")return ad(e);if(e.scheme==="http"||e.scheme==="https")return id(e);throw new j(`The client that uses Web standard APIs supports only "libsql:", "wss:", "ws:", "https:" and "http:" URLs, got ${JSON.stringify(e.scheme+":")}. For more information, please read ${Gs}`,"URL_SCHEME_NOT_SUPPORTED")}const pd={url:"libsql://retailer-os-digitalhues.aws-ap-south-1.turso.io",authToken:"eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzAxODY2NzMsImlkIjoiNDcwMDliODAtYmJlYS00YzQ3LTk1MzQtY2NlYjg4OWUzYjFjIiwicmlkIjoiNTk1ODMwNWEtMjlkNy00OGU5LWJkNTctN2FiZWVjNzVjMWYwIn0.381aJkYkBtcCsSDyQkFNLZud9lOPi9TuT3uRZgLYS9BqrjLFb0Zc7P1qRWN0k16XkHQ7raDwhCUE9H1G8Q80BA"},ud={url:"libsql://retailer-data-digitalhues.aws-ap-south-1.turso.io",authToken:"eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NzAyODMwNTgsImlkIjoiZTVmNzQ5MjMtMDFiMi00YzkxLTlmMjEtZTJhZDIxMzBmMmZmIiwicmlkIjoiZjQzNTc5NTMtN2E2OS00M2UzLWE3MWUtNDcyYzk1MWM1NTRiIn0.8dOIX1XeNnJswuRGhacgPypg_h_9_-bRAwBxtKhBX7rJ4bQuEtSz9Z6igZsvGrWxDlsYlHMo4V3KKIuIZRSuBA"},Tt=jr(pd),il=jr(ud);async function v(e,t=[]){try{return(await Tt.execute({sql:e,args:t})).rows}catch(s){throw console.error("DB Query Error:",s.message,"SQL:",e,"Params:",t),s}}async function xd(e){try{return await Tt.batch(e)}catch(t){throw console.error("DB Transaction Error:",t),t}}function C(){return localStorage.getItem("retaileros_retailer_id")}const T={clients:{getAll:()=>{const e=C();return e?v("SELECT * FROM customers WHERE retailer_id = ?",[e]):v("SELECT * FROM customers")},add:e=>{const t=C();return v("INSERT INTO customers (id, name, phone, email, joined_at, dob, location, retailer_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",[e.id,e.name,e.phone||"",e.email||"",new Date().toISOString(),e.dob||null,e.location||"",t])},getById:e=>{const t=C();return t?v("SELECT * FROM customers WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM customers WHERE id = ?",[e])}},companies:{getAll:()=>{const e=C();return e?v("SELECT * FROM companies WHERE retailer_id = ?",[e]):v("SELECT * FROM companies")},add:e=>{const t=C();return v("INSERT INTO companies (id, name, gst_number, customer_id, created_at, retailer_id) VALUES (?, ?, ?, ?, ?, ?)",[e.id,e.name,e.gst_number,e.customer_id,new Date().toISOString(),t])},getByCustomerId:e=>{const t=C();return t?v("SELECT * FROM companies WHERE customer_id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM companies WHERE customer_id = ?",[e])},getById:e=>{const t=C();return t?v("SELECT * FROM companies WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM companies WHERE id = ?",[e])}},sales:{getAll:()=>{const e=C();return e?v("SELECT * FROM sales WHERE retailer_id = ? ORDER BY date DESC",[e]):v("SELECT * FROM sales ORDER BY date DESC")},getById:e=>{const t=C();return t?v("SELECT * FROM sales WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM sales WHERE id = ?",[e])},getDrafts:()=>{const e=C();return e?v("SELECT * FROM sales WHERE status = 'draft' AND retailer_id = ? ORDER BY date DESC",[e]):v("SELECT * FROM sales WHERE status = 'draft' ORDER BY date DESC")},add:e=>{const t=C();return v(`INSERT INTO sales (id, customer_id, customer_name, date, total_amount, status, payment_mode, payment_reference, gst_required, company_id, installation_required, installation_date, retailer_id)
             ...
             AND date(start_date) <= date('now') AND date(end_date) >= date('now')`,[e,t,s,s])},groups:{getAll:()=>{const e=C();return e?v("SELECT * FROM groups WHERE retailer_id = ? ORDER BY created_at DESC",[e]):v("SELECT * FROM groups ORDER BY created_at DESC")},add:e=>{const t=C();return v(`INSERT INTO groups (id, name, description, is_company, gst_number, contact_person, created_at, retailer_id)
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,[e.id,e.name,e.description||null,e.is_company||0,e.gst_number||null,e.contact_person||null,e.created_at,t])},getById:e=>{const t=C();return t?v("SELECT * FROM groups WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM groups WHERE id = ?",[e])},delete:e=>{const t=C();return t?v("DELETE FROM groups WHERE id = ? AND retailer_id = ?",[e,t]):v("DELETE FROM groups WHERE id = ?",[e])},getMembers:e=>{const t=C();return t?v("SELECT * FROM group_members WHERE group_id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM group_members WHERE group_id = ?",[e])},getAllMembers:()=>{const e=C();return e?v("SELECT * FROM group_members WHERE retailer_id = ?",[e]):v("SELECT * FROM group_members")},addMember:e=>{const t=C();return v("INSERT INTO group_members (id, group_id, customer_id, added_at, retailer_id) VALUES (?, ?, ?, ?, ?)",[e.id,e.group_id,e.customer_id,e.added_at,t])},removeMember:(e,t)=>{const s=C();return s?v("DELETE FROM group_members WHERE group_id = ? AND customer_id = ? AND retailer_id = ?",[e,t,s]):v("DELETE FROM group_members WHERE group_id = ? AND customer_id = ?",[e,t])},deleteMembers:e=>{const t=C();return t?v("DELETE FROM group_members WHERE group_id = ? AND retailer_id = ?",[e,t]):v("DELETE FROM group_members WHERE group_id = ?",[e])}},automations:{getAll:()=>{const e=C();return e?v("SELECT * FROM automations WHERE retailer_id = ? ORDER BY created_at DESC",[e]):v("SELECT * FROM automations ORDER BY created_at DESC")},getById:e=>{const t=C();return t?v("SELECT * FROM automations WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM automations WHERE id = ?",[e])},getByCustomer:e=>{const t=C();return t?v("SELECT * FROM automations WHERE customer_id = ? AND retailer_id = ? ORDER BY created_at DESC",[e,t]):v("SELECT * FROM automations WHERE customer_id = ? ORDER BY created_at DESC",[e])},getBySale:e=>{const t=C();return t?v("SELECT * FROM automations WHERE sale_id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM automations WHERE sale_id = ?",[e])},add:e=>{const t=C();return v(`INSERT INTO automations (id, name, customer_id, customer_name, sale_id, status, created_at, retailer_id)
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,[e.id,e.name,e.customer_id,e.customer_name,e.sale_id||null,e.status||"active",e.created_at||new Date().toISOString(),t])},update:(e,t)=>{const s=C();return s?v("UPDATE automations SET status = ?, completed_at = ? WHERE id = ? AND retailer_id = ?",[t.status,t.completed_at||null,e,s]):v("UPDATE automations SET status = ?, completed_at = ? WHERE id = ?",[t.status,t.completed_at||null,e])},delete:e=>{const t=C();return t?v("DELETE FROM automations WHERE id = ? AND retailer_id = ?",[e,t]):v("DELETE FROM automations WHERE id = ?",[e])},getMessages:e=>{const t=C();return t?v("SELECT * FROM automation_messages WHERE automation_id = ? AND retailer_id = ? ORDER BY day_offset",[e,t]):v("SELECT * FROM automation_messages WHERE automation_id = ? ORDER BY day_offset",[e])},getAllMessages:()=>{const e=C();return e?v("SELECT * FROM automation_messages WHERE retailer_id = ? ORDER BY scheduled_date",[e]):v("SELECT * FROM automation_messages ORDER BY scheduled_date")},addMessage:e=>{const t=C();return v(`INSERT INTO automation_messages (id, automation_id, message_type, title, content, day_offset, scheduled_date, status, retailer_id)
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,[e.id,e.automation_id,e.message_type,e.title,e.content,e.day_offset,e.scheduled_date,e.status||"pending",t])},updateMessageStatus:(e,t,s)=>{const a=C();return a?v("UPDATE automation_messages SET status = ?, sent_at = ? WHERE id = ? AND retailer_id = ?",[t,s,e,a]):v("UPDATE automation_messages SET status = ?, sent_at = ? WHERE id = ?",[t,s,e])},deleteMessages:e=>{const t=C();return t?v("DELETE FROM automation_messages WHERE automation_id = ? AND retailer_id = ?",[e,t]):v("DELETE FROM automation_messages WHERE automation_id = ?",[e])}},communications:{getAll:()=>{const e=C();return e?v("SELECT * FROM communication_log WHERE retailer_id = ? ORDER BY sent_at DESC",[e]):v("SELECT * FROM communication_log ORDER BY sent_at DESC")},getByCustomer:e=>{const t=C();return t?v("SELECT * FROM communication_log WHERE customer_id = ? AND retailer_id = ? ORDER BY sent_at DESC",[e,t]):v("SELECT * FROM communication_log WHERE customer_id = ? ORDER BY sent_at DESC",[e])},add:e=>{const t=C();return v(`INSERT INTO communication_log (id, customer_id, type, direction, content, sent_at, automation_id, sale_id, status, retailer_id)
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,[e.id,e.customer_id,e.type,e.direction||"outgoing",e.content,e.sent_at||new Date().toISOString(),e.automation_id||null,e.sale_id||null,e.status||"sent",t])},updateStatus:(e,t)=>{const s=C();return s?v("UPDATE communication_log SET status = ? WHERE id = ? AND retailer_id = ?",[t,e,s]):v("UPDATE communication_log SET status = ? WHERE id = ?",[t,e])}},inquiries:{getAll:()=>{const e=C();return e?v("SELECT * FROM inquiries WHERE retailer_id = ? ORDER BY created_at DESC",[e]):v("SELECT * FROM inquiries ORDER BY created_at DESC")},getById:e=>{const t=C();return t?v("SELECT * FROM inquiries WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM inquiries WHERE id = ?",[e])},add:e=>{const t=C();return v("INSERT INTO inquiries (id, customer_name, product_name, request, status, created_at, retailer_id) VALUES (?, ?, ?, ?, ?, ?, ?)",[e.id,e.customer_name,e.product_name,e.request,e.status||"PENDING",e.created_at||new Date().toISOString(),t])},updateStatus:(e,t)=>{const s=C();return s?v("UPDATE inquiries SET status = ? WHERE id = ? AND retailer_id = ?",[t,e,s]):v("UPDATE inquiries SET status = ? WHERE id = ?",[t,e])}},repairs:{getAll:()=>{const e=C();return e?v("SELECT * FROM repairs WHERE retailer_id = ? ORDER BY created_at DESC",[e]):v("SELECT * FROM repairs ORDER BY created_at DESC")},getById:e=>{const t=C();return t?v("SELECT * FROM repairs WHERE id = ? AND retailer_id = ?",[e,t]):v("SELECT * FROM repairs WHERE id = ?",[e])},add:e=>{const t=C();return v("INSERT INTO repairs (id, customer_name, phone, device, issue, status, job_sheet_no, estimated_cost, assigned_to, created_at, retailer_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[e.id,e.customer_name,e.phone,e.device,e.issue,e.status||"COLLECTED",e.job_sheet_no,e.estimated_cost||"0",e.assigned_to||"Unassigned",e.created_at||new Date().toISOString(),t])},updateStatus:(e,t)=>{const s=C();return s?v("UPDATE repairs SET status = ? WHERE id = ? AND retailer_id = ?",[t,e,s]):v("UPDATE repairs SET status = ? WHERE id = ?",[t,e])}},inventoryLogs:{getAll:()=>{const e=C();return e?v("SELECT * FROM inventory_logs WHERE retailer_id = ? ORDER BY date DESC",[e]):v("SELECT * FROM inventory_logs ORDER BY date DESC")},add:e=>{const t=C();return v("INSERT INTO inventory_logs (id, product_id, type, quantity, reason, date, retailer_id) VALUES (?, ?, ?, ?, ?, ?, ?)",[e.id,e.product_id,e.type,e.quantity,e.reason,e.date||new Date().toISOString(),t])}},approved:{checkApproval:async e=>{const t=`
            ...
            `,args:[s,t,e.RetailerName,e.ContactPerson,e.Email,e.MobileNumber,e.PhoneNumber,e.Address_Line_1,e.Address_Line_2,e.CountryName,e.StateName,e.CityName,e.DistrictName,e.AreaName,e.PinCode,e.VATNnumber,e.PAN_Number,e.Name_of_Bank,e.Name_of_Bank_Account_Holder,e.Bank_Account_Number,e.Branch_Location,e.IFSC_Code,e.ParentRetailerName,e.NDName,e.RDSName,e.SalesmanName,e.Reporting_To_Name,e.CSA_on_Counter,e.Counter_Potential_in_Volume,e.Counter_Potential_in_Value,e.Retailer_Category,e.RETAILER_CATEGORY1,e.RETAILER_CLASSIFICATION,e.DOB,e.Creation_Date,e.ApprovalRemarks,e.id,e.Approval_Status,e.process_status,"active"]}),{id:s,retailerCode:t}},getById:async e=>(await Tt.execute({sql:"SELECT * FROM retailers WHERE id = ?",args:[e]})).rows[0]||null,getAll:async()=>(await Tt.execute("SELECT * FROM retailers ORDER BY onboarded_at DESC")).rows}},Rn=Object.freeze(Object.defineProperty({__proto__:null,db:T,query:v,transaction:xd},Symbol.toStringTag,{value:"Module"}));async function Y(){console.group("🔄 Synchronizing Data with Turso...");try{const e=localStorage.getItem("retaileros_retailer_id"),t=(h,q="")=>{const U=q?` ORDER BY ${q}`:"";return e?v(`SELECT * FROM ${h} WHERE retailer_id = ?${U}`,[e]):v(`SELECT * FROM ${h}${U}`)},[s,a,n,l,d,i,p,o,u,y,w,k,m,E,S]=await Promise.all([t("customers").catch(h=>(console.error("Sync customers failed:",h),[])),v("SELECT * FROM products").catch(h=>(console.error("Sync products failed:",h),[])),t("sales","date DESC").catch(h=>(console.error("Sync sales failed:",h),[])),(e?v("SELECT si.* FROM sale_items si INNER JOIN sales s ON si.sale_id = s.id WHERE s.retailer_id = ?",[e]):v("SELECT * FROM sale_items")).catch(h=>(console.error("Sync sale_items failed:",h),[])),t("companies").catch(h=>(console.error("Sync companies failed:",h),[])),t("groups","created_at DESC").catch(h=>(console.error("Sync groups failed:",h),[])),t("group_members").catch(h=>(console.error("Sync group_members failed:",h),[])),t("automations","created_at DESC").catch(h=>(console.error("Sync automations failed:",h),[])),t("automation_messages","scheduled_date").catch(h=>(console.error("Sync automation_messages failed:",h),[])),t("communication_log","sent_at DESC").catch(h=>(console.error("Sync communications failed:",h),[])),v("SELECT * FROM schemes WHERE status = 'active' ORDER BY brand, name").catch(h=>(console.error("Sync schemes failed:",h),[])),v("SELECT * FROM retailers ORDER BY onboarded_at DESC").catch(h=>(console.error("Sync retailers failed:",h),[])),t("inquiries","created_at DESC").catch(h=>(console.error("Sync inquiries failed:",h),[])),t("repairs","created_at DESC").catch(h=>(console.error("Sync repairs failed:",h),[])),t("inventory_logs","date DESC").catch(h=>(console.error("Sync inventory_logs failed:",h),[]))]);window._db_cache={customers:s||[],products:a||[],sales:n||[],saleItems:l||[],companies:d||[],groups:i||[],groupMembers:p||[],automations:o||[],automationMessages:u||[],communications:y||[],schemes:w||[],retailers:k||[],inquiries:m||[],repairs:E||[],inventoryLogs:S||[],marketplace:[],campaigns:[],bookings:[]},console.log("✅ Sync Complete. Tables cached:",{customers:s.length,products:a.length,sales:n.length,automations:o.length})}catch(e){console.error("❌ Data Sync Failed:",e),window.toast&&window.toast.error("Failed to sync data. Check your connection.")}finally{console.groupEnd(),R(!1)}}window.getCache=()=>window._db_cache||{customers:[],sales:[],products:[],saleItems:[],companies:[],groups:[],groupMembers:[],automations:[],automationMessages:[],communications:[],schemes:[],retailers:[],inventoryLogs:[],inquiries:[],repairs:[],marketplace:[],campaigns:[],bookings:[]};const qr=Object.freeze(Object.defineProperty({__proto__:null,syncData:Y},Symbol.toStringTag,{value:"Module"}));let yt=!1,ie="",be={customers:[],sales:[]};window.toggleSalesSearch=()=>{yt=!yt,yt||(ie="",be={customers:[],sales:[]}),window.triggerRender()};window.updateSalesSearch=e=>{const t=document.getElementById("sales-universal-search"),s=(t==null?void 0:t.selectionStart)||e.length;if(ie=e.toLowerCase().trim(),!ie){be={customers:[],sales:[]},window.triggerRender(!1),ol("sales-universal-search",s);return}const a=window.getCache(),n=a.customers||[],l=a.sales||[],d=a.saleItems||[];be.customers=n.filter(i=>{var p,o,u;return((p=i.name)==null?void 0:p.toLowerCase().includes(ie))||((o=i.phone)==null?void 0:o.includes(ie))||((u=i.email)==null?void 0:u.toLowerCase().includes(ie))}).slice(0,5),be.sales=l.filter(i=>{var o,u;return(o=i.id)!=null&&o.toLowerCase().includes(ie)||(u=i.customer_name)!=null&&u.toLowerCase().includes(ie)?!0:d.filter(y=>y.sale_id===i.id).some(y=>{var w;return(w=y.product_name)==null?void 0:w.toLowerCase().includes(ie)})}).slice(0,5),window.triggerRender(!1),ol("sales-universal-search",s)};function ol(e,t){setTimeout(()=>{const s=document.getElementById(e);s&&(s.focus(),s.setSelectionRange(t,t))},0)}window.selectSearchCustomer=(e,t)=>{c.historyViewMode="completed",c.historyDateFilter="all",window.setTab("history");const a=window.getCache().sales.find(n=>n.customer_id===e);a&&window.setSalesHistoryId(a.id),yt=!1,ie="",be={customers:[],sales:[]},window.triggerRender()};window.selectSearchSale=e=>{window.setTab("history"),window.setSalesHistoryId(e),yt=!1,ie="",be={customers:[],sales:[]},window.triggerRender()};function Pr(e){const t=be.customers.length>0||be.sales.length>0;return`
        <header class="p-4 sm:p-8 pb-4 shrink-0">
    ...
    `}let ts=!1,ya="",I=[],Oe=null,rt="Select Customer",oe=!1,Ge="",We="",da=!1,V="",it="",kt=null;const ss=e=>`${e}-${Math.random().toString(36).substr(2,8).toUpperCase()}`,fd=["appliances","air conditioners","ac","washing machines","refrigerators","tvs","television","home theater","dishwasher","microwave","geyser","water heater"];function Cn(e){if(e.installation_required===1)return!0;const t=(e.category||"").toLowerCase();return fd.some(s=>t.includes(s))}async function bd(e){const t=window.getCache().products,s=window.getCache().schemes||[],a=t.find(n=>n.id===e);if(a){const n=Cn(a),l=s.filter(i=>{const p=!i.brand||i.brand===a.brand,o=!i.category||i.category===a.category,u=(!i.min_price||a.mop>=i.min_price)&&(!i.max_price||a.mop<=i.max_price),y=new Date(i.start_date)<=new Date&&new Date(i.end_date)>=new Date;return p&&o&&u&&y&&i.status==="active"});I.push({...a,qty:1,imei:"",serial_number:"",mac_id:"",manufacturing_date:"",showDetails:!1,installation_required:n,installation_date:"",discount_type:null,discount_value:0,discount_amount:0,scheme_id:null,scheme_name:null,final_price:a.mop,applicableSchemes:l,showDiscount:!1,extraFields:[]});const d=document.getElementById("sales-item-search");d&&(d.value=""),window.triggerRender()}}window.toggleCartItemDiscount=e=>{I[e]&&(I[e].showDiscount=!I[e].showDiscount,window.triggerRender())};window.applyStoreDiscount=(e,t)=>{if(I[e]){const s=I[e],a=parseFloat(t)||0;a>0&&a<=100?(s.discount_type="store",s.discount_value=a,s.discount_amount=Math.round(s.mop*a/100),s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop-s.discount_amount):(s.discount_type=null,s.discount_value=0,s.discount_amount=0,s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop),window.triggerRender()}};window.applySchemeDiscount=(e,t)=>{if(I[e]){const s=I[e],n=(window.getCache().schemes||[]).find(l=>l.id===t);n?(s.discount_type="scheme",s.scheme_id=n.id,s.scheme_name=n.name,n.discount_type==="percentage"?(s.discount_value=n.discount_value,s.discount_amount=Math.round(s.mop*n.discount_value/100)):(s.discount_value=n.discount_value,s.discount_amount=n.discount_value),s.final_price=s.mop-s.discount_amount):(s.discount_type=null,s.discount_value=0,s.discount_amount=0,s.scheme_id=null,s.scheme_name=null,s.final_price=s.mop),window.triggerRender()}};window.clearItemDiscount=e=>{if(I[e]){const t=I[e];t.discount_type=null,t.discount_value=0,t.discount_amount=0,t.scheme_id=null,t.scheme_name=null,t.final_price=t.mop,window.triggerRender()}};function Nr(e,t){Oe=e,rt=t;const s=document.getElementById("customer-dropdown-menu");s&&s.classList.add("hidden");const n=(window.getCache().companies||[]).find(l=>l.customer_id===e);n&&(Ge=n.name,We=n.gst_number),window.triggerRender()}window.updateCartItemDetail=(e,t,s)=>{I[e]&&(I[e][t]=s)};window.toggleCartItemDetails=e=>{I[e]&&(I[e].showDetails=!I[e].showDetails,window.triggerRender())};window.toggleItemInstallation=e=>{I[e]&&(I[e].installation_required=!I[e].installation_required,I[e].installation_required||(I[e].installation_date=""),window.triggerRender())};window.updateItemInstallationDate=(e,t)=>{I[e]&&(I[e].installation_date=t)};const md="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";function hd(){return localStorage.getItem("openai_api_key")||md}window.captureDeviceImage=async e=>{const t=hd(),s=document.createElement("input");s.type="file",s.accept="image/*",s.capture="environment",s.onchange=async a=>{const n=a.target.files[0];if(n){ts=!0,ya="Reading image...",window.triggerRender(!1);try{const l=await gd(n);ya="AI analyzing...",wd(e,ya);const d=I[e],i={name:d.name,brand:d.brand,category:d.category},p=await vd(l,i,t);I[e]&&p&&(p.imei&&(I[e].imei=p.imei),p.serial_number&&(I[e].serial_number=p.serial_number),p.mac_id&&(I[e].mac_id=p.mac_id),p.manufacturing_date&&(I[e].manufacturing_date=p.manufacturing_date),p.extraFields&&p.extraFields.length>0&&(I[e].extraFields=[...I[e].extraFields||[],...p.extraFields])),ts=!1,window.triggerRender(!1);const o=[];p.imei&&o.push("IMEI"),p.serial_number&&o.push("Serial"),p.mac_id&&o.push("MAC ID"),p.manufacturing_date&&o.push("Mfg Date"),p.extraFields&&p.extraFields.forEach(u=>o.push(u.label)),o.length>0?window.toast.success(`Found: ${o.join(", ")}`):window.toast.warning("No device details found. Try a clearer image.")}catch(l){console.error("AI Vision Error:",l),ts=!1,window.triggerRender(!1),window.toast.error(l.message||"Error analyzing image")}}},s.click()};function gd(e){return new Promise((t,s)=>{const a=new FileReader;a.onload=()=>{const n=a.result.split(",")[1];t(n)},a.onerror=s,a.readAsDataURL(e)})}function wd(e,t){const s=document.getElementById(`ocr-progress-${e}`);s&&(s.textContent=t)}async function vd(e,t,s){var p,o,u,y;const a=`You are analyzing a product label/box image to extract device information.
...
Example response:
{
  ...
  "extraFields": [{"key": "model", "label": "Model", "value": "SM-A546E"}]
}`,n=await fetch("https://api.openai.com/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:JSON.stringify({model:"gpt-4o-mini",messages:[{role:"user",content:[{type:"text",text:a},{type:"image_url",image_url:{url:`data:image/jpeg;base64,${e}`,detail:"high"}}]}],max_tokens:1e3,temperature:.1})});if(!n.ok){const w=await n.json().catch(()=>({}));throw new Error(((p=w.error)==null?void 0:p.message)||`API Error: ${n.status}`)}const d=((y=(u=(o=(await n.json()).choices)==null?void 0:o[0])==null?void 0:u.message)==null?void 0:y.content)||"";console.log("AI Vision Response:",d);const i=d.match(/\{[\s\S]*\}/);if(!i)return{extraFields:[]};try{const w=JSON.parse(i[0]);return yd(w)}catch(w){return console.error("Failed to parse AI response:",w),{extraFields:[]}}}function yd(e){const t={imei:e.imei||null,serial_number:e.serial_number||e.serialNumber||null,mac_id:e.mac_id||e.macId||e.mac||null,manufacturing_date:e.manufacturing_date||e.manufacturingDate||e.mfg_date||null,extraFields:[]};return e.imei2&&t.extraFields.push({key:"imei2",label:"IMEI 2",value:e.imei2,type:"text"}),e.model&&t.extraFields.push({key:"model",label:"Model",value:e.model,type:"text"}),e.color&&t.extraFields.push({key:"color",label:"Color",value:e.color,type:"text"}),e.storage&&t.extraFields.push({key:"storage",label:"Storage",value:e.storage,type:"text"}),e.extraFields&&Array.isArray(e.extraFields)&&e.extraFields.forEach(s=>{s.value&&s.label&&(t.extraFields.some(n=>n.key===s.key)||t.extraFields.push({key:s.key||s.label.toLowerCase().replace(/\s+/g,"_"),label:s.label,value:s.value,type:s.type||"text"}))}),t}window.updateCartItemExtraField=(e,t,s)=>{I[e]&&I[e].extraFields[t]&&(I[e].extraFields[t].value=s)};window.addCustomExtraField=e=>{I[e]&&window.showPrompt('Enter field name (e.g., "IMEI 2", "Warranty Code"):',"",t=>{const s=t.toLowerCase().replace(/\s+/g,"_");I[e].extraFields=I[e].extraFields||[],I[e].extraFields.push({key:s,label:t,value:"",type:"text",custom:!0}),window.triggerRender()})};window.removeExtraField=(e,t)=>{I[e]&&I[e].extraFields&&(I[e].extraFields.splice(t,1),window.triggerRender())};window.toggleGstRequired=()=>{oe=!oe,window.triggerRender()};window.updateGstField=(e,t)=>{e==="companyName"&&(Ge=t),e==="gstNumber"&&(We=t.toUpperCase())};window.openPaymentModal=()=>{if(I.length===0||!Oe){window.toast.warning("Please select a customer and add items to cart");return}const e=I.filter(t=>t.installation_required&&!t.installation_date);if(e.length>0){window.toast.warning(`Set installation date for: ${e.map(t=>t.name).join(", ")}`);return}da=!0,window.triggerRender()};window.closePaymentModal=()=>{da=!1,V="",it="",window.triggerRender()};window.selectPaymentMode=e=>{V=e,it="",window.triggerRender()};window.updatePaymentReference=e=>{it=e};window.confirmPayment=async()=>{if(!V){window.toast.warning("Please select a payment mode");return}if((V==="card"||V==="upi")&&!it){window.toast.warning("Please enter the transaction reference");return}da=!1,await Br()};async function Br(){const e=document.getElementById("complete-txn-btn");e&&(e.disabled=!0,e.innerHTML="Processing...");try{const t=kt||ss("ORD"),s=I.reduce((i,p)=>i+(p.final_price||p.mop),0);let a=null;oe&&Ge&&We&&(a=ss("COMP"),await T.companies.add({id:a,name:Ge,gst_number:We,customer_id:Oe}));const n=I.some(i=>i.installation_required),d=I.filter(i=>i.installation_required&&i.installation_date).map(i=>i.installation_date).sort()[0]||null;kt?(await T.sales.deleteItems(kt),await T.sales.update({id:t,customer_id:Oe,customer_name:rt,total_amount:s,status:"completed",payment_mode:V,payment_reference:it,gst_required:oe?1:0,company_id:a,installation_required:n?1:0,installation_date:d})):await T.sales.add({id:t,customer_id:Oe,customer_name:rt,date:new Date().toISOString(),total_amount:s,status:"completed",payment_mode:V,payment_reference:it,gst_required:oe?1:0,company_id:a,installation_required:n?1:0,installation_date:d});for(const i of I)await T.sales.addItem({id:ss("ITEM"),sale_id:t,product_id:i.id,product_name:i.name,category:i.category,quantity:1,price:i.mop,discount_type:i.discount_type||null,discount_value:i.discount_value||null,discount_amount:i.discount_amount||null,scheme_id:i.scheme_id||null,final_price:i.final_price||i.mop,imei:i.imei||null,serial_number:i.serial_number||null,mac_id:i.mac_id||null,manufacturing_date:i.manufacturing_date||null,installation_date:i.installation_required?i.installation_date:null,extra_fields:i.extraFields&&i.extraFields.length>0?JSON.stringify(i.extraFields):null});$n(),await Y(),window.setTab("history"),window.setSalesHistoryId(t)}catch(t){console.error(t),window.toast.error("Error completing transaction: "+t.message),e&&(e.disabled=!1,e.innerHTML="Complete Transaction")}}async function kd(){if(I.length===0){window.toast.warning("Please add items to cart before saving draft");return}try{const e=kt||ss("DRF"),t=I.reduce((d,i)=>d+(i.final_price||i.mop),0);let s=null;oe&&Ge&&We&&(s=ss("COMP"),await T.companies.add({id:s,name:Ge,gst_number:We,customer_id:Oe}));const a=I.some(d=>d.installation_required),l=I.filter(d=>d.installation_required&&d.installation_date).map(d=>d.installation_date).sort()[0]||null;kt?(await T.sales.deleteItems(kt),await T.sales.update({id:e,customer_id:Oe,customer_name:rt||"No Customer",total_amount:t,status:"draft",payment_mode:null,payment_reference:null,gst_required:oe?1:0,company_id:s,installation_required:a?1:0,installation_date:l})):await T.sales.add({id:e,customer_id:Oe,customer_name:rt||"No Customer",date:new Date().toISOString(),total_amount:t,status:"draft",payment_mode:null,payment_reference:null,gst_required:oe?1:0,company_id:s,installation_required:a?1:0,installation_date:l});for(const d of I)await T.sales.addItem({id:ss("ITEM"),sale_id:e,product_id:d.id,product_name:d.name,category:d.category,quantity:1,price:d.mop,discount_type:d.discount_type||null,discount_value:d.discount_value||null,discount_amount:d.discount_amount||null,scheme_id:d.scheme_id||null,final_price:d.final_price||d.mop,imei:d.imei||null,serial_number:d.serial_number||null,mac_id:d.mac_id||null,manufacturing_date:d.manufacturing_date||null,installation_date:d.installation_required?d.installation_date:null,extra_fields:d.extraFields&&d.extraFields.length>0?JSON.stringify(d.extraFields):null});$n(),await Y(),window.setTab("history"),window.toast.success("Draft saved successfully!")}catch(e){console.error(e),window.toast.error("Error saving draft: "+e.message)}}async function _d(e){const t=window.getCache(),s=t.sales.find(l=>l.id===e);if(!s)return;if(kt=e,Oe=s.customer_id,rt=s.customer_name,oe=s.gst_required===1,s.company_id){const l=t.companies.find(d=>d.id===s.company_id);l&&(Ge=l.name,We=l.gst_number)}const a=t.saleItems.filter(l=>l.sale_id===e),n=t.products;I=a.map(l=>{const d=n.find(o=>o.id===l.product_id)||{},i=l.installation_date||Cn(d);let p=[];if(l.extra_fields)try{p=JSON.parse(l.extra_fields)}catch(o){console.warn("Failed to parse extra fields:",o)}return{...d,id:l.product_id,name:l.product_name,category:l.category,mop:l.price,qty:l.quantity,imei:l.imei||"",serial_number:l.serial_number||"",mac_id:l.mac_id||"",manufacturing_date:l.manufacturing_date||"",showDetails:!1,installation_required:!!i,installation_date:l.installation_date||"",extraFields:p}}),window.setTab("new-sale"),window.triggerRender()}function $n(){I=[],Oe=null,rt="Select Customer",oe=!1,Ge="",We="",da=!1,V="",it="",kt=null}window.selectSaleCustomer=Nr;window.addProductToCart=bd;window.completeTransaction=Br;window.saveDraft=kd;window.loadDraft=_d;window.getActiveCart=()=>I;window.getSelectedCustomer=()=>({id:Oe,name:rt});window.getSaleState=()=>({gstRequired:oe,companyName:Ge,gstNumber:We,paymentMode:V,paymentReference:it});window.clearCart=()=>{$n(),window.triggerRender()};window.removeFromCart=e=>{I.splice(e,1),window.triggerRender()};window.toggleCustomerDropdown=e=>{e&&e.stopPropagation();const t=document.getElementById("customer-dropdown-menu");t&&t.classList.toggle("hidden")};let Ns="";window.updateCustomerSearch=e=>{Ns=e.toLowerCase(),window.triggerRender(!1)};window.addNewCustomer=async()=>{window.setSalesMode("add-customer");const e=document.getElementById("customer-dropdown-menu");e&&e.classList.add("hidden")};function Fr(){const e=window.getCache(),t=e.products||[],s=e.customers||[],a=Ns?s.filter(o=>{var u;return o.name.toLowerCase().includes(Ns)||((u=o.phone)==null?void 0:u.includes(Ns))}):s,n=document.getElementById("sales-item-search"),l=n?n.value.toLowerCase():"",d=l?t.filter(o=>{var u;return o.name.toLowerCase().includes(l)||((u=o.brand)==null?void 0:u.toLowerCase().includes(l))}):[],i=I.reduce((o,u)=>o+(u.final_price||u.mop||0),0);I.reduce((o,u)=>o+(u.discount_amount||0),0);const p=I.filter(o=>o.installation_required).length;return`
        ${Pr("new-sale")}
                ...
                <div class="relative text-left">
                    ...
                    ${l?`
                        <div class="absolute top-full left-0 right-0 z-50 bg-white border border-slate-100 rounded-2xl shadow-2xl mt-2 overflow-hidden text-left max-h-60 overflow-y-auto">
                            ${d.length>0?d.map(o=>{var y;const u=Cn(o);return`
                                <button type="button" onclick="window.addProductToCart('${o.id}')" class="p-4 hover:bg-slate-50 cursor-pointer flex justify-between items-center text-left w-full border-b border-slate-50">
                                    ...
                                    <p class="text-xs font-black text-slate-900 text-right ml-2">₹${((y=o.mop)==null?void 0:y.toLocaleString())||0}</p>
                                </button>
                        ...
                        <div class="card overflow-hidden ${o.installation_required?"border-slate-300":""}">
                            <div class="p-4 flex items-center gap-4 text-left">
                                ...
                                <div class="text-right shrink-0">
                                    ${o.discount_amount>0?`
                                        <p class="text-[9px] font-bold text-slate-400 line-through text-right">₹${((y=o.mop)==null?void 0:y.toLocaleString())||0}</p>
                                        <p class="text-xs font-black text-right">₹${((w=o.final_price)==null?void 0:w.toLocaleString())||0}</p>
                                    `:`
                                        <p class="text-xs font-black text-right">₹${((k=o.mop)==null?void 0:k.toLocaleString())||0}</p>
                                    `}
                                                ...
                                                ${o.extraFields.map((m,E)=>`
                                                    <div class="relative">
                                                        ...
                                                        <div class="flex gap-1">
                                                            ...
                                                            <button type="button" onclick="window.removeExtraField(${u}, ${E})" class="w-8 h-8 flex items-center justify-center text-slate-300 hover:text-slate-600 hover:bg-slate-200 rounded-lg transition-all" title="Remove field">
                                                                <span class="material-icons-outlined text-sm">close</span>
                                                            </button>
                                                        </div>
                                                    </div>
                ...
                <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="grid grid-cols-3 gap-3">
                            <button type="button" onclick="window.selectPaymentMode('cash')" class="p-4 rounded-2xl border-2 flex flex-col items-center gap-2 transition-all ${V==="cash"?"border-slate-900 bg-slate-50":"border-slate-100 hover:border-slate-300"}">
                                <span class="material-icons-outlined text-2xl ${V==="cash"?"text-slate-900":"text-slate-400"}">payments</span>
                                <span class="text-[10px] font-black uppercase ${V==="cash"?"text-slate-900":"text-slate-500"}">Cash</span>
                            </button>
                            <button type="button" onclick="window.selectPaymentMode('card')" class="p-4 rounded-2xl border-2 flex flex-col items-center gap-2 transition-all ${V==="card"?"border-slate-900 bg-slate-50":"border-slate-100 hover:border-slate-300"}">
                                <span class="material-icons-outlined text-2xl ${V==="card"?"text-slate-900":"text-slate-400"}">credit_card</span>
                                <span class="text-[10px] font-black uppercase ${V==="card"?"text-slate-900":"text-slate-500"}">Card</span>
                            </button>
                            <button type="button" onclick="window.selectPaymentMode('upi')" class="p-4 rounded-2xl border-2 flex flex-col items-center gap-2 transition-all ${V==="upi"?"border-slate-900 bg-slate-50":"border-slate-100 hover:border-slate-300"}">
                                <span class="material-icons-outlined text-2xl ${V==="upi"?"text-slate-900":"text-slate-400"}">qr_code</span>
                                <span class="text-[10px] font-black uppercase ${V==="upi"?"text-slate-900":"text-slate-500"}">UPI</span>
                            </button>
                        </div>

                        ${V==="card"||V==="upi"?`
                            <div>
                                <label class="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-2 block">${V==="card"?"Card Reference / Last 4 Digits":"UPI Transaction ID"}</label>
                                <input type="text" value="${it}" oninput="window.updatePaymentReference(this.value)" placeholder="${V==="card"?"Enter reference":"Enter UPI ID"}" class="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl text-xs font-bold focus:outline-none focus:border-slate-900 transition-all">
                            </div>
                        `:""}
        ...
        `:""}
    `}function cl(e){const t=new Date(e);return t.setHours(0,0,0,0),t}function fa(e){const t=new Date(e);return t.setHours(23,59,59,999),t}function dl(e,t,s,a){if(t==="all")return e;const n=new Date,l=cl(n);return e.filter(d=>{const i=new Date(d.date);switch(t){case"today":return i>=l&&i<=fa(n);case"week":{const p=new Date(l);return p.setDate(p.getDate()-p.getDay()),i>=p&&i<=fa(n)}case"month":{const p=new Date(l.getFullYear(),l.getMonth(),1);return i>=p&&i<=fa(n)}case"custom":{if(!s&&!a)return!0;const p=s?cl(new Date(s)):new Date(0),o=a?fa(new Date(a)):new Date;return i>=p&&i<=o}default:return!0}})}window.toggleDateFilterDropdown=e=>{e&&e.stopPropagation();const t=document.getElementById("date-filter-dropdown");t&&t.classList.toggle("hidden")};window.updateHistoryFromDate=e=>{c.historyFromDate=e,c.historyToDate&&(c.historyDateFilter="custom",window.triggerRender())};window.updateHistoryToDate=e=>{c.historyToDate=e,c.historyFromDate&&(c.historyDateFilter="custom",window.triggerRender())};function Ur(){const e=window.getCache(),t=e.sales||[],s=e.saleItems||[],a=t.filter(k=>k.status==="draft"),n=t.filter(k=>k.status!=="draft"),l=c.historyViewMode||"completed",d=c.historyDateFilter||"all",i=dl(a,d,c.historyFromDate,c.historyToDate),p=dl(n,d,c.historyFromDate,c.historyToDate),o=l==="drafts"?i:p,u=()=>{switch(d){case"today":return"Today";case"week":return"This Week";case"month":return"This Month";case"custom":return c.historyFromDate||c.historyToDate?"Custom Range":"All Time";default:return"All Time"}},y=k=>{switch(k){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}},w=k=>{switch(k){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Paid"}};return`
        ${Pr("history")}
        <div class="scrolling-content px-4 sm:px-8 space-y-6 pb-12 text-left">
            ...
            `:`
                <section class="space-y-3 text-left">
                    ${l==="drafts"?`
                        <!-- Drafts List -->
                        ${i.map(k=>{const m=s.filter(h=>h.sale_id===k.id),E=m[0]?m[0].product_name:"No items",S=m.length>1?`+ ${m.length-1} more`:"";return`
                                <div class="card border-2 border-dashed overflow-hidden ${c.salesHistoryId===k.id?"border-slate-900 shadow-lg":"border-slate-200"}">
                                    <button type="button" onclick="window.setSalesHistoryId('${k.id}')" class="p-5 text-left w-full">
                                        ...
                                        <div class="space-y-1 text-left">
                                            <p class="text-[10px] font-bold text-slate-500 uppercase text-left">${E} ${S}</p>
                    ...
                    `:`
                        ...
                        ${p.map(k=>{const m=s.filter(U=>U.sale_id===k.id),E=m[0]?m[0].product_name:"Custom Sale",S=m.length>1?`+ ${m.length-1} more`:"",h=y(k.payment_mode),q=w(k.payment_mode);return`
                                <button type="button" onclick="window.setSalesHistoryId('${k.id}')" class="card p-4 sm:p-6 border-2 transition-all cursor-pointer text-left w-full ${c.salesHistoryId===k.id?"border-slate-900 shadow-lg":"border-transparent hover:border-slate-200"}">
                                    ...
                                    <div class="space-y-1 text-left">
                                        <p class="text-[10px] font-bold text-slate-500 uppercase text-left truncate">${E} ${S}</p>
                                        <div class="flex items-center justify-between text-left">
...
`,t+="Powered by RetailerOS",t}function Sd(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function Ed(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function An(){const e=c.currentTab==="history",t=qa();if(!t)return`<div class="p-10 text-center opacity-40 flex flex-col items-center justify-center h-full">
            ...
            ${t.paymentMode?`
                <div class="bg-slate-900 text-white p-4 rounded-xl mt-6 flex justify-between items-center text-left">
                    <div class="flex items-center gap-3 text-left">
                        ...
                        <div class="text-left">
                            <p class="text-[9px] font-black uppercase tracking-widest text-left">Paid via ${Ed(t.paymentMode)}</p>
    ...
    `}window.updateClientSearch=e=>{const t=document.getElementById("client-search-input"),s=(t==null?void 0:t.selectionStart)||e.length;c.clientSearchQuery=e,window.triggerRender(!1),setTimeout(()=>{const a=document.getElementById("client-search-input");a&&(a.focus(),a.setSelectionRange(s,s))},0)};async function Id(){const e=document.getElementById("client-name"),t=document.getElementById("client-phone"),s=document.getElementById("client-email"),a=document.getElementById("client-location");if(!e||!t){console.error("Form inputs not found"),window.toast.error("Form error. Please try again.");return}const n=e.value.trim(),l=t.value.trim(),d=s.value.trim(),i=a?a.value.trim():"";if(!n||!l){window.toast.warning("Name and Phone are required");return}const p=document.getElementById("save-client-btn");let o="";p&&(o=p.innerHTML,p.innerHTML='<span class="material-icons-outlined animate-spin text-xs">sync</span> Saving...',p.disabled=!0);try{const u="CL-"+Math.random().toString(36).substr(2,6).toUpperCase();console.log("Saving client:",{id:u,name:n,phone:l,email:d,location:i}),await T.clients.add({id:u,name:n,phone:l,email:d,location:i}),console.log("Client saved successfully"),await Y(),window.toast.success("Client added successfully!"),c.currentApp==="sales"?(Nr(u,n),$l("default")):Rl("directory")}catch(u){console.error("Error saving client:",u),window.toast.error("Error saving client: "+u.message),p&&(p.innerHTML=o,p.disabled=!1)}}window.saveClient=Id;function xn(e){const t=e==="desktop";return`
    ...
    `}function ul(e){var E;const t=e==="desktop",s=window.getCache(),a=((E=s.customers)==null?void 0:E.find(S=>S.id===c.selectedClientId||S.name===c.selectedClient))||{name:c.selectedClient||"Unknown",joined_at:new Date().toISOString()},n=a.name?a.name.split(" ").map(S=>S[0]).join("").toUpperCase():"?",l=(s.sales||[]).filter(S=>S.customer_id===a.id&&S.status!=="draft").sort((S,h)=>new Date(h.date)-new Date(S.date)),d=s.saleItems||[],i=(s.inquiries||[]).filter(S=>S.customer_id===a.id||S.customer_name===a.name),p=(s.repairs||[]).filter(S=>S.customer_id===a.id||S.customer_name===a.name),o=(s.automations||[]).filter(S=>S.customer_id===a.id),u=s.automationMessages||[],y=(s.communications||[]).filter(S=>S.customer_id===a.id),w=l.reduce((S,h)=>S+(h.total_amount||0),0),k=l.length,m=[...l.map(S=>({type:"sale",date:S.date,data:S,items:d.filter(h=>h.sale_id===S.id)})),...p.map(S=>({type:"repair",date:S.created_at||S.date,data:S})),...i.map(S=>({type:"inquiry",date:S.date||S.created_at,data:S})),...o.map(S=>({type:"automation",date:S.created_at,data:S,messages:u.filter(h=>h.automation_id===S.id)})),...y.map(S=>({type:"communication",date:S.sent_at,data:S}))].sort((S,h)=>new Date(h.date)-new Date(S.date));return`
            ...
            <div class="space-y-6 text-left">
                ...
                `:`
                    ...
                    <div class="relative pl-8 sm:pl-10 space-y-6 before:absolute before:left-3 sm:before:left-4 before:top-2 before:bottom-2 before:w-px before:bg-slate-100 before:border-l before:border-dashed before:border-slate-200 text-left">
                        ${m.map(S=>{if(S.type==="sale"){const h=S.data,q=S.items;return`
                                    <div class="relative text-left">
                                            ...
                                            <div class="space-y-2 text-left">
                                                ${q.map(U=>`
                                                    <div class="flex justify-between items-center bg-slate-50 rounded-lg p-2">
                                                        <div class="text-left flex-1 min-w-0">
                                                            <p class="text-[10px] font-black text-slate-900 truncate">${U.product_name}</p>
                                                            <p class="text-[8px] font-bold text-slate-400 uppercase">${U.category||"Product"}</p>
                                                        </div>
                                                        <p class="text-[10px] font-black text-slate-600 ml-2">₹${(U.price||0).toLocaleString()}</p>
                                                    </div>
                                                `).join("")}
                                            </div>
                                ...
                                `}if(S.type==="automation"){const h=S.data,q=S.messages||[],U=q.filter(zt=>zt.status==="sent").length,As=q.filter(zt=>zt.status==="pending").length;return`
                                    <div class="relative text-left">
                                ...
                                `}if(S.type==="communication"){const h=S.data,q=h.type==="whatsapp"?"chat":h.type==="call"?"call":"mail",U=h.type==="whatsapp"?"WhatsApp":h.type==="call"?"Phone Call":"Email";return`
                                    <div class="relative text-left">
                                        <div class="absolute -left-8 sm:-left-10 top-0 w-6 h-6 sm:w-8 sm:h-8 bg-white border border-slate-100 rounded-xl flex items-center justify-center z-10 shadow-sm text-center">
                                            <span class="material-icons-outlined text-xs text-slate-500 text-center">${q}</span>
                                        </div>
                                        <div class="card p-4 sm:p-5 group hover:border-slate-300 transition-all text-left">
                                            <div class="flex justify-between items-start mb-2 text-left">
                                                <div class="text-left flex-1 min-w-0">
                                                    <div class="flex items-center gap-2 mb-1">
                                                        <h4 class="text-xs font-black text-slate-900 text-left">${U}</h4>
    ...
    `}const Hr=e=>`${e}-${Math.random().toString(36).substr(2,8).toUpperCase()}`;let O={name:"",description:"",isCompany:!1,gstNumber:"",contactPerson:""};function Rd(){O={name:"",description:"",isCompany:!1,gstNumber:"",contactPerson:""}}window.updateGroupForm=(e,t)=>{O[e]=t,e==="isCompany"&&window.triggerRender(!1)};window.toggleGroupIsCompany=()=>{O.isCompany=!O.isCompany,window.triggerRender(!1)};window.saveGroup=async()=>{if(!O.name.trim()){window.toast.warning("Please enter a group name");return}const e=document.getElementById("save-group-btn");e&&(e.disabled=!0,e.innerHTML='<span class="material-icons-outlined animate-spin text-xs">sync</span> Saving...');try{const t=Hr("GRP");await T.groups.add({id:t,name:O.name.trim(),description:O.description.trim(),is_company:O.isCompany?1:0,gst_number:O.isCompany?O.gstNumber.trim():null,contact_person:O.isCompany?O.contactPerson.trim():null,created_at:new Date().toISOString()}),Rd(),await Y(),c.groupViewMode="list",c.selectedGroupId=t,window.toast.success(`${O.isCompany?"Company":"Group"} created successfully!`),window.triggerRender()}catch(t){console.error("Error saving group:",t),window.toast.error("Error saving group: "+t.message),e&&(e.disabled=!1,e.innerHTML="Create Group")}};window.deleteGroup=async e=>{window.showConfirm("Are you sure you want to delete this group? All member associations will be removed.",async()=>{try{await T.groups.deleteMembers(e),await T.groups.delete(e),await Y(),c.selectedGroupId=null,c.groupViewMode="list",window.toast.success("Group deleted successfully"),window.triggerRender()}catch(t){console.error("Error deleting group:",t),window.toast.error("Error deleting group: "+t.message)}})};window.addMemberToGroup=async(e,t)=>{try{await T.groups.addMember({id:Hr("GM"),group_id:e,customer_id:t,added_at:new Date().toISOString()}),await Y(),window.toast.success("Member added"),window.triggerRender(!1)}catch(s){console.error("Error adding member:",s),window.toast.error("Error adding member: "+s.message)}};window.removeMemberFromGroup=async(e,t)=>{try{await T.groups.removeMember(e,t),await Y(),window.toast.info("Member removed"),window.triggerRender(!1)}catch(s){console.error("Error removing member:",s),window.toast.error("Error removing member: "+s.message)}};window.updateGroupSearch=e=>{const t=document.getElementById("group-search-input"),s=(t==null?void 0:t.selectionStart)||e.length;c.groupSearchQuery=e,window.triggerRender(!1),setTimeout(()=>{const a=document.getElementById("group-search-input");a&&(a.focus(),a.setSelectionRange(s,s))},0)};function Cd(){const e=window.getCache(),t=e.groups||[],s=e.groupMembers||[],a=c.groupSearchQuery||"",n=a?t.filter(i=>i.name.toLowerCase().includes(a.toLowerCase())||i.description&&i.description.toLowerCase().includes(a.toLowerCase())):t,l=n.filter(i=>i.is_company===1),d=n.filter(i=>i.is_company!==1);return`
        ...
        <div class="h-full flex flex-col">
            ...
            <div class="p-6 border-b border-slate-100 flex items-center justify-between shrink-0">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-lg font-black text-slate-900 tracking-tighter">New ${O.isCompany?"Company":"Group"}</h2>
            ...
            <div class="flex-1 overflow-y-auto p-6 space-y-5">
                ...
                <div class="card p-4 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 ${O.isCompany?"bg-slate-900":"bg-slate-100"} rounded-xl flex items-center justify-center transition-all">
                            <span class="material-icons-outlined text-lg ${O.isCompany?"text-white":"text-slate-400"}">${O.isCompany?"business":"group"}</span>
                        </div>
                        <div>
                            <h3 class="text-sm font-black text-slate-900">${O.isCompany?"Company":"Group"}</h3>
                            <p class="text-[9px] font-bold text-slate-400">${O.isCompany?"B2B with GST":"For marketing"}</p>
                        </div>
                    </div>
                    <button type="button" onclick="window.toggleGroupIsCompany()" class="w-11 h-6 ${O.isCompany?"bg-slate-900":"bg-slate-200"} rounded-full relative transition-all">
                        <div class="absolute top-0.5 ${O.isCompany?"right-0.5":"left-0.5"} w-5 h-5 bg-white rounded-full shadow transition-all"></div>
                    </button>
                </div>

                <!-- Form Fields -->
                <div class="space-y-2">
                    <label class="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1">${O.isCompany?"Company Name":"Group Name"} <span class="text-slate-300">*</span></label>
                    <input type="text" 
                           value="${O.name}"
                           oninput="window.updateGroupForm('name', this.value)" 
                           placeholder="${O.isCompany?"e.g. Reliance Industries":"e.g. VIP Customers"}" 
                ...
                <div class="space-y-2">
                    ...
                    <textarea 
                           ...
                           placeholder="${O.isCompany?"Company details, address...":"Purpose of this group..."}" 
                           rows="2"
                           class="w-full px-4 py-3 bg-white border border-slate-100 rounded-xl text-sm font-bold focus:outline-none focus:border-slate-900 transition-all resize-none">${O.description}</textarea>
                </div>
                ...
                <button type="button" id="save-group-btn" onclick="window.saveGroup()" class="w-full py-4 bg-slate-900 text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 mt-4">
                    Create ${O.isCompany?"Company":"Group"}
    ...
    `}function Ad(){const e=window.getCache(),t=e.groups||[],s=e.groupMembers||[],a=e.customers||[],n=e.sales||[],l=t.find(u=>u.id===c.selectedGroupId);if(!l)return`
        ...
        `;const d=s.filter(u=>u.group_id===l.id).map(u=>u.customer_id),i=a.filter(u=>d.includes(u.id)),o=n.filter(u=>d.includes(u.customer_id)&&u.status!=="draft").reduce((u,y)=>u+(y.total_amount||0),0);return`
        <div class="h-full flex flex-col overflow-hidden">
            ...
            <div class="flex-1 overflow-y-auto p-6 space-y-5">
                ...
                <div class="space-y-3">
                    ...
                    `:`
                        <div class="space-y-2">
                            ${i.map(u=>{const w=n.filter(k=>k.customer_id===u.id&&k.status!=="draft").reduce((k,m)=>k+(m.total_amount||0),0);return`
    ...
    `}function xl(){return Cd()}function fl(){switch(c.groupViewMode){case"create":return $d();case"detail":return Ad();case"add-members":return Td();default:return`
                <div class="h-full flex items-center justify-center text-slate-300 text-center p-8">
                    <div class="text-center">
            ...
            `}}function Md(e){switch(e){case"cash":return"payments";case"card":return"credit_card";case"upi":return"qr_code";default:return"account_balance_wallet"}}function Dd(e){switch(e){case"cash":return"Cash";case"card":return"Card";case"upi":return"UPI";default:return"Payment"}}function bl(e="desktop"){var u,y;const t=window.getCache(),s=c.clientInvoiceId,a=(t.sales||[]).find(w=>w.id===s);if(!a)return`
        ...
        `;const n=(t.saleItems||[]).filter(w=>w.sale_id===a.id),l=(u=t.customers)==null?void 0:u.find(w=>w.id===a.customer_id),d=a.company_id?(y=t.companies)==null?void 0:y.find(w=>w.id===a.company_id):null,i=a.total_amount||0,p=n.map(w=>{let k=[];if(w.extra_fields)try{k=JSON.parse(w.extra_fields)}catch{}return{name:w.product_name,category:w.category||"Standard",price:w.price,imei:w.imei,serial_number:w.serial_number,mac_id:w.mac_id,manufacturing_date:w.manufacturing_date,installation_date:w.installation_date,extraFields:k}}),o={id:a.id,status:a.status,customer:a.customer_name,phone:(l==null?void 0:l.phone)||"N/A",date:new Date(a.date).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"}),time:new Date(a.date).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!0})+" IST",items:p,subtotal:i/1.18,gst:i-i/1.18,total:i,paymentMode:a.payment_mode,paymentReference:a.payment_reference,gstRequired:a.gst_required,company:d,installationRequired:a.installation_required,installationDate:a.installation_date};return`
...
`;window.setRepairCustomer=(e,t)=>{c.repairContext={customer_name:e,customer_phone:t},R()};function Pd(){const e=document.getElementById("repair-search-input"),t=e?e.value.trim():"",s=window.getCache?window.getCache():{customers:[]},a=t?s.customers.filter(n=>n.name.toLowerCase().includes(t.toLowerCase())||n.phone.includes(t)):[];return`
    ...
    `}async function Fd(e){if(c.activeRepairId)try{await T.repairs.updateStatus(c.activeRepairId,e),await Y()}catch(t){alert("Update failed: "+t.message)}}window.updateRepairStatus=Fd;function Ud(){const e=window.getCache(),t=e.repairs.find(n=>n.id===c.activeRepairId)||e.repairs[0];if(!t)return'<div class="p-20 text-center opacity-30 text-[10px] font-black uppercase">No active job selected</div>';const s=[{l:"Collected",s:"COLLECTED",i:"done"},{l:"Sent to Brand",s:"SENT_TO_BRAND",i:"shipping"},{l:"At Service Center",s:"IN_REPAIR",i:"build"},{l:"Ready for Pickup",s:"READY",i:"check_circle"},{l:"Handed Over",s:"COMPLETED",i:"person"}],a=s.findIndex(n=>n.s===t.status);return`
    ...
    `}function On(e){const t=e==="desktop-secondary";return window.setPromoterViewMode=s=>{c.promoterViewMode=s,R()},t?c.promoterViewMode==="onboarding"?Jd():Yd():zd()}function Kd(){return`
    ...
    `}async function Zd(){const e=document.getElementById("inward-model").value,t=document.getElementById("inward-imei").value;if(document.getElementById("inward-sn").value,!e||!t){alert("Model name and IMEI are required.");return}const s=document.getElementById("confirm-inward-btn");s.disabled=!0,s.innerText="Syncing...";try{const a=await T.query("SELECT * FROM products WHERE name = ?",[e]);let n=1;if(a.length>0)n=parseInt(a[0].stock)+1,await T.query("UPDATE products SET stock = ? WHERE id = ?",[n,a[0].id]);else{const l="PRD-"+Math.random().toString(36).substr(2,6).toUpperCase();await T.query(`
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?)
            `,[l,e,"Smartphone",e.split(" ")[0],5e4,1,t])}await T.inventoryLogs.add({id:"LOG-"+Math.random().toString(36).substr(2,6).toUpperCase(),product_id:e,type:"INWARD",quantity:1,reason:"New Shipment Arrival",date:new Date().toISOString()}),await Y(),window.setInventoryMode("details")}catch(a){alert("Inward failed: "+a.message),s.disabled=!1,s.innerText="Confirm Inward"}}window.confirmInward=Zd;function ep(){return`
        <div class="h-full flex flex-col relative bg-white animate-slide-up text-left">
            <!-- Header -->
            <div class="p-6 border-b border-slate-100 flex items-center justify-between shrink-0 text-left">
                 <div class="flex items-center gap-3 text-left">
    ...
    `}function jn(e){const t=e==="desktop-secondary";return window.setInventoryTab=s=>{c.inventoryTab=s,R()},window.setInventoryMode=s=>{c.inventoryMode=s,R()},t?c.inventoryMode==="inward"?ep():tp():`
    ...
    `}function qn(e){const t=e==="desktop-secondary";return window.setSettingsView=s=>{c.settingsView=s,c.settingsSubView=null,R()},window.setSettingsSubView=s=>{c.settingsSubView=s,R()},window.setSettingsRole=s=>{c.settingsActiveRole=s,c.settingsSubView="detail",R()},window.saveNewRole=()=>{const s=document.querySelector('input[placeholder="e.g. Floor Supervisor"]');s&&s.value?(c.settingsActiveRole=s.value,c.settingsSubView="detail",window.toast.success(`Role "${s.value}" created successfully!`),R()):window.toast.warning("Please enter a role name")},window.updateRole=()=>{window.toast.success("Role profile updated successfully!"),window.setSettingsSubView("detail")},t?c.settingsView==="roles"?ap():c.settingsView==="accounting"?np():c.settingsView==="ledger"?lp():c.settingsView==="ai"?ip():c.settingsView==="store"?op():"":sp(e)}function cp(){return`
        <div class="space-y-4 text-left">
    ...
    `}window.setSchemeViewMode=e=>{c.showSchemeDetails=e==="details",R()};window.setActiveScheme=e=>{c.activeScheme=e,R()};function dp(){const t=(window.getCache?window.getCache():{schemes:[]}).schemes||[];return`
    ...
    `}function pp(e){const t=e==="mobile",s=c.activeScheme;if(!s)return'<div class="p-10 text-center">Select a scheme to view details</div>';const n=((window.getCache?window.getCache():{sales:[]}).sales||[]).filter(u=>{const y=u.product_name||"",w=typeof s=="object"&&s.brand?s.brand:"";return y.includes(w)||u.items&&u.items.some(k=>(k.name||"").includes(w))}),l=typeof s=="object"&&s.brand?s.brand:s,d=typeof s=="object"&&s.name?s.name:"Scheme",i=typeof s=="object"&&s.payout?s.payout:"0",p=typeof s=="object"&&s.end_date?s.end_date:new Date,o={count:n.length,growth:"+0%",color:l==="Apple"?"bg-indigo-950":l==="Nothing"?"bg-slate-950":"bg-emerald-950"};return`
    ...
    `}function Pn(e){const t=e==="desktop-secondary",s=e==="mobile";if(window.selectSchemeBrand=n=>{c.activeSchemeBrand=n,c.schemesTab="list",R()},window.selectScheme=n=>{c.activeScheme=n,s&&(c.showSchemeDetails=!0),R()},window.setSchemesTab=n=>{c.schemesTab=n,R()},window.toggleSchemeDetails=n=>{c.showSchemeDetails=n,R()},t||s&&c.showSchemeDetails)return pp(e);const a=c.schemesTab==="brands";return`
    ...
    `}async function yp(e){var t;if((t=c.activeInquiry)!=null&&t.id)try{await T.inquiries.updateStatus(c.activeInquiry.id,e),await Y(),window.setInquiryViewMode("list")}catch(s){alert("Update failed: "+s.message)}}window.updateInquiryStatus=yp;function kp(){const e=c.activeInquiry;return e?`
    ...
    `}function Ep(e){const t=c.activeCampaign;return t?`
    ...
    `}function Fn(e){return e==="desktop-secondary"||e==="mobile"&&c.preBookingViewMode==="create"?Sp():c.preBookingViewMode==="details"&&c.activeCampaign?Ep():c.preBookingViewMode==="public"?Ip():_p()}function Rp(){const e=window.getCache(),t=e.automations||[],s=e.automationMessages||[],a=t.filter(o=>o.status==="active").length;t.filter(o=>o.status==="completed").length,s.length;const n=s.filter(o=>o.status==="sent").length,l=s.filter(o=>o.status==="pending").length,d=new Date,i=new Date(Date.now()+7*864e5),p=s.filter(o=>o.status==="pending"&&new Date(o.scheduled_date)<=i).sort((o,u)=>new Date(o.scheduled_date)-new Date(u.scheduled_date)).slice(0,5);return`
        <header class="p-4 sm:p-8 pb-4 shrink-0 text-left">
             <div class="flex items-center justify-between mb-6 text-left">
                <button onclick="setApp('launcher')" class="flex items-center gap-1 text-slate-400 hover:text-slate-900 transition-colors text-left">
                    <span class="material-icons-outlined text-left">chevron_left</span>
        ...
        <div class="scrolling-content px-4 sm:px-8 space-y-6 pb-32 text-left">
            ...
            ${p.length>0?`
                <section class="space-y-4 text-left">
                    ...
                    <div class="space-y-2 text-left">
                        ${p.map(o=>{const u=t.find(E=>E.id===o.automation_id),y=new Date(o.scheduled_date),w=y.toDateString()===d.toDateString(),k=y.toDateString()===new Date(Date.now()+864e5).toDateString(),m=w?"Today":k?"Tomorrow":y.toLocaleDateString("en-GB",{day:"2-digit",month:"short"});return`
            ...
            <section class="space-y-4 text-left">
                ...
                <div class="space-y-3 text-left">
                    ${t.map(o=>{const u=s.filter(k=>k.automation_id===o.id),y=u.filter(k=>k.status==="sent").length;u.filter(k=>k.status==="pending").length;const w=u.length>0?Math.round(y/u.length*100):0;return`
            ...
            <div class="flex-1 overflow-y-auto px-4 sm:px-6 py-6 space-y-6 text-left">
                ...
                ${_e?`
                    <div class="space-y-3 text-left">
                        ...
                        `:`
                            <div class="space-y-2 max-h-48 overflow-y-auto">
                                ${n.map(o=>{var w;const u=(t.saleItems||[]).filter(k=>k.sale_id===o.id),y=me===o.id;return`
                                        <button type="button" onclick="window.selectAutomationSale('${o.id}')" class="card p-4 w-full text-left transition-all ${y?"border-2 border-slate-900 shadow-lg":"hover:border-slate-300"}">
                                            <div class="flex justify-between items-start">
                                                <div class="text-left">
    ...
    `}window.sendAutomationMessage=async e=>{var t,s,a,n,l;try{const d=window.getCache(),i=(t=d.automationMessages)==null?void 0:t.find(E=>E.id===e),p=(s=d.automations)==null?void 0:s.find(E=>E.id===(i==null?void 0:i.automation_id)),o=(a=d.customers)==null?void 0:a.find(E=>E.id===(p==null?void 0:p.customer_id));if(!i||!p){window.toast.error("Message not found");return}if(!(o!=null&&o.phone)){window.toast.error("Customer phone number not found");return}window.toast.info("Sending WhatsApp message...");const y=((l=(((n=d.saleItems)==null?void 0:n.filter(E=>E.sale_id===p.sale_id))||[])[0])==null?void 0:l.product_name)||"your product",w=i.content.replace(/\{product\}/g,y).replace(/\{name\}/g,o.name.split(" ")[0]);let k="sent",m=null;try{m=await window.sendWhatsAppMessage(o.phone,w),m.success?(k="delivered",window.toast.success("WhatsApp message sent!")):(k="failed",window.toast.warning("Message queued but may not have been delivered"))}catch(E){console.error("WATI Error:",E),k="failed",window.toast.error("WhatsApp send failed: "+E.message)}await T.automations.updateMessageStatus(e,k==="failed"?"pending":"sent",new Date().toISOString()),await T.communications.add({id:`COMM-${Math.random().toString(36).substr(2,8).toUpperCase()}`,customer_id:p.customer_id,type:"whatsapp",direction:"outgoing",content:w,sent_at:new Date().toISOString(),automation_id:p.id,sale_id:p.sale_id,status:k}),await Y()}catch(d){console.error("Error sending message:",d),window.toast.error("Failed to send message: "+d.message)}};window.toggleAutomationStatus=async e=>{var t;try{const a=(t=window.getCache().automations)==null?void 0:t.find(l=>l.id===e);if(!a)return;const n=a.status==="active"?"paused":"active";await T.automations.update(e,{status:n}),await Y(),window.toast.success(`Automation ${n==="active"?"resumed":"paused"}`)}catch(s){console.error("Error toggling automation:",s),window.toast.error("Failed to update automation")}};window.deleteAutomation=async e=>{window.showConfirm("Are you sure you want to delete this automation? All scheduled messages will be cancelled.",async()=>{try{await T.automations.deleteMessages(e),await T.automations.delete(e),await Y(),window.toast.success("Automation deleted"),window.setAutomationMode("dashboard")}catch(t){console.error("Error deleting automation:",t),window.toast.error("Failed to delete automation")}})};window.openWhatsAppMessage=(e,t)=>{const s=`https://wa.me/${(e==null?void 0:e.replace(/\D/g,""))||""}?text=${encodeURIComponent(t)}`;window.open(s,"_blank")};function gl(e,t=!1){var y,w,k;const s=window.getCache(),a=(y=s.automations)==null?void 0:y.find(m=>m.id===e);if(!a)return`
            <div class="h-full flex items-center justify-center text-slate-300 text-center">
                <div class="text-center">
            ...
            <div class="flex-1 overflow-y-auto px-4 sm:px-6 py-6 space-y-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="relative pl-8 space-y-4 before:absolute before:left-3 before:top-4 before:bottom-4 before:w-px before:bg-slate-200">
                        ${n.map((m,E)=>{const S=u(m.message_type),h=m.status==="sent",q=new Date(m.scheduled_date).toDateString()===new Date().toDateString();return new Date(m.scheduled_date)<new Date,`
                                <div class="relative">
                                    <div class="absolute -left-8 top-4 w-6 h-6 ${h?"bg-slate-900":"bg-white border-2 border-slate-200"} rounded-full flex items-center justify-center z-10">
                                        ${h?'<span class="material-icons-outlined text-white text-xs">check</span>':`<span class="text-[9px] font-black text-slate-400">${E+1}</span>`}
                                    </div>
                                    
                                    <div class="card p-4 ${h?"bg-slate-50 border-slate-100":q?"border-slate-900 shadow-lg":"border-slate-100"}">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center justify-between mb-1">
                                                    <span class="text-[8px] font-black ${h?"text-slate-400":q?"text-slate-900":"text-slate-400"} uppercase">
                                                        Day ${m.day_offset} • ${m.message_type}
                                                    </span>
                                                    <span class="text-[8px] font-bold ${h?"text-slate-400":q?"text-slate-900":"text-slate-300"}">
                                                        ${h?"Sent":q?"Today":new Date(m.scheduled_date).toLocaleDateString("en-GB",{day:"2-digit",month:"short"})}
                                                    </span>
                                                </div>
    ...
    `}function Un(e){const t=e==="mobile",s=e==="desktop-secondary";return window.setAutomationMode=(a,n=null)=>{c.automationViewMode=a,n!==null&&(c.activeAutomationId=n),R()},s?c.automationViewMode==="create"?hl():c.automationViewMode==="details"&&c.activeAutomationId?gl(c.activeAutomationId):`
            <div class="h-full flex items-center justify-center text-slate-300 text-center">
                <div class="text-center">
        ...
        `:t&&c.automationViewMode==="create"?hl(!0):t&&c.automationViewMode==="details"?gl(c.activeAutomationId,!0):Rp()}function Cp(e=!0){if(!e)return;const t=[c.currentApp];c.currentApp==="sales"?t.push(c.currentTab):c.currentApp==="clients"?(t.push(c.clientViewMode),c.selectedClient&&c.clientViewMode==="profile"&&t.push(encodeURIComponent(c.selectedClient))):c.currentApp==="reports"?t.push(c.reportsTab):c.currentApp==="repairs"?(t.push(c.repairTab),t.push(c.repairViewMode)):c.currentApp==="inventory"?(t.push(c.inventoryTab),t.push(c.inventoryMode)):c.currentApp==="marketplace"?(t.push(c.marketplaceTab),t.push(c.marketplaceViewMode)):c.currentApp==="inquiries"?t.push(c.inquiryViewMode):c.currentApp==="prebooking"?t.push(c.preBookingViewMode):c.currentApp==="automation"?t.push(c.automationViewMode):c.currentApp==="schemes"?t.push(c.schemesTab):c.currentApp==="settings"&&t.push(c.settingsView);const s="#/"+t.filter(Boolean).join("/");window.location.hash!==s&&window.history.pushState(null,"",s)}function wl(){const e=window.location.hash.replace("#/","");if(!e)return;const t=e.split("/"),s=t[0];s&&(c.currentApp=s),s==="sales"?t[1]&&(c.currentTab=t[1]):s==="clients"?(t[1]&&(c.clientViewMode=t[1]),t[2]&&(c.selectedClient=decodeURIComponent(t[2]))):s==="reports"?t[1]&&(c.reportsTab=t[1]):s==="repairs"?(t[1]&&(c.repairTab=t[1]),t[2]&&(c.repairViewMode=t[2])):s==="inventory"?(t[1]&&(c.inventoryTab=t[1]),t[2]&&(c.inventoryMode=t[2])):s==="marketplace"?(t[1]&&(c.marketplaceTab=t[1]),t[2]&&(c.marketplaceViewMode=t[2])):s==="inquiries"?t[1]&&(c.inquiryViewMode=t[1]):s==="prebooking"?t[1]&&(c.preBookingViewMode=t[1]):s==="automation"?t[1]&&(c.automationViewMode=t[1]):s==="schemes"?t[1]&&(c.schemesTab=t[1]):s==="settings"&&t[1]&&(c.settingsView=t[1]),R(!1)}function $p(){window.addEventListener("hashchange",wl),wl()}const It={endpoint:"https://live-mt-server.wati.io/319917",token:"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..V1k2oIW0iDKep9_zG9WpS62LVcgXxj7vAndigvmZS2I"};function Ap(e){if(!e)return null;let t=e.replace(/\D/g,"");return t.length===10&&(t="91"+t),t}async function Tp(e,t){var a;const s=Ap(e);if(!s)throw new Error("Invalid phone number");try{const n=await fetch(`${It.endpoint}/api/v1/sendSessionMessage/${s}`,{method:"POST",headers:{Authorization:It.token,"Content-Type":"application/json"},body:JSON.stringify({messageText:t})}),l=await n.json();if(!n.ok){if(console.error("WATI API Error:",l),(a=l.message)!=null&&a.includes("session")||l.result===!1)return console.log("Session expired, trying template message..."),await Mp(s,t);throw new Error(l.message||"Failed to send message")}return{success:!0,data:l}}catch(n){throw console.error("WATI Send Error:",n),n}}async function Mp(e,t){try{const s=await fetch(`${It.endpoint}/api/v1/sendTemplateMessage`,{method:"POST",headers:{Authorization:It.token,"Content-Type":"application/json"},body:JSON.stringify({whatsappNumber:e,templateName:"retaileros_notification",parameters:[{name:"message",value:t}],broadcast_name:"RetailerOS"})}),a=await s.json();return!s.ok&&a.result===!1?(console.log("Template not found, trying interactive message..."),await Dp(e,t)):{success:!0,data:a,method:"template"}}catch(s){throw console.error("Template message error:",s),s}}async function Dp(e,t){try{const s=await fetch(`${It.endpoint}/api/v1/sendInteractiveButtonsMessage`,{method:"POST",headers:{Authorization:It.token,"Content-Type":"application/json"},body:JSON.stringify({whatsappNumber:e,header:{type:"Text",text:"RetailerOS"},body:t,footer:"Powered by RetailerOS",buttons:[{type:"reply",reply:{id:"reply_ok",title:"OK"}}]})}),a=await s.json();return{success:s.ok,data:a,method:"interactive"}}catch(s){throw console.error("Interactive message error:",s),s}}async function Lp(){try{return(await fetch(`${It.endpoint}/api/v1/getContacts?pageSize=1`,{method:"GET",headers:{Authorization:It.token}})).ok}catch(e){return console.error("WATI connection test failed:",e),!1}}window.sendWhatsAppMessage=Tp;window.testWatiConnection=Lp;let Mt=null,Ha=null;const vl={success:{icon:"check_circle",bg:"bg-slate-900",text:"text-white"},error:{icon:"error",bg:"bg-red-600",text:"text-white"},warning:{icon:"warning",bg:"bg-amber-500",text:"text-white"},info:{icon:"info",bg:"bg-slate-700",text:"text-white"}};function Op(){Mt||(Mt=document.createElement("div"),Mt.id="toast-container",Mt.className="fixed top-4 left-1/2 -translate-x-1/2 z-[9999] flex flex-col items-center gap-2 pointer-events-none",document.body.appendChild(Mt))}function Bs(e,t="info",s=3e3){Op(),Ha&&clearTimeout(Ha);const a=vl[t]||vl.info,n=document.createElement("div");return n.className=`
        ${a.bg} ${a.text} 
    ...
    `.trim().replace(/\s+/g," "),n.innerHTML=`
        ...
        <span class="text-sm font-bold leading-snug">${$a(e)}</span>
    `,(t==="error"||e.length>50)&&(n.innerHTML+=`
        ...
        `),Mt.innerHTML="",Mt.appendChild(n),requestAnimationFrame(()=>{n.classList.remove("opacity-0","translate-y-[-20px]","scale-95"),n.classList.add("opacity-100","translate-y-0","scale-100")}),Ha=setTimeout(()=>{jp(n)},s),n}function jp(e){!e||!e.parentElement||(e.classList.remove("opacity-100","translate-y-0","scale-100"),e.classList.add("opacity-0","translate-y-[-20px]","scale-95"),setTimeout(()=>{e.remove()},300))}function $a(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}const qp={success:(e,t)=>Bs(e,"success",t),error:(e,t)=>Bs(e,"error",t||5e3),warning:(e,t)=>Bs(e,"warning",t||4e3),info:(e,t)=>Bs(e,"info",t)};function Pp(e,t,s){const a=document.createElement("div");a.className="fixed inset-0 z-[9998] bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4",a.innerHTML=`
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden transform transition-all duration-200 scale-95 opacity-0">
            <div class="p-6 text-center">
                ...
                <p class="text-sm font-bold text-slate-900 leading-relaxed">${$a(e)}</p>
            </div>
    ...
    `,document.body.appendChild(a);const n=a.querySelector("div > div");requestAnimationFrame(()=>{n.classList.remove("scale-95","opacity-0"),n.classList.add("scale-100","opacity-100")}),a.querySelector("#confirm-cancel").onclick=()=>{pt(a),s&&s()},a.querySelector("#confirm-ok").onclick=()=>{pt(a),t&&t()},a.onclick=l=>{l.target===a&&(pt(a),s&&s())}}function pt(e){const t=e.querySelector("div > div");t.classList.remove("scale-100","opacity-100"),t.classList.add("scale-95","opacity-0"),setTimeout(()=>e.remove(),200)}function Np(e,t="",s,a){const n=document.createElement("div");n.className="fixed inset-0 z-[9998] bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4",n.innerHTML=`
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden transform transition-all duration-200 scale-95 opacity-0">
            <div class="p-6">
                <p class="text-sm font-bold text-slate-900 mb-4">${$a(e)}</p>
                <input type="text" id="prompt-input" value="${$a(t)}" 
    ...
    `,document.body.appendChild(n);const l=n.querySelector("div > div"),d=n.querySelector("#prompt-input");requestAnimationFrame(()=>{l.classList.remove("scale-95","opacity-0"),l.classList.add("scale-100","opacity-100"),d.focus(),d.select()}),d.onkeydown=i=>{if(i.key==="Enter"){const p=d.value.trim();pt(n),p&&s&&s(p)}else i.key==="Escape"&&(pt(n),a&&a())},n.querySelector("#prompt-cancel").onclick=()=>{pt(n),a&&a()},n.querySelector("#prompt-ok").onclick=()=>{const i=d.value.trim();pt(n),i&&s&&s(i)},n.onclick=i=>{i.target===n&&(pt(n),a&&a())}}window.toast=qp;window.showToast=Bs;window.showConfirm=Pp;window.showPrompt=Np;function Gr(){return c.currentApp==="sales"?c.currentTab==="new-sale"?Fr():Ur():c.currentApp==="clients"?Tn("desktop-primary"):c.currentApp==="reports"?Mn("desktop-primary"):c.currentApp==="repairs"?Dn("desktop-primary"):c.currentApp==="marketing"?Ln("desktop-primary"):c.currentApp==="promoters"?On("desktop-primary"):c.currentApp==="inventory"?jn("desktop-primary"):c.currentApp==="settings"?qn("desktop-primary"):c.currentApp==="schemes"?Pn("desktop-primary"):c.currentApp==="marketplace"?Nn("desktop-primary"):c.currentApp==="inquiries"?Bn("desktop-primary"):c.currentApp==="prebooking"?Fn("desktop-primary"):c.currentApp==="automation"?Un("desktop-primary"):'<div class="p-10 flex items-center justify-center h-full text-slate-300 font-bold uppercase tracking-widest">App Module Not Found</div>'}function Bp(){return c.currentApp==="sales"?c.salesMode==="add-customer"?xn("desktop"):An():c.currentApp==="clients"?Tn("desktop-secondary"):c.currentApp==="reports"?Mn("desktop-secondary"):c.currentApp==="repairs"?Dn("desktop-secondary"):c.currentApp==="marketing"?Ln("desktop-secondary"):c.currentApp==="promoters"?On("desktop-secondary"):c.currentApp==="inventory"?jn("desktop-secondary"):c.currentApp==="settings"?qn("desktop-secondary"):c.currentApp==="schemes"?Pn("desktop-secondary"):c.currentApp==="marketplace"?Nn("desktop-secondary"):c.currentApp==="inquiries"?Bn("desktop-secondary"):c.currentApp==="prebooking"?Fn("desktop-secondary"):c.currentApp==="automation"?Un("desktop-secondary"):'<div class="h-full flex items-center justify-center text-slate-300"><div class="text-center"><span class="material-icons-outlined text-4xl mb-2 opacity-50">grid_view</span><p class="text-[10px] font-black uppercase tracking-widest">Select an app to view details</p></div></div>'}function Wr(){return Ga("desktop")}function Fp(){return`
    ...
    `}function zr(){if(!c.isLoggedIn)return`
        ...
        `:""}
        `}let e="";if(c.currentApp==="clients")e=Tn("mobile");else if(c.currentApp==="reports")e=Mn("mobile");else if(c.currentApp==="repairs")e=Dn("mobile");else if(c.currentApp==="marketing")e=Ln("mobile");else if(c.currentApp==="promoters")e=On("mobile");else if(c.currentApp==="inventory")e=jn("mobile");else if(c.currentApp==="settings")e=qn("mobile");else if(c.currentApp==="schemes")e=Pn("mobile");else if(c.currentApp==="marketplace")e=Nn("mobile");else if(c.currentApp==="inquiries")e=Bn("mobile");else if(c.currentApp==="prebooking")e=Fn("mobile");else if(c.currentApp==="automation")e=Un("mobile");else return Ga("mobile");return`
        <div class="flex flex-col w-full h-full overflow-hidden bg-slate-50 relative">
            ${e}
        </div>
    `}function Aa(){const e=document.getElementById("app");if(e)try{const t=window.innerWidth;t<768?e.innerHTML=zr():t>=768&&t<1024?e.innerHTML=Up():e.innerHTML=Fp()}catch(t){console.error(t),e.innerHTML=`< div class="p-4 text-red-500 font-bold" > Error: ${t.message} <br><small>${t.stack}</small></div>`}}function Vp(){const e=window.innerWidth;if(e<768){const t=document.getElementById("app");t&&(t.innerHTML=zr())}else{const t=document.querySelector(".flex-1.bg-white.h-full.overflow-hidden.flex.flex-col.relative.z-10")||document.querySelector(".col-span-1.bg-white.h-full.overflow-hidden.flex.flex-col.relative.z-10"),s=document.querySelector(".w-\\[30\\%\\].shrink-0.bg-slate-50\\/50.h-full.overflow-hidden.flex.flex-col.relative.dot-grid.border-l.border-slate-200");t&&(t.innerHTML=c.authMode==="register"?Hs("desktop-primary"):'<div class="h-full w-full bg-slate-950 flex flex-col items-center justify-center text-white/5 font-black text-[20vw] leading-none overflow-hidden select-none pointer-events-none"><div>OS</div></div>'),s&&e>=1024&&(s.innerHTML=c.authMode==="register"?Hs("desktop-secondary"):'<div class="h-full w-full bg-slate-950/95 flex flex-col items-center justify-center text-white/5 font-black text-[15vw] leading-none overflow-hidden select-none pointer-events-none"><div>RETAILER</div></div>')}}window.updateAuthContent=Vp;Il(Aa);Il(Cp);$p();window.addEventListener("resize",()=>{window.innerWidth!==c.viewportWidth&&(c.viewportWidth=window.innerWidth,c.gridCols=window.innerWidth<768?4:3,Aa())});Y().then(()=>{console.log("Initial data sync complete"),Aa()}).catch(e=>{console.error("Initial sync failed:",e),Aa()});
